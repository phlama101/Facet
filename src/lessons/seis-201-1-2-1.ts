      ...
      cards: [
        {
          ...
          icon: Activity,
          color: BRAND.coral,
          desc: 'M₀ = μ × A × D (SI units: N·m). Moment magnitude: M_w = (log₁₀ M₀ / 1.5) − 10.7. One M_w unit = factor of 31.6 in M₀ and ~32× in radiated energy. Tōhoku 2011: M₀ = 3.9 × 10²² N·m, M_w 9.1, rupture area ~200 × 500 km (311 mi), avg slip ~40 m (131 ft). Does not saturate. Self-similar scaling: M₀ ∝ D³, constant stress drop 1–10 MPa across all magnitudes.',
          examples: '1960 Chile M_w 9.5: largest recorded, M₀ = 2.0 × 10²³ N·m, 800 km (497 mi) × 200 km (124 mi) rupture, ~30 m (98 ft) slip · 2004 Sumatra M_w 9.1: 1,300 km (808 mi) rupture, ~15 m (49 ft) avg slip, ~5 m (16 ft) seafloor uplift · M_w 6 vs M_w 9: M₀ ratio = 10^(1.5 × 3) = 10^4.5 ≈ 32,000 — a M9 releases 32,000 times more moment than a M6',
        },
        {
      ...
      questions: [
        {
          ...
          a: [
            ...
            'log₁₀(3.9 × 10²²) = 22.591; M_w = 22.591 / 1.5 − 10.7 = 15.061 − 10.7 = 4.36; the moment magnitude scale saturates above M7 just as the Richter scale does, because both are derived from the same seismic wave amplitudes measured at 100 km (62 mi) distance; the only difference is that M_w uses long-period amplitudes and M_L uses short-period amplitudes',
        ...
        {
          q: 'Self-similar scaling implies that M₀ ∝ D³ and that stress drop is approximately constant across all earthquake sizes (1–10 MPa). If a magnitude 6 earthquake has a stress drop of 3 MPa and an average slip of 0.5 m (2 ft), what average slip would you expect from a magnitude 9 earthquake with the same stress drop, and what does this imply about fault dimensions?',
          a: [
            'The M_w 9 earthquake has M₀ that is 10^(1.5 × 3) = 31,623 times larger than the M_w 6. Since M₀ ∝ D³ at constant stress drop, D scales as M₀^(1/3): D_9 / D_6 = (M₀_9 / M₀_6)^(1/3) = 31,623^(1/3) ≈ 31.6. Average slip for M_w 9 ≈ 31.6 × 0.5 m (2 ft) = 15.8 m (52 ft). Since stress drop Δτ = C × μD/L (where L is fault dimension and C a geometric constant), constant stress drop requires L_9 / L_6 = D_9 / D_6 × (L_6/L_6) — this means the linear fault dimension also scales by a factor of ~31.6: if L_6 = 15 km (9.3 mi), then L_9 ≈ 470 km (292 mi). This is consistent with the Tōhoku rupture dimensions.',
