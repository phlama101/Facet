...
Permafrost is ground (soil or rock) that remains at or below 0°C for two or more consecutive years. It is classified by spatial extent: continuous permafrost (>90% of area frozen, mean annual ground temperature typically below −5°C), discontinuous permafrost (50–90% coverage, temperatures between −5°C and 0°C), and sporadic permafrost (<10% coverage, near the southern limit of permafrost). The active layer is the surface zone that thaws seasonally each summer; it ranges from 0.3 m in high-Arctic tundra to 2 m or more in warmer, discontinuous zones. Below the active layer, the permafrost table marks the upper boundary of perennially frozen ground.
