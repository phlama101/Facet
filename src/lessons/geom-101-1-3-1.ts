      ...
      cards: [
        {
          ...
          icon: Wind,
          color: BRAND.accent,
          desc: 'Saltation dominates (70–80%): grains hop 10–60 cm (4–24 in) above surface, splash other grains on landing. Suspension carries silt and clay globally. Reptation/creep rolls large grains forward under saltation impact.',
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.jade,
          desc: 'Wind removes fine particles below threshold size, leaving a lag deposit of pebbles that forms desert pavement (reg in North Africa, gibber in Australia). Hamadas are bare rock surfaces stripped of fines. Deflation hollows can exceed 100 m (328 ft) depth.',
          examples: 'Qattara Depression, Egypt (−133 m / −436 ft, 19,605 km² / 7,569 sq mi) — one of the largest deflation basins on Earth; Australian gibber plains of the Simpson and Strzelecki deserts.',
        },
        {
          ...
          examples: 'Lut Desert, Iran — largest known yardang field on Earth, with ridges reaching 150 m (492 ft) height; ventifacts in Antarctic Dry Valleys sculpted by katabatic winds exceeding 300 km/h (186 mph).',
        },
        {
