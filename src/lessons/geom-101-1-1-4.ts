...
Cosmogenic nuclide dating has revolutionised the measurement of hillslope erosion rates. Cosmic rays penetrating Earth\'s surface produce rare isotopes — principally ¹⁰Be and ²⁶Al — in quartz minerals at rates that decrease exponentially with depth. If erosion is steady, the concentration of ¹⁰Be in surface quartz is inversely proportional to the erosion rate: fast erosion = low concentration (grains spend little time near the surface); slow erosion = high concentration. Global compilations show hillslope erosion rates spanning 0.01 mm/yr on ancient stable cratons to 1–10 mm/yr in rapidly uplifting mountain belts, beautifully capturing the coupling between tectonics and surface processes.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/Great_Sand_Dunes_NP-CoSand_Dune_field.jpg/1200px-Great_Sand_Dunes_NP-CoSand_Dune_field.jpg',
        alt: 'Photograph of the Great Sand Dunes in Colorado showing slip faces, dune crests, windward slopes, interdune corridors, and the mountain backdrop',
        aspectRatio: '16/9',
        ...
        annotations: [
          {
            ...
            x: 55,
            y: 55,
            label: 'Slip Face (Lee Side)',
            description: 'The steep leeward face of the dune, inclined at the angle of repose (~30–34°) for dry sand. Sand avalanches down the slip face when grains accumulate above this threshold, advancing the dune downwind.',
          },
          {
            id: 'dune-crest',
            x: 50,
            y: 40,
            label: 'Dune Crest',
            description: 'The sharp crest marks the transition from the gentle windward slope to the steep slip face. Sand is transported up the windward slope by saltation and creep, avalanches over the crest, and is deposited as foreset beds on the slip face.',
          },
          {
            id: 'windward-slope',
            x: 30,
            y: 60,
            label: 'Windward Slope (Stoss Side)',
            description: 'The gentle upwind slope (typically 5–15°) where sand grains are transported upslope by saltation and surface creep. Ripples on this face record the dominant wind direction and the saltation trajectory of individual grains.',
          },
          {
            id: 'interdune-corridor',
            x: 70,
            y: 70,
            label: 'Interdune Corridor',
            description: 'Low-lying areas between dunes where sand is deflated down to the water table or a resistant lag. These corridors can be colonised by vegetation that further stabilises the sediment and modulates dune migration.',
          },
          {
            id: 'mountain-backdrop',
            x: 20,
            y: 25,
            label: 'Sangre de Cristo Mountains',
            description: 'The mountains provide the sand source (glacial and fluvial deposits) and create the wind convergence zone that causes dunes to accumulate at their base. The Medano and Sand Creeks recycle sand back to the dune field seasonally.',
          },
        ],
      },
    },
