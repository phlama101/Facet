...
**Lapse rate feedback** is more subtle and spatially structured. The atmospheric lapse rate is the rate at which temperature decreases with altitude (in the troposphere, the environmental lapse rate averages ~6.5 °C/km). When surface warming is transmitted upward, the temperature profile changes — and this change affects how effectively the atmosphere radiates energy to space. In the **tropics**, deep convection couples the surface tightly to the upper troposphere through the **moist adiabatic lapse rate**: when air saturated with water vapour rises, it releases latent heat as water condenses, warming the surrounding environment. The moist adiabatic lapse rate (~6°C/km) is less steep than the dry adiabatic rate (~9.8°C/km). In a warming climate, the tropical upper troposphere (∼200–300 hPa) warms at approximately +0.6°C for every +1°C of surface warming — an enhanced warming aloft. Because the upper troposphere radiates at a higher temperature, it emits more energy to space than a uniform warming would predict, thereby partially offsetting the water vapour amplification. This makes the tropical lapse rate feedback **negative** (approximately −0.5 W/m²/°C in the tropics). In contrast, at **high latitudes** — particularly in the Arctic — strong surface-based temperature inversions mean that warming is concentrated near the surface rather than distributed through the troposphere. The upper atmosphere warms less than the surface, reducing upper-level outgoing longwave radiation and providing a **positive** lapse rate feedback contribution at polar latitudes. Polar amplification is partly driven by this mechanism.
...
**The lapse rate feedback partially cancels water vapour feedback in the tropics.** The moist adiabatic lapse rate is governed by condensational heating during ascent. A warmer atmosphere releases more latent heat per unit of ascent (because there is more water vapour to condense), steepening the temperature gradient between the surface and upper troposphere relative to the surface temperature increase alone. The tropical upper troposphere warming amplification (+0.6°C/°C surface warming) means the upper troposphere emits more longwave radiation to space than a vertically uniform warming would produce, reducing the net greenhouse trapping. This is the tropical negative lapse rate feedback. At high latitudes, strong inversions suppress vertical mixing, so warming accumulates near the surface; the upper atmosphere barely warms, reducing outgoing longwave radiation — a positive high-latitude lapse rate feedback that contributes to polar amplification.
...
**Radiative kernels as the diagnostic standard.** Before the kernel technique, feedback decomposition relied on differencing perturbed vs. control model runs with individual processes fixed — computationally expensive and imprecise. Radiative kernels pre-compute the sensitivity of top-of-atmosphere radiation to each state variable from a single baseline climate, allowing fast and consistent decomposition across any model output. The kernels themselves are model-derived but are insensitive to the choice of base climate — they have been validated against line-by-line radiative transfer calculations. The technique revealed that the large model spread in equilibrium climate sensitivity (2–5°C in CMIP5/6) is dominated by cloud feedback uncertainty, while water vapour and lapse rate feedbacks contribute relatively little to that spread — a key insight for understanding why climate sensitivity uncertainty persists despite decades of model development.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Extreme precipitation scaling: heavy rainfall events intensifying at ~7 %/°C in observations and models · 1 °C of warming since pre-industrial adds ~7 % more moisture to a global air parcel · Tropical cyclone rainfall rates intensifying consistent with CC scaling in satellite-era records',
        },
        {
          name: 'Lapse Rate Feedback: Partial Counterweight',
          icon: Globe,
          color: BRAND.coral,
          desc: 'Tropics: moist adiabatic adjustment warms upper troposphere ~0.6 °C per 1 °C surface warming → upper troposphere radiates more to space → negative feedback (~−0.5 W/m²/°C). High latitudes: inversions concentrate warming near surface → positive feedback. Net global lapse rate feedback: −0.6 to −0.8 W/m²/°C.',
        ...
        },
        {
          ...
          examples: 'Without WV + LR feedbacks, ECS would be ~1.2 °C per CO₂ doubling (Planck only); observed ECS ~2.5–4 °C demonstrates their combined amplification · Radiative kernel decomposition (Soden et al. 2008): WV + LR contribute ~40 % of total feedback in CMIP models · CMIP6 ensemble: WV + LR combined feedback spread <20 % across models vs >100 % spread in cloud feedback',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'A CO₂ doubling imposes ~3.7 W/m² of radiative forcing, directly warming the surface. Without any feedbacks the Planck response alone would produce ~1.2°C of warming.',
            color: BRAND.coral,
          },
          {
          ...
          },
          {
            ...
            description: 'Moist adiabatic lapse rate adjustment causes the tropical upper troposphere (~300 hPa) to warm ~0.6°C for every 1°C of surface warming. Deep convection transmits surface warmth aloft, releasing latent heat from condensing extra moisture.',
            color: BRAND.gold,
          },
          {
          ...
          },
          {
            ...
            description: 'Combined WV + lapse rate feedback: +1.0–1.1 W/m²/°C. Together with other feedbacks (albedo, cloud) these nearly double the warming from the Planck response alone, driving equilibrium climate sensitivity to ~2.5–4°C per CO₂ doubling.',
            color: BRAND.accent,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'The combined feedback implies equilibrium climate sensitivity of exactly 3°C per CO₂ doubling; it is robustly constrained because both feedbacks are governed by the same Clausius-Clapeyron equation and therefore cannot vary independently across models',
