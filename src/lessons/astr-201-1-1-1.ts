      ...
      cards: [
        {
          ...
          examples: 'Chicxulub impactor (~10 km, ~20 km/s): peak interface pressure ~200 GPa; impactor completely vaporised · Sudbury, Canada (1.85 Ga, ~200 km diameter): preserved melt sheet >2.5 km thick, one of largest confirmed impact structures · Coesite first synthesised by Loring Coes (1953) in laboratory; first found in nature at Meteor Crater, Arizona (1960) by Shoemaker — proving hypervelocity impact origin',
        },
        {
          name: 'Excavation: Transient Crater and Ejecta',
          icon: Layers,
          color: BRAND.gold,
          desc: 'Rarefaction waves following the shock convert compressive energy to kinetic energy, driving an excavation flow field. The transient crater grows to ~3× depth as diameter; ejecta exits at ~45° forming a continuous blanket thinning as r⁻³. Pi-group scaling: D_c ∝ ρ_i^(1/3) g^(-1/3) v^(2/3) m^(1/3) in gravity-dominated regime. Impact melt volume scales with kinetic energy: V_melt ∝ KE^0.8 approximately. Distal ejecta — impact spherules, tektites, and shocked mineral grains — may be globally distributed. The excavation cavity for a Chicxulub-scale event reached ~40 km depth before modification.',
          examples: 'Meteor Crater (Barringer), Arizona: 1.2 km diameter, ~50,000 years old; ejecta blanket visible to 3 km radius; ~10⁶ tonnes of shocked Coconino sandstone ejected · K-Pg iridium layer (Alvarez et al. 1980): globally uniform ~30 ppb Ir in 2.5-cm clay layer marking Chicxulub ejecta fallout, confirmed at >200 sites worldwide · Moldavite tektites (Czech Republic): green glass formed from silica-rich ejecta melted and re-quenched during Ries Crater impact 14.8 Ma, ~450 km distant',
        },
        {
          name: 'Modification: Collapse, Rebound, and Final Form',
          icon: FlaskConical,
          color: BRAND.jade,
          desc: 'Gravitational collapse of the transient crater determines final morphology. Simple craters (D < ~4 km on Moon, < ~2 km on Earth): walls slump, crater retains bowl shape, d/D ≈ 0.2. Complex craters (D > transition): floor rebounds upward (structural uplift of km-scale), rim collapses to form terraces; central peak exposes formerly deep target rocks. Multi-ring basins (D > ~300 km on Moon): multiple concentric fault-bounded rings form by inward collapse of large volumes of target. Transition diameter scales inversely with gravity: D_trans ∝ g^-1, explaining why Moon (1/6 g) has transition at ~15 km vs Earth at ~2–4 km.',
          examples: 'Copernicus Crater, Moon (93 km, ~800 Ma): textbook complex crater with three-peaked central peak rising 1.2 km, terraced walls, and well-preserved ejecta blanket · Vredefort Dome, South Africa (>200 km, 2.02 Ga): largest confirmed impact structure on Earth; central uplift exposes Archean basement rocks normally buried >25 km deep · Orientale Basin, Moon (930 km): three-ring multi-ring basin; Lunar Reconnaissance Orbiter mapping confirmed innermost ring = collapsed peak ring',
        },
      ],
    },
    {
...
**Impact melt scaling** is similarly important for understanding the thermal consequences of large impacts. Melt volume scales approximately with impactor kinetic energy: V_melt ≈ (KE / ΔH_fus × ρ_target)^0.8 in simplified form, where ΔH_fus is the enthalpy of fusion of the target rock. For the Chicxulub impactor (~10 km diameter, ~2.5 g/cm³, ~20 km/s), the kinetic energy was approximately 4 × 10²³ J, and the estimated melt volume ranges from ~10,000 to ~100,000 km³ — enough to fill Lake Superior seven times over.

Historical examples illustrate the range of impact energy scales: **Tunguska, Siberia (30 June 1908)** — a ~40-metre stony asteroid entered Earth's atmosphere and exploded as an airburst at ~8–10 km altitude, releasing energy equivalent to ~10–15 megatons of TNT (~4 × 10¹⁶ J). The airburst flattened ~2,150 km² of Siberian forest in a radial pattern centred on the burst point. No crater was formed because the impactor was destroyed before reaching the surface. **Chelyabinsk, Russia (15 February 2013)** — a ~20-metre bolide released ~500 kilotons (~2 × 10¹⁵ J) as a daytime fireball visible across 1,000 km, with the shock wave breaking windows across six Russian cities and injuring over 1,500 people — the largest confirmed impact-related injuries since Tunguska. **Chicxulub, Yucatán (66.0 Ma)** — a ~10-km diameter asteroid or comet impacted at ~20 km/s with kinetic energy ~4 × 10²³ J (~100 million megatons), producing the 180-km diameter Chicxulub crater and triggering the end-Cretaceous mass extinction that eliminated ~75% of species, including all non-avian dinosaurs.`,
      cards: [
        {
          name: 'Pi-Group Scaling Laws',
          icon: Zap,
          color: BRAND.amethyst,
          desc: 'Dimensional analysis reduces crater-forming physics to dimensionless Pi groups. In the gravity-dominated regime (large craters): D_c ∝ ρ_i^(1/3) g^(-1/3) v^(2/3) m^(1/3). In the strength-dominated regime (small craters, D < ~200 m on Earth): D_c ∝ ρ_i^(1/3) Y^(-1/3) v^(2/3) m^(1/3), where Y is target strength. Pi-group scaling allows extrapolation from laboratory (~cm) to planetary (~100 km) scales with ±30–50% uncertainty. Key insight: impact velocity has the strongest influence (v^(2/3)); doubling v yields 1.6× larger crater. Gravity strongly controls final morphology: same impactor produces larger craters on Moon (g = 1.62 m/s²) than Earth (g = 9.81 m/s²) by a factor of (9.81/1.62)^(1/3) ≈ 1.8×.',
          examples: 'Holsapple & Schmidt (1982, 1987): foundational Pi-group papers calibrated against >500 laboratory impact experiments · Meteor Crater (Arizona): 1.2 km diameter from ~50-m impactor at ~12 km/s — matches Pi-group prediction within 20% · Moon vs Earth comparison: 1-km impactor at 20 km/s → ~15 km crater on Moon, ~8 km on Earth (gravity scaling)',
        },
        {
          name: 'Impact Energy and Melt Volume',
          icon: FlaskConical,
          color: BRAND.accentHot,
          desc: 'Impact melt volume scales approximately as V_melt ∝ KE^0.8, where KE = ½mv² is impactor kinetic energy. For Chicxulub (~10 km, ρ = 2,500 kg/m³, v = 20 km/s): KE ≈ 4 × 10²³ J; estimated melt volume ~10⁴–10⁵ km³. Atmospheric effects scale similarly: impactors >1 km diameter inject enough material into the stratosphere to block sunlight globally for months to years ("impact winter"), causing photosynthesis shutdown and crop failure. The Chicxulub impact ejected an estimated ~100 trillion tonnes of sulphur dioxide from the target Cretaceous carbonates, causing global acid rain and decade-scale cooling of ~10–15°C.',
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Simple (D < ~4 km on Moon): bowl-shaped, d/D ≈ 0.2. Complex (D = 4–300 km): central peak, terraced walls, shallower d/D. Multi-ring basin (D > 300 km): concentric fault-bounded rings. Preserved as the geological record of bombardment history on all solid Solar System surfaces.',
            color: BRAND.amethyst,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'The Tunguska object was a stony or cometary body with insufficient strength to survive atmospheric passage intact, fragmenting and exploding as an airburst at ~8–10 km altitude before reaching the surface',
