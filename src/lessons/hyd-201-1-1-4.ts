...
**Global runoff ratio patterns.** The Budyko curve's prediction of Q/P = 1 − AET/P translates directly to the global pattern of water availability. The Amazon basin (φ ≈ 0.3–0.5): Q/P ≈ 0.45–0.55, generating ~6,000 km³ (1,439 cu mi)/yr of freshwater, the largest river discharge on Earth. The Congo basin (φ ≈ 0.6–0.8): Q/P ≈ 0.30–0.40, second largest river discharge. Mediterranean Europe (φ ≈ 1.5–2.0): Q/P ≈ 0.15–0.25, sensitive to any PET increase. Sahel (φ ≈ 3–5): Q/P ≈ 0.03–0.08, low but non-zero — seasonal high-intensity rains generate runoff before infiltration can absorb them. Central Australia (φ > 5): Q/P ≈ 0.01–0.03, with many years of zero streamflow in ephemeral systems.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Amazon at Obidos: Q/P = 0.48 (5,500 km³ (1,319 cu mi)/yr) · Congo at Brazzaville: Q/P = 0.32 (1,300 km³ (312 cu mi)/yr) · Rhine at Lobith: Q/P = 0.38 · Sacramento: Q/P = 0.35 (water year) · Colorado headwaters: Q/P = 0.50 (snow-fed) vs Colorado total: Q/P = 0.10 (internal losses) · Australia average: Q/P = 0.11 (high PET)',
        },
        {
          name: 'Streamflow Elasticity and Climate Change',
          icon: Droplets,
          color: BRAND.amethyst,
          desc: 'ε_P = (ΔQ/Q) / (ΔP/P). From Budyko: ε_P = 1 + φ·dEI/dφ / (EI − φ·dEI/dφ). Humid: ε ≈ 1. Semi-arid: ε ≈ 2–3. PET elasticity ε_PET = −ε_P × (AET/Q). Climate change: 2°C (36°F) warming → PET +5–8%. Semi-arid catchment: +8% PET → −16–24% Q. Australia: ε_P ≈ 2.4 → 10% rainfall decline → 24% runoff decline. CMIP6 projections: Mediterranean, southwestern US, southern Africa → Q decline 20–50% by 2100 (SSP5-8.5).',
...
**Using CAMELS for model benchmarking.** The CAMELS dataset has become the standard benchmark for testing rainfall-runoff models, machine learning hydrological predictions, and hydrological model parameter regionalisation. Deep learning models (Long Short-Term Memory LSTM networks, Kratzert et al. 2019) trained on CAMELS across many catchments simultaneously outperform individually calibrated conceptual models (HBV, SAC-SMA) on most catchments, including ungauged basins when transferred using physical similarity approaches. This finding — that data-driven pattern learning across many catchments can outperform physics-based models calibrated individually — is reshaping how hydrologists approach prediction at ungauged basins.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Chicago urban vs rural: time to peak 45 min vs 4 hr for same 50mm (1.97 in) storm · Baltimore impervious cover 50%: 3× pre-development flood frequency · CAMELS flashiness: forest catchments 0.08–0.15; urban 0.25–0.40 · Rocky Mountain headwaters: LC = 3–8 hr (steep, high D_d) vs Gulf Coast lowlands: LC = 24–72 hr (low D_d, flat)',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'AET is the water lost from the catchment by evaporation from soil and water surfaces plus transpiration through plant stomata. AET = min(PET, P) approximately — but the Budyko framework provides a more nuanced view of how AET interpolates between the energy and water limits. Global mean AET over land is approximately 480 mm/yr (of 720 mm/yr mean precipitation), generating approximately 36,000 km³ (8,636 cu mi)/yr of streamflow. AET is the largest outflow from most catchments by volume, yet it is the hardest variable to measure directly (typically inferred as P − Q − ΔS from the water balance, or estimated from remote sensing products such as MODIS ET and GLEAM).',
            color: BRAND.jade,
          },
          {
            id: 'runoff-ratio',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'CAMELS is the Coupled Atmosphere-Modelling-and-Energy-Land-Surface model, a global climate model that simulates the hydrological cycle at 25 km (16 mi) spatial resolution; it has transformed hydrology by providing the first fully coupled land-atmosphere simulations of evapotranspiration for all major river basins, allowing direct validation against streamflow observations',
