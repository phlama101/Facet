...
**Methane** (CH₄) from permafrost thaw deserves particular attention. When organic matter decomposes in waterlogged, oxygen-depleted (anaerobic) conditions — as in thermokarst lakes and saturated wetland sediments — methane is produced by methanogenic archaea. Methane has a global warming potential of approximately **30× CO₂ over a 100-year timescale** (and ~80× over 20 years), making even modest methane fluxes from thawing permafrost climatically significant. Siberian yedoma thaw lakes are active methane sources, with bubble emissions visible through ice in winter. The IPCC AR6 assessed that the permafrost carbon feedback adds approximately 0.1–0.3°C to global warming by 2100 under high emissions — a significant but uncertain additional forcing not fully included in standard climate projections.`,
      keyTerms: [
        {
          term: 'permafrost',
          def: 'Ground (rock or soil) that has remained at or below 0°C for at least two consecutive years; underlies ~25% of Northern Hemisphere land surface; defined by temperature, not ice content.',
        },
        {
          term: 'active layer',
          def: 'The seasonally thawing soil layer above permafrost, typically 0.5–3 m deep; deepens as climate warms; increased active layer depth is the primary initial response to permafrost warming.',
        },
        {
          term: 'yedoma',
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: `Batagaika megaslump (Siberia): the world\'s largest thaw slump, ~1 km wide and expanding ~10–15 m/yr; exposing yedoma carbon deposited 50,000+ years ago. Northwest Territories, Canada: thermokarst lake area increased ~2.5% per decade since 1980 in some regions. A single large retrogressive thaw slump on Banks Island (Canada) expanded from 3 ha to 28 ha in just 3 years (2017–2020). Thermokarst lake CH₄ bubble seeps: some Siberian lakes emit CH₄ continuously even in winter, visible as trapped bubbles in ice.`,
        },
        {
