...
**The rock record of deep volcanic systems.** When ancient volcanic systems are deeply eroded, the surface lavas are removed, and what remains is the intrusive plumbing — the batholiths, stocks, and dyke swarms that represent the "fossilised" magmatic system. This is why the Colorado Rockies contain granitic cores, why the Scottish Highlands expose Caledonian plutons, and why the oldest continental rocks (Acasta Gneisses of Canada, >4 Ga) are metamorphosed granitic rocks. Each batholith is a window into the magmatic roots of a now-vanished volcanic arc or collisional orogeny. By studying the chemistry, age, and isotopic composition of batholiths, geologists reconstruct the history of ancient subduction zones, crustal growth, and tectonic events that shaped the continents.`,
      cards: [
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.jade,
          desc: 'Not liquid magma pools: geophysics (seismics, GPS, InSAR (Interferometric Synthetic Aperture Radar, which detects millimetre-scale ground deformation from satellite)) shows mostly crystal mush (>70% solid) with small melt pockets. Yellowstone: magmatic reservoir 40–90 km × 40 km, 5–15% melt fraction (the fraction of a rock that has melted, from 0 to ~0.5); below it, basaltic crustal magma body 4.5 km deep. Magma ascent triggers: fresh mafic injection from below heats mush, increases melt fraction; volatile exsolution; tectonic stress changes. Dyke intrusion events observable as seismic swarms + GPS extension even without eruption.',
          examples: 'Mt. St. Helens pre-1980: cryptodome (a bulge of viscous lava that domes upward beneath the surface without erupting) deformed north flank → collapse → eruption · Krafla, Iceland 1975–84: 9-yr rifting episode, magma injected laterally in dykes 80 km from caldera · Long Valley Caldera: active magmatic intrusion (uplift, CO₂ emissions) despite last eruption 760,000 yr ago',
        },
      ],
    },
    {
