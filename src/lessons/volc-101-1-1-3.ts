      ...
      cards: [
        {
          ...
          examples: 'Palisades Sill, NJ: 300 m (984 ft) thick diabase, tilted river cliffs · Shiprock, NM: volcanic neck + radiating dykes exposed by erosion · Half Dome, Yosemite: exposed pluton of Sierra Nevada Batholith · Dartmoor, UK: exposed Variscan granite batholith',
        },
        {
      ...
      questions: [
        {
          ...
          correct: 1,
          explain: "A dyke (A) is by definition discordant (cuts across rock layers), not parallel to them; option A contradicts the definition it states, and the identification is therefore inconsistent with the field evidence. A lava flow (C) cannot produce contact metamorphism in the overlying rock — a lava flow cools from above when the overlying sedimentary rock is deposited on top of it after the lava has solidified; there is no mechanism for a lava flow to heat the limestone above it. The coarse grain size (gabbro) also rules out a lava flow, which would produce fine-grained basalt. A batholith (D) is a body >100 km² (39 sq mi) — a 50-metre-thick concordant body is definitively not a batholith by any geological definition; also, a batholith would be discordant (cutting across country rock structures), not concordant. The correct answer is B: the body is a sill — the canonical example of a concordant intrusion. The diagnostic field evidence is: (1) it is parallel to the surrounding sedimentary layers (concordant); (2) it is dark and coarse-grained (gabbro, the intrusive equivalent of basalt); (3) the overlying limestone shows contact metamorphism (baking). The baking is the decisive criterion distinguishing a sill from a lava flow: a sill was intruded as hot (1,100°C (2012°F)) magma into already-existing rock, and the heat conducted outward baked the adjacent sedimentary rock into hornfels or marble. A lava flow on top of limestone would bake the limestone below it (a lava-flow contact with underlying rock), not above it. The Palisades Sill (Hudson River, New Jersey), ~300 m (984 ft) thick diabase, is one of the world's most studied sills and shows exactly this field relationship.",
        },
        {
          q: "The Sierra Nevada Batholith — a ~650 km (404 mi) long × 100 km (62 mi) wide body of granite exposed at the surface in California — was the magmatic root of a subduction zone arc active from ~220 Ma to ~80 Ma. Today we see only the plutonic core, with no overlying volcanic rocks. What processes explain the absence of the original volcanic arc above the batholith, and what does this tell us about the relationship between surface volcanoes and their subsurface magmatic systems?",
          a: [
