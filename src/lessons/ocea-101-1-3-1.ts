...
Marine ecosystems are organised vertically (by depth) and horizontally (by latitude, distance from shore, and proximity to upwelling zones). The pelagic zone (open water) contains plankton, fish, and large predators. The benthic zone (the seafloor) hosts entirely different communities of sessile and burrowing organisms. Coastal ecosystems — coral reefs, kelp forests, salt marshes, mangroves, estuaries — are the most biologically diverse marine habitats, fuelled by the meeting of land and sea.`,
      keyTerms: [
        ...
        { term: 'Pelagic zone',   def: 'The open water column of the ocean, away from the seafloor and coast. Subdivided by depth: epipelagic (0–200 m (0–656 ft), sunlit), mesopelagic (200–1,000 m (656–3,281 ft), twilight), bathypelagic (1,000–4,000 m (3,281–13,124 ft), dark), abyssopelagic (4,000–6,000 m (13,124–19,686 ft)), hadalpelagic (>6,000 m (19,686 ft)).' },
...
**Why some areas are more productive than others.** Productivity varies enormously across the ocean. The most productive areas are **coastal upwelling zones** (Humboldt, California, Benguela, Canary), the **equatorial upwelling belts**, and the **polar oceans during summer** when ice melts and stratification breaks down. The least productive areas are the **subtropical gyres** — vast warm regions with strong stratification that prevents nutrients from reaching the surface; here the water is the famous deep blue colour because there is so little phytoplankton. Productivity controls fisheries: ~20% of the world's fish catch comes from upwelling zones that occupy <1% of the ocean surface.`,
    ...
    },
    {
      ...
      questions: [
        {
          q: `A blue whale weighs up to 200 tonnes (220.4 tons) and is the largest animal in Earth\'s history. It feeds almost exclusively on krill — small crustaceans typically a few centimetres long. How can such an enormous animal sustain itself on tiny prey, and why couldn\'t it instead feed on the largest fish in the ocean?`,
          a: [
        ...
        {
          q: 'Diel vertical migration is described as the largest daily movement of biomass on Earth. Mesopelagic organisms swim hundreds of metres upward at dusk and return to depth at dawn. What selective pressures drive this energetically costly behaviour?',
          a: [
            'Mesopelagic organisms migrate upward at dusk to warm their bodies in surface water, as metabolic rates are too slow in cold deep water; they return to cold depths at dawn to conserve energy during daylight hours when they are not feeding',
            'Organisms migrate upward to feed in food-rich surface waters under the cover of darkness, reducing predation risk from visually hunting predators; they return to the cold, dark deep water by day where both visual predators and metabolic costs are minimised, gaining a net energetic and survival benefit that outweighs the cost of the migration',
            'The migration is driven by oxygen: deep water in the oxygen minimum zone is avoided at night when organisms need more oxygen for active metabolism; they descend into the OMZ by day when they are resting and require less oxygen',
            'Organisms migrate in response to pressure waves from surface shipping and sonar; they evolved vertical migration to track surface sounds that indicate productive surface zones, independently of predation or feeding signals',
          ],
          correct: 1,
          explain: 'Thermoregulation (A) is not the primary driver — most mesopelagic organisms are ectothermic and do not actively regulate body temperature; while migrating to warmer surface water does increase metabolic rates during feeding, this is a consequence of their migration rather than its purpose, and the benefit does not explain returning to cold depths by day. Oxygen avoidance (C) is partly relevant — some organisms do avoid the most severe OMZ layers — but it does not explain the timing (dusk and dawn) or the directionality of vertical migration; many migrators pass through OMZ layers without apparent avoidance. Shipping and sonar (D) has no basis in evolutionary ecology; diel vertical migration is a behaviour that evolved hundreds of millions of years before human shipping existed and occurs throughout the remote open ocean. The correct answer is B: the behaviour represents a trade-off between foraging gain and predation risk. Surface waters at night are rich in phytoplankton and zooplankton; under darkness, visual predators (fish, seabirds) lose their advantage; organisms can feed with reduced risk of being eaten. At depth by day, cold water lowers metabolic costs (reducing how much food is needed to sustain the organism), and visual predators cannot pursue them into deep dark water. The migration effectively allows organisms to "eat in the dark restaurant and hide in the cold vault" — gaining the energy benefit of surface productivity while minimising exposure to the visual predators that dominate the lit surface during daytime.',
        },
      ],
    },
  ],
