    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          icon: Thermometer,
          color: BRAND.coral,
          desc: 'Armstrong McKay et al. (2022) assessed 16 tipping elements. Nine have thresholds below 2°C: Greenland (~1.5°C, 7 m SLR), West Antarctic Ice Sheet (~1.5–2°C, 3–4 m SLR), coral reef loss (~1.5°C), boreal permafrost (~1.5°C), Labrador Sea convection (~1.8°C). AMOC collapse threshold ~4°C; Amazon dieback ~3–4°C combined warming and deforestation.',
          examples: 'Greenland: losing ~280 Gt/yr at 1.2°C; committed to metres of SLR even at current warming · WAIS: Thwaites Glacier alone holds ~65 cm SLR and is considered already destabilised · Amazon: 17% deforested; 20–25% deforestation threshold for rainfall recycling collapse · Permafrost: ~1,500 Pg C stored; releasing 10% would equal ~30 years of current emissions',
        },
        {
          name: 'Tipping Cascades & Interactions',
          icon: Globe,
          color: BRAND.amethyst,
          desc: 'Tipping elements are coupled: triggering one raises the probability of others. Greenland melt weakens AMOC; AMOC weakening disrupts Amazon and Sahel rainfall; Amazon dieback emits CO₂, raising temperatures globally. Wunderling et al. (2021) modelled four interacting elements and found cascade risk significant at 2°C — the safe landing space may be smaller than widely assumed.',
          examples: 'Dansgaard-Oeschger events (palaeoclimate): ice cores record ~25 abrupt warming events during the last glacial, each linked to AMOC reorganisation — evidence that AMOC has multiple stable states · 2°C scenario modelling: Greenland + WAIS + AMOC + Amazon interaction can produce committed warming of ~0.5°C additional via carbon release alone · Coral–temperature cascade: bleaching kills corals, reducing coastline protection, increasing erosion and runoff that further damages reefs',
        },
        {
        ...
        nodes: [
          {
            ...
            description: 'Above ~1.5°C, the elevation-temperature feedback begins to self-sustain Greenland melting: as the ice surface lowers, it sits in warmer air, accelerating ablation. Currently losing ~280 Gt/yr. Full collapse over centuries to millennia would raise sea level by ~7 m. Meltwater input to the North Atlantic is the trigger for the next cascade step.',
            color: BRAND.accent,
          },
          {
            id: 'amoc-weakening',
            label: 'AMOC Weakening',
            description: 'Greenland freshwater discharge reduces the salinity and density of North Atlantic surface water, suppressing the deep convection that drives the Atlantic Meridional Overturning Circulation. The Stommel two-box model predicts bistability: current AMOC and a collapsed state. AMOC has already slowed ~15% since the mid-20th century based on observational proxies. Full collapse threshold estimated at ~3–5°C but hysteresis means recovery requires much greater forcing reversal.',
            color: BRAND.accentHot,
          },
          {
      ...
      questions: [
        {
          ...
          correct: 1,
          explain: 'Hysteresis is a fundamental property of bistable dynamical systems that makes climate tipping points uniquely dangerous. In a system with hysteresis, two different stable states exist for the same value of the external parameter (temperature), and the state the system occupies depends on its history. For the Greenland Ice Sheet, the tipping threshold for initiating collapse is approximately 1.5°C of global warming — but once the elevation-mass balance feedback is engaged, reducing temperatures back to 1.5°C does not stop the collapse; the ice sheet has already lowered in elevation and must now contend with warmer air at its new surface altitude. To halt and reverse the collapse, global temperatures must be reduced substantially below the tipping threshold — perhaps to below 1°C or even to pre-industrial levels — and even then, rebuilding the ice sheet requires millennia. This asymmetry means that the costs of overshoot are not recoverable on human timescales. Answer A incorrectly implies eventual full recovery is possible on relevant timescales. Answer C incorrectly restricts hysteresis to the Greenland Ice Sheet; AMOC exhibits the same bistability (described by the Stommel model), and Amazon dieback similarly has a hysteretic recovery threshold. Answer D confuses hysteresis with the unrelated concept of seasonal thermal lag.',
        },
        {
          q: 'The Armstrong McKay et al. (2022) assessment of tipping elements found that several thresholds lie below 2°C of global warming. Which of the following best describes the tipping element with the largest potential sea level contribution and its estimated temperature threshold?',
          a: [
            'The West Antarctic Ice Sheet has the largest sea level contribution (~7 m) and the lowest estimated threshold (~1.5°C), driven by the marine ice sheet instability mechanism in which warm ocean water removes ice shelf buttressing and triggers self-sustaining grounding line retreat',
            'The Greenland Ice Sheet has the largest sea level contribution (~7 m) and an estimated threshold of approximately 1.5°C (range 0.8–3.0°C), driven by the elevation-temperature feedback in which surface lowering exposes ice to warmer air, creating a self-sustaining melt cycle that is effectively irreversible on human timescales',
            'The Atlantic Meridional Overturning Circulation (AMOC) has the largest sea level contribution (~7 m) through its role in redistributing ocean heat; its collapse threshold is approximately 1.5°C and IPCC AR6 assessed this as likely to occur under current emission trajectories before 2100',
            'Amazon dieback carries the largest sea level contribution (~7 m) indirectly — by releasing ~100 Pg C from biomass, it raises atmospheric CO₂ sufficiently to melt both the Greenland and West Antarctic Ice Sheets; the combined Amazon–cryosphere cascade threshold is approximately 2°C',
          ],
          correct: 1,
          explain: 'The Greenland Ice Sheet (GIS) holds approximately 7.2 m of sea level equivalent in its ice volume. Armstrong McKay et al. (2022) estimated its tipping threshold at approximately 1.5°C of global warming above pre-industrial levels, with a range of 0.8–3.0°C. The key feedback is the elevation-mass balance (or height-temperature) feedback: as the ice surface melts and lowers in elevation, it sits in progressively warmer air (since temperature increases with decreasing altitude in the lower atmosphere), which accelerates melting, which lowers the surface further — a self-reinforcing loop. GIS is already losing approximately 280 Gt/yr at current warming (~1.2°C). Even if warming is stabilised, committed melting from already-triggered feedbacks means significant sea level rise is locked in over centuries. Answer A incorrectly assigns the 7 m contribution to the West Antarctic Ice Sheet; the WAIS holds approximately 3–4 m of sea level equivalent — still catastrophic, but substantially less than the GIS. The WAIS threshold and MISI mechanism described in Answer A are accurate descriptions but assigned to the wrong ice sheet. Answer C incorrectly attributes sea level contribution to AMOC — AMOC does not directly store water as ice but affects sea level distribution regionally through changes in ocean heat transport and steric sea level changes; a collapsed AMOC would redistribute sea level rather than contribute 7 m. Answer D incorrectly attributes sea level contribution to the Amazon dieback pathway.',
        },
        {
