      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'The Deccan Traps are the primary cause because their volume (~1 × 10^6 km³ (1.4 cu mi)) vastly exceeds the energy released by the Chicxulub impactor; larger events necessarily cause larger extinctions; the impact\'s iridium layer is a minor geochemical anomaly that does not by itself indicate biological damage',
          ],
          correct: 2,
        ...
        {
          q: 'The Ontong Java Plateau (OJP) in the western Pacific is the largest LIP on Earth by volume (~4.4 × 10^7 km³ (1.7 cu mi)), yet it is not directly linked to a major mass extinction at ~120 Ma. What factors might explain why an LIP of this scale produced less severe biotic consequences than the Siberian Traps (~4 × 10^6 km³ (1.4 cu mi), ten times smaller by volume)?',
          a: [
