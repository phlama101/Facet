      ...
      cards: [
        {
          ...
          icon: Globe,
          color: BRAND.accent,
          desc: '10 riparian nations sharing the Nile. Ethiopia\'s Grand Ethiopian Renaissance Dam (74 km³ (18 cu mi) capacity) reshapes downstream flows for Egypt and Sudan. Ongoing negotiation over filling rate and drought protocols. NBI provides scientific and diplomatic coordination framework.',
          examples: 'Egypt has historically claimed ~55.5 km³ (13 cu mi)/yr under a 1959 Nile Waters Agreement. Ethiopia argues the colonial-era agreements must be renegotiated. First GERD filling (2020–2022): ~11 km³ (2.6 cu mi) impounded; Egypt and Sudan requested slower filling. Negotiations ongoing under African Union mediation.',
        },
        {
