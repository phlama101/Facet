      ...
      cards: [
        {
          ...
          icon: Activity,
          color: BRAND.accent,
          desc: 'Longitudinal dispersivity αL scales with transport distance: pore scale (mm) → column (cm) → field (1–100 m (328 ft)) → regional (100–1000 m (3281 ft)). Reflects increasing heterogeneity sampled at larger scales. Scale dependence means ADE parameters calibrated at one scale cannot be extrapolated to another without uncertainty.',
          examples: 'Classic Borden tracer test (Ontario): αL ≈ 0.4 m (1 ft) at 10 m (33 ft) scale, 1.5 m (5 ft) at 70 m (230 ft) scale. Cape Cod tracer test (Massachusetts): αL ≈ 1–2 m (7 ft) over hundreds of metres in glacial outwash. Actual field plumes spread far more than column-calibrated models predict.',
        },
        {
