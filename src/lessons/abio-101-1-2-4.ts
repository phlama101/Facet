  ...
  sections: [
    {
      ...
      body: `Venus and Earth are often called twins. They formed in the same neighbourhood of the solar nebula at roughly the same time, and the numbers underscore the resemblance: Venus has a radius of 0.95 Earth radii, a mass of 0.815 Earth masses, and a bulk density of 5,240 kg/m³ — only slightly lower than Earth\'s 5,510 kg/m³. Their surface gravities are so similar that a person weighing 70 kg (154 lb) on Earth would weigh about 63 kg (139 lb) standing on Venus — if they could stand there at all. They cannot. Step onto the surface of Venus today and you encounter a mean surface temperature of 735 K (462 °C (864°F), 864 °F) — hot enough to melt lead — under an atmospheric pressure of 93 bar, equivalent to the pressure nearly 900 metres beneath Earth\'s ocean surface. The atmosphere is 96.5% carbon dioxide with 3.5% nitrogen, and a permanent cloud deck of sulfuric acid (H₂SO₄) droplets stretches from 45 to 70 km (43 mi) altitude, reflecting ~77% of incoming sunlight back to space. Venus is the hottest planet in the solar system, hotter even than Mercury despite being nearly twice as far from the Sun.
...
Venus is not merely a scientific curiosity — it is a warning. As astronomers identify rocky exoplanets near the inner edges of their stellar habitable zones, Venus\'s example shows that proximity to the inner edge can mean the difference between a temperate world and a hellscape. Understanding the conditions that initiated Venus\'s runaway greenhouse — and the factors that may have delayed it by billions of years — is essential for correctly assessing which exoplanets might be habitable, and for understanding the long-term climate trajectory of Earth itself.`,
      keyTerms: [
        ...
        },
        {
          ...
          def: `A permanent, global layer of concentrated sulfuric acid (H₂SO₄) droplets surrounding Venus from approximately 45 to 70 km (43 mi) altitude. The cloud deck reflects ~77% of incoming sunlight (giving Venus its high albedo of 0.77), making Venus\'s surface cooler than it would otherwise be, but trapping infrared radiation emitted by the surface and contributing to the extreme greenhouse warming below.`,
        },
        {
          term: 'Tesserae',
      ...
      cards: [
        {
          ...
          examples: `Venus surface: 735 K (462 °C (864°F)), 93 bar CO₂; Earth inner habitable zone boundary ~0.97 AU (moist greenhouse) to ~0.84 AU (runaway greenhouse) per Kopparapu et al. 2013 models; Mars analogue for outer edge; Venus\'s D/H enrichment (~120–150× SMOW) quantifies ancient water loss`,
        },
        {
        ...
        nodes: [
          {
            ...
            description: 'Early Venus (4.5–1.0 Ga): slow retrograde rotation, ~10 m (33 ft) global ocean, ~1 bar N₂ atmosphere. Persistent dayside cloud cover acts as a parasol. Surface temperatures temperate — liquid water stable at the surface for potentially 2–3 billion years (Way et al. 2016).',
            color: BRAND.jade,
          },
          {
          ...
          },
          {
            ...
            description: 'Today: 735 K surface temperature, 93 bar CO₂ atmosphere, permanent H₂SO₄ cloud deck at 45–70 km (43 mi). No liquid water anywhere on the surface. A temperate zone lingers at 48–60 km (37 mi) altitude (0–60 °C (140°F), 0.5–1 bar) — the only potentially habitable niche. Three upcoming missions (DAVINCI+, VERITAS, EnVision) will determine whether Venus was once habitable and what physical record survives in the tesserae.',
            color: BRAND.ruby,
          },
        ],
        edges: [
      ...
      questions: [
        {
          ...
          a: [
            'Venus\'s dense 93-bar CO₂ atmosphere creates an extreme greenhouse effect: CO₂ absorbs outgoing infrared radiation emitted by the surface and re-radiates it downward, trapping heat. Despite the high-albedo H₂SO₄ cloud deck reflecting ~77% of incoming sunlight, the CO₂ greenhouse warming so dominates that the surface temperature reaches 735 K — far exceeding Mercury\'s peak of ~700 K on its sunlit side (with a frigid −180 °C (-292°F) night side due to no atmosphere)',
