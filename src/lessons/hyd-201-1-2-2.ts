...
**Emerging contaminants** are increasingly recognised as a freshwater quality threat beyond classical nutrients and heavy metals. **Pharmaceuticals and personal care products (PPCPs)** — including 17α-ethinylestradiol (EE2, the synthetic oestrogen in oral contraceptives), antibiotics, antidepressants, and analgesics — enter water bodies through wastewater effluent (conventional treatment does not remove them efficiently). EE2 feminises male fish at concentrations of 1–10 ng/L and is detected in rivers downstream of wastewater outfalls at concentrations in this range globally. **Microplastics** — particles < 5 mm (0.20 in) from plastic degradation, synthetic fibres from clothing, and microbeads — are now ubiquitous in freshwater systems; their ecological effects on aquatic invertebrates and fish are under active investigation. **PFAS** (per- and polyfluoroalkyl substances, often called "forever chemicals" due to their extreme environmental persistence, addressed in detail in hyd-201-1-2-4) represent perhaps the most widespread emerging groundwater and surface water contamination challenge of the current era.`,
      keyTerms: [
        {
        ...
        {
          term: 'Tile Drainage',
          def: 'Subsurface perforated pipes at 60–120 cm (47.2 in) depth that intercept shallow groundwater and route it directly to streams. Converts diffuse soil-water flow to rapid conduit flow, bypassing riparian denitrification; delivers ~50% of agricultural N loads in tile-drained Midwestern US watersheds.',
        },
        {
          term: 'Hypoxia (Dead Zone)',
          def: 'Dissolved oxygen depletion (<2 mg/L) in bottom waters caused by decomposition of algal blooms stimulated by excess nutrient loading. Gulf of Mexico hypoxic zone: ~15,000–20,000 km² (7,722 sq mi) each summer from Mississippi River N+P loading (~1.5 M tons N/yr).',
        },
        {
          term: 'Riparian Buffer',
          def: 'Zone of native vegetation maintained along stream banks that removes nitrate from shallow groundwater via denitrification and plant uptake. A 30 m (98 ft) buffer can remove >80% of groundwater NO₃⁻, but does not intercept tile-drained water that bypasses the riparian zone.',
        },
        {
      ...
      cards: [
        {
          ...
          examples: 'Iowa nitrogen export to Gulf: ~500,000 t/yr. Chesapeake Bay: agricultural N contributes ~40% of total N load from a watershed of 166,000 km² (64,093 sq mi). Corn-soy rotations with tile drainage have the highest N loss rates: 20–50 kg (110 lb) N/ha/yr.',
        },
        {
        ...
        },
        {
          ...
          icon: Activity,
          color: BRAND.coral,
          desc: 'Mississippi-Atchafalaya delivers ~1.5 M t N/yr + ~0.15 M t P/yr. Spring flood pulse fuels algal growth in stratified Gulf. Bacterial decomposition of settled algae depletes bottom DO to <2 mg/L. Zone covers 15,000–20,000 km² (7,722 sq mi) in July; collapses in autumn mixing.',
          examples: '2017: largest ever measured at 22,720 km² (size of New Jersey). NOAA/LUMCON monitoring since 1985. EPA Hypoxia Task Force target: reduce to <5,000 km² (1,930 sq mi) by 2035. Target not approached despite 25 years of voluntary agricultural practices.',
        },
        {
        ...
        nodes: [
          {
            ...
            description: 'Synthetic N fertiliser (urea, ammonium nitrate) applied to cropland at rates often exceeding crop uptake by 30–50%. Atmospheric wet and dry deposition adds 5–20 kg (44 lb) N/ha/yr in the US Midwest. Excess N mineralises to NO₃⁻ in aerobic soils, becoming mobile.',
            color: BRAND.accent,
          },
          {
            id: 'soil-processes',
          ...
          },
          {
            ...
            description: 'N and P stimulate spring algal blooms in stratified Gulf waters. Decomposition of settled algae depletes bottom DO to <2 mg/L. Zone covers 15,000–20,000 km² (7,722 sq mi) each summer. Eliminates demersal fish and shrimp habitat. Costs Gulf fishing industry tens of millions per year.',
            color: BRAND.amethyst,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'Riparian buffers are universally effective regardless of soil type, hydrology, or tile drainage; the 30 m (98 ft) standard was developed for all agricultural landscape types and is sufficient in all settings; limitations are only relevant to strips narrower than 15 m (49 ft)',
