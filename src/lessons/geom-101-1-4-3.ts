  ...
  sections: [
    {
      ...
      body: `Coastlines are among Earth's most dynamic and rapidly changing landforms — shaped by the relentless energy of breaking waves, longshore currents, tides, and storms, and now increasingly by accelerating sea level rise and direct human modification. Approximately 40% of the world's population lives within 100 km of a coast, and more than 1 billion people live in the low-elevation coastal zone below 10 m above sea level, making coastal geomorphology a discipline with immediate consequences for human settlement, infrastructure, and ecosystem services.
...
**River deltas** represent perhaps the most acute intersection of coastal geomorphology and human vulnerability. The world's great deltas — Mississippi, Nile, Ganges-Brahmaputra, Mekong — support populations of tens to hundreds of millions and are among Earth's most productive agricultural and fisheries zones. Yet deltas are inherently unstable: they are built from compacting sediment, and natural compaction combined with **groundwater and hydrocarbon extraction** drives subsidence rates of **10–100 mm/yr** in some urban delta settings — far exceeding eustatic sea level rise. Jakarta (Indonesia) has subsided by up to **4 m** in parts of its northern coastal districts over the last 30 years due to groundwater extraction, while Venice has subsided **23 cm** over the 20th century and the Mississippi delta loses ~75 km² of land per year due to the combined effects of subsidence, sediment starvation from upstream dams and levee construction, and sea level rise. The **managed retreat** concept — deliberately allowing low-value agricultural or engineered land to return to intertidal habitat — is emerging as a more sustainable alternative to hard coastal defences. The **Medmerry managed realignment** (Sussex, UK, completed 2013) created 183 ha of new intertidal habitat by breaching a maintained shingle bank, providing flood protection, carbon storage, and ecological value at lower long-term cost than rebuilding the engineered structure.`,
      keyTerms: [
        ...
        },
        {
          ...
          def: 'Sinking of river delta surfaces due to compaction of young sediment, groundwater or hydrocarbon extraction, and sediment starvation; rates of 10–100 mm/yr in some urban deltas far exceed eustatic sea level rise, causing relative sea level rise of several cm/yr.',
        },
        {
        ...
        },
        {
          ...
          def: 'Vertical build-up of intertidal sediment trapped by marsh vegetation at rates of 2–10 mm/yr; allows marshes to keep pace with sea level rise within limits (~5–7 mm/yr threshold); provides natural wave attenuation and blue carbon storage.',
        },
      ],
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'The Outer Banks (North Carolina, USA) barrier islands have migrated landward ~100 m over the past century; some communities have been repeatedly relocated. The Nile Delta is losing 30–60 m of coastline per year near the river mouths because the Aswan High Dam (built 1970) traps ~98% of the sediment that once nourished the delta face. The Ganges-Brahmaputra delta is the world\'s largest, yet Bangladesh faces loss of 17% of its land area under 1 m sea level rise.',
        },
        {
          name: 'Coral Reefs and Coastal Protection',
          icon: Shield,
          color: BRAND.coral,
          desc: 'Coral reefs act as biological wave breakers, dissipating 97% of incoming wave energy across the reef crest and reducing shoreline erosion. The reef flat and lagoon provide the hydrodynamic buffer that allows low-lying reef islands (motu) to exist despite being only 1–3 m above sea level. Reef bleaching and degradation under ocean warming remove this protection. Reef carbonate sediment production (1–10 mm/yr on healthy reefs) has historically kept reef islands in pace with sea level rise, but this capacity is diminished by bleaching and acidification.',
      ...
      cards: [
        {
          ...
          icon: TrendingUp,
          color: BRAND.gold,
          desc: 'Global mean sea level has risen ~20 cm since 1900, at an average rate of ~1–2 mm/yr for most of the 20th century. Since 1993 (satellite altimetry era), the rate has accelerated to ~3.7 mm/yr. By 2100, IPCC AR6 projects likely ranges of 28–55 cm under SSP1-2.6 (low emissions) to 63–101 cm under SSP5-8.5 (high emissions), with low-likelihood high-end scenarios exceeding 1.5–2 m if ice sheet instabilities are triggered. Each 10 cm of sea level rise displaces shorelines horizontally by the Bruun factor — typically 50–100 m on a gently sloping beach (Bruun Rule: shoreline retreat = sea level rise / beach slope).',
          examples: 'Miami, Florida has experienced 25 cm of sea level rise since 1920, now flooding streets at king tides. Nuuk (Greenland) shows local sea level fall despite global rise, because the receding Greenland ice sheet exerts less gravitational pull on ocean water and the land is rebounding isostatically faster than the ocean rises. Jakarta sank 1–4 m over 30 years from groundwater extraction, giving a local relative sea level rise rate of 100–250 mm/yr — 25–60× the global average.',
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'The Mississippi River Delta is losing ~75 km² of land per year. Which combination of factors is primarily responsible for this land loss?',
          a: [
        ...
        },
        {
          ...
          a: [
            ...
            'Salt marshes accrete at 2–10 mm/yr through trapping of inorganic suspended sediment and accumulation of organic matter from marsh plants; they can keep pace with sea level rise up to approximately 5–7 mm/yr under high suspended sediment concentrations, but drown when rise rate exceeds organic and inorganic accretion capacity; reduced suspended sediment supply from upstream dams and human modifications lowers the upper threshold',
