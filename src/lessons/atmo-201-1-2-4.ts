      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'When the bow echo sustains forward motion >15 m/s for >400 km (249 mi) with repeated gusts ≥26 m/s, the event qualifies as a Derecho. Damaging winds result from RIJ momentum transport to the surface and cold pool outflow. The June 2012 US Derecho caused 4 million outages across 1,100 km (684 mi) in 10 hours.',
            color: BRAND.ruby,
          },
          {
            id: 'rainfall',
        ...
        edges: [
          ...
          { from: 'bow-echo',     to: 'derecho-wind', label: 'Sustained bow echo with ≥26 m/s gusts over ≥400 km (249 mi) corridor' },
