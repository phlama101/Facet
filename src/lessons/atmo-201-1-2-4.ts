    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explain: 'The nocturnal low-level jet over the US central plains is one of the most studied mesoscale circulation features in North America, and its origin is the Blackadar inertial oscillation mechanism (Blackadar 1957). During the day, the convective boundary layer is turbulent, and this turbulence exerts a frictional drag on the low-level wind, retarding it below its geostrophic value. The turbulent boundary layer is effectively a frictional force that keeps the wind in a near-steady, sub-geostrophic state. After sunset, radiative cooling at the surface rapidly stabilises the boundary layer — a strong temperature inversion forms that suppresses turbulence. Without the frictional coupling to the surface, the low-level wind is suddenly free to accelerate. It undergoes an inertial oscillation: the wind vector rotates clockwise (in the Northern Hemisphere) around the geostrophic wind vector over a period of approximately one inertial period (12/sin(latitude) hours, ~14–16 hours at 40°N), reaching a supergeostrophic speed maximum roughly half an inertial period (~7–8 hours) after decoupling — typically near midnight. The resulting jet, aligned with the mean low-level geostrophic flow (southerly over the plains), transports warm, moist air from the Gulf of Mexico northward into the MCS environment at speeds of 15–25 m/s. This moisture and instability flux sustains nocturnal MCS activity that would otherwise weaken as surface heating decays. The nocturnal LLJ explains why the central US has a pronounced nocturnal maximum in warm-season precipitation. Option A incorrectly attributes the LLJ to land-sea breeze dynamics, which operate at coastal boundaries rather than 1,500 km inland. Option C incorrectly attributes the LLJ to Rocky Mountain orographic channelling; while orography influences the directionality of plains flow, the Blackadar mechanism explains the nocturnal timing. Option D incorrectly invokes the thermal wind for a feature that is fundamentally about boundary-layer friction decoupling, not horizontal temperature gradients aloft.',
        },
        {
          ...
          a: [
            'The nocturnal maximum is driven by radiative cooling of the cloud tops at night, which destabilises the troposphere by cooling the upper levels relative to the still-warm surface; this radiative destabilisation triggers deep convection after midnight that is absent during the day when solar heating of cloud tops reduces the lapse rate; this mechanism operates everywhere but is amplified over the plains by the high albedo of agricultural land',
          ...
          correct: 1,
          explain: 'The nocturnal precipitation maximum over the US central plains is a well-documented climatological feature and one of the most distinctive precipitation signals in North America. It arises from the interaction of three factors: (1) the nocturnal low-level jet (LLJ), which transports warm moist air from the Gulf of Mexico northward after sunset as the boundary layer decouples and undergoes an inertial oscillation; (2) the tendency for the LLJ to produce low-level convergence and moisture flux divergence patterns that favour convective initiation and maintenance overnight; and (3) the prevalence of MCSs — particularly mesoscale convective complexes (MCCs) and nocturnal squall lines — that develop and maintain themselves on the LLJ fuel supply. MCSs produce 40–70% of annual warm-season precipitation in Iowa, Kansas, and adjacent plains states, and this precipitation is heavily weighted toward the nocturnal hours. The MCC archetype shows a particularly pronounced nocturnal peak, with maximum convective coverage often occurring between 0000 and 0600 local time. This nocturnal bias contrasts with eastern US and European continental precipitation, which peaks in the afternoon driven by solar surface heating. Option A describes radiative destabilisation, a real mechanism but a minor contributor compared to the LLJ; it cannot explain why the plains are uniquely affected compared to other continental interiors at similar latitudes. Option C contains a grain of truth — Rocky Mountain convection does propagate eastward — but this mechanism alone cannot account for the magnitude or areal extent of the nocturnal maximum, and the propagating systems are themselves MCSs sustained by the LLJ. Option D is incorrect: the nocturnal maximum is robustly observed in both gauge and radar data across rural and urban areas.',
        },
        {
