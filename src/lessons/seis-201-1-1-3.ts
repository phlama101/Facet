...
- **< 410 km (255 mi)**: olivine (α-phase), Vp ~ 8.2–9.7 km/s increasing with depth
- **410 km (255 mi)**: olivine → wadsleyite (β-phase); Vp jumps ~3–4%; transition width ~4–10 km (6.2 mi); positive Clapeyron slope (+2 to +3 MPa/K)
- **520 km (323 mi)**: wadsleyite → ringwoodite (γ-phase); smaller velocity jump (~1–2%); less sharp; Clapeyron slope near zero
- **660 km (410 mi)**: ringwoodite → bridgmanite + ferropericlase; Vp jumps ~4–5%; transition involves breakdown into two separate phases; negative Clapeyron slope (−2 to −3 MPa/K)

The transition zone (410–660 km (410 mi)) contains wadsleyite and ringwoodite — phases with no natural occurrence at the Earth's surface and first synthesised in laboratory high-pressure experiments. The thickness of the transition zone (nominally 250 km (155 mi)) varies with temperature: in cold regions, the 410 shallows and the 660 deepens (due to their opposite Clapeyron slopes), thickening the transition zone; in hot regions, the opposite occurs.

**The 660 and mantle layering.** The negative Clapeyron slope of the 660 km (410 mi) discontinuity has profound dynamic implications. As a cold slab penetrates toward 660 km (410 mi), the ringwoodite-to-bridgmanite transition occurs at greater depth than in ambient mantle — meaning the slab material at 660 km (410 mi) is still in the ringwoodite phase while surrounding warmer mantle has already transformed to the denser bridgmanite. This makes the slab at the 660 less dense than the surrounding lower mantle (because bridgmanite is denser than ringwoodite at that P-T condition), creating an upward buoyancy force that resists slab penetration. This is why some slabs appear to stagnate at or near 660 km (410 mi) rather than penetrating directly into the lower mantle — though as we saw in Lesson 1.1.1, many slabs do eventually penetrate.

**The D" layer and post-perovskite.** At the base of the mantle (~125 GPa, ~2,600–2,900 km (1802 mi) depth), bridgmanite undergoes another phase transition to post-perovskite — a layered structure with different elastic properties. This transition was first predicted experimentally by Murakami et al. (2004) and provides a likely explanation for the D" seismic discontinuity observed ~200–300 km (186 mi) above the CMB. Post-perovskite is also more anisotropic than bridgmanite, helping to explain the strong seismic anisotropy observed in D". Because the post-perovskite transition has a large positive Clapeyron slope, it may occur twice in regions of anomalous temperature: once going down through the thermal boundary layer, and again at the top of an LLSVP where the transition reverts back to bridgmanite (the "anti-crossing").`,
      cards: [
        {
...
**Practical limitations.** Receiver functions require clean teleseismic P waveforms from earthquakes at 30–95° distance. Data coverage is uneven: regions with few nearby earthquakes or few stations have poorly constrained receiver functions. The deconvolution is sensitive to noise and can produce ringing artefacts. Multiple reflections within the crust (crustal multiples) arrive at similar times to deeper Ps conversions and must be identified and separated. Despite these challenges, receiver functions have provided the primary observational basis for the global Moho map (CRUST1.0, Laske et al. 2013), the most accurate available constraint on crustal thickness worldwide.`,
      cards: [
        {
          ...
          examples: 'Tibet: Ps delay ~8–9 s → crustal thickness 60–75 km (thickest on Earth outside ice sheets) · Iceland: Ps ~2.5 s → Moho at ~20 km (anomalously thin oceanic crust + hotspot) · Global average: Ps ~4 s → ~35 km (22 mi) continental crust',
        },
        {
          ...
          examples: 'Japan subduction: TZ 290–310 km (193 mi) thick (vs global average ~250 km (155 mi)) · Tonga: TZ locally 300+ km · Iceland: TZ ~230 km (143 mi) — consistent with ~100–200 K thermal excess · Plume-associated TZ thinning: Hawaii receiver functions suggest TZ ~240 km (149 mi)',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          {
            id: 'moho',
            label: 'Moho (~20–70 km (43 mi)): Crust-Mantle Boundary',
            description: 'A compositional boundary where mafic/felsic crustal rocks (Vp 6.0–7.0 km/s) give way to ultramafic mantle peridotite (Vp 7.8–8.2 km/s). Not a phase transition — two different rock types. Depth varies: 6–10 km (6.2 mi) under oceans, 25–40 km (25 mi) under stable continents, 60–75 km (47 mi) under Tibet and Andes. Detected by: refracting Pn waves, reflection Moho, receiver function Ps conversion. The largest velocity jump in the Earth above the CMB.',
            color: BRAND.coral,
          },
          {
            id: 'd410',
            label: '410-km Discontinuity: Olivine → Wadsleyite',
            description: 'Olivine (α-(Mg,Fe)₂SiO₄) transforms to wadsleyite (β-phase) at ~13.5 GPa, ~1,500°C (2732°F). Vp increases ~3–4%. Clapeyron slope: +2 to +3 MPa/K (positive). In cold subducting slabs: the transition occurs at lower pressure (shallower depth) than in ambient warm mantle — the 410 is elevated by 10–30 km (19 mi) beneath cold slabs. In hot upwellings: the 410 is slightly depressed. Wadsleyite can store significant water (up to 3 wt%), making this transition important for the deep water cycle.',
            color: BRAND.accent,
          },
          {
            id: 'd520',
            label: '520-km Discontinuity: Wadsleyite → Ringwoodite',
            description: `Wadsleyite (β-phase) transforms to ringwoodite (γ-spinel phase) at ~18 GPa, ~1,600°C (2912°F). Smaller velocity jump (~1–2%) and broader transition width than the 410 or 660. Clapeyron slope near zero. Detected in high-quality stacked seismic data (SS and PP precursors) but not consistently visible as a receiver function conversion at individual stations. Ringwoodite is also a hydrous mineral, capable of storing water equal to the mass of Earth\'s oceans in the transition zone.`,
            color: BRAND.gold,
          },
          {
            id: 'd660',
            label: '660-km Discontinuity: Ringwoodite → Bridgmanite + Ferropericlase',
            description: 'Ringwoodite (γ-(Mg,Fe)₂SiO₄) dissociates at ~23 GPa, ~1,700°C (3092°F) into bridgmanite ((Mg,Fe)SiO₃, formerly called MgSiO₃ perovskite) and ferropericlase ((Mg,Fe)O). Vp increases ~4–5%. Clapeyron slope: −2 to −3 MPa/K (negative). In cold slabs: transition occurs at higher pressure (greater depth), so 660 is depressed 10–30 km (19 mi) — creating upward buoyancy that resists slab penetration. This is the main barrier to whole-mantle convection, though many slabs eventually overcome it.',
            color: BRAND.amethyst,
          },
          {
            id: 'lower-mantle',
            label: 'Lower Mantle (660–2,891 km (1796 mi)): Bridgmanite Domain',
          ...
          {
            id: 'd-layer',
            label: 'D″ Layer (~2,600–2,891 km (1796 mi)) and CMB',
            description: 'D" is the lowermost 200–300 km (186 mi) of the mantle: thermally and seismically anomalous. Features: (1) Post-perovskite phase transition ~200 km (124 mi) above CMB (bridgmanite → post-perovskite at ~125 GPa) producing a velocity discontinuity; (2) strong seismic anisotropy (VSH > VSV), interpreted as preferential alignment of post-perovskite crystals by horizontal shear flow; (3) ULVZs (5–40 km (25 mi) thick, 10–30% slow in Vp) at CMB in discrete patches; (4) LLSVPs rising from CMB. The CMB itself (2,891 km (1796 mi)) is where solid mantle meets liquid iron outer core: Vp drops from ~13.7 to ~8.0 km/s, Vs drops to zero.',
    ...
    },
    {
      ...
      questions: [
        {
          q: 'The 660-km discontinuity has a negative Clapeyron slope of approximately −2 to −3 MPa/K. What does this mean for a cold subducting slab approaching 660 km (410 mi) depth, and how does it differ from the effect of the 410-km transition on the same slab?',
          a: [
            'The negative Clapeyron slope means the 660-km transition occurs at lower temperature in cold material; slabs encounter the transition at shallower depth than ambient mantle, making them denser and accelerating their sinking — the same direction as at the 410 km (255 mi)',
            'The negative Clapeyron slope means the 660-km transition occurs at higher pressure (greater depth) in cold material; a cold slab at 660 km (410 mi) depth is still in the ringwoodite phase while surrounding warmer mantle has already converted to the denser bridgmanite; the slab is therefore less dense than the surrounding lower mantle at that depth, creating an upward buoyancy force that resists penetration — opposite to the 410, where cold material converts to denser wadsleyite at shallower depth than ambient mantle, increasing the slab\'s negative buoyancy',
        ...
        },
        {
          ...
          a: [
            'Moho depth ≈ 38 km (24 mi); calculated using delay time = depth × (1/Vs − 1/Vp) with Vs = Vp/1.73 ≈ 3.76 km/s: depth = 5.8 / (1/3.76 − 1/6.5) = 5.8 / (0.266 − 0.154) = 5.8 / 0.112 ≈ 51.8 km (32 mi) — this is approximately 52 km (32 mi)',
            'Moho depth ≈ 52 km (32 mi); using delay time = depth × (1/Vs − 1/Vp), with Vs = 6.5/1.73 ≈ 3.76 km/s, the calculation gives depth = 5.8 / (1/3.76 − 1/6.5) = 5.8 / 0.112 ≈ 52 km (32 mi)',
            'Moho depth ≈ 25 km (16 mi); the Ps delay time of 5.8 s divided by the average crustal velocity (6.5 km/s) gives the one-way travel time distance: 5.8/2 × 6.5 = 18.85 km (12 mi), approximately 25 km (16 mi) when adjusted for the Vp/Vs ratio',
            'Moho depth ≈ 70 km (43 mi); at a typical Ps velocity of 4 km/s, 5.8 s × 4 km/s / 2 (two-way path) = 11.6 km (7.2 mi); since receiver functions image reflections not conversions, the depth is doubled again to give 70 km (43 mi)',
          ],
          correct: 1,
          explain: 'The receiver function Ps conversion delay time formula is: Δt = H × (1/Vs − 1/Vp), where H is the Moho depth, Vs is the average crustal shear velocity, and Vp is the average crustal P velocity. The ray parameter (horizontal slowness) correction is often small for teleseismic distances and is neglected here. Given: Δt = 5.8 s, Vp = 6.5 km/s, Vp/Vs = 1.73 → Vs = 6.5/1.73 ≈ 3.757 km/s. Then: H = Δt / (1/Vs − 1/Vp) = 5.8 / (1/3.757 − 1/6.5) = 5.8 / (0.2663 − 0.1538) = 5.8 / 0.1125 ≈ 51.6 km (32 mi). Option A writes 38 km (24 mi) in the opening but then correctly calculates 51.8 km (32 mi) in the working — a mismatch; the written answer is wrong even though the math is shown correctly. Option C incorrectly uses a simple distance/speed formula (Δt = distance/velocity) applicable to body wave travel times, not to differential times between converted and direct phases. Option D confuses receiver functions (one-way conversion) with reflection seismic (two-way reflection); receiver functions measure one-way conversion, not two-way reflection.',
        },
        {
          q: 'Ultra-Low Velocity Zones (ULVZs) at the core-mantle boundary have P-wave velocity reductions of 10–30% over thicknesses of only 5–40 km (25 mi). Why do seismologists consider partial melt a leading explanation, and what observational evidence supports the CMB location?',
          a: [
            ...
            'Partial melt is inferred from the ULVZ thickness of 5–40 km (25 mi); at these depths, layers thinner than 50 km (31 mi) can only form by melting because tectonic processes such as folding and thrusting cannot operate at CMB pressures; the location at the CMB is confirmed by receiver function Ps conversions similar to Moho imaging',
        ...
        },
        {
          ...
          a: [
            ...
            'Transition zone water is geologically unimportant because the high pressure and temperature at 410–660 km (410 mi) decompose water molecules into hydrogen and oxygen ions that become incorporated into the mantle\'s oxide phases',
          ],
          correct: 1,
          explain: 'Wadsleyite can incorporate up to ~3 wt% H₂O and ringwoodite up to ~2 wt% H₂O into their crystal structures as hydroxyl (OH) groups. If the transition zone is fully hydrated, it could contain 2–5 times the mass of all surface ocean water — making it the largest water reservoir in the planet. This has several dynamic implications. First, the hydration state of the transition zone affects its rheology (wet mantle flows more easily than dry) and potentially its density structure. Second, subducting slabs deliver hydrated minerals into the transition zone; as the slab dehydrates with increasing pressure and temperature, released water lowers the local solidus and can trigger partial melting. Third, dehydration at the 660 km (410 mi) boundary, where ringwoodite breaks down to bridgmanite + ferropericlase (which store much less water), may release a large pulse of water into the lower mantle — this "transition zone water filter" hypothesis (Bercovici & Karato 2003) proposes that the 660 acts as a chemical filter controlling water exchange between upper and lower mantle. The long-term surface water budget is controlled by the balance between water delivered to the mantle by subduction and water returned by volcanism — the transition zone reservoir is a key unknown in this budget. Option A is incorrect — water does migrate out of the transition zone through melt fraction and volcanic degassing. Option C confuses transition zone minerals (which are stable only at high pressure and transform to other phases upon decompression) with volcanic eruptive products. Option D incorrectly describes water decomposition; OH groups in minerals are stable at high pressure and temperature in the transition zone.',
        },
        {
          q: 'Seismologists observe that the transition zone (distance between the 410 and 660 km (410 mi) discontinuities, measured by PP/SS precursors or receiver function migration) is about 280–310 km (193 mi) thick beneath the Japan subduction zone, compared with ~250 km (155 mi) globally. What quantitative constraint does this provide on the thermal structure of the subducting slab?',
          a: [
            'A 30–60 km (37 mi) thickening of the transition zone provides no temperature constraint because the Clapeyron slopes of the 410 and 660 are both uncertain by ±50%; the observation is only qualitatively consistent with cold material but cannot be used for quantitative estimates',
            'Using the Clapeyron slopes of the 410 (+2.5 MPa/K) and 660 (−2 MPa/K) and the density/gravity at those depths, a 30 km (19 mi) elevation of the 410 and 30 km (19 mi) depression of the 660 relative to ambient mantle corresponds to a temperature anomaly of approximately −400 to −800 K relative to ambient mantle at those depths, consistent with the thermal anomaly expected in a subducting slab that has been cold at the surface for millions of years',
            'The 30–60 km (37 mi) thickening indicates that the slab is chemically distinct from ambient mantle — it cannot be explained by temperature alone because the Clapeyron slopes only produce 5–10 km (6.2 mi) of discontinuity topography per 100 K of temperature anomaly; the Japan slab must therefore contain a different mineralogy from the surrounding mantle',
            'The TZ thickening of 30–60 km (37 mi) under Japan indicates the slab has stagnated horizontally in the transition zone for at least 50 Ma; the thickening represents sediment accumulation on top of the flat-lying slab rather than a temperature effect on phase transitions',
          ],
          correct: 1,
          explain: 'The Clapeyron slope relates the depth shift of a phase boundary to the temperature anomaly: ΔP = (dP/dT) × ΔT. Converting pressure to depth using the density gradient (dP/dz = ρg ≈ 3,300 kg/m³ × 10 m/s² = 33 MPa/km at 410 km (255 mi)). For the 410 (positive Clapeyron slope γ₄₁₀ ≈ +2.5 MPa/K): Δz₄₁₀ = −ΔT × γ₄₁₀ / (ρg). A cold slab with ΔT = −500 K: Δz₄₁₀ = −(−500) × 2.5 / 33 = +37.9 km (24 mi) elevation. For the 660 (negative Clapeyron slope γ₆₆₀ ≈ −2 MPa/K): Δz₆₆₀ = −(−500) × (−2) / 33 ≈ −30 km (19 mi) depression. Total TZ thickening: +37.9 + 30 = ~68 km (42 mi) for a 500 K cold anomaly. Observed thickening of 30–60 km (37 mi) under Japan is consistent with slab temperature anomalies of ~300–500 K below ambient mantle at those depths — physically reasonable for a slab that was at the surface (0°C (32°F)) and has sunk to 400–600 km (373 mi) depth over ~10–20 Ma, warming conductively from ambient mantle. Option A underestimates the quantitative power of the method — while there are uncertainties, the Clapeyron slopes are reasonably well constrained from laboratory mineral physics and the temperature inference is meaningful. Option C is incorrect — the Clapeyron slopes do produce 10–20 km (12 mi) of topography per 200–300 K, and the ~30 km (19 mi) per element is consistent with realistic slab temperature anomalies, without requiring compositional differences. Option D invents a sedimentation mechanism that has no physical basis at 410–660 km (410 mi) depth.',
        },
      ],
    },
  ],
