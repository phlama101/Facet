...
The world\'s most iconic landscapes bear the unmistakable signature of glacial erosion. The Norwegian fjords — drowned glacial troughs exceeding 1,300 m (4,265 ft) depth — represent the most extreme glacial carving on Earth. Yosemite Valley in California is a near-perfect U-shaped glacial trough carved 1 km (0.6 mi) deep in granite by Pleistocene valley glaciers. The Alps preserve classic cirques, arêtes (the Chamonix Aiguilles), and horns (the Matterhorn). Patagonia\'s Torres del Paine and New Zealand\'s Fiordland display troughs and fjords still being modified by active glaciers. As deglaciation continues — whether after a glacial maximum or under modern climate change — these forms emerge progressively, exposing the geological record of ice dynamics written in stone.`,
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Glacial trough below sea level, flooded after deglaciation. Can exceed 1,000 m (3,281 ft) depth.',
            color: BRAND.ruby,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Fjords are among the deepest sea inlets on Earth, often exceeding 1,000 m (3,281 ft) depth. What explains why glaciers eroded so far below sea level?',
          a: [
            ...
            'Glaciers maintained thick, fast-flowing, erosionally powerful conditions at the coast because global sea level was ~120 m (394 ft) lower during glacial maxima, exposing continental shelves, and the ice flowed to the extended coast — eroding deeply before deglaciation and sea level rise drowned the troughs',
          ...
          correct: 1,
          explain: 'During glacial maxima (e.g., Last Glacial Maximum, ~20,000 years ago), global sea level was ~120–130 m (394–427 ft) lower than today, exposing the continental shelf. Ice sheets extended to the exposed shelf edge, meaning outlet glaciers remained grounded (touching the bed) and erosionally active all the way to the coast and beyond. A grounded glacier with 1–3 km (0.6–1.9 mi) of ice thickness exerts enormous basal stress (~1–3 bars) and, if fast-flowing, produces extreme erosion rates. Sognefjord was eroded to 1,308 m (4,291 ft) depth because the outlet glacier remained thick and powerful at sea level. After deglaciation (~15,000–8,000 years ago), isostatic rebound lifted some areas, but the fjords were flooded by post-glacial sea level rise that added ~120 m (394 ft). The remaining depths (>120 m) genuinely represent sub-sea-level erosion by grounded ice.',
        },
        {
