...
This lesson is organised into two parts. First, the silicates — the dominant group, making up roughly 90% of the crust by volume — with the six mineral families you will encounter repeatedly throughout this course. Second, the non-silicates — carbonates, oxides, sulphides, and evaporites — which are less abundant in the crust overall but include some of the most geologically and economically important minerals on Earth.`,
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/1/19/Quartz%2C_Tibet.jpg/800px-Quartz%2C_Tibet.jpg',
        alt: 'Large quartz crystal cluster from Tibet showing characteristic hexagonal prismatic form',
        aspectRatio: '4/3',
        ...
        annotations: [
          {
            ...
            x: 55,
            y: 18,
            label: 'Hexagonal Prism Faces',
            description: 'Quartz belongs to the hexagonal crystal system, producing six long prism faces running parallel to the crystal\'s length. This six-fold symmetry is directly inherited from the hexagonal arrangement of silicon-oxygen tetrahedra in the crystal lattice.',
          },
          {
            id: '2',
            x: 70,
            y: 10,
            label: 'Pyramidal Termination',
            description: 'The pointed tip where the prism faces taper to a point via six rhombohedral faces. Well-formed quartz crystals almost always show this six-sided pyramidal termination — a reliable field identification feature.',
          },
          {
            id: '3',
            x: 35,
            y: 40,
            label: 'Vitreous Luster',
            description: 'Quartz displays a distinctive glass-like (vitreous) luster on its crystal faces. This glassy sheen, combined with its transparency or translucency in many samples, reflects the absence of metallic bonds in its pure SiO₂ structure.',
          },
          {
            id: '4',
            x: 50,
            ...
            description: 'Multiple crystals growing from a common base of rock matrix. Quartz commonly precipitates from hydrothermal (hot water) fluids that deposit SiO₂ into cracks and cavities as they cool, forming drusy crystal clusters like this one.',
          },
          {
            id: '5',
            x: 20,
            y: 60,
            label: 'Conchoidal Fracture Surface',
            description: 'The curved, shell-like fracture visible on broken crystal edges confirms quartz\'s lack of cleavage. Because all Si-O bonds are equally strong in all directions, quartz breaks irregularly rather than along flat planes.',
          },
        ],
      },
    },
    {
      ...
      variant: 'data',
      headline: 'Feldspar is the most abundant mineral in Earth\'s crust — making up roughly 60% of it by volume',
      body: "If you could sample every rock in Earth's entire crust and weigh each mineral type, feldspars (orthoclase and plagioclase combined) would account for about 60% of the total volume. Quartz adds another ~12%, and pyroxenes and amphiboles together contribute roughly 17%. All other mineral species combined — including the 5,400+ minerals that aren't in the top 30 — make up only about 11% of the crust. This extreme concentration means that learning just six mineral families gives you the tools to identify and interpret the overwhelming majority of rocks you will ever encounter.",
    },
    {
      type: 'concept',
