...
**Where igneous rocks form.** Igneous rocks are not randomly distributed across Earth's surface — they occur at predictable tectonic settings. Basalt erupts at **mid-ocean spreading centres**, where plates pull apart and decompression melting of the mantle produces large volumes of mafic magma. Basalt also erupts at **hotspots** — mantle plumes rising through the plate — creating chains of volcanic islands (Hawaii, Iceland). Granite and andesite dominate at **subduction-zone volcanic arcs**, where the descending oceanic plate releases water that lowers the melting point of the overlying mantle wedge, producing magmas that evolve toward more silica-rich compositions as they rise through the crust. These settings will be mapped in detail in Module 1.4; what matters here is that rock type and tectonic setting are linked: find basalt on the ocean floor or at a hotspot island; find granite in a continental batholith or mountain core.`,
    ...
    },
    {
      ...
      questions: [
        {
          q: "Two igneous rock samples have identical chemical compositions. Sample A has crystals 2 cm (0.8 in) across that are easily visible and identifiable by eye. Sample B looks uniformly dark and dense, with no crystals visible without a magnifier. What accounts for this difference?",
          a: [
        ...
        {
          q: "A porphyritic igneous rock contains two distinct populations of crystals: centimetre-scale pink feldspar phenocrysts embedded in a fine-grained grey groundmass. What two-stage cooling history does this texture record, and in which setting does porphyritic texture most commonly form?",
          a: [
            "The phenocrysts crystallised first in a deep magma chamber during slow cooling; the magma then erupted and the remaining melt cooled rapidly at the surface, freezing the groundmass in a fine-grained texture before large crystals could grow",
            "The fine groundmass formed first by rapid cooling of lava at the surface; the phenocrysts grew later by hydrothermal alteration as hot fluids circulated through the solidified rock and deposited feldspar in the pores",
            "Phenocrysts and groundmass crystallised simultaneously but from two separate magma batches of different composition that mixed during eruption — phenocrysts came from the felsic batch and the dark groundmass from a mafic batch",
            "The phenocrysts are xenocrysts — fragments of country rock picked up as the magma ascended — while the groundmass is the true magmatic component; porphyritic texture therefore indicates contamination of magma by wall rock",
          ],
          correct: 0,
          explain: "The correct answer is A: porphyritic texture records two-stage cooling history; the large phenocrysts grew slowly in a magma chamber at depth over thousands to millions of years, where insulating country rock kept temperatures high and allowed atoms to migrate and organise into large crystals; when the partially crystallised magma was then erupted or intruded into a shallower, cooler environment, the remaining melt cooled too quickly for further large crystal growth, freezing as the fine-grained groundmass; the contrast between the two crystal sizes thus directly records the two episodes of cooling at very different rates; porphyritic texture is especially common in subvolcanic intrusions and in lavas that spent time in shallow magma chambers before eruption. Hydrothermal alteration (B) can precipitate minerals into pore spaces but does not produce the clean, euhedral (well-formed) phenocrysts typical of porphyritic rocks — hydrothermal minerals tend to fill irregular voids and are chemically distinct from the original magmatic assemblage. Magma mixing (C) does occur and can produce unusual mineral assemblages, but porphyritic texture is not its defining signature — the two-crystal-size texture is specifically a cooling-rate record, not a mixing indicator. While xenocrysts do occasionally occur (D), they are typically rounded and corroded by reaction with the host magma; porphyritic phenocrysts are generally euhedral and in chemical equilibrium with the groundmass, confirming they are primary magmatic crystals, not contaminants.",
        },
      ],
    },
  ],
