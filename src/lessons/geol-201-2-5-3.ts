...
This is painstaking work. A 30 m section can take a full day. But the discipline pays off: a measured section recorded by a geologist in 1967 can still be used directly by a geologist in 2025 if it was recorded correctly — same bed thicknesses, same grain sizes, same Munsell colours, same sedimentary structures. That reproducibility, achieved through standardised methods and notations, is what makes geological data scientific rather than merely observational.`,
      keyTerms: [
        ...
        {
          term: "Jacob's staff",
          def: "A measuring rod of fixed length (1.5 m or 1.0 m) with a clinometer attachment fixed at one end. When the clinometer is set to the measured dip angle of the beds and the staff held at that angle, the top of the staff represents the same stratigraphic horizon as the base — the staff length equals the true stratigraphic thickness of the interval traversed, without trigonometric correction for topographic slope.",
        },
        {
          term: 'Wentworth scale',
          def: 'The standard grain-size classification scheme for sedimentary particles, based on powers of 2 in millimetres. Main divisions: clay (<0.004 mm, 4 μm); silt (0.004–0.063 mm); sand (0.063–2 mm, subdivided into very fine/fine/medium/coarse/very coarse); granule (2–4 mm); pebble (4–64 mm); cobble (64–256 mm); boulder (>256 mm). Named for Chester Wentworth (1922). Provides the grain-size axis of a graphic log.',
        },
        {
        ...
        },
        {
          ...
          def: 'The boundary between two successive beds in a sedimentary succession. Types: sharp (boundary located within <1 cm; abrupt change in lithology); gradational (boundary diffuse over several cm to >1 m, with beds merging gradually); erosive (the base of the upper bed incises into the lower bed, indicating a scour surface — a common base for channel sands); conformable (no time gap; beds parallel); unconformable (time gap, beds may be discordant in dip).',
        },
      ],
    },
    {
      ...
      body: `**The Jacob's staff technique.** The Jacob's staff is a 1.5 m (or 1.0 m) measuring rod with a clinometer fixed at the top end. To use it: (1) measure the dip of the beds at the section locality; (2) set the clinometer to the measured dip angle; (3) hold the base of the staff on the current stratigraphic horizon and the top of the staff in the upward stratigraphic direction. Because the clinometer angle matches the bed dip, the top of the staff projects along the same dipping surface as the base — meaning the vertical height traversed by one staff length equals the true stratigraphic thickness (1.5 m). This eliminates the need for a trigonometric correction when measuring on a slope. Record each staff placement as one increment on the cumulative thickness log. For flat-lying sections, a horizontal tape measure with GPS georeferencing suffices.

**The Wentworth grain-size scale.** Classification by grain size is the primary basis for naming clastic sedimentary rocks. The Wentworth scale divides grains by successive factors of 2 in millimetres: Clay (<0.004 mm): lithifies to mudstone/shale; settles from suspension in very low-energy environments. Silt (0.004–0.063 mm): lithifies to siltstone; deposited in low-energy settings (distal floodplains, prodelta, deep-marine). Sand (0.063–2 mm): lithifies to sandstone; subdivided as very fine/fine/medium/coarse/very coarse; deposited in moderate-energy environments (rivers, beaches, aeolian dunes, turbidite currents). Gravel (2–256 mm): lithifies to conglomerate (rounded) or breccia (angular); deposited in high-energy settings (braided rivers, alluvial fans, beaches, glacial outwash). Field determination: sand grains are visible and feel gritty; silt feels slightly gritty; clay feels smooth and plastic when wet. A printed grain-size card held against the rock in raking light is the standard field tool.
...
**Contact types.** Each bed boundary is described by its contact type. Sharp contacts (<1 cm transition) indicate abrupt environmental change — storm events, sudden current pulses, or erosional surfaces. Gradational contacts (diffuse over several cm to >1 m) indicate gradual changes in depositional energy. Erosive contacts show the base of the upper bed incising into the lower, indicating a scour surface (common at the base of river channel sands). Marker beds — distinctive laterally continuous layers (bentonite ash beds, coal seams, distinctive limestones) — serve as correlation datums between sections and are noted on every measured section.`,
    ...
    },
    {
      ...
      body: `**Cross-bedding (cross-stratification).** Inclined laminae within a bed, dipping in the direction of current flow at the time of deposition. The foresets — the inclined laminae themselves — indicate palaeocurrent direction. The scale of cross-bedding relates to the bedform size: ripple cross-lamination (small-scale, <3 cm set thickness) records ripple migration; dune cross-bedding (large-scale, up to metres) records dune migration. Environments: rivers, beaches, aeolian dune fields, tidal channels, and turbidite currents. In drill core, cross-bedding dip angle indicates transport direction.
...
**Constructing a graphic log.** Standard column organisation (left to right): cumulative thickness scale | bed number | lithology symbol column | grain-size column | Munsell colour column | sedimentary structures (drawn in margin) | contact type notation | fossil content | field notes. Two graphic log styles: (1) fixed-width column with all lithologies equal width — simpler; (2) grain-size column where column width represents grain size (wider = coarser) — more informative for environmental interpretation. Key facies patterns to recognise: *fining-upward cycles* (coarse base to mud top) = fluvial channel fill or decelerating turbidite; *coarsening-upward cycles* (mud base to sand top) = delta progradation or shallowing-upward shallow marine.`,
    ...
    },
    {
      ...
      body: 'This graphic log represents a 2 m measured section through a typical fluvial sequence. Beds are displayed youngest at top (as in a real section), oldest at base. Click each unit to read the full description, grain size, sedimentary structures, and environmental interpretation.',
      interaction: {
        type: 'layered-visual',
        description: 'A 2 m measured stratigraphic section showing a fining-upward fluvial channel sequence capped by a floodplain coal seam. Youngest beds are at the top, oldest at the base.',
        layers: [
          {
            id: 'coal',
            label: 'Coal Seam',
            sublabel: 'Marker bed · 0.1 m',
          ...
          },
          {
            ...
            sublabel: 'Floodplain · 0.3 m',
            color: BRAND.ruby,
            thickness: 15,
            state: 'Solid (fine-grained)',
            temperature: 'Surface',
            description: 'Red-brown mudstone (clay-grade, <0.004 mm) with polygonal desiccation crack networks on bedding surfaces. Crack edges are upturned, widths 1–3 mm, polygon diameters 5–20 cm. Root traces (rhizoliths) penetrate vertically downward into the bed. Indicates periodic subaerial exposure and soil development on a floodplain between flood events. The red colour indicates oxidising (well-drained) conditions.',
            facts: [
              'Grain size: clay (<0.004 mm) — smooth, plastic when wet',
              'Munsell: 5YR 5/6 (yellowish red)',
              'Desiccation cracks: polygonal, 5–20 cm diameter, edges upturned',
          ...
          },
          {
            ...
            sublabel: 'River channel · 0.8 m',
            color: BRAND.coral,
            thickness: 40,
            state: 'Solid (coarse-grained)',
            temperature: 'Surface',
            description: 'Well-sorted, medium-to-coarse sandstone (0.25–0.5 mm) with large-scale planar cross-bedding (set thickness 20–40 cm, foreset dip 25–30° toward SW). Cross-bed sets separated by reactivation surfaces. Represents deposition in the active river channel axis over migrating dunes. The dominant unit of the section; its sharp erosive base marks the channel scour surface where the river eroded into older floodplain deposits.',
            facts: [
              'Grain size: medium-coarse sand (0.25–0.5 mm) — clearly gritty, individual grains visible',
              'Munsell: 10YR 7/4 (very pale brown to pale yellow)',
              'Cross-bed sets: 20–40 cm thick; foreset dip 25–30° toward SW',
              'Sorting: well-sorted (narrow grain-size range — winnowed by sustained current)',
              'Sharp erosive base: incises up to 5 cm into underlying conglomerate',
            ],
          },
          {
            id: 'conglomerate',
            label: 'Conglomerate (Channel Lag)',
            sublabel: 'Erosive base · 0.15 m',
            color: BRAND.jade,
            thickness: 8,
            state: 'Solid (very coarse-grained)',
            temperature: 'Surface',
            description: 'Clast-supported pebble conglomerate with rounded clasts 4–30 mm, set in a coarse sandy matrix. Clasts are well-rounded (long transport distance). Sharp, irregular erosive lower contact incises up to 10 cm into subjacent floodplain deposits. Represents the coarsest material transported by the river during peak discharge — deposited as a lag when velocity dropped slightly after the initial erosive pulse. The base of the fining-upward sequence and the beginning of the channel fill cycle.',
            facts: [
              'Grain size: pebble (4–64 mm clasts), well-rounded — long-distance fluvial transport',
              'Munsell: matrix 10YR 6/3 (pale brown); clasts vary',
              'Contact: sharp, erosive lower boundary (incises 5–10 cm into underlying floodplain)',
      ...
      questions: [
        {
          ...
          a: [
            ...
            "A Jacob's staff is a 1 m rod used as a scale marker in field photographs; it does not measure thickness directly but provides a reference length for photogrammetric thickness calculations",
          ],
          correct: 1,
          explain: "The Jacob's staff is an elegant solution to the problem of measuring true stratigraphic thickness in dipping beds on a sloped terrain. Without correction, measuring bed thickness along a slope produces an apparent thickness that can be significantly different from the true (perpendicular-to-bedding) stratigraphic thickness. If you measure vertically up a slope with a tape measure while beds are dipping at an angle, you get a compound of topographic slope and bed dip that yields neither the vertical stratigraphic thickness nor the perpendicular-to-bedding thickness. The Jacob's staff solves this elegantly: by setting the clinometer to the measured bed dip and holding the staff at that angle, the top of the staff is always on the same bedding plane as the base. The staff therefore measures exactly one stratigraphic increment (1.5 m or 1.0 m of true stratigraphic thickness) regardless of topographic slope. This works because the staff and the bedding plane are co-planar — a consistent geometric relationship that eliminates the trigonometric correction. In practice, the geologist plants the staff base on one bedding surface, reads the meter mark at the top, records that as 1.5 m of section, moves the base to the top position, and repeats. Option A describes pacing with a correction — not the Jacob's staff method. Option C describes a clinometer function, not the instrument's primary use. Option D describes a photographic scale bar — an entirely different tool.",
        },
        {
          q: 'A geologist describes a sandstone bed as: "Well-sorted, medium-grained (0.3–0.5 mm) sandstone with large-scale planar cross-beds (dipping 25° toward the NNE, foreset height 40 cm), sharp erosive base, gradational top into overbank siltstone." Using the Wentworth scale and the significance of the sedimentary structures, what depositional environment does this description indicate?',
          a: [
            ...
            'This description indicates a fluvial (river) channel deposit. Medium-grained well-sorted sand (0.3–0.5 mm, Wentworth medium sand grade) is consistent with sustained unidirectional current transport. Large-scale planar cross-beds with 40 cm foreset height record migration of river dunes — bedforms that form at current velocities of ~0.3–1.0 m/s in sandy channels. The NNE-dipping foresets indicate palaeocurrent flow toward the NNE. The sharp erosive base records the channel scour surface where the river eroded into older deposits. The gradational top into overbank siltstone records deposition on the bar margin or channel tail as flow velocity decreased, followed by fine-grained overbank flood suspension settling — the classic fining-upward signature of a fluvial channel-fill sequence',
        ...
        },
        {
          ...
          a: [
            ...
            "5YR 5/6 means the sample is from the Silurian period (5YR = 5th era, Young Rock); Value 5 = depth of 5 m; Chroma 6 = 6th core interval. The notation is used in borehole logging rather than surface fieldwork",
          ],
          correct: 0,
