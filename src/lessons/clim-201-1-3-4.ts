...
Distinct from CDR, **Solar Radiation Management (SRM)** approaches do not remove CO₂ but instead reduce the solar energy reaching Earth\'s surface, masking the greenhouse warming effect without addressing its atmospheric cause. **Stratospheric Aerosol Injection (SAI)** would deliver sulfate or calcium carbonate particles into the lower stratosphere at ~20 km (12 mi) altitude, mimicking the cooling effect of large volcanic eruptions. The 1991 eruption of **Mt Pinatubo** (Philippines) injected ~20 Mt of SO₂, producing approximately 0.5°C (0.9°F) of global cooling over 1–2 years — providing the best natural analogue for SAI. Climate model simulations indicate that SAI at a scale of 1–8 Tg S/yr could offset ~1–2°C (1.8–3.6°F) of global warming, but with regional heterogeneity: reduced precipitation in some monsoon regions, altered stratospheric dynamics, and ozone depletion.
...
**Stratospheric aerosol injection** acts on the incoming solar flux rather than the CO₂ stock. It is fast (months to deploy at scale versus decades for CDR), cheap (estimated at $2–8 billion/yr for ~1°C (~1.8°F) of cooling — orders of magnitude less than CDR at equivalent scale), and reversible in principle (though termination shock makes reversal dangerous in practice). It does not reduce ocean acidification, does not address CO₂ as a long-term commitment, and creates a geopolitical hostage dynamic: once deployed at scale, any state or faction that interrupts supply imposes catastrophic warming rates on the entire planet.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Mt Pinatubo (1991): 20 Mt SO₂ → −0.5°C (-0.9°F) global cooling, 1–2 yr · SCoPEx experiment (Harvard): cancelled 2021 after governance disputes · MARINE programme (UK): MCB field trial near Farallon Islands · NAS 2021 report: recommended $100M research programme before any deployment decisions',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Atmospheric CO₂ has risen from 280 ppm pre-industrial to ~422 ppm today, driving ~1.2°C (~2.2°F) of global warming. IPCC AR6 median 1.5°C (2.7°F) pathways require removing 5–10 Pg CO₂/yr from this reservoir by 2050, in addition to near-complete emission cuts, to return to target after temporary overshoot.',
            color: BRAND.coral,
          },
          {
            id: 'cdr-biological',
          ...
          },
          {
            ...
            description: 'Stratospheric aerosol injection introduces sulfate or calcium carbonate particles at ~20 km (12 mi) altitude, scattering incoming solar radiation. Mt Pinatubo analogue: 20 Mt SO₂ → ~0.5°C (~0.9°F) cooling for 1–2 years. SAI models suggest 1–8 Tg S/yr could offset 1–2°C (1.8–3.6°F) of warming but alters regional precipitation and depletes stratospheric ozone. Does not reduce ocean acidification or address CO₂ accumulation.',
            color: BRAND.amethyst,
          },
          {
            id: 'termination-shock',
            label: 'Termination Shock & Governance Risk',
            description: 'If SAI ceased abruptly after masking 1–2°C (1.8–3.6°F) of warming, the unmasked CO₂-driven warming would re-emerge over years, imposing extreme warming rates on ecosystems and human systems. No international governance framework currently exists to authorise, regulate, or prohibit unilateral SAI deployment. ENMOD (1977) covers hostile use only. Moral hazard risk: geoengineering prospect may reduce emission-reduction urgency.',
            color: BRAND.ruby,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Why do virtually all IPCC AR6 1.5°C (2.7°F) pathways require large-scale Carbon Dioxide Removal (CDR), even in scenarios with aggressive emission cuts?',
          a: [
            'CDR is needed primarily to offset natural carbon cycle feedbacks such as permafrost thaw and Amazon dieback, which will release CO₂ regardless of human emission reductions; the human emission cuts alone would be sufficient to reach 1.5°C (2.7°F) if those natural feedbacks did not exist',
        ...
        },
        {
          ...
          a: [
            ...
            'The 1991 Pinatubo eruption injected approximately 20 Mt of SO₂ into the lower stratosphere, producing a global mean cooling of approximately 0.5°C (0.9°F) lasting 1–2 years; this observed cooling, its spatial pattern, its effects on stratospheric ozone and regional precipitation, and its subsequent decay as aerosols settled provide the most detailed real-world test of how the climate system responds to stratospheric sulfate loading — the same mechanism proposed for deliberate SAI',
