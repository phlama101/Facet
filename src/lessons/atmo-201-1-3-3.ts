      ...
      keyTerms: [
        {
          ...
          def: 'The theoretical upper bound on tropical cyclone wind speed, derived by Kerry Emanuel (1986) by treating the TC as a Carnot heat engine. MPI depends on the temperature of the ocean surface (heat source) and the temperature of the outflow near the tropopause (cold sink). A 1°C (34°F) increase in SST raises MPI by roughly 1.5–3 m/s. Observed TC intensities rarely reach MPI because environmental factors — wind shear, dry air intrusion, ocean cooling — reduce the actual intensity below the theoretical maximum. MPI provides the climatological ceiling that constrains TC intensity for a given SST and atmospheric temperature profile.',
        },
        {
      ...
      cards: [
        {
          ...
          desc: 'TC treated as Carnot engine: heat absorbed from warm ocean (~27–29°C (81–84°F)), expelled at cold tropopause (~−70°C (−94°F)). MPI = theoretical wind-speed ceiling; rises ~1.5–3 m/s per 1°C (34°F) SST increase. WISHE feedback: stronger winds → more evaporation → stronger updrafts → lower pressure → stronger winds.',
        ...
        },
        {
          ...
          icon: Activity,
          color: BRAND.ruby,
          desc: 'RI defined as ≥35 kt increase in 24 hours. Warm core eddies (100–200 m (328–656 ft) deep) suppress cold wake, sustaining heat flux. Cold wake formation limits intensity for slow-moving storms. RI frequency increasing with rising SSTs — compresses warning lead times.',
          examples: 'Patricia 2015: RI from Cat 1 to Cat 5 in ~24 hours over warm eddy · Harvey 2017: slow translation → 1,500 mm (19.69 in) rainfall, record SSTs in Gulf · Warm core eddies detectable via satellite altimetry → now in NHC intensity guidance · RI remains single largest source of TC intensity forecast error',
        },
        {
          name: 'Eye, Eyewall & Internal Dynamics',
          icon: Wind,
          color: BRAND.accent,
          desc: 'Eye: descending air, 5–10°C (41–50°F) warmer than environment aloft (warm core), calm winds. Eyewall: strongest winds and convection at radius of maximum wind. Eyewall replacement cycles: outer eyewall strangles inner → intensity fluctuation. Annular hurricanes: wide symmetric eyewall, unusual intensity maintenance.',
          examples: 'Eye diameter: typically 20–60 km (12–37 mi) · Warm core anomaly: up to +10°C (50°F) in upper troposphere vs. environment · ERC examples: Ivan 2004, Irma 2017 (weakened then re-intensified) · Annular mode: Isabel 2003, Pali 2016 · Saffir-Simpson Cat 5: ≥137 kt sustained winds',
        },
        {
          ...
          examples: 'Poleward shift: Kossin et al. 2014, Nature — 30-yr global dataset · Harvey 2017: record rainfall attributed to +0.5–1°C (33–34°F) Gulf SST anomaly · Cat 4–5 fraction: ~25–40% increase projected under 2°C (36°F) warming · NW Pacific: 30% of all global TCs · Mediterranean increasingly threatened by medicanes (Mediterranean hurricanes)',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Sea surface temperatures ≥26°C (79°F) to ~50 m (164 ft) depth provide the thermodynamic fuel. Warm core ocean eddies extend the warm layer to 100–200 m (328–656 ft), suppressing cold wake formation. SST controls the heat source temperature in the Carnot model and sets the ceiling on maximum potential intensity (MPI). A 1°C (34°F) increase in SST raises MPI by ~1.5–3 m/s. Under anthropogenic warming, SSTs are rising and warm core eddies are becoming more prevalent.',
            color: BRAND.accentHot,
          },
          {
            id: 'air-sea-flux',
      ...
      questions: [
        {
          ...
          a: [
            ...
            'MPI depends on the temperature of the ocean surface and the temperature of the lower stratosphere; because the stratosphere cools under greenhouse warming, rising CO₂ simultaneously warms the ocean and cools the cold sink, producing a large increase in MPI — roughly 10–15 m/s per 1°C (34°F) SST rise — much larger than current models project',
        ...
        },
        {
          ...
          a: [
            ...
            'Warm core ocean eddies provide a deeper reservoir of warm water (100–200 m (328–656 ft)) beneath the TC; when wind-driven upwelling and turbulent mixing occur under the storm, the mixing draws from this deep warm layer rather than the cold thermocline, maintaining higher SSTs beneath the storm; the reduced SST cooling preserves the air-sea enthalpy flux, sustains WISHE feedback, and allows the storm to approach or maintain near-MPI conditions — enabling rapid intensification without the self-limiting cold wake that constrains intensification over normal ocean depths',
            'Warm core ocean eddies raise the sea surface height above the eddy centre by 10–30 cm (11.8 in); this elevated sea surface creates a positive slope that directs TC surface inflow toward the eddy centre, concentrating the storm\'s circulation and mechanically increasing wind speeds independently of any thermodynamic mechanism',
          ],
          correct: 2,
          explain: `The cold wake is the primary self-limiting mechanism on TC intensity: the storm\'s strong surface winds apply a stress to the ocean that drives Ekman pumping (upwelling at the storm centre) and turbulent mixing across the thermocline, bringing cold water from below to the surface. Over a typical ocean with a warm mixed layer of only 20–50 m (66–164 ft) depth, this mixing can cool SSTs by 1–5°C (34–41°F) in the wake of the storm, reducing the air-sea enthalpy flux and limiting further intensification. Warm core ocean eddies — mesoscale features of anomalously warm water detectable as positive sea surface height anomalies via satellite altimetry — extend the warm mixed layer to depths of 100–200 m (328–656 ft). When a TC passes over such an eddy, the same wind-driven mixing occurs, but instead of drawing up cold water from 30–50 m (98–164 ft), it mixes within the deep warm layer. SST cooling is dramatically reduced — sometimes by half or more compared to crossing a thin mixed layer. This maintenance of high SST preserves the temperature gradient driving WISHE feedback, keeps the latent heat flux high, and allows the storm to sustain or accelerate intensification — the defining condition for RI. Patricia (2015) exemplified this: its explosive RI occurred as it moved over a deep warm eddy in the eastern Pacific with near-MPI conditions. Operationally, warm eddy locations derived from satellite altimetry are now incorporated into NHC and JTWC intensity guidance. Answer A is incorrect — eddies affect TC intensity primarily through ocean thermal effects, not rainband water vapour injection. Answer B incorrectly describes a mechanism by which eddies affect wind shear — eddies do slightly warm the atmosphere above them, but the primary TC intensification effect is oceanic, not atmospheric. Answer D confusingly conflates sea surface height (a proxy for the eddy) with a mechanical inflow-directing mechanism — sea surface height anomalies do not directly steer or concentrate TC circulation.`,
        },
        {
          ...
          a: [
            'RI is most favoured by high vertical wind shear (>20 m/s) combined with cold sea surface temperatures (<25°C (77°F)); the large shear tilts the eyewall, which paradoxically concentrates the convection into a narrow band that intensifies more efficiently than a symmetric eyewall; forecasting RI is difficult because shear is poorly measured by weather satellites',
