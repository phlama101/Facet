    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'ECMWF SPPT: random multiplicative perturbation applied to all parameterised tendencies (convection, boundary layer, radiation, gravity wave drag) · SPPT spatial correlation scale: ~500 km; temporal correlation: ~6 hours · SKEB: adds random rotational wind perturbations to represent upscale energy transfer from unresolved convection · Benefit: SPPT reduces underdispersion at day 7–10 by ~15–20%; improves CRPSS for 2-m temperature by ~5%',
        },
      ],
    },
    {
