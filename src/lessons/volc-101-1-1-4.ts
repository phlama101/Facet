...
Understanding volcanic landform types is one of the first skills a volcanologist develops — not just because it allows classification, but because each edifice type predicts the hazards it poses, the eruption style it is capable of, and the monitoring approach that is most relevant. A shield volcano monitored for lava flow paths requires different attention than a caldera system monitored for the first signs of magma chamber reactivation.`,
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/f/f4/Lahar_from_Mayon_Volcano.jpg/1200px-Lahar_from_Mayon_Volcano.jpg',
        alt: 'A lahar (volcanic mudflow) descending from Mayon Volcano in the Philippines, destroying vegetation and depositing thick sediment',
        aspectRatio: '16/9',
        credit: 'PHIVOLCS / Wikimedia Commons',
        annotations: [
          {
            id: 'lahar-flow-front',
            x: 40,
            y: 55,
            label: 'Lahar flow front',
            description: 'The leading edge of the lahar — a rapidly moving slurry of volcanic debris, water, and sediment with the consistency of wet concrete. Flow fronts can travel faster than 100 km/h down river valleys, carrying house-sized boulders.',
          },
          {
            id: 'volcanic-slope',
            x: 20,
            y: 20,
            label: 'Volcanic slope',
            description: 'The steep flanks of Mayon Volcano, mantled with loose pyroclastic deposits from previous eruptions. Heavy rainfall or summit snow melt rapidly mobilises this unconsolidated material, triggering lahars even without active eruption.',
          },
          {
            id: 'vegetation-destruction',
            x: 60,
            y: 65,
            label: 'Vegetation destruction',
            description: 'Trees and vegetation bulldozed and buried by the advancing lahar. The deposit can reach several metres in depth, burying farmland, buildings, and river channels under a hardened concrete-like layer that remains for decades.',
          },
          {
            id: 'deposit-levee',
            x: 15,
            y: 60,
            label: 'Deposit levee',
            description: 'Coarse debris deposited along the margins of the lahar channel as the flow loses energy. Natural levees build up over successive lahar events, confining later flows but also increasing flow depth and speed within the channel.',
          },
          {
            id: 'pyroclastic-origin',
            x: 50,
            y: 10,
            label: 'Pyroclastic source material',
            description: 'Loose tephra, ash, and pumice deposited on the upper slopes by previous eruptions provide the sediment load for lahars. Mayon\'s steep cone and frequent eruptions produce abundant unconsolidated material that remains lahar-prone for decades.',
          },
        ],
      },
    },
