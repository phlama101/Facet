...
Understanding volcanic landform types is one of the first skills a volcanologist develops — not just because it allows classification, but because each edifice type predicts the hazards it poses, the eruption style it is capable of, and the monitoring approach that is most relevant. A shield volcano monitored for lava flow paths requires different attention than a caldera system monitored for the first signs of magma chamber reactivation.`,
      keyTerms: [
        { term: 'Shield volcano',     def: 'A broad, gently sloping volcanic edifice (slopes 2–8°) built by the accumulation of highly fluid basaltic lava flows. Named for resemblance to a warrior\'s shield lying flat. Built by effusive eruptions from a central vent and radial fissures. Can be enormous: Mauna Loa (Hawaii) is ~100 km (62 mi) wide and rises ~10,000 m (32810 ft) from the seafloor — the largest volcano on Earth by volume.' },
    ...
    },
    {
      ...
      body: "Lahars (volcanic mudflows) can travel faster than 100 km/h (62 mph) and travel hundreds of kilometres from a volcano. The 1985 Nevado del Ruiz eruption in Colombia generated lahars that buried the town of Armero 74 km (46 mi) away, killing more than 23,000 people.",
    },
    {
      type: 'concept',
      title: 'Major edifice types, calderas, and volcanic fields',
      body: `**Shield volcanoes: building from the seafloor.** Shield volcanoes are constructed almost entirely from basaltic lava flows, with very little pyroclastic material. Because basaltic lava has low viscosity, it can flow tens of kilometres from the erupting vent before solidifying, producing the characteristic broad, gently sloping form. The Hawaiian volcanoes are the archetypical shields: Mauna Loa covers an area of 5,271 km² (2035 sq mi) and rises 4,169 m (13678 ft) above sea level, but its true height from the seafloor is ~10,000 m (32810 ft) — making it taller than Mt. Everest by 1,400 m (4593 ft). The island of Hawaii itself is the visible portion of five overlapping shield volcanoes (Kīlauea, Mauna Loa, Mauna Kea, Hualālai, Kohala). At the summit of most shields is a **pit crater** or caldera formed by subsidence when lava drains from the underlying lava lake system. Iceland, which sits on both the Mid-Atlantic Ridge and a mantle plume, is entirely built of shield and fissure-fed basaltic lava — the largest basaltic island on Earth.

**Stratovolcanoes: layered and dangerous.** Stratovolcanoes build their steep, elegant profiles through a long history of alternating eruption styles: periods of effusive lava production interrupted by explosive pyroclastic events that deposit thick layers of ash, lapilli, and pumice. The internal structure of a stratovolcano is a layered cake of lava flows (dense, strong) interbedded with pyroclastic deposits (weaker, more easily eroded). This combination of strong and weak layers makes the flanks of stratovolcanoes prone to **sector collapse** — massive landslides in which a large portion of the cone fails and slides away. The 1980 eruption of Mt. St. Helens began with exactly such a collapse: the bulging north flank, inflated by a cryptodome (shallow magma intrusion), collapsed in a catastrophic landslide that removed 2.5 km³ (0.60 cu mi) of the volcano's summit, triggering a **lateral blast** — a directed explosion that devastated 600 km² (232 sq mi) of forest to the north within minutes.

**Calderas: the super-eruption record.** The most dangerous volcanic structures are not peaks but holes — calderas form not from lava building upward but from catastrophic collapse after magma is rapidly evacuated from a shallow reservoir, and some caldera systems sit beneath unremarkable-looking ground. A caldera forms when a volcano's magma reservoir is rapidly and catastrophically emptied during a large-scale eruption, removing the support from beneath the overlying rock, which then collapses inward. The resulting depression can be 5–100 km (62 mi) in diameter and hundreds to thousands of metres deep. The collapse may occur in a matter of minutes during the most intense phase of a large eruption. Long Valley Caldera (California) formed 760,000 years ago during an eruption that produced ~600 km³ (144 cu mi) of rhyolitic magma; Yellowstone Caldera formed 640,000 years ago during a ~1,000 km³ (240 cu mi) eruption; Toba Caldera (Sumatra) formed ~74,000 years ago during the largest known eruption of the Quaternary (~2,800 km³ (672 cu mi)). Post-collapse activity often produces **resurgent calderas** — the caldera floor is lifted by renewed magma intrusion, creating a central dome, and the caldera moat fills with hydrothermal lakes and fumarole fields.

**Lava domes and their hazards.** When highly viscous dacitic or rhyolitic magma reaches the surface, it cannot flow away from the vent — it piles up as a slow-growing dome. Domes grow by both extrusion (new lava is added to the outer surface) and endogenous inflation (new magma is injected into the interior, making the dome swell). The greatest hazard of lava domes is their instability: as a dome grows, its oversteepened flanks may collapse, releasing the hot, gas-charged interior material as a **pyroclastic density current** (block-and-ash flow) — a fast-moving avalanche of hot gas and rock fragments capable of travelling at 100+ km (62+ mi)/h. The 1997 collapse of the Soufrière Hills dome (Montserrat) produced block-and-ash flows that destroyed the capital Plymouth. Mt. St. Helens grew a massive dome (150 m/hr at its peak growth rate in 2004–2005) in its crater after the 1980 eruption, monitored continuously as a proxy for magmatic recharge.
...
**Volcanic fields and monogenetic volcanism.** Not all volcanic activity produces long-lived central vent volcanoes. **Volcanic fields** are broad areas containing hundreds of individual small volcanic centres — cinder cones, maars (explosion craters formed by phreatomagmatic eruptions), lava shields, and lava flows — distributed over tens to hundreds of square kilometres. Each vent in a volcanic field typically has only one eruption episode (monogenetic) before becoming extinct; new eruptions occur at new locations within the field, driven by successive batches of magma rising through the crust. Examples: Michoacán-Guanajuato Volcanic Field (Mexico, 900+ cinder cones), Springerville Volcanic Field (Arizona), Auckland Volcanic Field (New Zealand, directly beneath a city of 1.7 million people). The hazard challenge of volcanic fields is that eruptions can potentially occur anywhere within the field, not at a known central vent.`,
      cards: [
        {
          ...
          icon: Mountain,
          color: BRAND.coral,
          desc: 'Shield: basalt, effusive, slopes 2–8°, very broad and flat, built over 100,000s yr; vent collapses → pit crater; Hawaiian example. Mauna Loa: largest on Earth by volume (75,000 km³ (17992 cu mi)). Stratovolcano: andesite/dacite, alternating explosive+effusive, slopes 20–35°, tall and steep, internal lava+tephra layers, prone to sector collapse; subduction zone. Mt. Fuji: 3,776 m (12389 ft); Mt. Rainier: 4,392 m (14410 ft); Merapi: most active in Indonesia. Cinder cone: scoria, Strombolian, small, monogenetic.',
          examples: 'Mauna Kea: 10,210 m (33499 ft) from seafloor (taller than Everest) · Parícutin: grew from cornfield in 9 years (1943), reached 424 m (1391 ft), now extinct · Mt. Fuji: last erupted 1707 (Hōei eruption), Plinian to Vulcanian; deposits found in Tokyo',
        },
        {
          ...
          examples: 'Crater Lake (Oregon): formed 7,700 yr ago when Mt. Mazama collapsed after erupting ~40 km³ (9.6 cu mi); lake now 594 m (1949 ft) deep · Campi Flegrei (Italy, Naples): active caldera, 40,000 years of unrest, near 3 million residents · Santorini (Greece, ~1600 BCE): Bronze Age Minoan eruption VEI 7 possibly linked to Atlantis legend and Exodus',
        },
        {
          name: 'Lava Domes and Volcanic Fields',
          icon: Globe,
          color: BRAND.jade,
          desc: 'Lava dome: dacite/rhyolite, too viscous to flow, piles up at vent, endogenous+exogenous growth, unstable flanks collapse → block-and-ash flows (PDC). Monitoring: GPS, seismicity, thermal cameras detect dome growth. Volcanic field: hundreds of monogenetic vents (cinder cones, maars, shields) over wide area; eruption can occur anywhere in field. Auckland: 53 volcanoes over 360 km² (139 sq mi), beneath 1.7 million people, last eruption 550 yr ago.',
    ...
    },
    {
      ...
      questions: [
        {
          q: "A geologist presents two satellite images side by side. Image A shows a massive volcanic edifice with very gentle slopes (2–5°) extending over 100 km (62 mi) in diameter, with a summit depression. Image B shows a steep, conical volcano rising sharply to a pointed summit, approximately 30 km (19 mi) in diameter and 3,000 m (9843 ft) tall. Without chemical analysis, what can the geologist infer about the eruption style, magma type, and likely tectonic setting of each volcano?",
          a: [
        ...
        },
        {
          ...
          a: [
            ...
            "The Krakatau eruption catastrophically emptied its shallow magmatic reservoir in a series of massive explosive eruptions; when the magma reservoir was sufficiently depleted of pressure support, the overlying volcanic island — approximately 6 km³ (1.4 cu mi) — collapsed into the evacuated chamber in minutes, producing the caldera; the sudden collapse of this volume of rock into the ocean generated the tsunami; the explosion itself injected sulfur dioxide into the stratosphere, causing measurable global cooling of ~0.4°C (1°F) for ~5 years",
        ...
        },
        {
          ...
          a: [
            ...
            "Auckland's volcanic field is challenging because eruptions can occur at new locations anywhere within the field — the 53 existing volcanoes are all extinct monogenetic vents that will not re-erupt; a new eruption will open at a different location within the ~360 km² (139 sq mi) field, and the location of the next vent cannot be predicted without real-time magma intrusion data; monitoring relies on detecting the seismic swarm, ground deformation, and gas emissions that precede vent opening by hours to days, combined with broad-field seismic and GPS networks sensitive to any emerging intrusion",
