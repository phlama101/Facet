...
Mitigation requires restructuring the global energy system more fundamentally and rapidly than any previous industrial transition in history. The core arithmetic is stark: to limit warming to 1.5 °C (2.7°F), net CO₂ emissions must reach zero by approximately 2050, and emissions of other greenhouse gases must be rapidly reduced. Solar and wind energy costs have fallen more than 90 % since 2010, making clean electricity cheaper than fossil fuels in most of the world — but energy is only ~35 % of global emissions. Industry, agriculture, land use, and transport each require distinct solutions, and the hardest-to-abate sectors (steel, cement, shipping, aviation) remain far from decarbonised.

Adaptation is unavoidable even under the most aggressive mitigation scenario, because ~0.3–0.5 °C (0.5–0.9°F) of committed warming remains in the pipeline from existing GHG concentrations. But adaptation has limits: some changes exceed the capacity of social-ecological systems to adjust, creating **hard adaptation limits** where harm cannot be prevented regardless of resources or technology. The international climate governance framework — from the 1992 UNFCCC through the 1997 Kyoto Protocol to the 2015 Paris Agreement — provides the scaffolding within which both mitigation and adaptation commitments are negotiated and implemented, though the gap between current pledges and the 1.5 °C (2.7°F) pathway remains substantial.`,
      keyTerms: [
        { term: 'Net-zero emissions', def: 'A state in which the amount of greenhouse gases added to the atmosphere by human activities equals the amount removed by natural and technological carbon sinks. Reaching net-zero CO₂ by approximately 2050 globally is the central requirement for limiting warming to 1.5 °C (2.7°F). Net-zero is distinct from "zero emissions" — some residual emissions from hard-to-abate sectors (aviation, shipping, agriculture) are offset by carbon dioxide removal (CDR). The IPCC AR6 assessed that delaying net-zero by 10 years roughly doubles the remaining cumulative emissions and makes 1.5 °C (2.7°F) unachievable.' },
...
**Carbon dioxide removal:** Most 1.5 °C (2.7°F) modelled pathways require 2–10 GtCO₂/yr of CDR by 2050. Current CDR capacity is ~0.002 GtCO₂/yr. Scaling CDR by a factor of 1,000 in 30 years is one of the most demanding technology challenges humanity faces.
...
**International climate governance.** The **UNFCCC** (1992) established the foundational principle of "common but differentiated responsibilities" (CBDR) and near-universal participation. The **Kyoto Protocol** (1997) imposed binding emission reduction targets on developed (Annex I) countries but excluded developing nations and was undermined by the US non-ratification. The **Paris Agreement** (2015) achieved near-universal participation through Nationally Determined Contributions (NDCs) — voluntary pledges reviewed every five years under a ratchet mechanism. Paris lacks enforcement mechanisms but creates transparency obligations and political accountability. Current NDCs project ~2.5–3.0 °C (4.5–5.4°F) by 2100 — well above the 1.5–2 °C (2.7–3.6°F) targets. Bridging this ambition gap while ensuring equity is the defining challenge of the current decade.`,
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Most IPCC 1.5 °C (2.7°F) scenarios require 2–10 GtCO₂/yr of carbon dioxide removal by mid-century, but current CDR capacity is only ~0.002 GtCO₂/yr. What does this gap imply?',
          a: [
            'Rapid CDR scale-up is a critical dependency in modelled 1.5 °C (2.7°F) pathways; failing to develop it would require even steeper near-term emission cuts to compensate',
            'The 1.5 °C (2.7°F) target is already unachievable and should be abandoned in favour of 2 °C (3.6°F)',
          ...
          correct: 0,
          explain: 'The CDR gap is one of the most significant implementation risks in current climate policy. Integrated Assessment Models that produce 1.5 °C (2.7°F) scenarios treat CDR as a balancing item — typically to offset residual hard-to-abate emissions. If CDR fails to scale, the same warming target requires even faster decarbonisation of energy, industry, and land use.',
        },
        {
