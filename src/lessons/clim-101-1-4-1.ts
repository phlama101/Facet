...
**Wind power: onshore and offshore.** Onshore wind turbines have similarly benefited from scale, technology, and experience: the average turbine capacity has grown from ~1 MW in the early 2000s to 4–6 MW today, with hub heights above 100 m (328 ft) capturing stronger and more consistent wind resources. Offshore wind harnesses stronger, more consistent winds over ocean surfaces with less visual impact and better proximity to coastal population centres; it is more expensive than onshore (~$80–110/MWh LCOE vs. $30–60/MWh for onshore in good locations) but costs have fallen dramatically and it is now commercially deployed at gigawatt scale in Europe, the UK, and increasingly in Asia. The IEA projects offshore wind capacity growing from ~65 GW in 2022 to ~380 GW by 2030 in its Announced Pledges Scenario.
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'Cement is harder to decarbonize than steel because cement plants operate at higher temperatures (>2,000 °C (>3,632°F)) than steel plants (~1,500 °C (2,732°F)), requiring more powerful and expensive electric arc furnaces; the primary solution is to replace all limestone with synthetic calcium silicate that does not release CO₂ when heated',
