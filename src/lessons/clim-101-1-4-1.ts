    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'Cement is harder to decarbonize than steel because cement plants operate at higher temperatures (>2,000 °C (0.0°F)) than steel plants (~1,500 °C (932°F)), requiring more powerful and expensive electric arc furnaces; the primary solution is to replace all limestone with synthetic calcium silicate that does not release CO₂ when heated',
