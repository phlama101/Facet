...
**Module 1.2 — complete.** This lesson closes the second module of GEOL 101. We have moved from defining what a mineral is (1.2.1) to testing its physical properties (1.2.2) to learning the 30 minerals that build Earth's rocks (1.2.3) to classifying the geometric basis for all of those properties (1.2.4). Module 1.3 zooms back out to the rock scale: armed with this mineral vocabulary, we will now examine how igneous, sedimentary, and metamorphic rocks form, and how to tell them apart.`,
      cards: [
        {
