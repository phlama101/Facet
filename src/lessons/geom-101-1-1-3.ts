...
Debris flows are a particularly lethal sub-type: water-saturated granular material moves as a viscous slurry at 1–30 m/s, confined to channels before spreading across alluvial fans. Lahars — volcanic debris flows incorporating ash and pyroclastic material — can travel more than 100 km from the source volcano. The 1985 Nevado del Ruiz lahar buried the town of Armero, killing ~23,000. Alluvial fans in mountain valleys are archives of past debris-flow events and define the primary hazard footprint for future flows. Hazard zonation maps combine topographic analysis, geological mapping, rainfall frequency statistics, and runout modelling to delineate risk zones. Modern early warning systems couple rain-gauge networks, soil-moisture sensors, and seismometers with automated alerts, demonstrating that mass-wasting fatalities are substantially reducible with adequate monitoring infrastructure.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/a/af/Grand_Canyon_from_south_rim_may_2012.jpg/1200px-Grand_Canyon_from_south_rim_may_2012.jpg',
        alt: 'View from the South Rim of the Grand Canyon showing the Colorado River at the bottom, layered rock formations, and the canyon rim',
        aspectRatio: '16/9',
        ...
        annotations: [
          {
            ...
            description: 'The Colorado River at the canyon floor — more than 1,800 m below the rim — is the agent that carved the Grand Canyon over 5–6 million years, removing an estimated 10 km³ of rock through abrasion and dissolution.',
          },
          {
            id: 'tapeats-sandstone',
            x: 50,
            y: 75,
            label: 'Tapeats Sandstone',
            description: 'The Tapeats Sandstone (~525 Ma) forms the prominent cliff band just above the river corridor. It rests directly on the Great Unconformity — a gap of nearly 1.2 billion years of missing rock record.',
          },
          {
            id: 'redwall-limestone',
            x: 50,
            y: 55,
            label: 'Redwall Limestone',
            description: 'The Redwall Limestone (~340 Ma) forms the most prominent vertical cliff in the canyon, up to 150 m thick. Its red staining comes from iron oxides washed down from overlying Supai Group sediments.',
          },
          {
            id: 'supai-group',
            x: 50,
            y: 40,
            label: 'Supai Group',
            description: 'The Supai Group (~300–285 Ma) comprises alternating shales and sandstones deposited in floodplain and coastal environments. It forms the stepped, reddish cliff-and-slope sequence in the upper canyon walls.',
          },
          {
            id: 'canyon-rim',
            x: 50,
            y: 5,
            label: 'South Rim (Kaibab Limestone)',
            description: 'The South Rim is capped by the Kaibab Limestone (~270 Ma), the youngest formation exposed in the canyon. From here to the river, the exposed rock spans nearly 1.8 billion years — about 40% of Earth\'s age.',
          },
        ],
      },
    },
