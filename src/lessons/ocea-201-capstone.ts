    ...
    },
    {
      ...
      questions: [
        ...
        // ── Q4: Dissolved oxygen minimum zones (OMZs) ────────────────────────
        {
          ...
          correct: 1,
          explain:
            'OMZs occur at roughly 200–1,000 m depth in the eastern tropical Pacific, Arabian Sea, Bay of Bengal, and eastern tropical Atlantic. Two factors conspire: (1) high surface productivity rains abundant organic matter downward, fuelling intense microbial respiration that consumes O₂ in the water column, and (2) sluggish circulation at those depths means ventilated water from the surface or poles is not replaced quickly enough to compensate. The result is O₂ concentrations below ~20 μmol kg⁻¹ (severe) or even truly anoxic conditions. Option A incorrectly attributes OMZs to ice cover; most OMZs occur in tropical regions far from sea ice. Option C confuses OMZs with specialised chemosynthetic ecosystems near vents; sulfide bacteria are not the primary cause of widespread open-ocean OMZs. Option D incorrectly inverts the source of OMZ water; polar waters are well-oxygenated (cold water holds more O₂) and actually ventilate the deep ocean rather than creating oxygen deficits.',
        },
        // ── Q5: Redfield ratio ────────────────────────────────────────────────
        {
        ...
        // ── Q9: Deep-sea carbon storage / CCD ────────────────────────────────
        {
          ...
          a: [
            'The CCD is controlled entirely by temperature; because the deep Pacific is warmer than the deep Atlantic, the CCD in the Pacific is shallower (~4,500 m) than in the Atlantic (~3,000 m); calcium carbonate is less stable at higher temperatures',
            'The CCD is set by the pressure at which CaCO₃ solubility equals its supply flux; because pressure increases with depth, CO₃²⁻ solubility rises sharply, driving thermodynamic undersaturation. In the Atlantic the CCD lies at roughly 4,500–5,000 m, while in the Pacific it is shallower at ~3,500–4,000 m; the Pacific CCD is higher because ageing deep waters accumulate more respired CO₂ (lowering pH and CO₃²⁻) and carry less total alkalinity relative to dissolved inorganic carbon than younger North Atlantic Deep Water',
            'The CCD is fixed at 4,000 m depth in all ocean basins because it is determined solely by the hydrostatic pressure equivalent to 400 atm, at which point the crystalline structure of calcite becomes thermodynamically unstable; the depth is geophysically constant regardless of water chemistry',
        ...
        // ── Q10: Methane hydrates stability ──────────────────────────────────
        {
          ...
          a: [
            'Methane hydrates are stable only at extremely high pressures below 10,000 m depth; they are too deep to be affected by near-surface ocean warming, and their potential climate impact is therefore negligible on any timescale shorter than millions of years',
            'Methane hydrates require high pressure and low temperature to remain stable; they occur in seafloor sediments at water depths typically greater than ~300–500 m (where pressure is sufficient) and in Arctic permafrost (where temperatures are persistently below freezing); ocean warming or permafrost thaw can shift the pressure–temperature stability boundary, causing dissociation and releasing methane — a potent greenhouse gas (~80× CO₂ over 20 years) — creating a positive feedback on warming',
        ...
        // ── Q11: ENSO Walker circulation mechanism ────────────────────────────
        {
          ...
          correct: 1,
          explain:
            'The Walker circulation, first described by Gilbert Walker in the early 20th century and mechanistically explained by Jacob Bjerknes in 1969, is a zonal overturning cell in the tropical atmosphere. Surface easterly trade winds drive westward surface currents that pile up warm water in the western Pacific warm pool (~30 °C) while allowing upwelling of cold (22–24 °C) water along the eastern equatorial Pacific. This SST contrast drives atmospheric convection: warm, moist air rises over the western Pacific, diverges at altitude, flows eastward aloft, and descends over the cooler eastern Pacific, reinforcing the surface trade winds. The Bjerknes feedback is the key positive feedback: any strengthening of the trades amplifies upwelling and cools the east further, steepening the SST gradient and strengthening the trades further. This coupled ocean–atmosphere feedback makes the tropical Pacific inherently oscillatory (prone to ENSO). Option A is incorrect; the Walker circulation is zonal (east–west), not meridional. Option C incorrectly dismisses the atmospheric role; the Walker cell is fundamentally an atmospheric-oceanic coupled phenomenon. Option D is incorrect in labelling it thermohaline; the Walker circulation\'s atmospheric branch is a direct response to surface heating differentials, not thermohaline dynamics.',
        },
        // ── Q12: El Niño global teleconnections ───────────────────────────────
        {
          ...
          a: [
            'El Niño causes uniform global warming of ~1.5 °C, reduced hurricane activity in all ocean basins simultaneously, and increased rainfall at all latitudes due to enhanced evaporation from the warm equatorial Pacific',
        ...
        // ── Q14: Ocean heat content measurement (Argo) ───────────────────────
        {
          ...
          a: [
            ...
            'Argo floats sample only the deep ocean below 2,000 m because shallower depths are well characterised by satellite altimetry; OHC trends in the upper ocean are derived entirely from satellite sea surface height measurements, and Argo is used only for abyssal validation',
          ],
          correct: 1,
          explain:
            'The international Argo programme, fully deployed from approximately 2005 onward, operates ~4,000 autonomous profiling floats distributed globally. Each float follows a 10-day cycle: drifting at a parking depth of ~1,000 m, descending to 2,000 m, then rising to the surface while a CTD (conductivity-temperature-depth sensor) profiles temperature and salinity; data is transmitted via satellite (Iridium or Argos) before the float re-submerges. This design provides near-global coverage with roughly one float per 3° × 3° grid cell. Before Argo, OHC estimates relied on irregular ship-based CTD casts, fixed moorings, and mechanical XBTs dropped from merchant ships; XBTs lacked salinity sensors and had documented fall-rate biases causing ~50 m depth errors, which introduced spurious decadal OHC trends. Argo\'s calibrated CTD sensors, consistent methodology, and near-global spatial coverage make it the gold standard for monitoring OHC changes. Option A incorrectly describes Argo as moored; the floats are free-drifting. Option C is incorrect; Argo measures full water column temperature profiles to 2,000 m depth, not just surface temperature. Option D inverts the roles; Argo primarily characterises the upper 2,000 m, which is where the bulk of anthropogenic heat uptake occurs, and satellite altimetry is a complement, not a replacement.',
        },
        // ── Q15: Earth's energy imbalance / OHC trends ───────────────────────
        {
          ...
          correct: 1,
          explain:
            'The ocean is the dominant heat reservoir of the climate system, absorbing over 90 % of the excess energy trapped by increased atmospheric greenhouse gases. This makes OHC the most direct and integrative measure of EEI. The global OHC has increased by roughly 9–10 × 10²² J per decade in the upper 2,000 m during the Argo era, with additional warming detected in the 2,000–6,000 m layer. Dividing this by Earth\'s surface area and the number of seconds per decade yields an EEI of approximately +0.5–1.0 W m⁻² — a small but globally significant imbalance. Independent satellite radiation budget measurements (CERES) confirm an EEI of similar magnitude. Option A is incorrect; the ocean\'s dominant role in heat uptake makes OHC the best integrated measure of EEI, though satellite data provide complementary information. Option C contradicts all observations; OHC has been rising, not falling, throughout the instrumental record, and more rapidly since ~1990. Option D is incorrect; geothermal heat flux (~0.09 W m⁻²) is real but roughly 5–10× smaller than the anthropogenic EEI and has been constant over human timescales, so it cannot explain the acceleration of OHC increase.',
        },
