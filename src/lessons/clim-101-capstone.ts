    ...
    },
    {
      ...
      questions: [
...

        {
          ...
          a: [
            "The total warming observed since pre-industrial times, currently measured at approximately 1.1 °C (2.0°F) above the 1850–1900 baseline",
            "The global mean surface temperature increase that results from a sustained doubling of atmospheric CO₂, once all slow feedbacks have equilibrated; best-estimate ~3 °C (~5.4°F)",
            "The rate of warming per decade, currently approximately 0.2 °C (0.4°F) per decade as measured by surface thermometer networks",
        ...
        },
        {
          ...
          a: [
            ...
            "Approximately 60%, primarily in the surface mixed layer down to 100 m (328 ft) depth",
        ...
        {
          q: "During the last glacial period (approximately 110,000 to 12,000 years ago), Greenland ice cores record more than 25 episodes in which temperatures rose abruptly by 5–15 °C (9–27°F) within decades and then gradually cooled over centuries. These are called:",
          a: [
        ...
        },
        {
          ...
          a: [
            "Approximately 18,000–15,000 years BP; caused by peak ice-sheet extent at the Last Glacial Maximum; Greenland cooled by ~3 °C (~5.4°F) over several thousand years",
            "Approximately 12,900–11,700 years BP; Greenland temperatures dropped by roughly 10 °C (18°F) within a few decades and then rebounded by a similar magnitude within roughly 50 years at the termination; likely triggered by a slowdown or collapse of AMOC following meltwater input to the North Atlantic",
        ...
        },
        {
          ...
          a: [
            "Sea level during the Eemian was approximately 1–2 m (3–7 ft) above present, attributable solely to thermal expansion of a slightly warmer ocean",
            "Sea level during the Eemian was approximately 6–9 m (20–30 ft) above present, requiring significant contributions from melting of both the Greenland Ice Sheet and parts of the West Antarctic Ice Sheet; global mean temperature was ~1–2 °C (1.8–3.6°F) warmer than pre-industrial",
            "Sea level during the Eemian was approximately 30–40 m (98–131 ft) above present; the full collapse of both the Greenland and Antarctic ice sheets contributed roughly equal amounts to this rise",
            "Sea level during the Eemian was approximately 2–4 m (7–13 ft) below present, because the Eemian was actually cooler than today and supported slightly larger polar ice sheets",
          ],
          correct: 1,
          explain:
            "The Eemian interglacial peaked around 125,000 years ago with global mean temperatures roughly 1–2 °C (1.8–3.6°F) above pre-industrial levels (similar to where we are heading in the near-term). Sea level indicators — submerged coral reefs, coastal notches, raised beach deposits — consistently indicate global mean sea level was approximately 6–9 m (20–30 ft) above present, sometimes cited as a minimum of +6 m (20 ft). This requires significant net loss from the Greenland Ice Sheet (contributing ~2–3 m (7–10 ft)) and from marine-based sectors of the West Antarctic Ice Sheet (contributing several additional metres). Option A drastically underestimates Eemian sea level by attributing it only to thermal expansion. Option C overstates the rise by an order of magnitude; full ice sheet collapse would yield ~65 m (213 ft) but there is no evidence for that. Option D has the sign wrong — the Eemian was warmer and had higher sea levels than today.",
        },
        {
          ...
          a: [
            "The PETM occurred approximately 34 million years ago, was triggered by the opening of the Drake Passage, caused ~2 °C (~3.6°F) of global warming, and lasted approximately 100,000 years",
            "The PETM occurred approximately 56 million years ago, was triggered by a massive input of isotopically light carbon to the atmosphere and ocean over roughly 20,000 years, caused global warming of 5–8 °C (9–14.4°F), and was associated with ocean acidification and deep-sea extinction of benthic foraminifera",
            "The PETM occurred approximately 66 million years ago, coinciding with the Chicxulub impact event; the ~10 °C (~18°F) warming resulted from soot and aerosols trapping outgoing longwave radiation",
            "The PETM occurred approximately 3 million years ago, was driven by Northern Hemisphere glaciation amplifying feedbacks, caused ~3 °C (~5.4°F) cooling rather than warming, and is characterised by the first appearance of tundra ecosystems",
          ],
          correct: 1,
          explain:
            "The PETM (~56 Ma) represents one of the best geological analogues for modern anthropogenic carbon release, though on a far slower timescale. A negative carbon isotope excursion (CIE) of ~3–4‰ in both marine and terrestrial records indicates a massive influx of isotopically light carbon (likely from volcanic degassing, methane hydrate destabilisation, or a combination). Global temperatures rose by 5–8 °C (9–14.4°F) over approximately 20,000 years; deep-ocean temperatures rose ~4–5 °C (7.2–9°F), and bottom waters became corrosive enough to dissolve carbonate, causing a dramatic shoaling of the calcite compensation depth and mass extinction of benthic foraminifera. Option A misidentifies the timing (34 Ma was the Eocene-Oligocene boundary and Antarctic glaciation onset), trigger (Drake Passage), and magnitude. Option C conflates the PETM with the Cretaceous-Paleogene boundary. Option D describes Pliocene-Pleistocene climate, not the PETM.",
        },
...

        {
          ...
          a: [
            "Approximately 5–7 cm (2.8 in) since 1880; current rate approximately 1.0 mm/yr (0.04 in/yr) and decelerating as ice sheet contributions diminish",
            "Approximately 21–24 cm (9.4 in) since 1880; current rate approximately 3.6 mm/yr (0.14 in/yr) and accelerating, with ice sheet melt increasingly dominant",
            "Approximately 50 cm (19.7 in) since 1880; current rate approximately 10 mm/yr (0.39 in/yr) and accelerating due to accelerating Antarctic ice sheet collapse",
            "Approximately 10–12 cm (4.7 in) since 1880; current rate approximately 2.0 mm/yr (0.08 in/yr) and stable, driven almost entirely by thermal expansion with negligible ice contributions",
          ],
          correct: 1,
          explain:
            "The tide gauge and satellite record shows global mean sea level has risen approximately 21–24 cm (9.4 in) since 1880. The rate has accelerated through the 20th and 21st centuries: from ~1.4 mm/yr (0.06 in/yr) in the early 20th century to ~1.9 mm/yr (0.07 in/yr) over 1971–2006 to the current satellite-era rate of approximately 3.6 mm/yr (0.14 in/yr) (2006–2018 average per IPCC AR6). The acceleration reflects growing contributions from the Greenland and Antarctic ice sheets, which now contribute roughly as much as thermal expansion and mountain glacier melt combined. Option A dramatically underestimates total rise and current rate. Option C overestimates by more than a factor of two. Option D underestimates total rise and current rate and understates ice sheet contributions.",
        },
        {
          q: "Coral reef ecosystems are particularly sensitive to ocean warming. What do projections indicate about the fate of tropical coral reefs at 1.5 °C (2.7°F) and 2 °C (3.6°F) of global warming above pre-industrial levels?",
          a: [
            "At 1.5 °C (2.7°F), approximately 10–20% of tropical coral reefs will experience bleaching; at 2 °C (3.6°F), approximately 50% will bleach; these projections assume bleaching is always fatal to the reef",
            "At 1.5 °C (2.7°F), approximately 70–90% of tropical coral reefs will experience severe bleaching or mortality; at 2 °C (3.6°F), more than 99% will experience severe bleaching, effectively eliminating coral reefs as functioning ecosystems at the higher warming level",
            "At 1.5 °C (2.7°F), coral reefs can adapt through symbiont shuffling and genetic selection; bleaching events will remain rare and reefs will fully recover between events; significant reef loss is not projected until 3 °C (5.4°F)",
            "Coral reef projections are highly uncertain; the range spans 10–90% loss at 1.5 °C (2.7°F), making any specific estimate scientifically unsupportable",
          ],
          correct: 1,
          explain:
            "The stark difference between 1.5 °C (2.7°F) and 2 °C (3.6°F) is one of the clearest examples of why half a degree matters in climate impacts. At 1.5 °C (2.7°F) above pre-industrial, projections indicate 70–90% of tropical coral reefs will experience severe bleaching or mortality. At 2 °C (3.6°F), this rises to more than 99% — effectively the functional loss of tropical coral reef ecosystems globally. Bleaching occurs when ocean temperatures exceed the coral's thermal tolerance threshold, causing the expulsion of symbiotic algae (zooxanthellae) and eventual mortality if the event is prolonged. Option A severely underestimates the sensitivity. Option C is overly optimistic — while some genetic and symbiont adaptation is possible, the pace of warming outstrips the rate of evolutionary adaptation for most reef systems. Option D mischaracterises scientific confidence; multiple independent modelling lines converge on the 70–90%/>99% estimates.",
        },
        {
          q: "Which statement most accurately describes the projected impact of 1 °C (1.8°F) of warming on staple crop yields?",
          a: [
            "A 1 °C (1.8°F) warming uniformly increases global crop yields by approximately 5% through CO₂ fertilisation and extended growing seasons, benefiting high-latitude agricultural regions more than tropical ones",
            "A 1 °C (1.8°F) warming is projected to reduce global average wheat yields by approximately 6% and maize yields by approximately 7%, driven by heat stress on flowering and pollination, increased evapotranspiration, and more frequent extreme heat events",
            "Crop yield impacts of 1 °C (1.8°F) are negligible and within normal interannual variability; significant impacts only emerge above 3 °C (5.4°F) where crop production zones shift poleward",
            "A 1 °C (1.8°F) warming causes 20–30% yield losses for all major staple crops because of mandatory irrigation increases in tropical regions",
          ],
          correct: 1,
          explain:
            "Meta-analyses of field experiments, crop models, and observed yield trends converge on approximately 6% reduction in global wheat yields and 7% reduction in maize yields per degree Celsius of warming. These losses arise from multiple pathways: heat stress during flowering and grain fill (which has a sharp temperature threshold), increased vapour pressure deficit driving water stress, higher respiration rates at night, and greater frequency of compound heat-drought events. CO₂ fertilisation provides a partial offset for C3 crops (wheat, rice, soybean) but not for C4 crops (maize). Option A conflates the CO₂ fertilisation benefit (which is real but partial) with the net yield outcome, and warming does not uniformly increase yields. Option C ignores observed attribution studies showing yield impacts already detectable at current ~1.2 °C (~2.2°F) warming. Option D overstates the losses by 3–5×.",
        },
        {
          q: "The wet-bulb temperature threshold of 35 °C (95°F) is considered a critical physiological limit. What does this mean, and which regions are most at risk of exceeding it?",
          a: [
            "A wet-bulb temperature of 35 °C (95°F) means the dry-bulb (air) temperature is 35 °C (95°F); regions in the mid-latitudes with cool oceanic climates are most at risk because their populations are unacclimatised",
            "A wet-bulb temperature of 35 °C (95°F) represents the combination of heat and humidity at which a healthy, resting adult human in the shade cannot dissipate metabolic heat through sweating alone, even with unlimited water, making survival impossible beyond roughly 6 hours; the Persian Gulf, South Asia, and parts of coastal China are most at risk",
            "A wet-bulb temperature of 35 °C (95°F) is the threshold above which crops fail from heat stress, not a direct human physiological limit; agricultural regions in the Sahel are most at risk",
            "A wet-bulb temperature of 35 °C (95°F) represents conditions under which open-water evaporation ceases; lake and reservoir systems in arid subtropical regions are most at risk from water loss",
          ],
          correct: 1,
          explain:
            "Wet-bulb temperature accounts for both air temperature and humidity: at a wet-bulb temperature of 35 °C (95°F), the combination of heat and humidity is so extreme that even a healthy, unclothed, resting adult in shade with unlimited water cannot maintain core body temperature because the ambient wet-bulb temperature equals skin temperature, eliminating the thermal gradient required for evaporative cooling. Exposure for more than roughly 6 hours is fatal. Today, brief exceedances above 35 °C (95°F) TW have already been recorded in the Persian Gulf and South Asian coastal cities; at 2–4 °C (3.6–7.2°F) of global warming, such events become regular occurrences. Option A confuses wet-bulb with dry-bulb temperature; 35 °C (95°F) dry-bulb is warm but tolerable at low humidity. Option C is incorrect — the 35 °C (95°F) wet-bulb limit is a human physiological limit, not primarily a crop threshold. Option D describes a different physical process unrelated to human thermoregulation.",
        },
        {
