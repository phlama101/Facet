...
const lavaFlowModeling: Lesson = {
  ...
  duration: '16 min',
  xpReward: 200,
  description: `How rheology, topography, and effusion rate combine to determine where lava flows go and how fast — from Kilauea\'s 2018 lower East Rift Zone flows that advanced 13 km (8.1 mi) in 12 hours, to probabilistic flow mapping with MOLASSES and PyFLOWGO that now guides land-use planning in volcanic hazard zones.`,
  sources: [
...
**InSAR (Interferometric Synthetic Aperture Radar)** and **airborne thermal infrared** have become the workhorses of real-time lava flow monitoring. InSAR from Sentinel-1 and ALOS-2 can detect surface deformation and new flow emplacement within a 6–12 day repeat cycle; airborne thermal IR cameras mounted on USGS helicopters can map the active flow margin, measure surface temperatures, and estimate effusion rates from flow velocity and cross-section measurements. Together, these data streams feed lava flow models in near-real time, improving forecasts as eruptions evolve.`,
    ...
    },
    {
      ...
      body: `Lava rheology — how lava resists flowing — is the foundational variable in all lava flow modelling. Two idealised end-members bracket the observed range. A **Newtonian fluid** has viscosity independent of applied shear rate: it flows proportionally to stress. Pure melts at high temperature (>1,200°C (2192°F), low crystal content) approximate Newtonian behaviour. A **Bingham plastic** has a yield strength that must be exceeded before flow begins, after which it behaves as a viscous fluid. Lavas with >~30 vol% crystals exhibit Bingham behaviour: the crystal skeleton resists deformation until stress is sufficient to shear the crystal network. Real lavas transition between these regimes as they cool and crystallise.

The **temperature-viscosity relationship** in silicate melts is described by the Vogel-Fulcher-Tammann (VFT) equation: log₁₀(η) = A + B/(T − C), where A, B, C are constants dependent on melt composition (primarily SiO₂ content). This relationship is highly non-linear: viscosity increases by orders of magnitude over relatively small temperature decreases. **Basaltic melt** at 1,200°C (2192°F) has η ~100–1,000 Pa·s (similar to honey), while at 1,100°C (2012°F) it rises to ~10³–10⁴ Pa·s as crystallisation accelerates. **Rhyolitic melt** at 900°C (1652°F) has η ~10¹²–10¹⁴ Pa·s — a range of 10 orders of magnitude relative to basalt. This difference is dominated by the polymerisation of the silicate network: high SiO₂ melts form extensive chain and ring structures of SiO₄ tetrahedra linked by bridging oxygens, creating a highly viscous, elastic-like structure that does not flow easily.
      ...
      cards: [
        {
          ...
          icon: Thermometer,
          color: BRAND.coral,
          desc: 'Melt viscosity is controlled by SiO₂ content (polymerisation) and temperature. Basalt at 1,200°C (2192°F): η ~100–1,000 Pa·s → flows at 1–10 km/h (6 mph) on shallow slopes. Andesite at 1,050°C (1922°F): η ~10⁵–10⁶ Pa·s → slow, blocky flows, metres per hour. Rhyolite at 900°C (1652°F): η ~10¹²–10¹⁴ Pa·s → essentially no flow; forms lava domes and obsidian. Temperature drop of 100°C (212°F) can increase viscosity by 2–4 orders of magnitude. Crystal content amplifies: Einstein-Roscoe correction → above 40 vol% crystals, bulk viscosity increases by 10³× beyond melt alone.',
          examples: '2018 Kilauea LERZ fissure 8 basalt: 1,150–1,200°C (2192°F), η ~10²–10³ Pa·s, advance 13 km (8.1 mi) in 12 hrs · 1980 Mount St. Helens dacite dome lava: ~900°C (1652°F), η ~10¹⁰ Pa·s, growth <1 m/day · 1992 Etna basalt flow: 1,050–1,100°C (2012°F), η ~10³–10⁴ Pa·s, advance ~0.5–2 km/day on 15° slope',
        },
        {
          ...
          examples: '2018 Kilauea LERZ: tube system enabled lava advance to ocean entry point 13 km (8.1 mi) from fissure 8 in ~12 hrs · Mauna Loa 1950: tube-fed basalt reached the ocean 24 km (15 mi) from the vent in ~3 hours at peak · Etna 2001: tubes maintained 1,150°C (2102°F) lava 8 km (5.0 mi) from vent for 3 weeks, allowing multiple flow pulses',
        },
        {
...
**Remote sensing integration** is now transforming the operational practice of lava flow monitoring. **InSAR** from Sentinel-1 (6–12 day repeat) detects new flow emplacement as areas of coherence loss; **airborne thermal IR** from HVO helicopters provides direct surface temperature and flow margin mapping every 1–2 days during active eruptions; **MODIS and VIIRS** provide daily flow extent estimates from space. Effusion rate can be estimated from the satellite-derived flow area growth rate (via the erupted volume–flow area relationship) or from airborne measurements of flow velocity and cross-section. These real-time estimates feed model updates, allowing forecasters to issue revised flow path projections as eruption conditions evolve. During the 2022 Mauna Loa eruption, HVO published updated flow front position maps every 6 hours using this integrated approach.`,
    ...
    },
    {
      ...
      questions: [
        {
          q: `A basaltic lava flow at 1,200°C (2192°F) has viscosity ~500 Pa·s. After advancing 5 km (3.1 mi) in an open channel and cooling to 1,050°C (1922°F), its crystallinity increases from 5% to 40 vol%. Using the Einstein-Roscoe relationship, which best describes the approximate change in bulk viscosity and the flow\'s behaviour?`,
          a: [
          ...
          correct: 1,
          explain: 'The Einstein-Roscoe relationship gives relative viscosity ηᵣ = (1 − φ/φ_max)^(-2.5), where φ_max ≈ 0.6. At φ = 0.40: ηᵣ = (1 − 0.40/0.60)^(-2.5) = (0.333)^(-2.5) = (3.0)^(2.5) ≈ 15.6. But this is the multiplicative correction to the melt viscosity alone. The melt viscosity itself also increases enormously with cooling from 1,200°C (2192°F) to 1,050°C (1922°F) — from ~500 Pa·s to perhaps ~10⁴–10⁵ Pa·s for the melt fraction alone (VFT non-linearity). Combined: ~10⁵ Pa·s × 15.6 ≈ 10⁶ Pa·s. The bulk viscosity increase is 3–4 orders of magnitude, consistent with B. At these viscosities, an open-channel flow on typical Hawaiian slopes (5–15°) cannot maintain sufficient driving stress to exceed the Bingham yield strength and essentially stalls. Option A underestimates the non-linearity of the combined thermal + crystallisation effect. Option C reverses the sign: latent heat does partially offset cooling (FLOWGO explicitly includes this term), but it is never sufficient to reverse the net viscosity increase — the cooling effect dominates. Option D describes a linear relationship (Einstein-Roscoe is not linear; it diverges as φ approaches φ_max).',
        },
        {
          q: 'The 2018 Kilauea LERZ fissure 8 flow advanced 13 km (8.1 mi) in approximately 12 hours. FLOWGO open-channel model predictions suggested the flow should have stalled at ~5 km (3.1 mi) given the measured effusion rate of ~100 m³/s. What physical mechanism explains the discrepancy, and what monitoring signature would confirm this mechanism was operating?',
          a: [
            'The model underestimated the initial eruption temperature — if the lava was actually erupting at 1,300°C (2372°F) rather than the assumed 1,200°C (2192°F), the additional thermal budget would allow the flow to travel 13 km (8.1 mi); the monitoring signature would be anomalously bright thermal IR measurements at the vent',
            'The flow developed a lava tube system that insulated the interior lava from atmospheric cooling, reducing heat loss by a factor of 10–30 compared to the open-channel assumption in FLOWGO; monitoring signatures include: (1) thermal IR showing a narrow hot corridor rather than a broad cooling flow sheet, (2) active skylight openings where the tube roof has collapsed showing bright (~1,100°C (2012°F)) interior lava, and (3) consistent high-temperature lava arriving at the distal flow front despite being tens of km from the vent',
            'The slope of the terrain steepened significantly beyond 5 km (3.1 mi) from the vent due to the scarp topography of the lower East Rift Zone; FLOWGO\'s assumption of constant slope was wrong; the monitoring signature would be a sudden increase in flow advance rate and thinning of the flow at the scarp crest',
            'Rainfall interacted with the flow beyond 5 km (3.1 mi), generating steam explosions that fragmented the flow crust and prevented insulating skin formation, paradoxically keeping the flow hotter by continuously exposing fresh lava; the monitoring signature would be steam plumes and phreatomagmatic ash emission beyond 5 km (3.1 mi) from the vent',
          ],
          correct: 1,
          explain: 'The systematic discrepancy between open-channel FLOWGO predictions and observed flow travel distances in tube-fed systems is a well-documented and fundamental issue in lava flow modelling. FLOWGO assumes continuous heat loss from an exposed lava surface; once a tube forms, heat loss drops by 10–30× because the tube crust conductivity is ~1–3 kW/m² compared to ~30–50 kW/m² for an exposed radiating surface. As a result, tube-fed lava arrives at the distal flow front at temperatures only slightly below the eruption temperature — maintaining mobility that an open-channel flow would have lost kilometres earlier. The monitoring signatures described in B are all field-confirmed indicators of an active tube system: thermal IR anomalies showing a narrow hot corridor, skylight thermal emissions at ~1,100°C (2012°F), and high-temperature lava at distal entry points. Option A is incorrect: eruption temperatures for Kilauea 2018 fissure 8 basalt were well-constrained at ~1,140–1,170°C (2138°F) by thermal measurements; a 100°C (212°F) underestimate is implausible and would be evident in vent thermal data. Option C is partially plausible (slope does influence flow velocity) but was not the primary documented cause; the DEM for the LERZ area is well-constrained and the model used appropriate slope data. Option D mischaracterises the phreatomagmatic interaction effect: rainfall on active lava does cause steam explosions and can disrupt crust formation locally, but does not systematically sustain flow over 13 km (8.1 mi) — rather, it tends to fragment and disrupt flows and increase hazard, not extend travel distance.',
        },
        {
          q: 'MOLASSES probabilistic flow mapping runs 1,000 ensemble simulations to produce a probability-of-inundation map. A civil defence officer asks why the 90th percentile model run (showing flow reaching a coastal town) should be communicated alongside the median run (showing flow stalling 8 km (5.0 mi) short), rather than just presenting the most likely (median) outcome. What is the correct justification?',
          a: [
        ...
        },
        {
          ...
          a: [
            ...
            'Airborne thermal infrared cameras mounted on helicopters flown along the flow margins, providing direct surface temperature maps with 1–2 day temporal resolution and spatial resolution of ~0.5–2 m (7 ft) per pixel — enabling detection of active flow margins (bright thermal anomalies >500°C (932°F)) against cooled flow surfaces (<100°C (212°F)) and allowing effusion rate estimation from velocity and cross-section measurements',
            'MODIS Terra and Aqua multispectral satellite imagery, which provides multiple observations per day globally and detects active lava flows through the MIROVA (Middle InfraRed Observation of Volcanic Activity) system at up to 4 daily overpasses with 250–1000 m (3281 ft) pixel resolution',
          ],
          correct: 2,
          explain: 'For tracking active lava flow margins in near-real time with the highest spatial resolution and operational utility during a fast-moving eruption, airborne thermal IR is the gold standard. During the 2018 Kilauea LERZ and 2022 Mauna Loa eruptions, USGS HVO conducted daily (sometimes twice-daily) helicopter flights with thermal IR cameras, producing georeferenced temperature maps of the entire active flow field at ~0.5–2 m (7 ft) resolution. These maps could distinguish: active flow fronts and channels (bright, >500°C (932°F)), recently cooled but still hot lava (100–500°C (932°F)), and fully cooled flows (<100°C (212°F)). From these maps, flow advance rates could be measured by comparing positions from consecutive flights (daily resolution), and effusion rate could be estimated by measuring flow velocity (from time-lapse thermal imagery of floating crust) and channel cross-section. Option A (GPS) is correct that GPS detects deformation from lava loading, but this gives an indirect and spatially coarse measure of flow location — not direct margin mapping. Option B (seismic tremor triangulation) is used for eruption source location but not for distal lava flow front position tracking with useful accuracy. Option D (MODIS/MIROVA) is a genuinely important complement providing daily-to-multiple-daily global coverage, but at 250–1000 m (3281 ft) resolution it cannot resolve individual flow margins or measure advance rates accurately enough for emergency management during a fast-moving event like the 2018 Kilauea LERZ; it is most useful for total flow area estimation and erupted volume tracking.',
        },
        {
