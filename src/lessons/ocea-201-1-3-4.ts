      ...
      cards: [
        {
          ...
          examples: 'Frazil → grease ice → nilas (calm) or pancake ice (rough seas) · First-year ice: 1–2 m, ~4–6 psu · Multi-year ice: 3–5 m, ~0.1–0.5 psu · Brine rejection raises local salinity by several psu, triggering deep convection',
        },
        {
        ...
        },
        {
          ...
          examples: 'Sea ice albedo: 0.6–0.9 · Open ocean albedo: ~0.06 · Arctic warming ~4 °C since 1980 vs. ~0.9 °C global · Ice-albedo feedback: ~40–50% of observed Arctic amplification · Antarctic 2023 sea ice: ~1–1.5 × 10⁶ km² below previous record low',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          {
            ...
            description: 'In winter, intense radiative cooling and cold, dry polar winds remove heat from Arctic and Antarctic surface waters, lowering sea surface temperature toward the freezing point of seawater (~−1.8 °C at salinity ~34 psu). The polar night removes solar input for months; longwave radiative loss, sensible heat flux, and latent heat flux together create some of the largest ocean heat losses on Earth, particularly in coastal polynyas where the ice-free surface is exposed continuously to extremely cold air.',
            color: BRAND.accent,
          },
          {
            id: 'ice-formation',
          ...
          },
          {
            ...
            description: 'Sea ice crystals incorporate only pure water molecules; dissolved salts are expelled into the surrounding seawater. This brine rejection raises local salinity by several psu and produces extremely cold, saline water — significantly denser than surrounding seawater. In the Weddell Sea and Ross Sea coastal polynyas, continuous brine rejection sustains a persistent density anomaly at the surface that drives deep convection. In the North Atlantic Labrador Sea, winter cooling and brine rejection similarly initiate open-ocean convection to depths of 1,000–2,000 m, producing Labrador Sea Water.',
            color: BRAND.jade,
          },
          {
            id: 'dense-water-sinks',
            label: 'Dense water sinks',
            description: 'Brine-enriched water, denser than the water column below, sinks along the continental slope (in Antarctica) or overturns in place (in the open Labrador Sea). Antarctic shelf water at ~34.65 psu and ~−1.9 °C is among the densest surface-produced water anywhere in the ocean. It cascades down the continental slope, entraining ambient water as it descends, and reaches the seafloor at abyssal depths (~3,000–5,000 m). This is a rapid, energetic process — the sinking limb of the thermohaline circulation — that physically moves water properties set at the surface to the deep interior of the ocean.',
            color: BRAND.gold,
          },
          {
            id: 'aabw-formation',
            label: 'Antarctic/Arctic bottom water formation',
            description: 'Antarctic Bottom Water (AABW) is the end product of brine rejection and deep convection around Antarctica, characterised by temperatures near −0.5 °C, salinities ~34.65 psu, and very high dissolved oxygen (recently ventilated from the atmosphere). AABW fills the bottom of all ocean basins, spreading northward through the Atlantic, Pacific, and Indian Oceans. In the North Atlantic, North Atlantic Deep Water (NADW) — formed from Labrador Sea Water, Iceland-Scotland Overflow Water, and Denmark Strait Overflow Water — fills intermediate and deep layers, flowing southward and ultimately mixing with AABW in the deep Southern Ocean. Both water masses carry oxygen and trace gases that record their last contact with the atmosphere, providing tracers of ventilation age and circulation pathways.',
        ...
        edges: [
          { from: 'polar-cooling',       to: 'ice-formation',        label: 'surface temperature drops to freezing point (~−1.8 °C)' },
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Multi-year ice is sea ice that has survived at least one summer melt season, accumulating to 3–5 m thickness and losing most brine over successive melt cycles to become nearly fresh (<0.5 psu) and structurally robust; first-year ice is thinner (1–2 m), more saline (~4–6 psu), and more vulnerable to melt; the distinction matters because the dramatic replacement of multi-year ice by first-year ice represents a fundamental change in Arctic cryosphere character, reducing ice volume faster than area and creating a more fragile, mobile, and albedo-reduced ice pack',
