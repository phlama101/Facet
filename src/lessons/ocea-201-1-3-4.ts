...
**Albedo feedback and stratification changes.** Ice-albedo feedback operates as a powerful amplifier of any initial warming signal. Modern climate models attribute approximately 40–50% of observed Arctic amplification to the direct loss of sea ice and snow albedo; the remainder comes from atmospheric feedbacks including water vapour, lapse rate changes, and increased poleward energy transport. As sea ice retreats, the increased solar absorption warms the ocean mixed layer — storing heat that delays autumn freeze-up and accelerates spring melt, lengthening the ice-free season. Ocean stratification is also changing: freshwater input from ice melt and Greenland discharge strengthens the halocline (the salinity gradient that inhibits vertical mixing), potentially reducing the upward flux of nutrients into the sunlit surface layer and suppressing biological productivity even as the ice-free season lengthens.`,
      cards: [
        ...
        },
        {
          ...
          examples: `Ross Sea polynya: largest Antarctic coastal polynya · Weddell Sea polynya 1974–76: anomalous open-ocean convection, not repeated at scale · AABW: ~34.65 psu, ~−0.5°C (33°F), spreads across global ocean floor · Coastal polynya ice-algae: 10–50% of some Arctic regions\' total primary production`,
        },
        {
    ...
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          {
            ...
            description: 'In winter, intense radiative cooling and cold, dry polar winds remove heat from Arctic and Antarctic surface waters, lowering sea surface temperature toward the freezing point of seawater (~−1.8°C (35°F) at salinity ~34 psu). The polar night removes solar input for months; longwave radiative loss, sensible heat flux, and latent heat flux together create some of the largest ocean heat losses on Earth, particularly in coastal polynyas where the ice-free surface is exposed continuously to extremely cold air.',
            color: BRAND.accent,
          },
          {
            id: 'ice-formation',
        ...
        edges: [
          { from: 'polar-cooling',       to: 'ice-formation',        label: 'surface temperature drops to freezing point (~−1.8°C (35°F))' },
