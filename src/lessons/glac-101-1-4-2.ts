...
**Thwaites Glacier** in West Antarctica has attracted intense scientific attention. It is roughly the size of Florida (~190,000 km² (73,360 sq mi)), contains ice equivalent to approximately **0.6 m (2 ft) of global sea level rise**, and acts as a "keystone" buttressing adjacent ice. Its grounding line has retreated ~14 km (8.7 mi) since the 1990s. The **International Thwaites Glacier Collaboration (ITGC)** — a major US-UK research programme launched in 2018 — deployed autonomous submarines, sensors, and ice-penetrating radar to examine ocean-ice interactions at the grounding zone. Observations revealed warm Circumpolar Deep Water (CDW, ~1°C above freezing) is accessing the cavity beneath the Thwaites ice shelf, melting it from below at ~50 Gt/yr. Cracks and rifts propagating across the Thwaites Eastern Ice Shelf suggest it could fracture within a decade.

A second and more speculative mechanism is **Marine Ice Cliff Instability (MICI)**. If a floating ice shelf collapses (through fracturing, surface melt ponding, and hydrofracturing of crevasses), it exposes a tall exposed ice cliff at the grounding line. Ice cliffs taller than ~100 m (328 ft) are mechanically unstable — the vertical stress at the base of the cliff exceeds the strength of ice, causing successive cliff calving that cannot be halted by buttressing. MICI has been invoked to explain rapid sea level contributions during past warm periods (Last Interglacial sea level ~6–9 m (20–30 ft) above present when global temperatures were only ~1–2°C warmer) but remains scientifically debated: not all models find MICI necessary to match palaeoclimate sea level data, and observational constraints are limited.

IPCC AR6 (2021) assessed **likely** sea level rise of 0.3–1.0 m (12–39 in) by 2100 (medium emissions, SSP2-4.5) and 0.6–1.0 m (24–39 in) (high emissions, SSP5-8.5), with a **low-confidence** upper end extending beyond 1.5–2.0 m (59–79 in) if ice sheet instabilities are triggered. Post-AR6 studies extending projections to 2300 under high emissions show potential rises of several metres, with high structural uncertainty from poorly constrained Antarctic outlet glacier dynamics. The IPCC also assessed **isostatic rebound**: as ice melts off Greenland and Antarctica, the underlying crust rises (glacial isostatic adjustment, GIA), affecting relative sea level differently in different locations — land near former ice masses rises, reducing local sea level, while far-field sites experience different patterns of rise.`,
      keyTerms: [
        {
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          desc: 'beyond 2100, structural uncertainty from ice sheet dynamics grows rapidly; AR6 assessed that under high emissions, sea level could reach 2–5 m (7–16 ft) by 2300, with the low-confidence upper end exceeding 15 m (49 ft) if MICI and full WAIS collapse operate; committed sea level rise — the eventual equilibrium rise for a given atmospheric CO₂ — is much larger than 2100 projections because ice sheets respond over centuries to millennia; even at current CO₂, long-term commitment is likely several metres',
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'CDW accesses the cavity beneath the Thwaites ice shelf, melting ice from below at ~50 Gt/yr (~55.1 billion tons/yr). A cavity the size of Manhattan has been detected growing under the glacier. Basal melt weakens the ice shelf and reduces its buttressing capacity.',
            color: BRAND.gold,
          },
          {
          ...
          },
          {
            ...
            description: 'If MISI propagates across Thwaites basin and adjacent glaciers (Pine Island, Kohler, Smith), total ice discharge could increase dramatically. Full Thwaites basin collapse: ~0.6 m (2 ft) SLR. Full WAIS collapse: ~3.3 m (11 ft) SLR over centuries.',
            color: BRAND.ruby,
          },
          {
            id: 'sea-level-rise',
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Thwaites is distinctive because it contains ~0.6 m (2 ft) SLR equivalent, sits on a retrograde bed grounded below sea level, and buttresses adjacent WAIS glaciers; monitoring shows warm Circumpolar Deep Water melting its ice shelf at ~50 Gt/yr (~55.1 billion tons/yr), grounding line retreat of ~14 km (8.7 mi) since 1990, a growing sub-glacial cavity, and major cracks across its Eastern Ice Shelf that could precipitate fracture within years',
        ...
        {
          q: 'The Last Interglacial (approximately 125,000 years ago) had global temperatures only 1–2°C above pre-industrial and yet sea level was approximately 6–9 m (20–30 ft) higher than today. What does this imply about modern committed sea level rise?',
          a: [
