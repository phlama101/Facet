    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'Eastern tropical Pacific OMZ: expanded upward by ~20–40 m (66–131 ft) since 1960s · Tropical Atlantic OMZ: O₂ declined 10–15 µmol kg⁻¹ in 50 years · Arabian Sea OMZ: suboxic zone (< 5 µmol kg⁻¹) one of largest in global ocean · Global OMZ volume (< 20 µmol kg⁻¹): expanded ~3–8% since 1960 · Humboldt Current upwelling: shoaling oxycline increases hypoxic exposure for demersal fish',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          a: [
            ...
            'The two primary mechanisms are (1) reduced photosynthesis by phytoplankton under increased turbidity from terrestrial runoff, reducing oxygen production in the euphotic zone (~50%), and (2) increased respiration by zooplankton whose populations have expanded in warmer waters, consuming more oxygen in the upper 200 m (656 ft) (~50%)',
