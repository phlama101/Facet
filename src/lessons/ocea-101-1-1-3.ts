...
The deepest ocean — conventionally defined as water below 6,000 metres, called the **hadal zone** — represents only about 0.15% of the total ocean area, yet it has emerged as a scientifically fascinating environment with distinct biology, chemistry, and geophysics. The trenches and the hadal zone are among the least explored places on Earth.`,
      keyTerms: [
        ...
        {
          term: 'Hadal zone',
          def: 'Ocean depth below 6,000 m, corresponding to the deepest ocean trenches. Named after Hades (the underworld). Characterised by extreme hydrostatic pressure (the weight of the overlying water column, 600–1,100 atm), near-freezing temperatures (1–4°C), complete darkness, and low but not zero food availability. About 0.15% of total ocean area.',
        },
        {
...
The 2004 Indian Ocean tsunami, generated by a magnitude 9.1 megathrust earthquake off northern Sumatra, reached wave heights of 30 m onshore and killed approximately 230,000 people.
