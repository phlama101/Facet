...
The deepest ocean — conventionally defined as water below 6,000 metres, called the **hadal zone** — represents only about 0.15% of the total ocean area, yet it has emerged as a scientifically fascinating environment with distinct biology, chemistry, and geophysics. The trenches and the hadal zone are among the least explored places on Earth.`,
      keyTerms: [
        {
        ...
        {
          term: 'Hadal zone',
          def: 'Ocean depth below 6,000 m, corresponding to the deepest ocean trenches. Named after Hades (the underworld). Characterised by extreme hydrostatic pressure (600–1,100 atm), near-freezing temperatures (1–4°C), complete darkness, and low but not zero food availability. About 0.15% of total ocean area.',
        },
        {
