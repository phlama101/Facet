...
The **IPCC Sixth Assessment Report (AR6, 2021)** assessed that AMOC will **very likely weaken over the 21st century** under all high-emission scenarios. A complete collapse before 2100 is assessed as **unlikely but not ruled out** — the uncertainty is large because the models used in AR6 may underestimate AMOC sensitivity to freshwater forcing. More recent statistical analyses of early warning signals in AMOC indicators have suggested the circulation may be closer to a tipping point than AR6 models indicate, though this interpretation is actively debated. The consensus remains that prudent risk management — given the severe and potentially irreversible consequences of collapse — argues for aggressive emissions reduction to keep both warming and Greenland melt within bounds where AMOC can remain in its present strong state.`,
      keyTerms: [
        ...
        {
          term: 'NADW',
          def: 'North Atlantic Deep Water — the dense, cold, oxygen-rich water mass formed by deep convection in the Labrador Sea and Nordic Seas. NADW flows southward at depths of 1,000–3,000 m (3,281–9,843 ft), constituting the deep limb of AMOC. It is a major reservoir of anthropogenic CO₂ transported into the deep ocean.',
        },
        {
          term: 'RAPID array',
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'GISP2 Greenland ice core: 10–15°C (50–59°F) cooling in <100 years at Younger Dryas onset · Source of freshwater forcing: drainage of glacial Lake Agassiz and Laurentide ice sheet retreat · Duration: ~1,200 years of cold conditions before abrupt re-warming · Day After Tomorrow misconception: collapse in days/hours has no physical basis; decades-scale transitions are the realistic scenario',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          {
            ...
            description: 'The North Atlantic Current carries warm (~12–20°C (54–68°F)), relatively salty (~36 psu) surface water northward from the subtropical Atlantic. This surface limb of AMOC transports roughly 1.3 PW of heat toward the poles, releasing energy to the overlying atmosphere and moderating European climate.',
            color: BRAND.accentHot,
          },
          {
            id: 'cooling-densification',
            label: 'Cooling and densification',
            description: 'As surface water moves poleward it loses heat to the cold atmosphere, dropping from ~12°C (54°F) in the subpolar gyre to near-freezing in the Nordic Seas and Labrador Sea. Cooling increases seawater density. Evaporation concentrates salt, raising salinity and density further. When density exceeds that of the underlying water column, the surface layer becomes gravitationally unstable.',
            color: BRAND.accent,
          },
          {
            id: 'deep-convection',
            label: 'Deep convection in Labrador/Nordic Seas',
            description: 'In the Labrador Sea and Norwegian–Greenland Seas, destabilised surface water undergoes open-ocean deep convection — vertical overturning of the water column driven by buoyancy loss. Convection chimneys can penetrate to 1,000–2,500 m (3,281–8,202 ft) depth in intense winters, ventilating the deep ocean with oxygenated water and carrying dissolved CO₂ to depth.',
            color: BRAND.jade,
          },
          {
            id: 'nadw-southward',
            label: 'NADW formation and southward flow',
            description: `Convected water mixes and equilibrates to form North Atlantic Deep Water (NADW) — cold (~2–4°C (36–39°F)), salty (~34.9 psu), oxygen-rich. NADW flows southward at 1,000–3,000 m (3,281–9,843 ft) depth through the Atlantic as a deep western boundary current, transporting roughly 17 Sv (Sverdrups). RAPID\'s moorings at 26.5°N directly measure this southward transport.`,
        ...
        edges: [
          ...
          { from: 'deep-convection',       to: 'nadw-southward',         label: 'NADW formed at 1,000–3,000 m (3,281–9,843 ft) depth' },
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'AMOC weakening would significantly cool Northwestern Europe — potentially by 3–8°C (37–46°F) in the most affected regions — as the circulation currently delivers ~1.3 PW of heat northward; it would also shift monsoon systems, raise sea level along the US East Coast, and alter precipitation patterns across the Atlantic sector',
            ...
            'AMOC weakening would cool Europe slightly (1–2°C (34–36°F)) but this would be fully offset by greenhouse warming, making the net effect neutral; it is therefore not considered a priority climate risk',
          ],
          correct: 1,
          explain: `AMOC currently delivers approximately 1.3 petawatts (PW) of heat northward — an enormous flux that maintains Northwestern Europe 5–10°C (41–50°F) warmer than it would otherwise be at equivalent latitudes. Norway, the UK, and Ireland all experience far milder climates than equivalent latitudes in Canada or Russia. A major AMOC weakening would reduce this heat delivery, producing substantial cooling across Northwestern Europe — climate models project regional cooling of 3–8°C (37–46°F) in severely affected scenarios, partially offset by background greenhouse warming. But the impacts extend beyond European temperature. AMOC drives the position of the Atlantic Intertropical Convergence Zone (ITCZ); weakening shifts it southward, disrupting the West African and South Asian monsoon systems on which billions of people depend. Sea level along the US East Coast would rise by an additional 30–50 cm (11.8–19.7 in) as the centrifugal depression of sea level currently maintained by the Gulf Stream system diminishes. Arctic sea ice extent would increase. Option A incorrectly claims weakening traps more heat in the tropics — reduced northward transport means more heat stays in the tropics, but this does not warm Europe, which depends on receiving that transported heat. Option C dismisses ocean heat transport entirely, which is incorrect — oceanographic measurements confirm the heat delivery. Option D underestimates the potential cooling and misrepresents the IPCC\'s risk assessment.`,
        },
      ],
    },
  ],
