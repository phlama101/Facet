        ...
        nodes: [
          {
            ...
            description: 'Initial greenhouse forcing raises surface and SST. Global mean +1.2°C (+2.2°F) above pre-industrial already observed. Further warming projected under all emissions scenarios.',
            color: BRAND.accentHot,
          },
          {
            id: 'low-cloud-change',
          ...
          },
          {
            ...
            description: 'Reduced cloud reflection amplifies surface warming beyond the direct greenhouse effect. In high-ECS models this positive low-cloud feedback adds ~0.5–1.5°C (0.9–2.7°F) to equilibrium warming per CO₂ doubling compared to low-ECS models.',
            color: BRAND.coral,
          },
          {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Low clouds cover a large fraction of the global ocean with high albedo (~30–60%), so their shortwave CRE is very large; uncertainty in whether their coverage decreases (positive feedback) or increases (negative feedback) as SSTs warm is the primary cause of the 2.5–5.7°C (4.5–10.3°F) spread in CMIP6 ECS estimates',
