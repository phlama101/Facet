    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.gold,
          desc: 'Measure ET (as latent heat, LE) by computing w′q′ covariance at 10–20 Hz. Typical footprint 0.1–1 km² (0.39 sq mi). FLUXNET synthesises 900+ global sites. Energy balance closure (Rn − G = H + LE) is rarely perfect (10–30% gap), a known challenge.',
    ...
    },
    {
      ...
      interaction: {
        ...
        edges: [
          ...
          { from: 'leaf-transpiration', to: 'ec-tower',           label: 'Turbulent w′q′ covariance integrates canopy ET over the flux footprint (0.1–1 km² (0.39 sq mi))' },
