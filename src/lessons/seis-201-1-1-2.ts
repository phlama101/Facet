...
- **Cratons**: ancient (~2+ Ga) continental cores with cold, depleted lithospheric roots extending to 200–300 km (186 mi) depth. Vs is anomalously fast — the cold, water-poor, iron-depleted composition of Archean lithosphere produces Vs up to 4.8 km/s at 100–150 km (93 mi) depth. The Kaapvaal craton (southern Africa) and Superior Province (Canada) are archetypal examples.
- **Mid-ocean ridges**: shallow, slow Vs anomaly centred at 20–80 km (50 mi) depth directly beneath ridge axes — partial melt (even 1–2% melt reduces Vs dramatically) and elevated temperature. Vs of 4.0–4.2 km/s or lower beneath active spreading centres.
- **Oceanic plates**: Vs increases as plates cool and thicken with age. Young plates (0–10 Ma): Vs ~ 4.2 km/s at 60 km (37 mi); old plates (80+ Ma): Vs ~ 4.5+ km/s at 80 km (50 mi), reflecting a 50–80 km (50 mi) thick thermal lithosphere.

**The partial melt effect.** Even small fractions of partial melt (0.5–2%) dramatically lower shear velocity because melt has near-zero shear modulus. This high sensitivity makes Vs the best seismic proxy for partial melt. The slow Vs anomaly beneath Yellowstone (4.0–4.1 km/s at 40–60 km (37 mi) depth) is partly attributed to crustal partial melt associated with the hotspot. The low-velocity zone (LVZ) in the upper mantle at 80–200 km (124 mi) depth globally is attributed to a small melt fraction in the asthenosphere.`,
      cards: [
        {
        ...
        },
        {
          ...
          examples: 'Moschetti et al. 2010 JGR: Vs maps of US crust and uppermost mantle from TA ambient noise · Yang et al. 2008: Yellowstone low-velocity body at 40–80 km (50 mi) depth, ΔVs ~ −8% · Cascadia: slow Vs under Cascades volcanic arc at 30–50 km (31 mi) depth',
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          examples: 'Typical stack: 12–24 months; SNR > 10 at 10 s period for station pairs < 1,000 km (621 mi) · Cross-correlation length: retain times from −max_dist/c to +max_dist/c · Bensen et al. (2007): widely used processing guide for ambient noise cross-correlation',
        },
        {
          name: 'Yellowstone and Basin and Range from TA',
          icon: Activity,
          color: BRAND.accent,
          desc: 'The US Transportable Array revealed dramatic Vs contrasts across the western US. Basin and Range Province: Vs 3.4–3.6 km/s at 20–30 km (19 mi) depth (thin, hot crust; Moho at 25–30 km (19 mi)). Yellowstone hotspot: prominent slow body centred at 40–80 km (50 mi) depth (ΔVs ~ −8 to −10%), interpreted as a combination of partial melt, elevated temperature, and possible fluids from the underlying mantle plume. The Yellowstone slow anomaly tilts NW with depth, consistent with southwestward motion of the North American plate over a fixed heat source. Colorado Plateau: faster Vs (3.9 km/s at 30 km (19 mi)), thick (40–50 km (31 mi)) crust; resistant to Basin and Range extension.',
          examples: 'Yellowstone caldera: heat flow up to 2,000 mW/m² (100× global average) · Basin and Range crustal thickness: 25–35 km (22 mi) vs 40–50 km (31 mi) for Colorado Plateau · Smith et al. (2009): Yellowstone hotspot imaged to 200 km (124 mi) depth using body waves',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Broadband seismometers at permanent network stations record ground motion continuously at sample rates of 1–100 Hz. The USArray Transportable Array (400 stations, 70 km (43 mi) spacing) was the prototype large-scale deployment. Modern processing uses 12–24 months of continuous data per station pair to accumulate sufficient signal-to-noise ratio in the cross-correlation. Data are archived in SEED format at data centres (IRIS DMC, NCEDC) and freely available.',
            color: BRAND.coral,
          },
          {
            id: 'preprocessing',
          ...
          },
          {
            ...
            description: 'Inverting the period-dependent phase velocity maps yields a 3-D Vs model of the crust and upper mantle. Fast Vs regions (blue): cold cratonic lithosphere, subducted slabs. Slow Vs regions (red): hot asthenosphere, partial melt, rifts, active volcanic regions. At 100 km (62 mi) depth across North America, USArray ambient noise tomography shows a dramatic contrast: Vs > 4.5 km/s under the stable Archean craton of the Canadian Shield vs Vs < 4.1 km/s under the Basin and Range, Cascades, and Yellowstone hotspot.',
      ...
      questions: [
        {
          ...
          a: [
            ...
            'The difference reveals that the upper mantle beneath the Canadian Shield is colder and has a thicker, faster-Vs lithospheric root than beneath the Basin and Range; shear velocity is sensitive to temperature and partial melt — cold, depleted cratonic lithosphere has Vs up to 4.8 km/s at 100 km (62 mi) depth, while hot, thin extensional lithosphere has Vs of 4.0–4.2 km/s at the same depth; at 50 s period, Rayleigh waves are most sensitive to Vs at ~50 km (31 mi) depth, sampling well into the lithospheric mantle',
          ...
          correct: 1,
          explain: 'Rayleigh waves at 50 s period have their peak sensitivity to Vs at approximately 50 km (31 mi) depth — well into the lithospheric mantle beneath a thick craton, and into the asthenosphere beneath thin, extended lithosphere. Shear velocity (Vs) is sensitive primarily to temperature and the presence of partial melt. The Canadian Shield (Archean craton) has a cold, depleted lithospheric root extending to 200–300 km (186 mi) depth, with Vs of 4.6–4.85 km/s in the uppermost mantle. The Basin and Range Province is in active extensional rifting: thin lithosphere (~50 km (31 mi)), elevated heat flow (80–120 mW/m² vs 40–60 mW/m² for shield), and possible small fractions of partial melt in the asthenosphere give Vs of 4.0–4.2 km/s at 50 km (31 mi) depth. The 0.5 km/s difference in surface wave phase velocity directly reflects this ~500°C (932°F) temperature difference in the uppermost mantle. Crustal thickness (A) does affect Rayleigh waves at shorter periods (10–30 s) but is secondary to mantle Vs at 50 s. Crustal composition (C) has a modest effect on velocities but cannot explain the 0.5 km/s contrast — temperature and melt dominate. Topography (D) is irrelevant to intrinsic wave velocity measurements corrected for path length.',
        },
        {
        ...
        {
          q: 'The USArray Transportable Array had ~400 stations spaced 70 km (43 mi) apart and moved across the US from 2004–2012. Why does a rolling array configuration achieve better tomographic resolution than a fixed array of the same number of stations?',
          a: [
          ...
          correct: 1,
          explain: 'The Transportable Array design solved a resource-allocation problem. Installing and maintaining 400 permanent stations across the entire US simultaneously would provide only ~250–300 km (186 mi) station spacing on average — too coarse for high-resolution crust and upper mantle imaging. But if 400 stations are deployed in a dense 70 km (43 mi) grid over the western US for 2 years, then moved to the central US for 2 years, then to the eastern US, every subregion receives the same dense coverage for 2 years. The result is continental-scale coverage with 70 km (43 mi) resolution everywhere, using the same 400 instruments sequentially. Because ambient noise tomography accumulates measurements over the recording period, 2 years per station provides sufficient SNR in the cross-correlations. The trade-off is temporal: no single location is monitored continuously, so time-varying features (episodic volcanism, changing aquifer levels) are captured only during the 2-year window. Option A is incorrect — resolution is not identical; a fixed array of 400 stations across the CONUS would have much coarser spacing. Option C has the logic backwards — instrument quality is maintained by careful calibration regardless of movement; the movement is about coverage, not hardware longevity. Option D is not a valid physical mechanism — noise randomisation from different environments is not the reason for the rolling design.',
        },
        {
          q: 'Surface wave tomography reveals that the low-velocity zone (LVZ) in the upper mantle — a layer from ~80 to 220 km (137 mi) depth where Vs is anomalously slow — is more pronounced under oceans than under old continental cratons. What is the best physical explanation?',
          a: [
            ...
            'The LVZ beneath oceans reflects elevated temperature and the presence of a small amount of partial melt (0.5–2%) in the asthenosphere, which drastically lowers shear velocity; beneath Archean cratons, the lithospheric root extends to 200–300 km (186 mi) depth, so the asthenosphere — and the LVZ — are displaced below the depth range sampled at typical surface wave periods; the cold, dry, depleted craton root itself has high Vs and masks the global asthenosphere',
            'The LVZ is a phase-transition artefact: at depths of 80–220 km (137 mi), olivine undergoes a partial structural transformation that reduces Vs; this transformation is suppressed under cratons because the higher pressure from the thick crust accelerates the transition through the LVZ depth range',
            'The LVZ does not actually exist beneath oceans; it is a tomographic artefact caused by poor station coverage over the oceans, where few seismograph networks operate; the smooth inversion regularisation smears crustal anomalies downward, creating the false appearance of a slow zone at 80–220 km (137 mi) depth',
          ],
          correct: 1,
          explain: 'The low-velocity zone is the seismic expression of the asthenosphere — the rheologically weak, partially molten upper mantle layer that underlies the more rigid lithosphere. Its Vs reduction (typically 4–6% below the overlying lithosphere) is caused by elevated temperature (close to or above the mantle solidus for peridotite) and by the presence of a small melt fraction. Even 0.5–2% partial melt dramatically reduces shear modulus because melt has essentially zero shear rigidity. Under oceanic lithosphere (which is 50–100 km (62 mi) thick depending on age), the asthenosphere begins at 50–100 km (62 mi) depth and the LVZ is easily imaged by surface waves at 40–100 s period. Under Archean continental cratons, the situation is different: the cold, thick lithospheric root (200–300 km (186 mi) of depleted peridotite, ~500°C (932°F) cooler than the oceanic asthenosphere at the same depth) means the asthenosphere is displaced to much greater depths, below the sensitivity of typical surface-wave measurements. The cratonic lithosphere itself has high Vs, and the 50–300 s period surface waves sample mostly this high-velocity root, masking any deep asthenospheric LVZ. Option A confuses asthenospheric processes with subduction-related serpentinisation, which is localised to wedge regions. Option C is incorrect — there is no olivine phase transition at 80–220 km (137 mi) under normal upper mantle conditions (olivine transitions to wadsleyite at ~410 km (255 mi)). Option D misidentifies the LVZ as a resolution artefact; the LVZ has been confirmed by body-wave studies, refraction surveys, and receiver functions independently of surface-wave tomography.',
        },
      ],
    },
  ],
