...
Relative sea level (RSL) is the sea level experienced at any specific coastal location, combining eustasy, isostasy, and tectonics: RSL = eustasy + vertical land movement + tectonic effects. Communities do not experience global mean sea level — they experience RSL. In subsiding deltaic cities, RSL rise can vastly exceed global rates: Jakarta, Indonesia subsides at ~25 cm/yr (9.8 in/yr) from groundwater extraction, making its RSL rise more than 10 times the global average. New Orleans has subsided 2–3 m (7–10 ft) since the 1930s from sediment compaction and groundwater withdrawal. Conversely, in formerly glaciated regions still undergoing postglacial rebound, RSL may be falling: Stockholm, Sweden sees RSL falling at ~4 mm/yr, and the Gulf of Bothnia coastline is currently rising at up to +8 mm/yr — GIA uplift exceeding global eustatic rise.`,
      keyTerms: [
        ...
        },
        {
          ...
          def: 'The period ~20,000 years ago when global ice volume was at its maximum, with sea level ~120–130 m (394–427 ft) below present. North Sea, Bering Strait, and English Channel were dry land.',
        },
        {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Last Glacial Maximum ~20,000 BP (sea level −120 m (−394 ft)). Exposed continental shelves. Bering Land Bridge open. Coastlines 100s km seaward.',
            color: BRAND.accentHot,
          },
          {
            id: 'deglaciation',
            label: 'Deglaciation (15,000–8,000 BP)',
            description: 'Ice sheets melt rapidly. Meltwater pulses add up to 20 mm/yr (0.79 in/yr) of sea level rise episodically.',
            color: BRAND.coral,
          },
          {
          ...
          },
          {
            ...
            description: 'Former ice centres still rebounding: Fennoscandia +8 mm/yr (0.31 in/yr), Hudson Bay +10 mm/yr (0.39 in/yr). Will continue for ~10,000 years.',
            color: BRAND.gold,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        {
          q: 'At the Last Glacial Maximum (~20,000 years ago), global sea level was approximately 120–130 m (394–427 ft) lower than today. Where did all that water go?',
          a: [
        ...
        },
        {
          ...
          correct: 1,
          explain: `Relative sea level = eustatic sea level + vertical land movement (VLM) + tectonic effects. VLM includes: (1) glacial isostatic adjustment (GIA) uplift in formerly glaciated areas; (2) tectonic uplift or subsidence; (3) sediment compaction; (4) groundwater/oil extraction. In Scandinavia, GIA uplift exceeds +8 mm/yr (0.31 in/yr) near the Gulf of Bothnia, while global mean sea level rise is ~3.6 mm/yr (0.14 in/yr) — net RSL fall of ~4 mm/yr (0.16 in/yr). Stockholm\'s tide gauge record shows the sea level falling at ~4 mm/yr (0.16 in/yr) over the 20th century. The Baltic coastline of Sweden is extending seaward as new land emerges. This is the \'land of the rising coast\' phenomenon. Conversely, in Jakarta (groundwater extraction), New Orleans (sediment compaction), and the Mekong delta (reduced sediment supply), RSL rises at 5–40× the global rate.`,
        },
        {
          q: `During deglaciation, episodic \'meltwater pulses\' caused abrupt rapid sea level rise. The most dramatic, Meltwater Pulse 1A (MWP-1A), is estimated to have raised sea level by ~14–18 m (46–59 ft) in ~300 years (~50 mm/yr (1.97 in/yr)). What is the likely source of this freshwater pulse?`,
          a: [
            'Intensified rainfall over the subtropical oceans that temporarily increased ocean volume',
            'Partial collapse of the Laurentide or Antarctic Ice Sheet (or both), releasing ice equivalent to a 14–18 m (46–59 ft) rise in ~300 years — ~10× the current rate of sea level rise',
