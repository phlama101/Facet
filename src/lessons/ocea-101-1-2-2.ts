...
Understanding the vertical structure of the ocean has become urgently important in the context of climate change. The ocean absorbs over 90% of the excess heat trapped by greenhouse gases, and this heat is distributed through the water column in ways that determine how quickly surface temperatures rise, how much heat eventually reaches deep water, and how ocean circulation patterns might change as the planet warms.`,
      keyTerms: [
        {
          term: 'Thermocline',
          def: 'A layer in the ocean characterised by a rapid decrease in temperature with depth, separating the warm, sunlit surface mixed layer from the cold, dark deep ocean. In tropical and subtropical regions, the permanent thermocline lies at 200–1,000 m (656–3,281 ft) depth. In polar regions, the thermocline is weak or absent because the surface water is as cold as the deep water.',
        },
        {
          term: 'Pycnocline',
...
**Oxygen minimum zones.** Between approximately 200 and 1,000 m (3,281 ft) depth in many parts of the ocean, there is a pronounced **oxygen minimum zone (OMZ)** — a layer where dissolved oxygen falls to very low levels (less than 20 μmol/kg) or even to hypoxic/anoxic conditions. OMZs form because bacterial decomposition of sinking organic matter consumes oxygen faster than physical mixing can replenish it. The OMZ is too deep to be ventilated from the surface (the pycnocline blocks mixing) and too shallow to receive the well-oxygenated AABW from below. OMZs are expanding as ocean warming reduces oxygen solubility and stratification increases. They represent a major challenge for marine life, compressing the habitable water column and stressing organisms that cannot tolerate low oxygen.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Gulf Stream: 30 Sv transport (30 million m³/s) · London: avg Jan 5°C (41°F); Newfoundland at same latitude: avg Jan −8°C (18°F) · AMOC weakening: palaeoclimate evidence shows abrupt shutdowns during ice ages (Younger Dryas)',
        },
      ],
    },
    {
      ...
      questions: [
        {
          q: 'In the deep ocean below 1,000 m (3,281 ft) depth, temperature is nearly uniform at 2–4°C (36–39°F) regardless of latitude — tropical deep water and polar deep water are at the same temperature. What process explains this uniformity, and why does deep water have similar temperatures worldwide?',
          a: [
            'The geothermal heat from the seafloor warms deep water to a uniform temperature; the volcanic activity at mid-ocean ridges maintains a consistent heat source that prevents the deep ocean from cooling below 2°C (36°F) in any region',
