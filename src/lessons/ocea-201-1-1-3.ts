...
Oxygen enters the sea at the surface through gas exchange with the atmosphere and, critically, through photosynthesis by phytoplankton in the sunlit upper ocean. Both processes are temperature-dependent: **warm water holds less dissolved oxygen than cold water** — a direct consequence of the inverse relationship between gas solubility and temperature. At 0°C, seawater can hold about 14.6 mg/L of oxygen; at 25°C, only about 8.2 mg/L. This means tropical surface waters start with a structural oxygen deficit compared to polar waters, even before any biological consumption occurs.

Below the sunlit surface layer, oxygen is consumed but not replenished by photosynthesis. Bacteria and zooplankton decompose sinking organic matter — marine snow drifting down from the productive surface — consuming oxygen in the process. This biological oxygen demand creates a characteristic depth profile: oxygen declines sharply below the thermocline, reaching a pronounced minimum at depths of roughly **200 to 1,000 metres**. These are the **oxygen minimum zones (OMZs)** — layers of persistently low oxygen that are a permanent feature of the world ocean. The three major OMZs occupy the **Eastern Tropical Pacific** (off the coasts of California, Mexico, and Peru), the **Arabian Sea**, and the **Bay of Bengal**. Together they cover roughly 8% of the global ocean volume and are expanding.
...
Coastal **dead zones** arise from a different pathway than open-ocean OMZs. They are driven by **eutrophication**: the overloading of coastal waters with nutrients — primarily nitrogen and phosphorus from agricultural fertilisers, sewage, and animal waste — that stimulates explosive phytoplankton blooms. When the bloom dies and sinks, bacterial decomposition of the organic matter consumes oxygen faster than it can be resupplied, pushing bottom waters into hypoxia. The **Gulf of Mexico dead zone**, fed by nitrogen and phosphorus carried down the Mississippi River from corn and soybean farms across the Midwest, covers roughly **22,000 km²** at its peak each summer — an area larger than New Jersey. **Chesapeake Bay** and the **Baltic Sea** are two other iconic examples: the Baltic is particularly prone because its nearly landlocked geometry and strong seasonal stratification prevent deep waters from being ventilated, and its dead zone now covers over 70,000 km².
...
**Deoxygenation under warming** operates through three mechanisms: (1) **Solubility effect** — warmer water holds less O₂; a 1°C warming reduces saturation oxygen by ~1.6%; (2) **Stratification effect** — warmer surface layers are less dense, strengthening the density barrier that prevents surface-to-deep oxygen transport; (3) **Metabolic effect** — warming accelerates microbial respiration, increasing the biological oxygen demand at depth. All three amplify one another, making the ocean\'s oxygen loss a non-linear response to continued greenhouse warming.`,
      cards: [
        {
          name: 'Oxygen Minimum Zones',
          icon: Waves,
          color: BRAND.accent,
          desc: 'Persistent mid-water layers at 200–1,000 m where O₂ is depleted by decomposition of sinking organic matter; poor ventilation prevents resupply. Hypoxic core (<0.5 mg/L) repels fish and suffocates slow-moving benthos. OMZs are expanding ~3–8% per decade in volume.',
          examples: `Eastern Tropical Pacific OMZ: shoals to <50 m off Peru, compressing fisheries habitat · Arabian Sea OMZ: among world\'s thickest, sustained by high monsoon-driven productivity · Bay of Bengal: seasonal reinforcement by freshwater stratification from Ganges/Brahmaputra discharge`,
        },
        {
          ...
          examples: 'Gulf of Mexico dead zone: ~22,000 km² peak summer extent, fed by Mississippi River nitrogen from Midwestern agriculture · Chesapeake Bay: hypoxia recorded since 1950s, linked to nitrogen from Susquehanna watershed · Baltic Sea: >70,000 km² of hypoxic seafloor, worsened by landlocked basin geometry limiting ventilation',
        },
        {
          ...
          examples: 'Global Argo float data (2004–present): measurable O₂ decline in thermocline globally · Eastern Pacific OMZ: upward shoaling by 10–20 m over past 50 years · Baltic hypoxia: dead zone area tripled since 1960s, now covers most of deep basins year-round',
        },
        {
          ...
          examples: `Namibia Shelf: recurring H₂S eruptions turn sea surface white-green and cause mass fish kills visible from satellite · Black Sea: permanently anoxic below 150–200 m — world\'s largest anoxic water body · OAE 2 (~94 Ma): near-global seafloor anoxia; 25–50% of marine genera went extinct at the Cenomanian-Turonian boundary`,
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Excess nutrients trigger explosive phytoplankton growth. Warm surface water already holds less dissolved O₂ (~8 mg/L at 25°C vs ~14 mg/L at 0°C). Dense blooms shade and collapse rapidly. The combination of warm low-solubility water above and organic-rich bloom below sets up the oxygen debt.',
            color: BRAND.jade,
          },
          {
            id: 'sinking-matter',
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Why do oxygen minimum zones form at intermediate depths (200–1,000 m) rather than at the seafloor or at the surface?',
          a: [
