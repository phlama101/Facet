      ...
      cards: [
        {
          ...
          examples: '50 km² catchment: N ≈ 50^0.2 ≈ 2.2 days after peak · 500 km² catchment: N ≈ 500^0.2 ≈ 3.5 days · Comparison of methods shows ±15–30% variation in computed baseflow index depending on separation technique · UK BFIHOST database: BFI ranges from 0.16 (impermeable clay) to 0.97 (chalk aquifer)',
        },
        {
      ...
      cards: [
        {
          ...
          examples: 'Hubbard Brook 14.4 km²: UH peak ≈ 0.8 m³/s/mm; time-to-peak ≈ 3 hrs · Wye at Builth Wells (904 km²): UH tp ≈ 12 hrs; qp ≈ 0.45 m³/s/mm/km² · Urban catchment Chicago: UH tp ≈ 1.5 hrs — 3× faster than rural after urbanisation · HEC-HMS software: automated UH derivation from observed event data',
        },
        {
        ...
        },
        {
          ...
          icon: BarChart2,
          color: BRAND.coral,
          desc: 'S = (25400/CN) − 254 mm. CN = 100 → impervious; CN = 30 → open sandy forest. AMC III raises CN by ~10–15 units (wet antecedent), AMC I lowers by ~10–15 (dry). Soil hydrologic groups: A (sand, gravel, >7.6 mm/hr Ks); B (loam, 3.8–7.6 mm/hr); C (clay loam, 1.3–3.8 mm/hr); D (clay, <1.3 mm/hr). NRCS TR-55 urban hydrology: CN tables for various urban land uses by impervious %. HEC-HMS implements CN loss method.',
          examples: 'Residential (1/4-acre lots, B soils): CN = 75, AMC II → Q = 36 mm from 100 mm storm · Corn on B soils, good cover: CN = 72 → Q = 31 mm · Row crops, straight rows, D soils: CN = 90 → Q = 64 mm · 2019 Midwest floods: AMC III + CN 93 → 90% runoff ratio on agricultural land',
        },
        {
          name: '2019 Midwest Flooding: CN Theory in Practice',
          icon: Droplets,
          color: BRAND.gold,
          desc: 'March 2019: "bomb cyclone" deposited 25–75 mm rain on already-saturated, frozen soil across 770,000 km² of upper Midwest. Antecedent moisture: AMC III across Missouri, Iowa, Nebraska. Effective CN ≈ 92–95 on agricultural land (vs standard AMC II CN = 72–78). Snowmelt contribution added another 25–50 mm equivalent. Direct runoff ≈ 55–75 mm from single storm. Missouri River: peak at Omaha = 13,500 m³/s (record); Gavins Point Dam spillway at 95% capacity. Infrastructure losses exceeded $10.8 billion (USACE estimate).',
          examples: 'Computed vs observed: HEC-HMS CN model with AMC III reproduced 85% of peak discharge · Plattsmouth gauge: record crest 9.2 m vs previous record 8.8 m (1952 flood) · Hamburg, Iowa: levee failure inundated 60,000 ha of farmland · Nebraska: 65 of 93 counties declared federal disaster areas · Offutt Air Force Base: 5,000 acres flooded; $800 million damage',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        edges: [
          ...
          { from: 'unit-hydrograph',     to: 'convolution',        label: 'UH ordinates U₁, U₂, ..., Um define catchment impulse response (1 mm, unit duration)' },
