    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: '1964 Alaska M 9.2: Turnagain Heights lateral spread destroyed 75 homes; 130-hectare block displaced 600 m (1969 ft) seaward.',
        },
        {
          ...
          examples: '1970 Peru M 7.9: Huascarán avalanche 50 million m³ debris, 280 km/h (174 mph), buried Yungay. ~18,000 dead.',
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explain: 'The Mw 7.9 Ancash earthquake destabilised the glaciated north peak of Mount Huascarán (6,654 m (21832 ft)). About 50 million cubic metres of rock, ice, and glacial debris avalanched down the steep Llanganuco valley at speeds estimated at 280 km/h (174 mph). The flow buried the city of Yungay (population ~18,000) under several metres of debris within minutes. Total death toll from the earthquake and associated mass movements reached ~70,000, making it the deadliest earthquake disaster in South American history. The Huascarán avalanche alone is the deadliest landslide in recorded history.',
        },
        {
