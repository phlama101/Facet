...
The **2014 Oso landslide** in Washington State, USA, on 22 March 2014, is one of the most studied slope failures in North American history. A 5–7 m (16–23 ft) of winter rainfall had saturated the regolith overlying weak glaciolacustrine silt and clay, dramatically reducing effective stress. A large rotational-translational slide on the hillside above the North Fork of the Stillaguamish River liquefied on impact with the valley floor and transformed into a high-mobility debris flow that overwhelmed the Steelhead Haven community, killing **43 people** and running out **8 km (5.0 mi)** across the floodplain at speeds estimated at 40–60 km/h (25–37 mph). Post-event mapping revealed that the slope had experienced multiple prehistoric failures, creating a hummocky topographic record that should have been a warning signal.
      ...
      cards: [
        {
          ...
          examples: '2009 rock fall at Yosemite Valley (El Capitan) sent 1,000-tonne (1,102-ton) boulders 500 m (1,640 ft) across the meadow floor. Rock fall from Vajont reservoir canyon walls, Italy (1963), generated a wave overtopping the dam and killing ~2,000 people in the valley below — the catastrophe was driven by the reservoir raising pore pressures in the adjacent slope. Topple failures are common in columnar-jointed basalt sea cliffs in Iceland and northern Scotland.',
        },
        {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'The distance the moving mass travels from its source to its final deposit. Controlled by volume (larger = longer runout), water content (wetter = farther), and valley morphology (confined channels focus and accelerate flow). The 2014 Oso slide ran out 8 km (5.0 mi); the Frank Slide ran out 3 km (1.9 mi). Impact areas can extend far beyond the slope itself, threatening communities in valley floors downstream.',
            color: BRAND.amethyst,
          },
          {
