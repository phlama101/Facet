    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'Greenland has lost on average ~270 Gt/yr (~297.5 billion tons/yr) (2002–2022) with the rate accelerating from ~100 Gt/yr (~110.2 billion tons/yr) in 2002–2006 to >300 Gt/yr (>330.6 billion tons/yr) in some recent years. Antarctica loses ~150 Gt/yr (~165.3 billion tons/yr) overall, dominated by West Antarctica (particularly Pine Island and Thwaites glaciers). The Pamir and Karakoram showed anomalous near-zero or slightly positive mass balance 2000–2010 (the "Karakoram Anomaly"), attributed to anomalous winter precipitation increase — though now showing renewed loss.',
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          examples: 'Rhône Glacier (Uri Alps): retreated ~3 km (1.9 mi) since 1874; terminus photographs since 1870 show near-continuous recession. Aletsch Glacier (largest in Alps, ~80 km² (31 sq mi)): lost ~3 km (1.9 mi) of length since 1900 and continues at ~50 m/yr (164 ft/yr). In summer 2022, Swiss glaciers collectively lost ~6% of their remaining volume in a single season — unprecedented in the observational record. By 2050, most Swiss glaciers below ~3,000 m (9,843 ft) ELA are projected to have disappeared entirely.',
        },
        {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Methods cross-validated and combined: WGMS stake data, ICESat-2 altimetry, GRACE gravity. Global assessment: ~270 Gt/yr (~297.5 billion tons/yr) from Greenland, ~150 Gt/yr (~165.3 billion tons/yr) from Antarctica, ~300 Gt/yr (~330.6 billion tons/yr) from mountain glaciers. Together contributing ~1.8 mm/yr (0.07 in/yr) to sea level rise.',
            color: BRAND.ruby,
          },
        ],
        edges: [
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Each 1 Gt of ice lost raises global sea level by approximately 1/360 mm (since the ocean surface area is ~360 million km²); 270 + 150 = 420 Gt/yr (~462.8 billion tons/yr) ≈ 1.2 mm/yr (0.05 in/yr) from ice sheets, plus ~0.8 mm/yr (0.03 in/yr) from mountain glaciers and ~1.7 mm/yr (0.07 in/yr) from thermal expansion, summing to ~3.7 mm/yr (0.15 in/yr) total observed sea level rise',
