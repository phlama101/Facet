    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 0,
          explain: "Cassini\'s INMS made several plume flybys, most notably the E21 flyby in 2015 at 49 km altitude. The instrument detected H₂O as the dominant species, plus CO₂, CH₄, H₂, NH₃, and various organic compounds. The molecular hydrogen (H₂) is particularly significant: H₂ is produced on Earth by serpentinisation — the reaction of water with iron- and magnesium-rich silicate minerals (olivine, pyroxene) — and is a key electron donor for methanogenic microorganisms. The SiO₂ nanoparticles require hot alkaline water dissolving silica from rock and then cooling to precipitate it — this thermal signature points to ~90 °C hydrothermal venting. Option B is incorrect: the INMS findings are far richer than simple sublimation. Option C overstates the findings — large complex amino acids were not directly confirmed; the organics detected were simpler compounds, though Cassini did detect higher-mass organics in later analyses. Option D is incorrect: the inferred pH is ~11 (alkaline), not acidic.",
        },
        {
