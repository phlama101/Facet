      ...
      cards: [
        {
          ...
          icon: Waves,
          color: BRAND.accent,
          desc: `Europa\'s global subsurface ocean is ~100 km (62 mi) deep, containing more water than all Earth\'s oceans. Galileo magnetometer evidence (induced magnetic field) confirmed a conductive saltwater layer. The ice shell is 15–25 km (16 mi) thick. Ocean composition includes MgSO₄ and NaCl; seafloor likely rocky with potential hydrothermal activity. Radiolysis of surface ice creates oxidants that may be transported into the ocean via ice recycling, driving redox gradients that could support chemolithotrophs.`,
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 2,
          explain: "Cassini\'s INMS made several plume flybys, most notably the E21 flyby in 2015 at 49 km (30 mi) altitude. The instrument detected H₂O as the dominant species, plus CO₂, CH₄, H₂, NH₃, and various organic compounds. The molecular hydrogen (H₂) is particularly significant: H₂ is produced on Earth by serpentinisation — the reaction of water with iron- and magnesium-rich silicate minerals (olivine, pyroxene) — and is a key electron donor for methanogenic microorganisms. The SiO₂ nanoparticles require hot alkaline water dissolving silica from rock and then cooling to precipitate it — this thermal signature points to ~90 °C (194°F) hydrothermal venting. Option A is incorrect: the INMS findings are far richer than simple sublimation. Option B overstates the findings — large complex amino acids were not directly confirmed; the organics detected were simpler compounds, though Cassini did detect higher-mass organics in later analyses. Option D is incorrect: the inferred pH is ~11 (alkaline), not acidic.",
        },
        {
