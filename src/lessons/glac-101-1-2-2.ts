...
The most urgent concern is the Amundsen Sea sector of the WAIS. Thwaites and Pine Island glaciers are losing mass at accelerating rates, driven by the intrusion of relatively warm Circumpolar Deep Water (CDW) onto the continental shelf and beneath ice shelves. CDW, at 1–2°C above the in-situ freezing point, melts ice shelves from below at rates of 20–70 m/yr (66–230 ft/yr). The EAIS, while showing near-zero or slightly positive mass balance from increased snowfall, cannot offset the accelerating losses from West Antarctica. Antarctica as a whole is now losing approximately 150 Gt (~165.3 billion tons) of ice per year, contributing ~0.4 mm/yr (0.02 in/yr) to sea level rise — a rate that has roughly tripled since the 1990s.`,
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Lake Vostok, the largest Antarctic subglacial lake, has been isolated from the surface for approximately 15 million years. What maintains liquid water in a lake buried under ~4 km (2.5 mi) of ice at −55°C (−67°F) surface temperatures?',
          a: [
        ...
        },
        {
          ...
          correct: 1,
          explain: `The Larsen B collapse was a natural experiment that directly confirmed the buttressing hypothesis. Before collapse, the ice shelf exerted back-stress on eight tributary glaciers, restraining their flow. Within months of the February–March 2002 collapse (3,250 km² (1,255 sq mi) in ~35 days), Eric Rignot and Robert Thomas measured glacier velocities using InSAR. Glaciers that had flowed into Larsen B accelerated 2–8× — the Crane Glacier quadrupled from ~0.7 to ~3 km/yr (0.4 to 1.9 mi/yr) within one year. Glaciers that flowed into the remaining Larsen C shelf (which has not collapsed) showed no change. This direct before-and-after comparison provided the clearest evidence that ice shelves actively buttress inland ice, and by extension that ice shelf loss from ocean warming can directly accelerate ice sheet discharge and sea level contribution.`,
        },
        {
          q: `Antarctica\'s total ice volume of ~26.5 million km³ (6,357,350 cu mi) represents approximately how much potential sea level rise?`,
          a: [
            'About 5.8 m (19 ft) — roughly equal to Greenland\'s contribution',
            'About 58 m (190 ft) — enough to transform Earth\'s coastlines beyond recognition',
            'About 580 m (1,903 ft) — but most ice is below sea level so it does not count',
            'About 0.58 m (1.9 ft) — Antarctica is too cold to contribute significantly',
          ],
          correct: 1,
          explain: `Converting Antarctic ice volume to sea level equivalent (SLE): ice density (917 kg/m³) / seawater density (1,025 kg/m³) × volume above floatation / ocean area. The EAIS contains ~53.3 m (175 ft) SLE, the WAIS ~3.3 m (11 ft) SLE, and the Antarctic Peninsula ~0.2 m (0.7 ft) SLE, totalling ~58 m (190 ft). This dwarfs all other freshwater sources: Greenland (~7.4 m (24 ft)), mountain glaciers (~0.4 m (1.3 ft)), and permafrost. However, the timescale matters critically: full deglaciation of Antarctica would require sustained multi-millennial warming far beyond any scenario in the next few centuries. Under IPCC AR6 scenarios, Antarctic contribution by 2100 is projected at 0.03–0.28 m (1–11 in) (medium confidence), with low-likelihood but high-impact scenarios (involving Marine Ice Cliff Instability) potentially contributing up to 0.56 m (22 in) from Antarctica alone by 2100. The 58 m (190 ft) figure represents the long-term ultimate risk, not the near-term projection.`,
        },
      ],
    },
  ],
