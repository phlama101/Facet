...
Beneath the ice, a remarkable hidden world exists. Radar surveys and satellite altimetry have detected approximately 400 subglacial lakes, maintained by geothermal heat from Earth\'s interior and pressure-melting under the immense weight of overlying ice. The largest, Lake Vostok, measures roughly 250 × 50 km with an estimated volume of ~5,400 km³ — the largest freshwater lake on Earth by volume. These lakes are connected in active hydrological networks that modulate ice stream dynamics and have been isolated from the surface atmosphere for millions of years.

Ice shelves — floating extensions of grounded ice — fringe approximately 75% of Antarctica\'s coastline, covering ~1.5 million km². These shelves are not merely passive features; they provide critical buttressing back-stress that restrains the flow of inland ice. Where ice shelves thin or collapse, tributary glaciers accelerate dramatically, as demonstrated by the 2002 Larsen B collapse.

The most urgent concern is the Amundsen Sea sector of the WAIS. Thwaites and Pine Island glaciers are losing mass at accelerating rates, driven by the intrusion of relatively warm Circumpolar Deep Water (CDW) onto the continental shelf and beneath ice shelves. CDW, at 1–2°C above the in-situ freezing point, melts ice shelves from below at rates of 20–70 m/yr. The EAIS, while showing near-zero or slightly positive mass balance from increased snowfall, cannot offset the accelerating losses from West Antarctica. Antarctica as a whole is now losing approximately 150 Gt of ice per year, contributing ~0.4 mm/yr to sea level rise — a rate that has roughly tripled since the 1990s.`,
      keyTerms: [
        {
        ...
        },
        {
          ...
          def: 'Marine-based ice sheet grounded up to 2,500 m below sea level; holds ~3.3 m SLE and is considered the most vulnerable large ice mass on Earth due to retrograde bed slopes.',
        },
        {
          term: 'Ice shelf',
      ...
      cards: [
        {
          ...
          examples: 'EAIS average bed elevation: ~200 m above sea level; WAIS: ~1,000 m below sea level — a critical vulnerability. The Transantarctic Mountains (>4,500 m) form a 3,500 km spine dividing East from West Antarctica. EAIS shows small positive or near-zero mass balance from increased snowfall; WAIS is losing ~150 Gt/yr.',
        },
        {
          ...
          examples: 'Lake Vostok (15,690 km², ~5,400 km³) is isolated from the surface for ~15 million years — extreme life forms found. Subglacial drainage connects many lakes in "active" systems that fill and drain over months, producing surface elevation signals. Ice stream dynamics at Siple Coast ice streams are modulated by subglacial water routing between connected lake systems.',
        },
        {
          ...
          examples: 'Thwaites Glacier (Florida-sized) is retreating at 0.6–1 km/yr; its loss alone could raise sea level 0.5 m. Pine Island Glacier thinned 4 m/yr 1994–2012 from basal melt by CDW at +1.5°C above the freezing point. "Doomsday Glacier" nickname reflects scientific concern: full WAIS collapse could raise sea level 3.3 m over centuries.',
        },
        {
        ...
        nodes: [
          {
            ...
            description: 'High, cold, dry centre of East Antarctica. Summit at Dome A (4,093 m). Very slow flow (~1 m/yr).',
            color: BRAND.accent,
          },
          {
            id: 'transantarctic',
            label: 'Transantarctic Mountains',
            description: '3,500 km barrier separating EAIS and WAIS. Glaciers flow through passes.',
            color: BRAND.accentHot,
          },
          {
            id: 'wais-basin',
            label: 'WAIS Basin (Below Sea Level)',
            description: 'West Antarctic basins 1,000–2,500 m below sea level. Vulnerable to marine instability.',
            color: BRAND.jade,
          },
          {
            id: 'ice-stream',
            label: 'Ice Streams (Thwaites, PIG, Siple)',
            description: 'Fast-flowing corridors draining WAIS. 1–10 km/yr. Controlled by subglacial water and geology.',
            color: BRAND.coral,
          },
          {
            id: 'ice-shelf',
          ...
          },
          {
            ...
            description: 'Icebergs calve. CDW intrusion melts from below. Total Antarctic discharge: ~2,200 km³/yr.',
            color: BRAND.ruby,
          },
        ],
        edges: [
