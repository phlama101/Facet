...
Not all sinking particles reach the seafloor. **Export production** — the fraction of primary production that crosses the base of the euphotic zone (~100–200 m depth) — is typically only **5–20%** of total primary production, and often closer to the lower end in warm, stratified subtropical gyres. The Martin curve (Martin et al., 1987) describes how particle flux attenuates with depth: flux(z) = flux(z₀) × (z/z₀)^(−b), where b ≈ 0.86 for the global ocean average. This power-law relationship — sometimes called the Martin curve or the **remineralisation length scale** — encapsulates a crucial reality: most of the organic carbon exported from the surface is respired by bacteria and zooplankton within the **twilight zone** (200–1000 m depth), releasing the carbon back as CO₂ into the mid-ocean interior. Only a few percent of export production — perhaps 0.3–3% of primary production — ultimately reaches the seafloor sediments, where it can be buried on geological timescales.
...
The efficiency of the biological pump is not fixed. **Pump efficiency** is often expressed as the ratio of export production to primary production (the e-ratio). In cold, well-mixed, nutrient-rich waters such as polar gyres and upwelling zones, the e-ratio can reach 20–50%, because large diatoms and aggregates dominate the community and sink quickly before being fully respired. In warm, stratified subtropical gyres where picophytoplankton dominate, the e-ratio falls below 5%, because small cells are rapidly consumed in microbial loops and little carbon sinks. **Ocean stratification**, which has been strengthening under anthropogenic warming, shoals the mixed layer and cuts off the supply of deep nutrients to the surface, reducing both primary production and pump efficiency. Most climate models project a weakening biological pump under continued warming — with global export production declining by 1–12% by 2100 under high-emissions scenarios — reducing the ocean's capacity to sequester carbon at precisely the moment when atmospheric CO₂ is rising most rapidly. Understanding the controls on biological pump efficiency is therefore one of the central challenges in marine biogeochemistry and climate science.`,
      keyTerms: [
        ...
        {
          term: 'marine snow',
          def: 'Loosely aggregated particles of organic detritus, living cells, fecal pellets, and transparent exopolymer particles (TEP) larger than 0.5 mm that sink through the water column at 1–100 m per day. Named for their resemblance to falling snow when illuminated underwater. Marine snow is the dominant vehicle for carbon export in most ocean regions.',
        },
        {
          term: 'remineralisation',
          def: 'The bacterial and enzymatic decomposition of sinking organic particles back into dissolved inorganic forms (CO₂, nitrate, phosphate, ammonium). Occurs primarily in the twilight zone (200–1,000 m). The Martin curve describes how remineralisation attenuates particle flux exponentially with depth; only a small fraction escapes to the deep ocean or sediments.',
        },
        {
          term: 'Martin curve',
...
**The twilight zone and deep storage.** The twilight zone (200–1,000 m) is a critical horizon: it is too deep for photosynthesis but still receives a rain of organic particles. Most remineralisation (60–90% of export flux) occurs here, releasing CO₂ into mid-ocean waters where it may remain isolated from the atmosphere for decades to centuries. Carbon that survives remineralisation and crosses 1,000 m enters the deep ocean, where residence times exceed 1,000 years. Sediment burial — which represents perhaps 0.2–0.5% of primary production — sequesters carbon on geological (million-year) timescales, ultimately driving the long-term regulation of atmospheric CO₂ over Earth history.`,
      cards: [
        {
        ...
        },
        {
          ...
          icon: ArrowRight,
          color: BRAND.coral,
          desc: 'Martin curve: F(z) = F(z₀) × (z/z₀)^(−b), b ≈ 0.86. ~60–90% of export production remineralised in the twilight zone (200–1,000 m). Only ~0.3–3% of primary production reaches the seafloor. Diel vertical migration (DVM) actively transports carbon below the mixed layer, bypassing Martin-curve attenuation. Twilight zone carbon residence time: decades to centuries. Deep sediment burial: geological (>Ma) timescale. Mesopelagic fish (myctophids) contribute significantly to active transport; poorly quantified.',
          examples: 'VERTIGO station ALOHA (N. Pacific): 90% of export remineralised above 500 m · HOT station: 30-yr time series, export flux ~1.5 mol C m⁻² yr⁻¹ · Antarctic krill: diel migration ~200–400 m, estimated 23 Tg C yr⁻¹ active transport',
        },
        {
          ...
          examples: 'LOHAFEX iron fertilisation experiment (2009): 300 km² bloom, limited export below 200 m · Paleo evidence: glacial biological pump more efficient → atmospheric CO₂ ~180 ppm vs 280 ppm interglacial · CMIP6 models: export production −2 to −16% by 2100 under SSP5-8.5',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Phytoplankton absorb dissolved CO₂ and sunlight to fix ~50 Pg C yr⁻¹ via photosynthesis in the euphotic zone (0–200 m). Surface seawater CO₂ equilibrates with the atmosphere on timescales of ~1 year.',
            color: BRAND.accent,
          },
          {
            id: 'phytoplankton',
          ...
          },
          {
            ...
            description: 'Marine snow sinks at 1–100 m day⁻¹; dense fecal pellets at 50–200 m day⁻¹; carbonate-ballasted particles fastest. Export flux crosses the base of the euphotic zone (~100 m) at 5–20% of primary production. Diel vertical migration by zooplankton and fish actively transports additional carbon below the mixed layer.',
            color: BRAND.coral,
          },
          {
            id: 'twilight-zone',
            label: 'Twilight Zone Remineralisation',
            description: 'Between 200 and 1,000 m, bacteria colonise and decompose 60–90% of sinking particles. CO₂, nutrients, and dissolved organic carbon are released back into mid-ocean waters. Martin curve describes this attenuation: F(z) = F(z₀) × (z/z₀)^(−0.86). CO₂ released here is isolated from the atmosphere for decades to centuries.',
            color: BRAND.amethyst,
          },
          {
            id: 'deep-storage',
            label: 'Deep-Sea Storage & Sediment Burial',
            description: 'Particles surviving below 1,000 m enter the deep ocean reservoir (~37,000 Pg C dissolved inorganic carbon), where they reside for >1,000 years. ~0.2–0.5% of primary production reaches and is buried in seafloor sediments, sequestering carbon for geological timescales (>Ma). This sediment burial drives long-term atmospheric CO₂ regulation.',
            color: BRAND.ruby,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'A plot of primary production versus sea surface temperature, showing the exponential increase in phytoplankton biomass as the ocean warms above 10°C',
        ...
        {
          q: 'What percentage of surface primary production typically reaches the deep ocean (below ~1,000 m)?',
          a: [
            'Approximately 50–60% of primary production sinks below 1,000 m, with the remainder consumed by surface grazers',
            'Export production is ~5–20% of primary production, but most of that is remineralised in the twilight zone (200–1,000 m) by bacteria; only ~1–5% of primary production ultimately reaches depths below 1,000 m, and well under 1% is buried in sediments',
            ...
            'Approximately 30–40% of primary production crosses 1,000 m depth in productive upwelling zones, though this falls to near zero in subtropical gyres',
          ],
          correct: 1,
          explain: 'Option A vastly overestimates deep export — 50–60% reaching below 1,000 m would imply almost no remineralisation, which contradicts all observations from sediment traps and radionuclide tracers. Option C is wrong because dissolved and colloidal organic matter, while abundant, is largely consumed within the upper ocean by the microbial loop; density alone does not drive sinking, and most organic carbon is respired before it can sink. Option D overestimates even upwelling-zone export; 30–40% of primary production reaching 1,000 m has never been observed at any location. Option B reflects the current scientific consensus: globally, export production (crossing the euphotic zone base at ~100–200 m) is 5–20% of primary production; the Martin curve then attenuates this by ~90% between 100 m and 1,000 m, leaving only ~1–5% of primary production crossing the 1,000 m horizon. Sediment burial represents another order-of-magnitude reduction: roughly 0.2–0.5% of primary production. These small percentages are nevertheless climate-significant because the total primary production is ~50 Pg C yr⁻¹ — meaning even 0.5% represents ~250 Mt C yr⁻¹ buried permanently.',
        },
        {
