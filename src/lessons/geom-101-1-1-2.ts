...
Key pedogenic processes differentiate soil orders across the globe. Eluviation–illuviation redistributes fine particles and solutes within the profile. Leaching in humid climates removes soluble bases (Ca²⁺, Mg²⁺, K⁺), progressively acidifying and depleting soils. Gleization occurs in waterlogged soils: anaerobic microbial respiration reduces Fe³⁺ to Fe²⁺, producing characteristic blue-grey gley colours. Podzolization dominates under boreal and heathland vegetation: organic acids chelate and mobilise iron and aluminium, stripping the E horizon to a pale ash colour (Swed. podzol = ashy soil) and depositing a rust-red to black Bhs horizon below. Calcification operates in semi-arid soils where limited leaching allows CaCO₃ to accumulate, forming caliche or petrocalcic horizons. These processes produce the twelve USDA soil orders: ultisols (intensely leached red-yellow soils of the humid tropics), oxisols (even more weathered, dominated by Fe/Al oxides), spodosols (podzolized boreal soils), mollisols (dark, base-rich grassland soils), and aridisols (desert soils with carbonate or saline horizons) are among the most areally significant.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/e/e3/Landslide_in_Caraballeda%2C_Venezuela.jpg/1200px-Landslide_in_Caraballeda%2C_Venezuela.jpg',
        alt: 'Photograph of a landslide in Caraballeda, Venezuela showing the failure scarp, displaced mass, debris fan, undisturbed slope, and flow track',
        aspectRatio: '16/9',
        ...
        annotations: [
          {
            ...
            y: 25,
            label: 'Failure Scarp',
            description: 'The headscarp is the steep, freshly exposed backwall where the landslide mass detached from the parent slope. Its concave shape is characteristic of a rotational failure; the bare rock or soil face shows no vegetation cover, indicating very recent failure.',
          },
          {
            id: 'displaced-mass',
            x: 50,
            ...
            description: 'The body of the landslide — the material that moved downslope from the scarp. In this debris avalanche, the mass incorporated weathered tropical regolith, vegetation, and infrastructure as it descended.',
          },
          {
            id: 'debris-fan',
            x: 55,
            y: 75,
            label: 'Debris Fan',
            description: 'Where the confined flow exited the valley onto the piedmont, it spread radially, depositing a lobe of poorly sorted debris. Alluvial fans like this are archives of past events and define the primary hazard footprint.',
          },
          {
            id: 'undisturbed-slope',
            x: 20,
            y: 35,
            label: 'Undisturbed Slope',
            description: 'The intact vegetated hillslope adjacent to the failure zone. The contrast between the dark green forested slope and the pale failure scar illustrates how localised — and how sudden — slope failures can be.',
          },
          {
            id: 'flow-track',
            x: 50,
            y: 40,
            label: 'Flow Track',
            description: 'The elongated erosional corridor scoured by the descending debris flow. Levées of coarser material flank the track; finer, water-saturated material flowed faster in the central channel.',
          },
        ],
      },
    },
