    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'Speleothems are dated by counting their visible annual growth laminae under a microscope, similar to dendrochronology in trees; since growth rates in most caves are constant at exactly 1 mm (0.04 in) per year, a 1 m (3 ft) stalagmite can be reliably dated to 1,000 years with no calibration required',
        ...
        },
        {
          ...
          a: [
            'Alkenone UK\'37 is superior to Mg/Ca in all respects: it has a wider temperature calibration range (−5 to 40°C (-9 to 72°F) vs. 15–30°C (27–54°F) for Mg/Ca), is not affected by diagenesis, and directly records the annual mean SST of the overlying water column, making it the preferred method for all paleoclimate applications in marine sediment studies',
            'UK\'37 measures SST through the degree of unsaturation in C₃₇ alkenones produced primarily by haptophyte algae; advantages include resistance to carbonate dissolution (unlike foraminifera), long-term organic preservation, and independence from ice-volume effects (unlike δ¹⁸O); limitations include a calibration range of ~0–28°C (0–50.4°F) (signal saturates at high temperatures), seasonal and depth biases in production relative to annual mean SST, and inability to distinguish temperature from species composition changes in the alkenone-producing assemblage',
            'Mg/Ca and UK\'37 are statistically indistinguishable in precision and accuracy (±0.5°C (0.9°F) for both), and the choice between them depends only on the availability of foraminiferal calcite versus organic matter preservation in any given core; there are no systematic advantages or limitations unique to either proxy',
