...
**HCl and HF** are measured by FTIR and indicate magma degassing at very shallow depths (<1 km) since both chlorine and fluorine are highly soluble in silicate melts and only exsolve in the uppermost conduit. Rising HCl/SO₂ can indicate shallower magma or a shift in degassing style. HF is particularly hazardous — the 1783 Laki eruption in Iceland released massive amounts of HF, causing **fluorosis** in ~80% of Iceland's sheep and cattle and contributing to the famine that killed ~20% of Iceland's population.`,
      cards: [
        ...
        },
        {
          ...
          desc: 'TROPOMI (Sentinel-5P): 2,600 km swath, 3.5×5.5 km resolution, daily global coverage. Measures SO₂ in Dobson Units at sensitivity ~1–5 kt per pixel. Superseded OMI (13×24 km) for eruption monitoring. TOMS (1978–2005), OMI (2004–present), TROPOMI (2017–present): the progressive archive. Key capability: detects SO₂ at volcanoes not otherwise monitored, providing global baseline of ~500 persistently degassing volcanoes tracked simultaneously. Provides total SO₂ burden for mass-balance and climate impact estimation. Limitation: misses small eruptions in cloudy tropical settings; requires plume to be above boundary layer for satellite detection.',
          examples: 'Pinatubo 1991: TOMS tracked 20 Mt SO₂ cloud globally — first confirmation of stratospheric injection extent · Sarychev 2009 (Kuril Islands): OMI detected 1.2 Mt SO₂ at 15 km in remote Pacific with no ground monitoring · Hunga Tonga 2022: TROPOMI measured 0.4 Mt SO₂ within 2 hrs; unprecedented injection to 57 km altitude detected within 6 hrs by multiple satellites · Cumbre Vieja La Palma 2021: TROPOMI tracked SO₂ plume daily for 85 days of eruption — 1.5 Mt total SO₂ emitted',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'TROPOMI SO₂ data shows a volcano in a remote region has emitted 50 kt of SO₂ over 3 days at a column height estimated from cloud top temperature at ~8 km. No ground-based monitoring exists at this volcano. What can be inferred about the eruption, and what is the key limitation of using only TROPOMI data for hazard assessment?',
          a: [
            'The 50 kt SO₂ burden and 8 km column height indicate a VEI 3–4 eruption with significant Plinian activity; the key limitation is that TROPOMI cannot detect lava flows or ashfall, so the full hazard suite cannot be assessed from satellite data alone',
            'The 50 kt SO₂ over 3 days suggests an average SO₂ emission rate of ~16 kt/day (~190 t/day), which is consistent with sustained but moderate volcanic activity; the 8 km column height suggests eruption in the upper troposphere but below the stratosphere; the key limitation is that TROPOMI detects SO₂ column amounts but not cloud concentration profile — without knowing the vertical distribution of the SO₂ or the eruption column height with better precision, MER estimation is uncertain; additionally TROPOMI misses emissions in cloudy conditions (common in tropical volcanic regions), and cannot distinguish magmatic SO₂ from hydrothermal SO₂ without gas ratio data',
            'The 50 kt SO₂ burden indicates this is a minor eruption with no significant hazard — major eruptions like Pinatubo 1991 emitted 20,000 kt SO₂, so 50 kt represents only 0.25% of a major event; TROPOMI\'s limitation is its coarse 3.5 km resolution, which cannot image the vent structure needed for lava flow hazard mapping',
            'The eruption definitely has no impact on aviation safety since the 8 km cloud top is below the cruise altitude of commercial aircraft; TROPOMI\'s key limitation is that it cannot detect ash particle concentrations, so the volcanic ash cloud may extend above 8 km without being detected',
          ],
          correct: 1,
          explain: '50 kt SO₂ over 3 days is ~16 kt/day average, or roughly 185–190 t/day — a significant but not extreme SO₂ emission rate. For context: Etna\'s typical background is 2,000–10,000 t/day during active phases; Pinatubo 1991 emitted ~20,000 kt total. An 8 km column top (upper troposphere, typical of VEI 2–3 events) with this SO₂ rate suggests sustained moderate activity, potentially a VEI 2–3 eruption with persistent lava fountaining or small Plinian episodes. The limitations described in B are the most complete and operationally relevant: TROPOMI measures integrated SO₂ column amounts in Dobson Units, which reflect total SO₂ mass but not vertical distribution — a plume at 3 km altitude and one at 8 km with the same column amount have very different aviation impacts. Cloud top temperature provides a rough altitude estimate but has uncertainty of ±1–2 km in tropical settings. Persistent cloud cover in tropical regions can prevent TROPOMI detection entirely (the satellite measures reflected UV, which requires cloud-free conditions or plume above clouds). The lack of ground monitoring means gas ratios (CO₂/SO₂, H₂S/SO₂) are unknown, preventing inference about degassing depth or system state. Option C trivialises 50 kt by comparing to Pinatubo\'s total — but 50 kt/3 days is a high sustained emission rate that would warrant aviation warnings and health advisories downwind. Option D is incorrect: the 8 km column top is within commercial cruising altitudes (FL200–FL330 = 6–10 km), not below them, so aviation safety is absolutely a concern; TROPOMI can detect the SO₂ plume (though not ash concentration, correctly noted) but the response framing of "no aviation impact" is wrong.',
        },
        {
