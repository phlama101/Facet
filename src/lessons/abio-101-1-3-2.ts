    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: `Mars: lost magnetic field ~4.0 Ga, atmosphere stripped by solar wind, surface water lost. Venus: no plate tectonics, runaway CO₂ build-up, 465°C (869°F) surface. Earth: plate tectonics regulates CO₂ via carbonate-silicate cycle, magnetic field protects atmosphere. Moon stabilises Earth\'s obliquity at ~23.5° ± 2.4°.`,
        },
        {
    ...
    },
    {
      ...
      interaction: {
        ...
        edges: [
          ...
          { from: 'surface-temperature', to: 'liquid-water',       label: 'Phase equilibrium: 0–100°C (212°F) at 1 bar permits liquid surface water; CO₂ greenhouse extends outer edge' },
