...
Coral reefs are concentrated in the "coral triangle" of the Indo-Pacific (Indonesia, Philippines, Papua New Guinea), the Great Barrier Reef, the Caribbean, and the Red Sea. They require warm water (18–30°C (64–86°F)), sunlight (hence shallow water, typically <30 m (98 ft)), low nutrients (excess nutrients favour algae that smother corals), and a firm substrate. These constraints make reefs geographically limited — and acutely vulnerable to climate change, pollution, and overfishing, all of which push conditions outside the narrow envelope corals can tolerate.`,
      keyTerms: [
...
**Ocean acidification and calcification.** Reef corals don't just face temperature stress — they face chemical stress. As the ocean absorbs CO₂, it becomes more acidic (lower pH), reducing the availability of carbonate ions that corals use to build their skeletons. Studies show calcification rates in many reef-building corals have declined 15–30% since pre-industrial times, and the rate of reef erosion is beginning to exceed the rate of reef building in some locations. At CO₂ concentrations projected for mid-century under high-emission scenarios, conditions may cross a threshold where net reef erosion exceeds accretion globally — meaning the physical reef structure begins to dissolve faster than corals can build it. This is separate from, and compounding, the bleaching problem.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Great Barrier Reef: 2,300+ individual reefs, 344,400 km² (132,973 sq mi) · Belize Barrier Reef: second largest, UNESCO World Heritage · Indo-Pacific coral triangle: highest coral species diversity (~500 coral species vs. 70 in the Caribbean)',
        },
        {
          name: 'Threats: Bleaching, Acidification, Overfishing',
          icon: Globe,
          color: BRAND.jade,
          desc: 'Thermal bleaching: >1°C (34°F) above seasonal maximum for weeks triggers zooxanthellae expulsion. Ocean acidification: rising CO₂ reduces carbonate ion concentration, slowing calcification and weakening reef framework. Overfishing of herbivores (parrotfish, surgeonfish, urchins) allows algal overgrowth and phase shifts to algae-dominated reef. Sedimentation and nutrient run-off from land further stress corals by reducing light and promoting algae.',
          examples: '2016 bleaching: >50% of northern Great Barrier Reef corals killed in one season · Phase shift example: Jamaican reefs shifted from coral to algae dominance after overfishing + 1980 hurricane removed urchins · Outlook: IPCC projects 70–90% of reefs lost at 1.5°C (35°F) warming, >99% at 2°C (36°F)',
        },
      ],
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Parrotfish are often described as ecosystem engineers on coral reefs. What specific feeding behaviour justifies this description, and what would happen to a reef ecosystem if parrotfish were completely removed by overfishing?',
          a: [
            'Parrotfish build shelter structures from coral rubble, creating habitat for juvenile fish; without parrotfish, juvenile fish would have no shelter, and reef fish populations would collapse due to predation',
            'Parrotfish use their beak-like teeth to scrape and bite living coral and algae-encrusted dead coral, excreting the calcium carbonate as fine white sand; by grazing algae and creating bare carbonate substrate, they control algal overgrowth and open space for coral larvae to settle; their removal leads to algal proliferation, which smothers corals and blocks recruitment',
            'Parrotfish produce mucus cocoons at night that contain antibiotics protecting the reef from bacterial infections; without parrotfish, coral disease rates would increase dramatically and bleaching would be more severe',
            'Parrotfish graze on crown-of-thorns starfish eggs, preventing population outbreaks; their removal would lead to unchecked starfish population explosions that would consume all remaining live coral within a few years',
          ],
          correct: 1,
          explain: 'Parrotfish do not build rubble shelters (A) — they are not structure-building organisms; their engineering role is through grazing and bioerosion, not construction. Mucus cocoon antibiotics (C) is a real behaviour — parrotfish do secrete mucus cocoons at night, possibly to deter parasites — but these do not produce reef-protecting antibiotics and this is not why parrotfish are considered ecosystem engineers. Grazing crown-of-thorns eggs (D) is not a documented parrotfish behaviour; parrotfish are herbivores that feed on algae and coral, not on starfish eggs. The correct answer is B: parrotfish possess fused, beak-like teeth (the "parrot" resemblance) that allow them to scrape living coral tissue and bite off chunks of calcium carbonate; the ingested carbonate is ground to fine powder in their digestive system and excreted as white sand — a large parrotfish can produce 100–300 kg (220–662 lb) of sand per year, and parrotfish are a major source of the white sand on tropical beaches; more ecologically critical is their role as herbivores: they graze the algae that would otherwise overgrow dead coral and bare substrate, preventing algal dominance; they also bite the reef surface clean, creating bare carbonate substrate where coral larvae can settle; when parrotfish are removed, algal growth accelerates on dead coral surfaces and blocks the space needed for coral recruitment, shifting the reef toward algal dominance — the same phase shift documented in Jamaican reefs after overfishing in the 1980s.',
        },
      ],
    },
  ],
