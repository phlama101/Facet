...
The stability of methane hydrate is governed by what geoscientists call the **gas hydrate stability zone (GHSZ)**: the range of depths in sediment and the water column where pressure and temperature conditions allow the clathrate lattice to persist. In the ocean, this generally requires water depths greater than about 500 metres (1,640 ft), where the combination of cold bottom water (typically 2–4°C (36–39°F)) and hydrostatic pressure keeps the hydrate stable. In Arctic permafrost on land, hydrates can persist at shallower depths because the sediment is continuously frozen. The GHSZ has a defined base — below which the geothermal gradient warms sediments enough to destabilise the lattice — and a top defined by the temperature–pressure curve. If temperature rises or pressure falls, hydrates at the margins of the GHSZ will begin to **dissociate**, releasing free methane gas.
      ...
      cards: [
        {
          ...
          icon: Waves,
          color: BRAND.accent,
          desc: 'CH₄ trapped in water-ice cages (clathrate). Stable only where pressure is high and temperature is low: >500 m (1,640 ft) water depth in the ocean, or within Arctic permafrost. Dissociation is endothermic — requires heat input — but releases free methane gas that can reach the atmosphere. GHSZ bounded above by temperature–pressure crossover, below by geothermal gradient.',
          examples: 'GHSZ top in deep Pacific (~2,500 m (8,202 ft)): reaches seafloor · GHSZ top on Arctic shelf (100 m (328 ft) depth): hydrates near or above sediment surface, most vulnerable · 1 m³ solid hydrate contains ~164 m³ of methane gas at STP',
        },
        {
          ...
          examples: 'ESAS methane plumes: documented in Shakhova & Semiletov expeditions (2007–2014) · Arctic bottom water warming: ~0.5°C (33°F) per decade on shallow ESAS · Methane flux estimates: 8–17 Tg CH₄/yr (ESAS, Shakhova et al.) — debated vs. lower estimates',
        },
        {
          name: 'Historical Methane Release Events',
          icon: Globe,
          color: BRAND.jade,
          desc: 'PETM (~55.9 Ma): 5–8°C (41–46°F) global warming + carbon isotope excursion; hydrate dissociation proposed as amplifier (not sole cause). Storegga Slide (~8,150 BP): massive Norwegian slope collapse ~area of Iceland; hydrate destabilisation implicated in slope failure and methane release; generated tsunami reaching Scotland, Shetland, Norway. Both events show hydrates can be part of major Earth system reorganisations.',
          examples: 'PETM carbon release: ~2,000–3,000 Pg C total (too large for hydrates alone — volcanism + permafrost also involved) · Storegga tsunami run-up: 10–20 m (33–66 ft) at Shetland, 4–6 m (13–20 ft) at Scottish coast · Japan MH21 production test (2013, Nankai Trough): 119,500 m³ gas in 6 days before sand influx shut well',
        },
        {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Below the sulfate reduction zone (~10–30 m (33–98 ft) below seafloor), methanogenic archaea break down organic matter under strictly anaerobic conditions, producing CH₄ and CO₂. This biogenic methane is the dominant source gas for most shallow hydrate systems.',
            color: BRAND.coral,
          },
          {
            id: 'migration',
      ...
      questions: [
        {
          ...
          a: [
            ...
            'High pressure and low temperature — typically water depths greater than ~500 m (1,640 ft) combined with cold bottom water, or within Arctic permafrost where sustained freezing temperatures persist at shallower depths',
