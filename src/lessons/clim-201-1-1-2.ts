      ...
      cards: [
        {
          ...
          examples: 'Amazon basin GPP: ~8 Pg C/yr in ~6 million km² · Boreal forests: large biomass, low NPP per area due to cold temperatures · Croplands: high NPP but most harvested carbon rapidly respired; net near-zero sink · Temperate forest regrowth (eastern USA, Europe): ~0.5 Pg C/yr net uptake',
        },
        {
          name: 'Permafrost and Soil Carbon Vulnerability',
          icon: Thermometer,
          color: BRAND.accentHot,
          desc: 'Arctic permafrost stores ~1,700 Pg C — twice the atmospheric carbon pool. Warming causes active-layer deepening, thermokarst, and abrupt thaw, releasing CO₂ (aerobic) and CH₄ (anaerobic). Permafrost borehole temps rising 0.3–0.5 °C/decade since 1980s. Projected release: 40–160 Pg C by 2100 under high emissions.',
          examples: 'Siberian yedoma: ice-rich permafrost up to 30 m deep; rapid collapse on thaw · Thermokarst lakes, Alaska: CH₄ ebullition (bubbling) measured at >10 g CH₄/m²/yr in some hotspot lakes · Radiocarbon dating: thawed Siberian permafrost releasing carbon fixed >25,000 years ago',
        },
        {
          ...
          examples: '1997–98 Indonesian peat fires: ~2 Pg C released in a single year from drained peatlands · Brazilian Amazon: deforestation peaked 2004 (~27,000 km²/yr), reduced to ~5,000–12,000 km²/yr by 2012; uptick since 2019 · Congo Basin peatlands: ~30 Pg C; largely intact but under pressure from agricultural expansion',
        },
        {
