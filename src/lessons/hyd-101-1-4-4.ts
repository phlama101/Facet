...
**Floodplain encroachment** — the development of homes, businesses, and infrastructure in areas that naturally flood — is the primary reason flood losses have risen globally even as flood forecasting and emergency response have improved. The expected number of people living in the 100-year global floodplain will grow from ~1.2 billion in 2010 to ~1.6 billion by 2050 under moderate growth projections. Each new building in a floodplain is not just at risk itself; it often increases peak flood levels for neighbours by reducing permeable surface and channel storage.`,
      keyTerms: [
        ...
        {
          term: 'Flash Flood',
          def: 'Rapid-onset flood produced by intense, localised precipitation over short durations (<6 hours). Response times are too short for conventional flood warning systems. Zhengzhou 2021: 201.9 mm in one hour.',
        },
        {
    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'Hurricane Harvey (2017): ~60 cm rainfall over Houston in 4 days; storm surge blocked Gulf drainage; river flooding exceeded all records. NYC Hurricane Sandy (2012): 4-m storm surge + peak river flow flooded subway and tunnels.',
        },
        {
        ...
        },
        {
          ...
          icon: AlertTriangle,
          color: BRAND.coral,
          desc: 'Historical flood statistics assume a stationary climate; warming violates this. Clausius-Clapeyron: ~7% more moisture per 1°C warming → more intense extreme precipitation. 100-yr floods may recur every 30–50 years by 2100.',
      ...
      cards: [
        {
          ...
          examples: 'Netherlands Delta Works: surge barriers and dike network protect 26% of Dutch territory below sea level. US Army Corps: ~100,000 km of levees protect agricultural and urban land; many not inspected since construction.',
        },
        {
          ...
          examples: 'Flood meadow restoration on River Cherwell, UK: reconnected 3 km² of floodplain; reduced downstream flood peaks 30%. NYC green infrastructure (green roofs, bioswales): $1.5B investment reduces combined sewer overflow to harbour.',
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Zhengzhou, China recorded 201.9 mm of rainfall in a single hour on July 20, 2021. How does atmospheric warming contribute to such extreme hourly rainfall intensities?',
          a: [
            ...
            'Warming allows the atmosphere to hold more water vapour (approximately 7% more per 1°C following the Clausius-Clapeyron relation); when this additional moisture is rapidly lifted, it condenses and falls as proportionally more intense precipitation',
        ...
        },
        {
          ...
          a: [
            ...
            'Compound flooding is the simultaneous or sequential occurrence of multiple flood-generating mechanisms; Harvey produced extreme rainfall (60 cm in 4 days) that coincided with storm surge blocking coastal drainage, overwhelming the Houston area from multiple directions',
