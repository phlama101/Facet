      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Hollow drill collects ~10 cm (4 in) diameter core. Stored at −20°C (−4°F). Shipped to labs worldwide.',
            color: BRAND.coral,
          },
          {
            id: 'proxy-analysis',
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explain: 'The isotopic fractionation occurs through Rayleigh distillation. Water evaporates preferentially as ¹H₂¹⁶O (lighter) over ¹H₂¹⁸O (heavier). As the water vapour mass moves poleward and cools, it rains out progressively; heavier molecules condense preferentially, leaving the remaining vapour increasingly depleted in ¹⁸O. The colder the condensation temperature, the stronger this fractionation effect. At a polar site like Vostok (−55°C (−67°F) mean annual temperature), the precipitation is extremely depleted in ¹⁸O (δ¹⁸O ~ −55 to −60‰ SMOW) compared to tropical precipitation (δ¹⁸O ~ −5 to 0‰). During a glaciation, when polar temperatures drop a further 5–10°C, δ¹⁸O shifts by approximately −3 to −7‰. This temperature-δ¹⁸O relationship is calibrated using modern spatial gradients and borehole thermometry, allowing quantitative temperature reconstruction.',
        },
        {
