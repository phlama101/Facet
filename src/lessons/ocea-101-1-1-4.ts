...
The international effort to drill and recover these sediment cores — the **Deep Sea Drilling Project** (DSDP, 1968–1983), succeeded by the **Ocean Drilling Program** (ODP, 1985–2003) and the **Integrated Ocean Drilling Program / International Ocean Discovery Program** (IODP, 2003–present) — has produced one of the most productive archives in the history of science. Cores from around the world are stored in refrigerated repositories in the United States, Germany, and Japan, available to any researcher who applies for access.`,
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/0/0b/Wave_breaks_on_shore.jpg/1200px-Wave_breaks_on_shore.jpg',
        alt: 'Ocean wave breaking on a shore, showing wave crest, trough, and surf zone',
        aspectRatio: '16/9',
        ...
        annotations: [
          {
            ...
            y: 30,
            label: 'Wave Crest',
            description: 'The highest point of a wave. As a swell enters shallower water, wave crests steepen and increase in height. The distance between successive crests is the wavelength.',
          },
          {
            id: 'wave-trough',
            x: 55,
            y: 45,
            label: 'Wave Trough',
            description: 'The lowest point between two wave crests. The vertical distance from trough to crest is the wave height. Larger troughs indicate more energetic sea states and faster-moving swell systems.',
          },
          {
            id: 'breaking-point',
            x: 20,
            ...
            description: 'Where the wave becomes unstable and breaks as the seafloor shallows. Waves break when the water depth is approximately 1.3 times the wave height, causing the crest to topple forward.',
          },
          {
            id: 'surf-zone',
            x: 15,
            y: 65,
            label: 'Foam / Surf Zone',
            description: 'The turbulent area of broken waves between the breaker line and the shoreline. White foam results from air being trapped as the wave collapses. This zone is where most wave energy is dissipated.',
          },
          {
            id: 'open-ocean-swell',
            x: 75,
            ...
            description: 'Undisturbed, organised wave energy travelling from a distant storm. Deep-water swells can travel thousands of kilometres with minimal energy loss, transferring energy generated by wind far out at sea to distant coastlines.',
          },
        ],
      },
    },
    {
      ...
      body: "Unlike the rolling water waves you see at the beach, the energy in a deep-water ocean swell travels at speeds up to 800 km/h — as fast as a commercial jet aircraft — while the water itself barely moves forward.",
    },
    {
      type: 'concept',
...
**Economic importance of deep-sea sediments.** Deep-sea sediments are increasingly of economic interest. **Polymetallic nodules** — potato-sized lumps of manganese, iron, nickel, cobalt, and copper that grow layer by layer at rates of a few millimetres per million years — litter the abyssal plain of the Pacific Ocean in concentrations that, if harvested, could supply global demand for these metals for centuries. **Cobalt-rich ferromanganese crusts** on seamount flanks contain concentrations of cobalt, platinum, and rare earth elements far above crustal averages. **Methane hydrates** — ice-like structures trapping methane in the sediment at high pressure and low temperature along continental slopes — represent the largest reservoir of natural gas on Earth, though their extraction remains technically challenging. These resources are the subject of increasing geopolitical interest, and their potential extraction raises major environmental concerns.`,
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Polymetallic manganese nodules litter the abyssal plains of the Pacific in vast quantities, yet they grow at rates of only 1–10 mm per million years — among the slowest mineral growth rates known. Why do these nodules exist at all, given that the sediment around them accumulates at rates thousands of times faster?',
          a: [
