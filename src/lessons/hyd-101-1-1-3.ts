...
Urbanisation profoundly alters the infiltration-runoff relationship. Impermeable surfaces (roads, roofs, car parks) eliminate infiltration, creating near-100% runoff from impervious areas. Studies show that watersheds with > 10% impervious cover show measurable stream degradation; above 25–30% impervious cover, stream ecosystems are severely impaired. Urban stormwater travels to streams 3–10× faster than in natural catchments, creating flashier hydrographs and more frequent bank-erosion events. Green infrastructure (permeable pavements, bioswales, rain gardens, green roofs) aims to restore pre-development infiltration and slow stormwater delivery.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/9/9d/Aquifer_en.svg/1200px-Aquifer_en.svg',
        alt: 'Cross-section diagram of an aquifer system showing unconfined and confined aquifers, the water table, aquitard, and an artesian well',
        aspectRatio: '16/9',
        ...
        annotations: [
          {
            ...
            description: 'An unconfined (water-table) aquifer is directly open to the atmosphere. Its upper boundary — the water table — fluctuates seasonally with recharge from precipitation and drainage to streams.',
          },
          {
            id: 'confined-aquifer',
            x: 60,
            ...
            description: 'A confined aquifer is sandwiched between impermeable aquitard layers. It is under pressure greater than atmospheric, so water in a well drilled into it rises above the top of the aquifer.',
          },
          {
            id: 'aquitard',
            x: 55,
            y: 60,
            label: 'Aquitard',
            description: 'An aquitard is a layer of low-permeability material (clay, shale) that restricts groundwater flow between aquifers. It separates the unconfined and confined zones, slowing vertical recharge to millennia.',
          },
          {
            id: 'artesian-well',
            x: 75,
            y: 45,
            label: 'Artesian Well',
            description: 'Where a well penetrates a confined aquifer whose pressure head exceeds the ground surface elevation, water flows naturally to the surface without pumping — an artesian (flowing) well.',
          },
          {
            id: 'water-table',
            x: 25,
            y: 45,
            label: 'Water Table',
            description: 'The water table marks the upper boundary of the saturated zone in an unconfined aquifer. It typically slopes toward adjacent streams, which it feeds as baseflow during dry periods.',
          },
        ],
      },
    },
