...
**What tomography has revealed.** Global P-wave tomography has produced several landmark findings: (1) subducted oceanic slabs are visible as fast (blue) curtains extending from surface trenches into the mantle, in some cases all the way to the core-mantle boundary (CMB); (2) the LLSVPs at the base of the mantle are the largest velocity anomalies in the planet; (3) the mid-mantle (1,000–2,000 km (1243 mi) depth) is relatively homogeneous compared with the upper mantle and D" layer, suggesting either efficient mixing at those depths or lower sensitivity of rays to structure there; (4) the African LLSVP is tilted relative to the Pacific LLSVP, consistent with the history of subduction that has shaped each hemisphere differently.`,
      cards: [
        {
        ...
        },
        {
          ...
          examples: 'Farallon slab (Grand 1994): continuous fast anomaly to ~2,800 km (1740 mi) under eastern North America · Tonga slab: fast anomaly to >1,000 km (621 mi), stagnant above 660 km (410 mi) in places · Cocos slab: visible beneath Mexico to ~400 km (249 mi)',
        },
        {
          name: 'LLSVPs and Primordial Mantle',
          icon: Globe,
          color: BRAND.amethyst,
          desc: `The two Large Low Shear Velocity Provinces at the base of the mantle (D" layer, ~2,700–2,900 km (1802 mi)) are the most enigmatic features in global tomography. Each spans ~2,000 km (1243 mi) horizontally with dVs of −2 to −3% relative to PREM. Their edges are sharp — sometimes velocity changes by 3% over <100 km (62 mi) — inconsistent with purely thermal origin. Leading hypothesis: chemically distinct, iron-enriched primordial reservoirs surviving from Earth\'s magma ocean differentiation ~4.5 Ga. Hotspot tracks (Hawaii, Samoa, Iceland, Afar) appear to originate at LLSVP edges.`,
          examples: 'African LLSVP: centred at ~10°E, 10°S at CMB, ~2,000 km (1243 mi) wide · Pacific LLSVP: centred beneath central Pacific, comparable size · Correlation: all large igneous province eruption sites project to LLSVP margins at CMB (Torsvik et al. 2006)',
        },
        {
...
**From residuals to images: the inversion workflow.** (1) Collect observed arrival times. (2) Compute predicted times through PREM. (3) Calculate residuals (observed − predicted). (4) Correct for source-side effects (earthquake depth and location errors), receiver-side effects (local crustal thickness), and ellipticity of the Earth. (5) Assign residuals to ray segments passing through volume elements (voxels or blocks) in the mantle. (6) Solve the large linear system of equations (millions of equations, thousands of unknowns) by iterative least squares with regularisation. (7) Assess resolution via synthetic tests. The result is dVp or dVs at each block in the model, visualised as tomographic cross-sections and depth slices.`,
    ...
    },
    {
      ...
      questions: [
        {
          q: 'A seismograph station records P-waves that arrive 2.5 seconds earlier than predicted by PREM from an earthquake 5,000 km (3107 mi) away. What does this negative travel-time residual indicate, and what geological structure most commonly produces such anomalies?',
          a: [
            ...
            'A negative residual means P-waves traversed faster-than-average material along part of their path; the most common geological cause is a cold, dense subducted oceanic slab, which retains temperatures 500–800°C (1472°F) below ambient mantle and produces P-wave velocities 2–3% faster than PREM',
        ...
        {
          q: 'Grand (1994) imaged the Farallon slab as a fast (dVp > 0) anomaly extending from the western United States down to ~2,800 km (1740 mi) depth — the core-mantle boundary. What does this tell us about mantle convection, and why is it significant for our understanding of the 660 km (410 mi) discontinuity?',
          a: [
            'The Farallon slab image confirms that the 660 km (410 mi) discontinuity acts as a complete barrier to downward flow, deflecting all slabs horizontally into the transition zone; the deep fast anomaly is from a separate ancient subduction event unrelated to Farallon',
            'The Farallon slab image shows that subducted oceanic lithosphere can penetrate through the 660 km (410 mi) phase transition and descend into the lower mantle as a coherent fast anomaly, reaching the CMB over geological time; this implies whole-mantle convection rather than layered convection and shows that the 660 km (410 mi) discontinuity does not completely block slab penetration',
            'The Farallon slab image demonstrates that the lower mantle is compositionally identical to the upper mantle, because a slab of different composition would have been seismically invisible below 660 km (410 mi) depth; composition controls visibility, not temperature',
            'The fast anomaly at 2,800 km (1740 mi) depth simply reflects the higher intrinsic velocity of the lower mantle; all material reaching CMB pressures has elevated Vp regardless of temperature, making it impossible to distinguish the Farallon slab from normal lower-mantle material',
          ],
          correct: 1,
          explain: `One of the central debates in mantle dynamics for decades was whether convection operates as a single whole-mantle system or as two layered systems separated at 660 km (410 mi) depth. The 660 km (410 mi) discontinuity corresponds to the ringwoodite → bridgmanite + ferropericlase phase transition, which has a negative Clapeyron slope (the transition occurs at lower pressure, i.e. shallower depth, in cold material). This negative slope means that a cold downgoing slab experiences extra negative buoyancy at the 660, which should resist penetration — potentially supporting layered convection. Grand\'s (1994) S-wave tomography, and van der Hilst et al.\'s (1997) P-wave model, showed the Farallon slab as a coherent, continuous fast anomaly from ~100 km (62 mi) depth under the western US all the way to the CMB under the eastern US, a vertical span of ~2,700 km (1678 mi). This was compelling evidence for whole-mantle convection — at least some slabs do penetrate 660 km (410 mi) and descend to the CMB. The Farallon plate subducted primarily from ~170 Ma to ~30 Ma; the slab material has had tens of millions of years to sink through the lower mantle and accumulate at the CMB. Option A contradicts the observation — Grand explicitly imaged the slab below 660 km (410 mi) as continuous. Option C is incorrect — thermal anomalies in cold slabs do remain visible in the lower mantle because the thermal relaxation time at lower mantle pressures is long. Option D misunderstands the observation — the fast anomaly is localised to the region of the expected Farallon slab, not uniformly present throughout the lower mantle.`,
        },
      ],
    },
  ],
