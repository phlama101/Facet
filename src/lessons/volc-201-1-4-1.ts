...
const eruptionColumnPhysics: Lesson = {
  ...
  duration: '16 min',
  xpReward: 200,
  description: 'From the vent to the stratosphere: how buoyant volcanic plumes rise, collapse, and spread — and why the 1991 Pinatubo eruption injected 20 Mt of SO₂ to 35 km altitude while Eyjafjallajökull in 2010 grounded 100,000 flights. Master the physics of eruption columns, pyroclastic density currents, and modern ash-dispersion modelling.',
  sources: [
...
**Partial collapse** — where the outermost margins of the column detach and collapse while a central sustained column continues — generates PDCs simultaneously with maintained eruption columns, as observed at Pinatubo 1991. **Total collapse** produces massive PDC-dominated eruptions: the deposit record of the Campanian Ignimbrite (~40 ka, ~280 km³) or the Fish Canyon Tuff (~28 Ma, ~5,000 km³) reflects total column collapse over sustained periods.`,
      cards: [
        {
          name: 'Gas-Thrust to Convective Transition',
          icon: Wind,
          color: BRAND.accent,
          desc: 'Immediately above the vent, the column is a supersonic or near-sonic gas-particle jet — dense, momentum-driven, decelerating rapidly as it entrains and heats ambient air. When the heated mixture becomes less dense than surrounding air, the column transitions to convective buoyancy. This "thermal boundary" sits typically 1–5 km above the vent. Above it, the column rises as a classic Morton-Taylor-Turner buoyant plume, entraining air at ~10–20% of vertical velocity. Column height H scales with MER^0.25: doubling column height requires a 16-fold increase in MER.',
          examples: 'Pinatubo 1991 peak MER ~2×10⁹ kg/s → column height ~35 km · Eyjafjallajökull 2010 MER ~3×10⁵ to 10⁶ kg/s → column 5–9 km · Sinabung 2014 partial collapse MER threshold exceeded intermittently → PDC generation with simultaneous column',
        },
        {
          name: 'Column Collapse and Pyroclastic Density Currents',
          icon: AlertTriangle,
          color: BRAND.ruby,
          desc: 'When MER exceeds the entrainment capacity of the column, the mixture fails to achieve buoyancy and collapses back to the surface, generating PDCs. PDCs travel 100–300 km/h at 300–700°C, overtop ridges up to 1,000 m, and are lethal to tens of km. Collapse may be total (all material collapses, producing ignimbrites) or partial (margin collapses while core sustains). The transition from column-forming to collapse-dominated behaviour is abrupt and can occur mid-eruption as MER fluctuates.',
          examples: 'Pinatubo June 15 1991: simultaneous PDCs on all flanks + sustained column → 800 deaths despite pre-evacuation · Merapi 2010 dome collapse: PDCs to 15 km at 300 km/h · Campi Flegrei 39 ka Campanian Ignimbrite: ~280 km³ total collapse PDC reaching 100+ km from vent',
        },
        {
          name: 'VEI Scale and Mass Eruption Rates',
          icon: BarChart2,
          color: BRAND.gold,
          desc: 'The Volcanic Explosivity Index (VEI, 0–8) is logarithmic: VEI 4 = ~0.1 km³ tephra; VEI 5 = ~1 km³; VEI 6 = ~10 km³. Column height correlates: VEI 4 ≈ 10–25 km, VEI 6 ≈ 25–35 km. MER estimated from H: log(MER) ≈ 4×log(H) − 4.3 (Wilson & Walker 1987). VEI does not capture duration or SO₂ injection, so climate impact can be under-predicted by VEI alone — Laki 1783 (VEI 4 effusive) killed ~20% of Iceland\'s population via SO₂ haze with negligible tephra.',
          examples: 'Eyjafjallajökull 2010: VEI 4, column 5–9 km, MER ~3×10⁵–10⁶ kg/s, 100,000 flights cancelled · Pinatubo 1991: VEI 6, column 35 km, MER ~2×10⁹ kg/s, 20 Mt SO₂, global cooling ~0.5°C · Tambora 1815: VEI 7, ~160 km³ tephra, "Year Without a Summer" 1816',
        },
      ],
    },
    {
...
The current international aviation framework uses **concentration-based thresholds** (introduced after 2010): zones with ash concentrations >4×10⁻³ g/m³ are closed to all traffic; zones with 2–4×10⁻³ g/m³ require airline risk assessment; zones <2×10⁻³ g/m³ are generally open with enhanced monitoring. **VONA (Volcano Observatory Notices for Aviation)** are issued directly from volcano observatories to aviation authorities and VAACs, describing observed or inferred ash cloud altitude, intensity, and movement — the first alert in the aviation warning chain.`,
      cards: [
        {
          ...
          examples: 'Eyjafjallajökull 2010: NAME ensemble showed ash over central Europe at >2×10⁻³ g/m³ for 6 days → widespread airspace closure · Raikoke 2019: HYSPLIT correctly predicted trans-Pacific ash dispersal to 12 km altitude, tracked by TROPOMI · Hunga Tonga 2022: stratospheric SO₂ plume reached 58 km altitude — far exceeding model inputs calibrated for tropospheric eruptions',
        },
        {
          name: 'Satellite SO₂ and Ash Monitoring',
          icon: Layers,
          color: BRAND.amethyst,
          desc: 'UV/IR satellite instruments detect SO₂ columns (DU = Dobson units) and ash optical depth globally. TOMS (1978–2005), OMI (2004–present), TROPOMI (2018–present, 3.5×5.5 km resolution): map SO₂ columns hours after eruption. MODIS and VIIRS: ash optical depth in IR. SEVIRI on Meteosat: 15-min repeat cycle for rapid ash evolution. SO₂ burden provides top-down constraint on MER when column height estimates are uncertain. TROPOMI detects eruptions as small as VEI 2 globally — improving precursor SO₂ monitoring at restless volcanoes.',
          examples: 'Pinatubo 1991: TOMS mapped 20 Mt SO₂ globally; aerosol optical depth 0.1–0.15 persisted 18 months · Sarychev 2009: OMI detected 1.2 Mt SO₂ at 15 km altitude from Kuril Islands eruption · Hunga Tonga 2022: TROPOMI captured 0.4 Mt SO₂ within first hour; umbrella cloud reached 57 km altitude at 900 km/h lateral spread',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        {
          q: 'Column height H scales with mass eruption rate (MER) as H ∝ MER^0.25. If a Vulcanian eruption produces a 10 km column, what MER increase would be needed to produce a 20 km column?',
          a: [
