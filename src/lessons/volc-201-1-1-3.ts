      ...
      cards: [
        {
          ...
          icon: Layers,
          color: BRAND.accent,
          desc: 'Decompression melting of depleted asthenosphere; ~15–25% partial melt. SiO₂ ~50%, very dry (<0.1 wt% H₂O), Fe-enriching tholeiitic trend. High T (1,200°C+), low viscosity (~10² Pa·s). Effusive pillow lavas. Forms oceanic crust. Most voluminous magma on Earth.',
        ...
        },
        {
          ...
          icon: Flame,
          color: BRAND.ruby,
          desc: 'Slab dehydration fluxes water into mantle wedge, triggering wet melting 100–200°C below dry solidus. Calc-alkaline series: basalt→andesite→dacite→rhyolite. High H₂O (up to 6 wt%): early magnetite stabilisation suppresses Fe enrichment. Explosivity increases with SiO₂. Most hazardous volcanic setting on Earth.',
          examples: 'Soufrière Hills, Montserrat (andesite lava dome, block-and-ash flows) · Pinatubo 1991 (dacite, VEI 6, 5 km³, global cooling 0.5°C) · Cascade Arc, USA (andesite–dacite stratovolcanoes: Rainier, Hood, Shasta)',
        },
        {
          ...
          examples: 'Kilauea, Hawaii (tholeiitic OIB, ~0.1 km³/yr, lava tubes, effusive) · Piton de la Fournaise, Réunion (tholeiitic, annual eruptions) · Yellowstone (hotspot over continent — bimodal basalt + rhyolite caldera system, 640 ka supereruption 1,000 km³)',
        },
        {
          ...
          examples: 'East African Rift (Afar, Erta Ale basalt lava lake; Ethiopian rift rhyolite calderas; bimodal volcanics from Kenya to Afar) · Basin and Range Province, USA (alkali basalt cinder cones + rhyolite domes) · Taupo Volcanic Zone, New Zealand (back-arc rift, prolific rhyolite, Taupo 26.5 ka = 530 km³)',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'How melting is triggered controls melt fraction and composition. Decompression melting (MOR, hotspots, rifts): upward movement of hot mantle crosses the solidus as pressure drops; high melt fractions (15–25%) at ridges, lower fractions (<5%) at rifts. Flux melting (subduction): water from the dehydrating slab lowers the mantle wedge solidus by 100–200°C, triggering melting at depths of 80–130 km. Higher water content in the primary melt leads to more oxidised, more silicic magmas during subsequent evolution.',
            color: BRAND.gold,
          },
          {
            id: 'composition',
          ...
          },
          {
            ...
            description: 'Viscosity and volatile content determine eruption character. Basalt (MOR/hotspot): effusive lava flows, lava fountains, Strombolian bursts — low explosive hazard, predictable flow paths (Kilauea 2018: 1.2 km³ basalt, 1 fatality). Andesite/dacite (subduction): dome-forming, block-and-ash flows, sub-Plinian to Plinian columns — high hazard (Pinatubo 1991: VEI 6, 800 deaths). Rhyolite (continental/subduction): Plinian to Ultra-Plinian, caldera-forming supereruptions — catastrophic (Yellowstone 640 ka: ~1,000 km³). Bimodal (rift): alternating effusive basalt and explosive rhyolite.',
            color: BRAND.ruby,
          },
        ],
        edges: [
