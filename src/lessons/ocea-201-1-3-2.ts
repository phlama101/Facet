...
The measure of this accumulated warmth is **ocean heat content (OHC)**: the total thermal energy stored in the ocean, typically expressed for the 0–2,000 m (0–6,562 ft) layer where Argo floats now provide near-global observations. The 0–2,000 m (0–6,562 ft) OHC has been increasing at a rate of approximately **10 zettajoules per year** (10 × 10²¹ joules/yr) since the early 2000s. To contextualise that rate: 10 ZJ is equivalent to roughly 25 times humanity\'s annual primary energy consumption. Since 1955, the 0–2,000 m (0–6,562 ft) layer has gained more than 400 ZJ of heat.

**The Argo float programme** transformed our ability to monitor OHC. Before Argo, ocean heat measurements were sparse, biased toward ship routes, and lacked coverage below 700 m (2,297 ft). Argo floats — autonomous profiling instruments roughly the size of a large fire extinguisher — drift at a parking depth of 1,000 m (3,281 ft), then periodically descend to 2,000 m (6,562 ft) and rise slowly to the surface, collecting **CTD profiles** (conductivity, temperature, and depth) through the full 2,000 m (6,562 ft) water column. On surfacing, data are transmitted via satellite. More than **4,000 active Argo floats** now provide near-global coverage, with profiles every 10 days; this network has been operational since approximately 2005. A newer generation, **Deep Argo**, profiles to 6,000 m (19,686 ft), capturing the abyssal ocean that remains below the standard Argo depth and stores a small but climatically significant additional heat inventory.
...
Ocean heat has a direct physical link to sea level rise through **thermal expansion** (thermosteric sea level rise): as seawater warms, it expands. Thermosteric expansion currently contributes approximately **38–55% of observed global sea level rise**, the remainder coming from melting glaciers and ice sheets. The 0–700 m (0–2,297 ft) layer contributes most immediately; the 700–2,000 m (2,297–6,562 ft) layer and below contribute increasingly as heat penetrates deeper. Even at 2°C (36°F) of global warming, committed thermosteric sea level rise from heat already stored would continue for centuries.
...
Perhaps the most dramatic ecological manifestation of OHC increase is the growing frequency and intensity of **marine heatwaves (MHWs)**: prolonged episodes of anomalously warm sea surface temperature. The **Great Barrier Reef** experienced catastrophic bleaching events in 2016 and 2020 driven by marine heatwaves, with 2016 killing ~50% of corals in the northern reef system. The North Pacific **"Blob"** of 2013–2016 was an extraordinary warm water anomaly — sea surface temperatures 2–6°C (36–43°F) above normal across millions of square kilometres — that disrupted fisheries, caused mass strandings of marine mammals, and triggered harmful algal blooms from Alaska to California. Under 2°C (36°F) of global warming, MHWs projected to be up to 40 times more frequent than in the pre-industrial baseline.
      ...
      keyTerms: [
        {
          ...
          def: 'The total thermal energy stored in the ocean, typically quantified for the 0–700 m (0–2,297 ft) or 0–2,000 m (0–6,562 ft) layer. Expressed in zettajoules (ZJ = 10²¹ J). The 0–2,000 m (0–6,562 ft) layer has been gaining ~10 ZJ/yr since the early 2000s and is the most robust measure of the planetary energy imbalance, integrating over short-term atmospheric variability.',
        },
        {
          term: 'Argo float',
        ...
        },
        {
          ...
          def: 'Sea level rise caused by thermal expansion of seawater as it warms. Currently accounts for ~38–55% of observed global sea level rise, the rest coming from melting ice. Even at 2°C (36°F) warming, committed thermosteric rise from heat already stored will continue for centuries after emissions stop.',
        },
        {
...
**Argo floats** transformed ocean observation from a sparse, ship-dependent enterprise to a genuine global monitoring network. Before Argo, coverage below 700 m (2,297 ft) was so poor that deep ocean heat changes were essentially unknown. The 10-day profiling cycle means that Argo can track seasonal and interannual OHC variations in addition to the long-term trend. Data are freely available in real time to any researcher. The programme is overseen by an international consortium; floats are deployed from research ships, commercial vessels, and even aircraft.

**Thermosteric sea level rise** is the most consequential long-term impact of OHC increase for coastal populations. Every 1 ZJ of OHC gain raises global mean sea level by approximately 0.15 mm (0.01 in) through thermal expansion alone; with OHC increasing at ~10 ZJ/yr, thermosteric expansion alone contributes ~1.5 mm/yr to the total ~3.7 mm/yr of global sea level rise. The deep ocean (below 2,000 m (6,562 ft)) contributes an additional expansion signal that is less well observed but climatically important on centennial timescales.

**Marine heatwaves** are perhaps the most vivid ecological signal of ocean warming. They are increasing in frequency (roughly doubling over the past century), duration, and intensity. The 2016 Great Barrier Reef bleaching — the most severe on record at the time — was directly driven by SSTs 1–2°C (34–36°F) above the bleaching threshold sustained for months. The North Pacific Blob reorganised the food web across the entire Pacific coast of North America, with cascading effects from phytoplankton to salmon to sea lions. Modelling studies project that under RCP8.5 (high-emissions scenario), permanent MHW conditions will exist over much of the global ocean by 2050.`,
      cards: [
        {
          name: 'Earth\'s Energy Imbalance and Ocean Uptake',
          icon: Thermometer,
          color: BRAND.accentHot,
          desc: 'Earth absorbs ~0.87 W/m² more than it emits, with >90% of excess heat stored in the ocean. OHC in the 0–2,000 m (0–6,562 ft) layer rises ~10 ZJ/yr. ENSO modulates annual uptake; La Niña phases subduct heat into Pacific subsurface.',
          examples: 'Since 1955, 0–2,000 m (0–6,562 ft) OHC has gained ~400 ZJ · Southern Ocean absorbs ~35–40% of total ocean heat gain · "Hiatus" 2000s: surface T paused while OHC continued rising — heat stored in subsurface Pacific',
        },
        {
          name: 'Argo Floats — Eyes in the Ocean',
          icon: Waves,
          color: BRAND.accent,
          desc: '>4,000 autonomous floats profile temperature and salinity from surface to 2,000 m (6,562 ft) every 10 days, transmitting via satellite. Near-global coverage since ~2005. Deep Argo extends to 6,000 m (19,686 ft). Pre-Argo, deep ocean heat change was essentially unknown.',
          examples: 'Argo detected >300 ZJ of 0–2,000 m (0–6,562 ft) heat gain since 2005 · Deep Argo pilot (2019–present): discovers significant heat gain 2,000–6,000 m (6,562–19,686 ft) · Float battery life ~4–5 years; ~800 new floats deployed per year to maintain array',
        },
        {
          ...
          examples: '1 ZJ OHC gain ≈ 0.15 mm (0.01 in) thermosteric sea level rise · 0–700 m (0–2,297 ft) expansion dominates near-term signal · Deep ocean (below 2,000 m (6,562 ft)) contributes additional slow expansion — not yet fully captured by standard Argo',
        },
        {
          name: 'Marine Heatwaves and Ecological Impacts',
          icon: Activity,
          color: BRAND.jade,
          desc: 'Marine heatwaves (SST >90th percentile ≥5 days) are doubling in frequency. Great Barrier Reef 2016 bleaching killed ~50% of northern corals. North Pacific "Blob" 2013–16 disrupted fisheries coast-wide. Projected ~40× more frequent at 2°C (36°F) warming.',
          examples: 'Great Barrier Reef 2020: second mass bleaching event in 5 years — now affecting middle and southern reef sectors · NE Pacific Blob SST anomaly +6°C (43°F) over 4 million km² · Mediterranean 2023 MHW: SST 4–5°C (39–41°F) above average, seagrass and posidonia die-offs',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          {
            id: 'ohc-increase',
            label: 'OHC Increase in 0–2,000 m (0–6,562 ft) Layer',
            description: `Ocean heat content rises ~10 ZJ/yr in the 0–2,000 m (0–6,562 ft) layer. Observed by >4,000 Argo floats since 2005. Since 1955, total 0–2,000 m (0–6,562 ft) OHC gain ~400+ ZJ. OHC is more robust metric of warming than surface air temperature due to ocean\'s thermal inertia.`,
            color: BRAND.jade,
          },
          {
            id: 'thermal-expansion',
            label: 'Thermal Expansion',
            description: 'Warmer seawater is less dense and occupies greater volume. Each 1 ZJ of OHC gain raises global mean sea level ~0.15 mm (0.01 in). Rate: ~1.5 mm/yr thermosteric contribution. Deep ocean expansion adds further slow contribution on centennial timescales.',
            color: BRAND.coral,
          },
          {
            id: 'consequences',
            label: 'Sea Level Rise and Marine Heatwaves',
            description: 'Thermosteric expansion = 38–55% of observed sea level rise (~3.7 mm/yr total). Marine heatwaves (SST >90th percentile ≥5 days) are doubling in frequency: GBR mass bleachings 2016 and 2020, NE Pacific Blob 2013–16. Under 2°C (36°F): MHWs ~40× more frequent; committed thermosteric rise continues centuries.',
            color: BRAND.ruby,
          },
        ],
        edges: [
          ...
          { from: 'ocean-uptake',    to: 'ohc-increase',      label: 'Heat stored in 0–2,000 m (0–6,562 ft) layer' },
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Argo is a global array of >4,000 autonomous profiling floats that collect CTD (conductivity, temperature, depth) profiles from the surface to 2,000 m (6,562 ft) every 10 days, transmitting data via satellite; before Argo achieved near-global coverage (~2005), deep ocean heat measurements were sparse, biased toward ship routes, and coverage below 700 m (2,297 ft) was so poor that deep ocean heat changes were essentially unknown',
            ...
            'Argo is a numerical ocean model that assimilates satellite sea surface height data to reconstruct subsurface temperatures; before Argo, OHC could only be estimated for the top 100 m (328 ft) of the ocean',
          ],
          correct: 1,
          explain: 'Argo floats are free-drifting autonomous instruments, not satellite-based or moored. Each float descends to a parking depth of 1,000 m (3,281 ft), then periodically descends further to 2,000 m (6,562 ft) and rises slowly to the surface while recording a CTD (conductivity, temperature, depth) profile — measuring temperature and salinity through the full 2,000 m (6,562 ft) water column. On surfacing, data are transmitted via the Argos or Iridium satellite systems and made publicly available within 24 hours. Before Argo, oceanographic temperature measurements below 700 m (2,297 ft) were largely limited to ship-deployed expendable bathythermographs (XBTs), which only reached 700–1,000 m (2,297–3,281 ft), were deployed non-uniformly along shipping lanes, and had known calibration biases. The deep ocean heat content below 700 m (2,297 ft) was essentially unknown in real time. The Argo era has transformed this: now, global 0–2,000 m (0–6,562 ft) OHC can be computed monthly with quantified uncertainty. Deep Argo, which profiles to 6,000 m (19,686 ft), is extending this coverage to the abyssal ocean.',
        },
        {
