      ...
      cards: [
        {
          ...
          desc: '~1,700 Pg C frozen in Arctic soils — twice the atmospheric CO₂ stock. Thaw releases CO₂ (aerobic) and CH₄ (anaerobic, GWP80). IPCC AR6: +0.02–0.09°C (0–0.2°F) additional warming per 1°C (1.8°F) rise by 2100. Feedback is committed and largely irreversible on human timescales.',
        ...
        },
        {
          ...
          icon: Activity,
          color: BRAND.gold,
          desc: 'Q10 ≈ 2: microbial decomposition doubles per 10°C (18°F) warming. Global soil carbon ~1,500–2,400 Pg (top 1 m (3 ft)). Warming soils release CO₂; if respiration exceeds plant uptake, net positive feedback. Long-term field experiments show loss persists for decades.',
          examples: 'Harvard Forest soil warming experiment (1991–present): 2°C (3.6°F) warming reduced soil C by ~17% over 26 years · Subarctic Sweden: warmed plots lost 15–20% soil C over 20 years · Global Q10 meta-analysis: mean Q10 = 2.1 (range 1.3–3.3) across biomes',
        },
        {
        ...
        },
        {
          ...
          examples: '2005 Amazon drought: 1.6 Pg C net source vs. ~0.5 Pg C normal sink (Phillips et al. 2009) · 2019–20 Australian bushfires: ~0.9 Pg C emitted in one season · CMIP6 models: eastern Amazon savannisation projected above +3°C (+5.4°F) global warming under SSP5-8.5',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Fossil fuel combustion and land-use change raise atmospheric CO₂ from 280 ppm (pre-industrial) to over 420 ppm today (~2024). Each doubling of CO₂ produces a direct radiative forcing of ~3.7 W/m², driving surface warming of ~1.1°C (~2.0°F) (Planck response alone before feedbacks).',
            color: BRAND.accentHot,
          },
          {
            id: 'surface-warming',
            label: 'Surface & Ocean Warming',
            description: 'Radiative forcing from CO₂ raises global mean surface temperature. Ocean surface warms along with land, though more slowly. Current global mean warming is ~1.2°C (~2.2°F) above pre-industrial. Warming activates carbon cycle feedbacks through multiple pathways simultaneously.',
            color: BRAND.coral,
          },
          {
            id: 'permafrost-thaw',
          ...
          },
          {
            ...
            description: 'Carbon released from permafrost, soils, weakened ocean sinks, and fire-disturbance adds to atmospheric CO₂ above the fossil fuel signal alone. The carbon cycle amplification factor increases effective warming relative to ECS by ~0.5–1.0°C (0.9–1.8°F) under high-emission scenarios. Earth system sensitivity (ESS) exceeds ECS, making long-term committed warming larger and less reversible.',
            color: BRAND.ruby,
          },
        ],
        edges: [
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Ocean warming reduces the biological pump efficiency by killing phytoplankton in warm surface waters, which is the dominant mechanism for carbon sink saturation; the Arctic Ocean shows the first saturation signals because Arctic phytoplankton are most sensitive to temperature increases above 5°C (9.0°F)',
          ],
          correct: 1,
        ...
        {
          q: 'The IPCC AR6 assessed that carbon cycle feedbacks increase effective warming relative to ECS by approximately 0.5–1.0°C (0.9–1.8°F) under high-emission scenarios. What is the primary reason this additional warming is considered "committed" and largely irreversible on human timescales?',
          a: [
