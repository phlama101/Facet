...
In Lesson 1.1.1, we established that the outer core is liquid iron-nickel — proved by the S-wave shadow zone. In Lesson 1.1.3, we saw that the core provides heat that drives mantle convection. Now we look at what the core does for the planet's surface: it generates the field that keeps Earth habitable. This lesson covers the geodynamo, the magnetosphere, and one of the most remarkable pieces of geological evidence ever discovered — the record of Earth's magnetic history written in the rocks of the ocean floor.`,
      ...
      interaction: {
        ...
        alt: 'Large quartz crystal cluster from Tibet showing hexagonal prismatic crystal form',
        aspectRatio: '4/3',
        ...
        annotations: [
          {
            ...
            x: 50,
            y: 25,
            label: 'Prismatic Crystal Faces',
            description: 'The long flat faces running the length of the crystal are the m-faces (prism faces) of the hexagonal system. Their smooth, glassy surfaces reflect quartz\'s vitreous luster and hardness of 7 on the Mohs scale.',
          },
          {
            id: '2',
            x: 65,
            ...
            description: 'The pointed tip where the prism faces converge into r-faces and z-faces (rhombohedral termination faces). This six-sided pyramidal termination is the signature crystal form of hexagonal quartz.',
          },
          {
            id: '3',
            x: 30,
            y: 55,
            label: 'Crystal Cluster Base',
            description: 'Multiple quartz crystals growing outward from a common rock matrix. Individual crystals compete for space as they grow, producing the irregular cluster form commonly found lining vugs and cavities in hydrothermal veins.',
          },
          {
            id: '4',
            x: 55,
            y: 70,
            label: 'Matrix Rock',
            description: 'The host rock from which the quartz crystals project. Quartz often precipitates from hydrothermal fluids circulating through fractures, depositing as veins or crystal-lined cavities in the surrounding rock.',
          },
        ],
      },
    },
