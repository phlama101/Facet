...
**Pteropods and the polar food web.** The aragonite shells of pteropods are only ~1–10 µm thick — extremely vulnerable to dissolution. In the Southern Ocean, aragonite saturation horizon (the depth below which aragonite dissolves) has shoaled from ~800 m in the 1990s to less than ~200 m in parts of the Southern Ocean today. Some surface waters are already seasonally undersaturated. Pteropods form up to 45 % of pink salmon diet in the Gulf of Alaska and are important prey for whales and seabirds. Their disruption propagates broadly through polar food webs.
...
**Adaptation and resilience.** Not all marine organisms respond to OA identically. Some species of algae and seagrasses show increased growth under elevated CO₂ (they benefit from the carbon fertilisation effect). Sea urchins and some echinoderms can partially compensate by increasing calcification effort. Nongeniculate crustose coralline algae, which cement reefs together, are among the most vulnerable. Evolutionary adaptation is possible but requires many generations; the current rate of pH change is far faster than most marine evolutionary timescales, making rapid genetic adaptation unlikely to save the most vulnerable species. The distinction between acclimatisation (short-term physiological adjustment within one organism\'s lifetime) and adaptation (evolutionary change across generations) is important for projecting future outcomes.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Beaufort Sea, Arctic: surface aragonite undersaturation recorded in summer 2008 · Southern Ocean: aragonite saturation horizon has shoaled from ~800 m (1990s) to <200 m in parts today · Arctic pteropod (*Limacina helicina*) shell dissolution confirmed in live specimens, 2012',
        },
        {
          name: 'Historical Analogues: The PETM',
          icon: Globe,
          color: BRAND.jade,
          desc: `The Paleocene-Eocene Thermal Maximum (~56 Ma) involved a rapid carbon pulse of 3,000–10,000 Pg C over ~20,000 years, driving global warming of 5–8 °C and a major OA event. Sediment cores show a sharp carbonate dissolution horizon — foraminifera tests simply vanish. Today\'s anthropogenic carbon release rate is at least 10× faster.`,
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Pteropods are vulnerable because they only inhabit very shallow water (less than 10 m depth) where CO₂ concentrations are highest due to surface warming',
          ],
          correct: 1,
        ...
        },
        {
          ...
          a: [
            ...
            'The deep ocean below 3,000 m in all basins, because hydrostatic pressure increases CO₂ solubility uniformly at depth regardless of latitude',
        ...
        },
        {
          ...
          a: [
            ...
            'The PETM was a rapid carbon release event ~56 Ma ago causing global warming of 5–8 °C and ocean acidification; it is relevant because it is the closest deep-time analogue to modern CO₂ injection, though today\'s emission rate is at least 10× faster than the PETM carbon release rate',
