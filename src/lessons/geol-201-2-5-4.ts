...
*Coarse-grained (phaneritic, >1 mm (0.04 in)):* Individual crystals visible to the naked eye; slow cooling at depth → plutonic. **Granite**: quartz + K-feldspar (pink or white) + plagioclase + biotite ± hornblende; light-coloured, felsic. **Gabbro**: plagioclase + pyroxene ± olivine; dark, mafic; no quartz. **Diorite**: plagioclase + hornblende; intermediate, grey; rare quartz.

*Fine-grained (aphanitic, <0.1 mm (0.00 in)):* Crystals microscopic; rapid cooling at surface → volcanic. **Rhyolite**: felsic, light-coloured (cream, pink, grey); equivalent to granite in composition. **Andesite**: intermediate, grey. **Basalt**: mafic, dark grey to black; may have olivine microphenocrysts.
...
*Clastic rocks (Wentworth scale):* Conglomerate (>2 mm (0.08 in), rounded clasts) or breccia (>2 mm (0.08 in), angular clasts — shorter transport). Sandstone (0.063–2 mm (0.00–0.08 in)). Siltstone (0.004–0.063 mm (0.00–0.00 in)). Mudstone (<0.004 mm (0.00 in), blocky) or shale (fissile — splits into thin sheets along bedding planes).
...
*Foliated — ordered by increasing metamorphic grade:* **Slate** (very fine-grained; smooth slaty cleavage; dull lustre; no visible crystals; low grade; protolith = shale). **Phyllite** (fine-grained; silky sheen on cleavage surfaces from aligned sericite/chlorite; slightly higher grade than slate). **Schist** (medium to coarse-grained; strong schistosity — aligned micas visible to naked eye; index minerals indicate grade: chlorite → biotite → garnet → staurolite → kyanite → sillimanite). **Gneiss** (coarse-grained; gneissic banding — alternating light felsic and dark mafic layers; high grade; migmatite at partial-melt conditions).`,
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'A rock sample is coarse-grained with crystals approximately 3–5 mm (0.12–0.20 in) across, light grey, containing clear glassy quartz, pink K-feldspar, white plagioclase, and black biotite. Name the rock and explain which textural and mineralogical properties led to your identification.',
          a: [
        ...
        },
        {
          ...
          a: [
            ...
            'Sample 1 = slate; Sample 2 = phyllite; Sample 3 = schist. Grade order from lowest to highest: slate < phyllite < schist. Protolith for both 1 and 2: shale or mudstone (pelite — a fine-grained, clay-rich sedimentary rock). Slate forms at the lowest grade of regional metamorphism (chlorite zone, ~150–300°C (302–572°F)): the original clay minerals have been partially recrystallised into chlorite and sericite, producing the characteristic smooth slaty cleavage, but individual crystals are not visible to the naked eye. Phyllite represents slightly higher grade than slate (~300–400°C (572–752°F)): sericite (fine-grained white mica) and chlorite are coarser and their alignment on the foliation planes produces the diagnostic silky or satiny sheen. Schist forms at medium to high grade (~400–650°C (752–1202°F)): biotite, garnet, and other index minerals are large enough to see without magnification; the coarse schistosity (aligned micas) and garnet porphyroblasts indicate amphibolite facies',
          ...
          correct: 1,
          explain: "Metamorphic rocks form a continuous sequence of increasing grade, and the foliated rocks slate → phyllite → schist → gneiss record progressively higher temperature and pressure metamorphism of a pelitic (clay-rich sedimentary) protolith. Sample 1 (slate): the key properties are (1) smooth, planar fracture — the slaty cleavage; (2) dull lustre — individual crystals are too fine-grained (generally <0.01 mm (0.00 in)) to reflect light individually, producing an aggregate dull surface; (3) no visible crystals — confirms very low grade metamorphism. Slate forms in the chlorite zone (approximately 150–300°C (302–572°F), 2–5 km (1.2–3.1 mi) depth). The protolith shale has its clay minerals recrystallised into chlorite and sericite (fine muscovite), and the new foliation (slaty cleavage) is usually at an angle to the original bedding. Sample 2 (phyllite): the silky or satin sheen is the single diagnostic property — it results from aligned sericite (fine muscovite) and chlorite crystals that are slightly coarser than in slate (roughly 0.01–0.1 mm (0.00–0.00 in)), large enough to reflect light specularly from the foliation surface. Grade is slightly higher than slate (~300–400°C (572–752°F)). Same protolith as slate: shale or mudstone. Sample 3 (schist): aligned biotite (which requires ~400°C (752°F) to form stably), plus garnet porphyroblasts (which typically grow at ~450–550°C (842–1022°F) in the almandine garnet zone of amphibolite facies). The coarseness of the crystals, visible to the naked eye, and the garnet growth are together diagnostic of medium-to-high grade metamorphism. Grade order: slate (lowest, ~150–300°C (302–572°F)) < phyllite (~300–400°C (572–752°F)) < schist (~400–650°C (752–1202°F)). Options A and C confuse marble and quartzite — non-foliated metamorphic rocks with different protoliths (limestone and sandstone respectively). Option D inverts the slate and phyllite definitions.",
        },
        {
          q: 'A volcanic rock contains approximately 3 mm (0.12 in) hornblende and plagioclase crystals (phenocrysts) set in a fine-grained dark groundmass, with 10–20% vesicles partially filled by green chlorite. Identify the rock and explain what the texture tells you about its cooling history and what the vesicles tell you about the eruption conditions.',
          a: [
