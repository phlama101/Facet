...
const climateProjectionsScenarios: Lesson = {
  ...
  duration: '13 min',
  xpReward: 130,
  description: 'What the future holds under different emissions pathways — SSP scenarios, 1.5°C (2.7°F) vs 2°C (3.6°F) thresholds, regional climate projections, sea level rise, and the concept of committed warming.',
  sources: [
    ...
    { org: 'Nature', title: 'Nature — Remaining carbon budgets and 1.5°C (2.7°F) pathways',            url: 'https://www.nature.com/articles/s41558-018-0324-6' },
...
Four SSPs bracket the plausible range of human futures. **SSP1-1.9** is the most ambitious mitigation pathway: net-zero CO₂ emissions around 2050, atmospheric CO₂ peaking below 430 ppm, and total radiative forcing held to 1.9 W/m² by 2100. This is the only pathway consistent with limiting warming to 1.5°C (2.7°F) above pre-industrial. **SSP2-4.5** is the "middle of the road" scenario: moderate mitigation efforts, CO₂ reaching ~600 ppm by 2100, forcing at 4.5 W/m², and warming of approximately 2.7°C (likely range 2.1–3.5°C (3.8–6.3°F)). It broadly reflects current national pledges if partially implemented. **SSP3-7.0** represents fragmented governance and regional rivalry, with CO₂ doubling from today\'s ~425 ppm to reach ~800 ppm by 2100 and warming of approximately 3.6°C (2.8–4.6°C (5–8.3°F)). **SSP5-8.5** is the fossil-fuel-intensive high-end scenario: CO₂ exceeding 1000 ppm by 2100, forcing reaching 8.5 W/m², and warming of approximately 4.4°C (3.3–5.7°C (5.9–10.3°F)) — though most analysts now consider this scenario less likely than it appeared in AR5 given observed energy transitions.

The **Paris Agreement** (2015) enshrined two temperature thresholds — limiting warming to **1.5°C (2.7°F)** and a harder limit of **2°C (3.6°F)** above pre-industrial — as the dual goals of international climate policy. The physical science rationale for these thresholds comes from the sharp nonlinearity of climate impacts: at 1.5°C (2.7°F), approximately 6% of insects, 8% of plants, and 4% of vertebrates lose more than half their geographic range; at 2°C (3.6°F) those fractions approximately double. Coral reef bleaching frequency shifts from once per decade at 1.5°C (2.7°F) to annual bleaching at 2°C (3.6°F). Heat extremes that occurred once per 50 years in the pre-industrial climate now occur roughly **1.5 times more frequently at 1.5°C (2.7°F)** and approximately **2.8 times more frequently at 2°C (3.6°F)**, a near-doubling of extreme heat recurrence with just 0.5°C (0.9°F) of additional warming.

As of 2023, global mean surface temperature has already risen approximately 1.2°C (2.2°F) above the 1850–1900 pre-industrial baseline. Even if all human CO₂ emissions stopped today, approximately **0.3°C (0.5°F) of additional warming is already committed** — locked in by the thermal inertia of the ocean and the atmospheric lifetime of CO₂ already emitted. This **committed warming** or "warming in the pipeline" arises because the deep ocean is still slowly equilibrating to the energy imbalance already imposed by current CO₂ levels. It sets a floor: the world will warm to at least ~1.5°C (~2.7°F) above pre-industrial even under the most aggressive mitigation scenario.

**Remaining carbon budget** quantifies the maximum cumulative CO₂ emissions still permissible to stay within a temperature threshold at a given probability. IPCC AR6 estimated a remaining budget of approximately **400 Pg C (petagrammes of carbon)** from the start of 2023 to limit warming to 1.5°C (2.7°F) with 50% probability (~550 Pg CO₂), or roughly 300 Pg C for 67% probability. At current global emissions of ~10 Pg C/year, the 50% budget is exhausted in about four decades — though the actual timeline is sensitive to methane and aerosol co-emissions.

**Sea level projections** illustrate the scenario dependence of long-term change. IPCC AR6 projects global mean sea level rise of **0.28–0.55 m (180 ft)** by 2100 under SSP1-1.9 (low emissions) and **0.63–1.01 m (3 ft)** under SSP5-8.5 (high emissions), with low-confidence upper bounds extending to **~2.0 m (0 ft)** under SSP5-8.5 if marine ice-sheet instabilities are triggered. Sea level rise is driven by thermal expansion of warming ocean water (~40% of rise) and melting of glaciers, ice caps, the Greenland Ice Sheet, and the West Antarctic Ice Sheet.
...
**Emissions scenarios and forcing pathways.** The SSP framework captures the breadth of plausible human choices. The gap between SSP1-1.9 and SSP5-8.5 represents not merely a temperature difference of ~3°C (~5.4°F) by 2100, but a qualitative difference in ecosystem integrity, sea level commitment, and the number of tipping systems triggered. Current nationally determined contributions under the Paris Agreement, if fully implemented, track closer to SSP2-4.5 or SSP3-7.0 than to SSP1-1.9 — a ~2.5°C (~4.5°F) trajectory that falls short of the 1.5°C (2.7°F) target.

**Temperature and sea level response.** The 1.5°C (2.7°F) and 2°C (3.6°F) Paris thresholds mark physically meaningful steps in impact severity, not just round numbers. Sea level rise projections under AR6 span a factor of ~3.5 between SSP1-1.9 and the high-end SSP5-8.5 estimate, with committed multi-century rises extending far beyond 2100 once ice-sheet feedbacks are activated.

**Regional amplification and extremes.** Global mean warming averages over vast regional heterogeneity. The Arctic warming 3–4× faster than the global mean, the Mediterranean drying, and South Asian monsoon intensification illustrate how the same global average conceals radically different local futures. Extreme event frequency scaling — heat extremes occurring ~2.8× more often at 2°C (3.6°F) than at pre-industrial — quantifies societal risk in decision-relevant terms.
      ...
      cards: [
        {
          ...
          icon: BarChart,
          color: BRAND.accent,
          desc: 'Four SSPs span from aggressive mitigation (SSP1-1.9, 1.5°C (2.7°F)-compatible) to fossil-fuel-intensive growth (SSP5-8.5, ~4.4°C (~7.9°F)). CO₂ ranges from <430 ppm to >1000 ppm by 2100. Current policy pledges track ~SSP2-4.5 to SSP3-7.0, a ~2.5–3°C (4.5–5.4°F) trajectory.',
          examples: 'SSP1-1.9: net-zero CO₂ ~2050, peak forcing 1.9 W/m² · SSP2-4.5: ~600 ppm CO₂, ~2.7°C (~4.9°F) by 2100 · SSP3-7.0: ~800 ppm CO₂, ~3.6°C (~6.5°F) · SSP5-8.5: >1000 ppm CO₂, ~4.4°C (~7.9°F) · Paris pledges: ~2.5°C (~4.5°F) gap between current pledges and 1.5°C (2.7°F) target',
        },
        {
          name: 'Temperature Thresholds & Committed Warming',
          icon: Thermometer,
          color: BRAND.accentHot,
          desc: 'At 1.5°C (2.7°F) heat extremes recur ~1.5× more often; at 2°C (3.6°F) ~2.8×. ~0.3°C (~0.5°F) committed warming is already locked in from current CO₂. Remaining carbon budget: ~400 Pg C for 1.5°C (2.7°F) at 50% probability (as of 2023) — ~4 decades at current emissions.',
          examples: '1.2°C (2.2°F) above pre-industrial already observed (2023) · +0.3°C (+0.5°F) committed even with zero emissions today · Annual coral bleaching shifts from once/decade at 1.5°C (2.7°F) to annual at 2°C (3.6°F) · 50-year heat extreme: 1.5× at 1.5°C (2.7°F), 2.8× at 2°C (3.6°F) · Carbon budget exhausted ~2060s at current rates',
        },
        {
          name: 'Regional Amplification & Sea Level Rise',
          icon: Globe,
          color: BRAND.jade,
          desc: 'Arctic warms 3–4× global mean via ice-albedo and water vapour feedbacks. Mediterranean loses 20–40% precipitation. Sea level rises 0.28–0.55 m (180 ft) (SSP1-1.9) to 0.63–2.0 m (0 ft) (SSP5-8.5) by 2100, driven by thermal expansion and ice-sheet melt.',
          examples: 'Arctic: +3–4× global mean warming rate (all scenarios) · Mediterranean: −20–40% annual precipitation (SSP3-7.0, SSP5-8.5) · South Asia monsoon: heavier, more variable rainfall · Sea level 2100: 0.28 m (92 ft) (SSP1-1.9 low) to ~2.0 m (0 ft) (SSP5-8.5 high-end) · Greenland Ice Sheet: committed 7 m (23 ft) over millennia if >1.5°C (2.7°F) sustained',
        },
        {
          ...
          examples: 'pH 8.2 (pre-industrial) → 8.1 (today) → ~7.8 (SSP5-8.5 2100) · Pteropod shell dissolution below pH 7.9 · AMOC collapse risk: low under SSP1-1.9, elevated under SSP3-7.0+ · Amazon dieback threshold: ~3–4°C (5.4–7.2°F) global warming · WAIS collapse: committed SLR ~3.3 m (10 ft) if triggered',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Human decisions on energy systems, land use, and governance determine cumulative CO₂ and non-CO₂ greenhouse-gas emissions. The four core SSPs span from SSP1-1.9 (net-zero ~2050) to SSP5-8.5 (fossil-fuel-intensive growth). Current policies track ~SSP2-4.5 to SSP3-7.0 — a 2.5–3.6°C (4.5–6.5°F) trajectory that falls short of Paris Agreement targets.',
            color: BRAND.accent,
          },
          {
            id: 'atmospheric-co2',
            label: 'Atmospheric CO₂ & Radiative Forcing',
            description: 'Cumulative emissions set atmospheric CO₂ concentration (350–1000+ ppm by 2100 across SSPs) and total anthropogenic radiative forcing (1.9–8.5 W/m²). Committed warming (~0.3°C (~0.5°F)) is locked in at the current ~425 ppm regardless of future choices. The remaining carbon budget for 1.5°C (2.7°F) is ~400 Pg C from 2023.',
            color: BRAND.gold,
          },
          {
            id: 'global-temperature',
            label: 'Global Mean Temperature Response',
            description: 'IPCC AR6 projects global warming of 1.0–1.8°C (1.8–3.2°F) (SSP1-1.9) to 3.3–5.7°C (5.9–10.3°F) (SSP5-8.5) above pre-industrial by 2100. The 1.5°C (2.7°F) and 2°C (3.6°F) Paris thresholds mark nonlinear steps in impact severity: heat extremes recur ~1.5× more often at 1.5°C (2.7°F) and ~2.8× more often at 2°C (3.6°F) than in the pre-industrial climate.',
            color: BRAND.accentHot,
          },
          {
          ...
          },
          {
            ...
            description: 'Global mean sea level rise by 2100 ranges from 0.28–0.55 m (180 ft) (SSP1-1.9) to 0.63–1.01 m (3 ft) (SSP5-8.5), with low-confidence upper bounds reaching ~2.0 m (0 ft) under ice-sheet instability scenarios. Driven by thermal expansion (~40%) and glacier/ice-sheet melt (~60%). Multi-century commitment to Greenland and Antarctic melt extends sea level rise for millennia beyond 2100.',
      ...
      questions: [
        {
          ...
          a: [
            'SSPs are purely statistical extrapolations of historical emission trends, while RCPs were based on detailed process models; SSP1-1.9 projects a 1.9°C (3.4°F) warming by 2100 and SSP5-8.5 projects an 8.5°C (15°F) warming, with the numbers indicating absolute temperature outcomes rather than radiative forcing levels',
            'SSPs couple radiative forcing targets with explicit socioeconomic narratives about energy, land use, population, and governance, whereas RCPs specified forcing levels without a linked socioeconomic story; SSP1-1.9 reaches net-zero CO₂ around 2050 and is the only scenario consistent with 1.5°C (2.7°F), while SSP5-8.5 represents fossil-fuel-intensive growth with CO₂ exceeding 1000 ppm and ~4.4°C (~7.9°F) warming by 2100',
        ...
        },
        {
          ...
          a: [
            'Committed warming is the warming already "paid for" by current CO₂ concentrations due to ocean thermal inertia and the long atmospheric lifetime of CO₂; approximately 0.3°C (0.5°F) of additional warming above the current ~1.2°C (~2.2°F) anomaly is locked in even if all emissions ceased immediately today, because the deep ocean is still equilibrating to the energy imbalance imposed by present CO₂ levels',
            ...
            'Committed warming equals the current ~1.2°C (~2.2°F) anomaly and represents warming already observed; it is the floor because, while temperatures could theoretically fall if CO₂ were actively removed from the atmosphere, no current carbon removal technology has sufficient scale to lower temperatures below the current level within this century',
          ],
          correct: 0,
          explain: `Committed warming — also called "warming in the pipeline" — arises from two factors. First, the ocean has enormous heat capacity and absorbs roughly 90% of the excess energy trapped by the greenhouse effect. Because the ocean is still warming toward equilibrium with current radiative forcing, even if CO₂ concentrations were held constant at today\'s ~425 ppm (let alone reduced to zero emissions), the surface would continue to warm as heat redistributes from the atmosphere into the deep ocean. Second, CO₂ already emitted has an atmospheric lifetime of centuries to millennia, so its forcing persists. The combination means approximately 0.3°C (0.5°F) of additional warming above the current ~1.2°C (~2.2°F) is already "committed" — total minimum warming of ~1.5°C (~2.7°F) above pre-industrial, regardless of mitigation. This is why some scientists and policymakers argue that adaptation measures for 1.5°C (2.7°F) of warming are necessary even as mitigation efforts aim to hold the line at that threshold. Answer B confuses physical committed warming with policy commitments. Answer C incorrectly attributes committed warming to methane from permafrost (which is a concern for future feedbacks but not the primary source of committed warming) and wrongly states methane persists over 1000 years (its atmospheric lifetime is ~12 years). Answer D conflates committed warming with current observed warming.`,
        },
        {
          q: 'How does the frequency of extreme heat events change between 1.5°C (2.7°F) and 2°C (3.6°F) of global warming, and what does this imply about the policy significance of 0.5°C (0.9°F) of additional warming?',
          a: [
            'Extreme heat events that occurred once per 50 years in the pre-industrial climate become approximately 1.5 times more frequent at 1.5°C (2.7°F) of warming and approximately 2.8 times more frequent at 2°C (3.6°F) — a near-doubling of recurrence rate from a mere 0.5°C (0.9°F) of additional warming, demonstrating that the 1.5°C (2.7°F) and 2°C (3.6°F) Paris thresholds correspond to physically meaningful, nonlinear steps in climate risk',
            'Extreme heat events scale linearly with global mean temperature: each additional 0.5°C (0.9°F) adds roughly the same fractional increase in extreme heat frequency; the difference between 1.5°C (2.7°F) and 2°C (3.6°F) is therefore similar in proportional terms to the difference between 1.0°C (1.8°F) and 1.5°C (2.7°F), and the Paris thresholds were chosen for political rather than physical reasons',
            'Extreme heat events defined as the once-per-50-year event become approximately 5 times more frequent at 1.5°C (2.7°F) and approximately 50 times more frequent at 2°C (3.6°F) of global warming, implying an order-of-magnitude change in risk between the two Paris thresholds',
            'The frequency of extreme heat events does not change substantially between 1.5°C (2.7°F) and 2°C (3.6°F) because the statistical distribution of daily temperatures is dominated by natural variability; the 0.5°C (0.9°F) signal is smaller than the noise in most regional temperature records and does not meaningfully shift the tail of the distribution',
          ],
          correct: 0,
          explain: 'IPCC AR6 (and earlier SR1.5) quantified extreme heat event frequency changes precisely because this nonlinearity is central to the policy case for limiting warming to 1.5°C (2.7°F) rather than 2°C (3.6°F). A heat extreme that occurred once every 50 years in the pre-industrial climate (i.e., with 2% annual probability) occurs approximately 1.5 times more frequently at 1.5°C (2.7°F) of global warming (roughly once every 33 years) and approximately 2.8 times more frequently at 2°C (3.6°F) of warming (roughly once every 18 years). This near-doubling of recurrence rate between 1.5°C (2.7°F) and 2°C (3.6°F) — from just 0.5°C (0.9°F) of additional warming — arises because the daily temperature distribution shifts toward the mean warming, but the tail (extreme events) scales more than linearly with mean shift when the threshold is fixed at a pre-industrial exceedance value. The result is highly policy-relevant: an additional half-degree of warming translates into roughly twice as many extreme heat events, with cascading effects on human health, agriculture, and ecosystem function. Answer B incorrectly claims linear scaling. Answer C overstates the frequency change by orders of magnitude relative to AR6 findings. Answer D incorrectly dismisses the signal as lost in variability — the frequency change is statistically robust and detectable in observed records.',
        },
        {
