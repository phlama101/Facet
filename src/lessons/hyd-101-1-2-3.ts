      ...
      cards: [
        {
          ...
          examples: 'Mississippi River: sinuosity 2.0-3.5. Meanders migrate 1-30 m/yr. 1929 artificial cutoffs straightened 270 km (168 mi); river is re-meandering.',
        },
        {
          name: 'Braided',
          icon: ArrowRight,
          ...
          examples: 'Waimakariri River, NZ: braided across 2 km (1.2 mi) width. Outwash rivers from glaciers (e.g., Skeiðará, Iceland) classically braided.',
        },
        {
          ...
          examples: 'Fine sand (0.3 mm (0.01 in)) erodes at ~20 cm/s. Clay (0.001 mm (0.00 in)) requires ~100 cm/s. Suspended silt deposits only below ~1 cm/s.',
        },
        {
          name: 'Lane\'s Balance',
          icon: Activity,
          ...
          examples: 'Colorado River below Hoover Dam: channel degraded 7.5 m (25 ft) in 65 km (40 mi) over 14 years as clear water eroded bed free of sediment supply.',
        },
        {
          name: 'Floodplain',
          icon: Globe,
          ...
          examples: `Mississippi floodplain: up to 100 km (62 mi) wide in places. Supports 12 million people and some of North America\'s most productive farmland.`,
        },
      ],
    },
    {
