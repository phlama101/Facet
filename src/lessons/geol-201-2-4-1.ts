      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            id: 'arthropoda',
            label: 'Arthropoda',
            description: 'Segmented body + jointed limbs + exoskeleton. The most species-rich animal phylum today. Cambrian forms: trilobites (extinct), anomalocaridids (giant predators, ~0.5–1 m (2–3 ft)), bivalved arthropods. Trilobites first appear at the base of Cambrian Stage 3 (~521 Ma) and are the most abundant Cambrian macrofossils.',
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            "Dickinsonia is a flat, segmented, oval Ediacaran organism up to 1.4 m (5 ft) long; 2018 biomarker analysis found cholesterol-derived molecules in preserved organic films within the fossil, providing biochemical evidence for animal identity since cholesterol is synthesised by animals (and other eukaryotes) but not by bacteria; this suggests animals existed at least by the latest Ediacaran. Kimberella is a bilateral, D-shaped organism associated with radula-like scratch marks in the surrounding sediment, consistent with a mollusc-grade bilaterian using a toothed feeding organ; trace fossil evidence (scratch marks) qualifies as non-body-fossil evidence for animal behavior before the Cambrian body fossil record begins",
        ...
        },
        {
          ...
          a: [
            ...
            "Small shelly fossils are a diverse assemblage of tiny (0.1–2 mm (0.00–0.08 in)) mineralized structures — tubes, cones, plates, and spines — from multiple unrelated animal lineages appearing at ~535–521 Ma; their simultaneous independent appearance across many phyla suggests that biomineralisation was not a single evolutionary event but a polyphyletic phenomenon: a threshold in ocean chemistry (calcium and phosphate availability), atmospheric oxygenation, or ecological pressure (predation arms race) was crossed at the Cambrian boundary that made mineralised hard parts simultaneously advantageous and achievable across many lineages; this multiphyletic biomineralisation event is a defining characteristic of the Cambrian Explosion",
