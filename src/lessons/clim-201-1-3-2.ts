      ...
      cards: [
        {
          ...
          examples: 'Zero-dimensional EBM: ECS ≈ S·ΔF/4 in one equation · Intermediate: MIT 2D zonally averaged ocean-atmosphere · CESM2 (NCAR): ~1° atmosphere, 1° ocean, interactive land carbon, sea ice, chemistry · MPI-ESM1.2: fully coupled ESM contributing to CMIP6 · Storm-resolving models (3–5 km): next frontier, beginning to resolve deep convection explicitly',
        },
        {
          name: 'Parameterization and the Cloud Problem',
          icon: Activity,
          color: BRAND.gold,
          desc: 'Sub-grid processes — deep convection (~1 km), boundary layer turbulence, cloud microphysics — cannot be resolved on 25–100 km grids and must be parameterized. Low-cloud parameterizations are the dominant source of spread in CMIP6 ECS values (2.5–5.7°C). Parameterization tuning against present-day observations does not guarantee correct future behavior under novel forcing.',
          examples: 'Mass-flux convection schemes (Arakawa-Schubert, Tiedtke): relate convective mass flux to large-scale instability · CLUBB (Cloud Layers Unified By Binormals): unified boundary layer and shallow cloud scheme in CESM2 · CMIP6 high-ECS tail (>5°C in some models) traced to revised low-cloud parameterizations · HighResMIP: testing impact of higher resolution (~25 km) on cloud and precipitation simulation',
        },
        {
          name: 'CMIP6 Ensemble and Projection Uncertainty',
          icon: BarChart,
          color: BRAND.jade,
          desc: 'Over 100 model configurations from 49 centres; standardised ScenarioMIP runs under SSP1-2.6 through SSP5-8.5. Ensemble spread quantifies structural model uncertainty. CMIP6 ECS range: 1.8–5.7°C, wider than CMIP5 due to new cloud parameterizations. IPCC AR6 assessed likely ECS: 2.5–4.0°C, constrained by paleoclimate and observational evidence beyond model spread alone.',
          examples: 'ScenarioMIP SSP2-4.5: ~2.7°C global mean warming by 2100 (multi-model median) · CMIP6 models with ECS >4.5°C inconsistent with Pliocene and Last Glacial Maximum paleoclimate constraints · Pattern effect: spatial structure of SST warming affects effective ECS in CMIP6 — a source of uncertainty not present in idealised 4×CO2 experiments · Model democracy vs. model weighting by performance metrics: active research area for reducing ensemble spread',
        },
        {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Solves the primitive equations (Navier-Stokes + thermodynamics + moisture) on a 3D grid, typically at ~50–100 km horizontal resolution with 30–100 vertical levels. Radiation scheme computes shortwave and longwave fluxes. Parameterizations handle deep convection, boundary layer turbulence, gravity wave drag, and cloud microphysics. Exchanges heat, moisture, momentum, and carbon fluxes with all other components via the coupler every 30–60 minutes.',
      ...
      questions: [
        {
          ...
          a: [
            ...
            'ESMs run at higher horizontal resolution (~10 km) than GCMs (~100 km), enabling them to explicitly resolve deep convection and cloud microphysics; the higher resolution reduces parameterization uncertainty and produces more accurate precipitation projections',
        ...
        },
        {
          ...
          correct: 2,
          explain: `Answer A describes parameter tuning, which does occur and contributes to model differences, but conflates it with parameterization — the tuning process adjusts the empirical constants within parameterization schemes but does not define parameterization itself. Answer B describes grid geometry and discretisation, a real numerical consideration but not the primary source of ECS spread. Answer D is incorrect — unit assignment is handled algorithmically and is not a source of ECS uncertainty. The correct answer is C: parameterization is the representation of sub-grid processes through empirical or semi-empirical relationships derived from observations or high-resolution simulations. The irreducible need for parameterization arises from the disparity between grid cell sizes (~50 km) and the scales of cloud formation (~μm–km), convective updrafts (~1 km), and boundary layer turbulence (~cm–m). Because marine low clouds — the dominant contributor to the shortwave cloud radiative effect — form in the boundary layer at sub-grid scales, how they respond to warming is controlled entirely by parameterization choices. CMIP6 models that revised their low-cloud parameterizations (e.g., introducing more sophisticated boundary layer schemes like CLUBB in CESM2) showed larger positive low-cloud feedbacks and correspondingly higher ECS values, producing the expanded CMIP6 ECS range of 1.8–5.7°C compared with CMIP5\'s 2.1–4.7°C. This illustrates directly how parameterization decisions drive ECS uncertainty.`,
        },
        {
          q: 'The CMIP6 ensemble produced several models with equilibrium climate sensitivity exceeding 5°C — higher than the IPCC AR6 assessed likely range of 2.5–4.0°C. How did scientists reconcile this discrepancy?',
          a: [
            'The high-ECS CMIP6 models were found to have coding errors in their radiation schemes that were subsequently corrected; the corrected versions all fell within the 2.5–4.0°C likely range, and the discrepancy was therefore an artefact of software bugs rather than a genuine physical uncertainty',
