    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explain: "Where sedimentary rocks rest directly on crystalline basement (igneous or metamorphic rock), the unconformity is a nonconformity — the defining criterion is the nature of the lower contact (crystalline vs. sedimentary), not the orientation. The Vishnu Schist is a high-grade metamorphic rock (~1,740 Ma) intruded by the Zoroaster Granite; these deep crustal rocks were exhumed by erosion — perhaps 20+ km (12+ mi) of overlying rock was removed — before the Cambrian sea transgressed and deposited the Tapeats Sandstone at ~508 Ma; the gap is ~1,230 million years. Where the Tapeats rests on tilted Proterozoic Grand Canyon Supergroup rocks (also within the canyon), the unconformity is angular; where it rests directly on Vishnu it is a nonconformity. An angular unconformity (A) applies where lower strata are tilted — the Vishnu is not a sedimentary layer but a metamorphic complex. A disconformity (C) requires parallel sedimentary sequences, not basement; the Vishnu is not sedimentary. The contact is definitely not a conformity (D) — the 1.2 Ga gap is one of the longest documented unconformities in North America.",
        },
        {
