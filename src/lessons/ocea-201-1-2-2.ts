...
Satellites have transformed our view of ocean productivity. Ocean-color sensors — SeaWiFS (1997–2010), MODIS-Aqua (2002–present), and PACE (2024–) — measure the spectral reflectance of the ocean surface and retrieve chlorophyll a concentrations as a proxy for phytoplankton biomass. Global maps reveal the stark contrast between productive upwelling zones and coastal regions (high chlorophyll, green) and the barren subtropical gyres (low chlorophyll, blue). Long time series now show alarming trends: as the ocean warms and stratification intensifies, subtropical gyres are expanding, phytoplankton ranges are shifting poleward, and total ocean NPP may be declining in some regions — with cascading consequences for marine food webs and the ocean\'s capacity to absorb CO₂.`,
      keyTerms: [
        ...
        {
          term: 'euphotic zone',
          def: 'The sunlit upper layer of the ocean where light exceeds ~1% of surface irradiance and net photosynthesis can occur; extends to roughly 200 m (656 ft) in clear open-ocean water, but much shallower in turbid coastal waters.',
        },
        {
          term: 'spring bloom',
      ...
      cards: [
        {
          ...
          examples: 'Southern Ocean HNLC: NO₃⁻ ~25 µM yet chlorophyll <0.3 mg m⁻³ without Fe · IronEx I (1993): Fe addition → 6× chlorophyll increase in 7 days · Critical depth ~100 m (328 ft) triggers North Atlantic spring bloom in March–April',
        },
        {
        ...
        },
        {
          ...
          examples: 'Sargasso Sea surface NO₃⁻ <0.05 µM vs. California upwelling: 20–30 µM · Peru-Humboldt system: ~10% of global fish catch · South Pacific Gyre: clearest water on Earth (Secchi depth >80 m (262 ft))',
        },
        {
          ...
          examples: 'MODIS-Aqua: daily global ocean coverage at 4 km (2.5 mi) resolution since 2002 · Global NPP algorithm (VGPM): estimates ~50 Pg C yr⁻¹ · Time series shows subtropical gyre expansion of ~1% per year since 1998 · PACE (2024): hyperspectral sensor distinguishes phytoplankton species composition',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Sunlight attenuates exponentially with depth. The euphotic zone (0–200 m (0–656 ft) in clear water) receives enough light for net photosynthesis. Photoinhibition suppresses production near the very surface; the deep chlorophyll maximum sits at the optimal depth. Seasonal and latitude changes in day length and solar angle drive bloom timing.',
            color: BRAND.gold,
          },
          {
            id: 'nutrients',
          ...
          },
          {
            ...
            description: 'Zooplankton (copepods, krill) graze phytoplankton, transferring energy up the food web. Dead cells, fecal pellets, and aggregates sink as particulate organic carbon (POC) — the biological pump. Sinking rate increases with cell size; diatom aggregates sink at >100 m (328 ft) day⁻¹. The fraction of NPP exported below the euphotic zone (export ratio, e-ratio) ranges from ~5% in oligotrophic gyres to ~30% in productive upwelling zones.',
            color: BRAND.amethyst,
          },
          {
            id: 'nutrients-regenerated',
            label: 'Nutrients regenerated or exported',
            description: 'Bacteria remineralise most sinking organic matter back to dissolved inorganic nutrients in the mesopelagic (100–1,000 m (328–3,281 ft)). Only ~10–20% of export flux survives to the deep ocean (>1,000 m (3,281 ft)), where carbon can be sequestered for centuries to millennia. Nutrients returned to the surface by mixing fuel future production; nutrients that reach the deep ocean are removed from the surface cycle until upwelled.',
            color: BRAND.ruby,
          },
        ],
        edges: [
      ...
      questions: [
        {
          ...
          a: [
            'The critical depth hypothesis states that a bloom begins when sea surface temperature rises above 10°C (50°F) in spring, warming the water enough for phytoplankton metabolic rates to exceed grazing mortality by zooplankton',
            ...
            'The critical depth hypothesis predicts that blooms begin when the nutricline rises above 200 m (656 ft) depth, delivering nitrate and phosphate directly into the euphotic zone without any change in stratification or mixed layer depth',
          ...
          correct: 1,
          explain: 'In winter at high latitudes, deep wind-driven mixing distributes phytoplankton throughout a mixed layer that may extend to 200–400 m (656–1,312 ft) — well below the euphotic zone (~50–100 m (164–328 ft) in winter). Cells spend the majority of their time in darkness, so depth-integrated community respiration exceeds depth-integrated photosynthesis and there is no net growth. Harald Sverdrup (1953) defined the critical depth as the depth at which these two integrated rates are exactly equal. In spring, solar heating stratifies the surface ocean, rapidly shoaling the mixed layer to perhaps 20–50 m (66–164 ft). Once the mixed layer depth drops below the critical depth, phytoplankton are retained in the euphotic zone long enough for photosynthesis to outpace respiration and bloom conditions are met. The hypothesis correctly predicts that blooms begin not simply when light increases, but specifically when stratification provides adequate light integration time — which is why the North Atlantic bloom begins in March–April while the Southern Ocean bloom can be delayed until December–January.',
        },
        {
          ...
          a: [
            'Tropical gyres are unproductive because high water temperatures denature phytoplankton enzymes, preventing photosynthesis from occurring efficiently above 25°C (77°F) even when light and nutrients are available',
