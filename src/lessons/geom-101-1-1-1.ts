...
Weathering products depend on the intensity of leaching. Moderate hydrolysis produces smectite and illite clays; intense, prolonged tropical leaching produces kaolinite and ultimately gibbsite (Al(OH)₃) as silica is progressively removed. Quartz is highly resistant and concentrates as a residual mineral in soils and sand deposits worldwide. Iron oxides (hematite, goethite) are nearly universal in oxidising, well-drained tropical soils. Together these secondary minerals constitute the regolith — the mantle of altered, unconsolidated material covering bedrock — which is the foundation for soil formation and the primary medium for terrestrial ecosystems.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c8/Frost_weathering.jpg/1200px-Frost_weathering.jpg',
        alt: 'Photograph showing frost-shattered rock fragments, active frost wedging cracks, angular debris, fresh rock face, and lichen colonising the surface',
        aspectRatio: '16/9',
        ...
        annotations: [
          {
            ...
            x: 50,
            y: 60,
            label: 'Frost-Shattered Rock Fragments',
            description: 'Angular, sharp-edged clasts produced by repeated freeze-thaw cycles. The absence of rounding indicates short transport — these fragments broke from the rock face directly above and accumulated in situ as a blockfield (felsenmeer).',
          },
          {
            id: 'frost-crack',
            x: 40,
            y: 35,
            label: 'Active Frost-Wedging Crack',
            description: 'A water-filled joint being progressively widened by ice-crystal growth. Pressures up to 207 MPa can be generated when water freezes in a confined crack — far exceeding the tensile strength of most rocks (5–25 MPa).',
          },
          {
            id: 'debris-pile',
            x: 65,
            y: 70,
            label: 'Angular Debris Pile',
            description: 'Accumulated frost-shattered debris at the base of a rock face. The angular, unsorted character (no fine matrix) is diagnostic of mechanical disintegration without chemical alteration or fluvial transport.',
          },
          {
            id: 'fresh-rock',
            x: 25,
            y: 30,
            label: 'Fresh Rock Face',
            description: 'Newly exposed bedrock surface where frost wedging has recently detached slabs. The pale, unweathered surface contrasts with the darker, lichen-colonised older faces, recording the progressive retreat of the rock wall.',
          },
          {
            id: 'lichen',
            x: 70,
            y: 40,
            label: 'Lichen Colonisation',
            description: 'Pioneer lichens colonise stable rock surfaces, secreting organic acids that initiate chemical weathering. Lichen thalli can also physically disrupt the surface via repeated wetting-drying expansion cycles — a process called bioweathering.',
          },
        ],
      },
    },
