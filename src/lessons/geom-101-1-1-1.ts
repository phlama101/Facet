...
Weathering products depend on the intensity of leaching. Moderate hydrolysis produces smectite and illite clays; intense, prolonged tropical leaching produces kaolinite and ultimately gibbsite (Al(OH)₃) as silica is progressively removed. Quartz is highly resistant and concentrates as a residual mineral in soils and sand deposits worldwide. Iron oxides (hematite, goethite) are nearly universal in oxidising, well-drained tropical soils. Together these secondary minerals constitute the regolith — the mantle of altered, unconsolidated material covering bedrock — which is the foundation for soil formation and the primary medium for terrestrial ecosystems.`,
      keyTerms: [
        {
          term: 'frost wedging',
          def: 'Mechanical breakdown of rock caused by the ~9% volumetric expansion of water on freezing in pores and joints; most effective between 0°C (32°F) and −5°C (23°F) where pressure can reach up to 207 MPa.',
        },
        {
          term: 'hydrolysis',
        ...
        {
          term: 'laterite',
          def: 'A deeply weathered, iron- and aluminium-rich regolith formed under intense tropical chemical weathering; characterised by red or orange hematite and goethite, and can extend 30–100 m (98–328 ft) below the surface.',
        },
      ],
    },
    {
      ...
      variant: 'insight',
      headline: 'Frost wedging is most effective between 0°C (32°F) and −5°C (23°F) — not at very cold temperatures',
      body: 'Frost wedging is most effective between 0°C (32°F) and −5°C (23°F) — not at very cold temperatures. In this range, water in larger pores remains liquid while freezing in smaller cracks, creating hydraulic pressure up to 207 MPa. That\'s 5 times more pressure than at the bottom of the deepest ocean trench.',
    },
    {
      type: 'concept',
      ...
      cards: [
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.jade,
          desc: 'Hydrolysis converts unstable primary silicate minerals (feldspars, micas) to stable secondary clay minerals; rate doubles per 10°C (18°F). Carbonation dissolves carbonate rocks via H₂CO₃, creating karst. Both reactions require water and are strongest in warm, humid climates.',
        ...
        },
        {
          ...
          examples: 'Tropical laterites in the Congo Basin and Amazonia reach 30+ m (98+ ft) depth; quartz sand — the ultimate weathering residue of granite — forms continental dune fields and beaches worldwide.',
        },
        {
      ...
      questions: [
        {
          ...
          a: [
            'Below −5°C (23°F) ice contracts, exerting maximum tension on rock walls',
            'Water expands 9% on freezing, generating up to 207 MPa; below −5°C (23°F) pore water is already frozen and little further expansion occurs; above 0°C (32°F) no freezing takes place',
          ...
          correct: 1,
          explain: `Frost wedging depends on the phase change of liquid water to ice. Water is anomalous in expanding ~9% when it freezes, and in confined rock pores this expansion can generate pressures up to 207 MPa — far exceeding the tensile strength of most rocks (typically 5–25 MPa). The temperature window of 0°C (32°F) to −5°C (23°F) is optimal because larger pores still contain liquid water that can migrate and refreeze while smaller pores freeze first, maximising the hydraulic pressure differential. Below −5°C (23°F), nearly all pore water has already frozen and volumetric change is small; above 0°C (32°F) no freezing occurs. Repeated daily or seasonal cycling through this range drives progressive crack propagation and rockfall in alpine and periglacial environments.`,
        },
        {
        ...
        },
        {
          ...
          correct: 3,
          explain: `Weathering profile depth reflects the integrated product of reaction rate and time. In humid tropical environments, three factors combine to maximise chemical weathering intensity: (1) High temperature — following the Arrhenius equation, chemical reaction rates approximately double per 10°C (18°F) increase, so tropical mean temperatures of 25–30°C (77–86°F) yield reaction rates 4–8× faster than temperate regions at 5–15°C (41–59°F); (2) Abundant water — high rainfall and humidity maintain saturated conditions that sustain hydrolysis, carbonation, and oxidation throughout the year; (3) Continuous operation — unlike temperate and polar regions where freezing temperatures halt chemical reactions for months, tropical systems operate year-round without dormant seasons. Over millions of years of tectonic stability, these conditions produce saprolite and laterite profiles 30–100 m (98–328 ft) deep in the Congo Basin, Amazonia, West Africa, and tropical Australia, compared to metres in temperate regions and centimetres in Arctic areas.`,
        },
      ],
    },
  ],
