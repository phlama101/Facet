        ...
        nodes: [
          {
            ...
            description: 'Currently +1.2 °C (+2.2°F) above pre-industrial; projected +1.5–4 °C (2.7–7.2°F) by 2100 depending on emissions pathway. Even at current levels, impacts are observed on every inhabited continent. Each additional fraction of a degree narrows options for adaptation.',
            color: BRAND.ruby,
          },
          {
            id: 'ecosystem',
            label: 'Ecosystem Disruption',
            description: '47 % of species ranges already shifted. Coral reefs bleach annually at +1.5 °C (+2.7°F) (70–90 %) and >99 % at +2 °C (+3.6°F). Amazon savannisation risk at +3–4 °C (5.4–7.2°F) regional warming. Ocean deoxygenation expanding oxygen minimum zones.',
            color: BRAND.coral,
          },
          {
            id: 'food',
            label: 'Food Security',
            description: 'Crop yields decline ~6 % (wheat), ~7 % (maize) per 1 °C (1.8°F) of warming. Fisheries shift poleward and decline in total productivity. 216 million internal climate migrants projected by 2050 as agriculture becomes untenable in some regions.',
            color: BRAND.gold,
          },
          {
            id: 'water',
          ...
          },
          {
            id: 'health',
            label: 'Human Health',
            description: 'Wet-bulb temperature of 35 °C (95°F) is the physiological survival limit — already briefly recorded in the Persian Gulf and South Asia. Dengue, malaria, and Lyme disease ranges expanding poleward. 2003 European heat wave killed ~70,000.',
            color: BRAND.amethyst,
          },
          {
            id: 'compound',
          ...
          },
          {
            ...
            description: 'Mortality risk from climate change is ~10× higher in low-income vs. high-income nations at +2 °C (+3.6°F). Small island states and Sub-Saharan Africa face existential risk while contributing <1 % of historical emissions. COP27 established a Loss and Damage Fund to address irreversible harms.',
            color: BRAND.textDim,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 0,
          explain: 'Climate injustice arises from the convergence of three independent factors: geographic exposure (tropical and subtropical locations experience greater warming impacts per degree of global mean temperature change, more intense precipitation extremes, and greater dependence on climate-sensitive sectors like rainfed agriculture and coastal fisheries), adaptive capacity (low-income nations lack the financial reserves, insurance systems, infrastructure redundancy, and institutional capacity to absorb climate shocks), and historical responsibility (those nations bearing the greatest burden contributed a tiny fraction of cumulative emissions). Option B directly contradicts the international policy landscape: climate finance mechanisms — including the Adaptation Fund, the Green Climate Fund, the $100 billion/yr pledge under the Paris Agreement, and the Loss and Damage Fund established at COP27 (2022) — are explicitly designed to direct resources to low-income vulnerable nations; the critique is that delivery has been inadequate, not that exclusion is legally mandated. Option C has a kernel of truth (some tropical ocean regions are warming faster than the global mean) but overstates the physical component; the primary injustice driver is adaptive capacity, not that physical forcing alone is larger — a wealthy Gulf state and a low-income delta farming community face very different outcomes even if local warming is identical. Option D notes a real vulnerability (rainfed subsistence agriculture is climate-sensitive) but captures only one dimension; climate vulnerability is multidimensional, spanning urban heat mortality, coastal flooding from sea level rise, water security, disease vectors, and conflict driven by resource scarcity. At +2 °C (+3.6°F), mortality risk from climate change is projected to be ~10× higher in low-income than high-income countries despite the latter being responsible for the vast majority of cumulative emissions.',
        },
        {
          q: 'A wet-bulb temperature of 35 °C (95°F) is described as the upper physiological limit for human survival, even at rest and in the shade. What physical mechanism makes this threshold so dangerous, and why is it particularly significant for densely populated tropical regions?',
          a: [
            'At Tw = 35 °C (95°F), the human body can no longer cool itself through radiation or conduction because air and surface temperatures exceed body temperature; the limit reflects the point at which all sensible heat transfer pathways are blocked simultaneously',
            'At Tw = 35 °C (95°F), the vapour pressure of the air equals the vapour pressure at the skin surface, making evaporative cooling thermodynamically impossible; the body can no longer dissipate metabolic heat through sweating regardless of sweat rate, causing fatal hyperthermia within hours even at rest',
            'The 35 °C (95°F) wet-bulb limit applies specifically to the elderly and immunocompromised; healthy adults can physiologically tolerate wet-bulb temperatures up to ~40 °C (~104°F) because cardiovascular conditioning allows more efficient sweat-based cooling at high humidity',
            'At Tw = 35 °C (95°F), the partial pressure of oxygen drops below physiological minima as water vapour crowds out O₂ molecules; the 35 °C (95°F) limit is primarily a respiratory threshold rather than a thermoregulatory one',
          ],
          correct: 1,
          explain: 'The wet-bulb temperature limit is a hard thermodynamic constraint, not a soft physiological one. The human body maintains a core temperature of ~37 °C (~99°F) and generates metabolic heat (~80 W at rest, several hundred watts during exertion) that must be continuously rejected to the environment. Below Tw ~35 °C (~95°F), the vapour pressure at the moist skin surface exceeds the ambient vapour pressure, so sweat evaporates and carries latent heat (2.4 MJ per litre) away from the body. At Tw = 35 °C (95°F), these vapour pressures equalise — the air is already holding as much water vapour as the skin surface can produce, so no net evaporation occurs regardless of how hard the body sweats. Metabolic heat accumulates and core temperature rises at approximately 1–2 °C (1.8–3.6°F) per hour, leading to heat stroke and organ failure. Option A incorrectly identifies radiation and conduction as the blocked pathways; at ambient temperatures above ~37 °C (~99°F), radiation and conduction do add heat to the body rather than removing it, but this is a separate effect from the wet-bulb limit — the 35 °C (95°F) threshold specifically describes the evaporative cooling breakdown. Option C is incorrect: the physiological limit applies to all healthy adults; the critical constraint is thermodynamic (vapour pressure equilibrium), not cardiovascular, so no degree of fitness bypasses it. Option D misunderstands atmospheric composition: humid air at 100 % relative humidity at sea level contains essentially the same 21 % oxygen mole fraction as dry air; the danger is thermal, not respiratory. For densely populated tropical regions — South Asia, West Africa, the Persian Gulf, the Mekong Delta — Tw ≥ 31–35 °C (88–95°F) events that are currently rare could become seasonally recurring under +2–3 °C (3.6–5.4°F) of global warming, affecting over a billion people with limited access to air conditioning.',
        },
        {
