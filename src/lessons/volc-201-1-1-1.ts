    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explain: 'Option A is partly correct in identifying hydrous minerals as important carriers of water into the subduction zone, but it misidentifies the mechanism: the direct lowering of the solidus is not because hydrous minerals have lower melting points per se, but because dissolved water in the silicate melt changes the thermodynamic activity of melt components. Option C is incorrect: the density argument describes a consequence of melting (buoyant melt rises) but not the cause; water demonstrably and measurably shifts the experimentally determined solidus curve to lower temperatures — this is a thermodynamic effect, not an artifact of melt density. Option D is incorrect: water does not significantly change the thermal conductivity of the mantle, and heat conduction is not the mechanism of flux melting. The correct answer is B: water dissolved in silicate melt breaks the polymerised Si–O–Si network, reducing the configurational entropy difference between the melt and the crystal phases. This thermodynamically stabilises the melt relative to the crystal aggregate, shifting the solidus to lower temperatures. Experimental petrology has quantified this as approximately –100°C per wt% H₂O added at upper mantle pressures. In subduction zones, the slab enters the mantle at temperatures 200–400°C cooler than the ambient wedge, so the wedge directly above the slab at 80–120 km depth is at ~900–1,100°C — above the wet solidus (~1,000°C at those pressures with modest H₂O) but below the dry solidus (~1,300°C). When slab dehydration releases water into this wedge, the solidus drops below the ambient temperature and melting begins — even though no heat has been added. This is the essence of flux melting, and it is the reason that subduction zones generate ~35% of Earth\'s arc magmatism despite being settings where relatively cool material is being recycled into the mantle.',
        },
        {
          ...
          correct: 1,
          explain: 'Option A incorrectly attributes the mineralogical difference to tectonic provenance rather than pressure-temperature stability; spinel and garnet lherzolites are defined by their aluminous phase, not their tectonic setting. Option C incorrectly places the transition at the crust-mantle boundary (Moho); the Moho beneath continental crust is typically at 30–50 km depth, well above the ~65–75 km spinel-garnet transition, which is entirely within the mantle. Option D partially describes a real process (retrograde conversion of garnet to spinel during decompression can occur in slowly ascending xenoliths) but this is not the primary interpretation — the coexistence of both pristine assemblages without pervasive reaction textures indicates sampling from two different pressure regimes. The correct answer is B: the aluminium phase in peridotite changes systematically with pressure because the thermodynamic stability of the three Al-bearing phases depends on the P-T conditions. At the lowest pressures (roughly <30 km in the spinel stability field), plagioclase feldspar (CaAl₂Si₂O₈) is stable. At intermediate pressures (roughly 30–75 km), aluminium is incorporated into spinel (MgAl₂O₄), which is denser than plagioclase. At greater pressures (>65–75 km), garnet (specifically pyrope-rich garnet, Mg₃Al₂Si₃O₁₂) becomes the stable aluminous phase because its denser, more compact structure is favoured by high pressure. The exact depth of the spinel-garnet transition varies with temperature (hotter geotherms push the boundary deeper) and bulk composition. Crucially, garnet strongly retains the heavy rare-earth elements (HREE: Dy, Er, Yb) due to their ionic radius match with the garnet dodecahedral site, while spinel does not; magmas generated in the garnet stability field therefore show HREE depletion, providing a geochemical barometer for melting depth.',
        },
        {
