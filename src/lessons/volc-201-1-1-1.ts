      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'One of three mechanisms pushes rock past the solidus: (1) Decompression — pressure drop during adiabatic ascent at MOR or hotspot; (2) Flux — H₂O from slab dehydration lowers solidus by ~100°C (180°F)/wt%; (3) Heat transfer — mantle plume thermally erodes thick continental crust.',
            color: BRAND.ruby,
          },
          {
