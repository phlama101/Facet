  ...
  sections: [
    {
      ...
      body: `The mantle makes up roughly 84% of Earth\'s volume and is, paradoxically, nearly entirely solid despite temperatures exceeding 1,300°C (2372°F) at 100 km (62 mi) depth. The reason is pressure: the weight of overlying rock elevates the melting temperature of mantle minerals far above any local temperature. Melt forms only where that balance is disrupted — and understanding exactly how and where that disruption occurs is the central problem of magma genesis.

Geologists recognise three distinct mechanisms by which the mantle crosses its solidus — the temperature at which rock begins to melt. Each mechanism dominates in a different tectonic setting, produces magma of different composition, and ultimately controls the style and distribution of volcanic activity at the surface. Together they explain why ~21 km³ (5.0 cu mi) of new igneous rock is generated on Earth every year, why roughly 30% of all mantle melting happens at mid-ocean ridges, and why island arc volcanoes erupt explosively while ocean floor basalts ooze quietly onto the seafloor.

The mantle\'s primary rock type is **peridotite**, a coarse-grained assemblage dominated by olivine (~60%), orthopyroxene, clinopyroxene, and an aluminous phase — either plagioclase (shallow), spinel (intermediate), or garnet (deep, >65–75 km (47 mi)). This transition from spinel lherzolite to garnet lherzolite at ~65–75 km (47 mi) is not merely mineralogical bookkeeping: garnet retains heavy rare-earth elements far more effectively than spinel, so the depth of melting leaves a distinct chemical fingerprint in the resulting magma — a tool exploited by petrologists to infer melting depth from lava chemistry.
...
The residue left behind after partial melting is equally informative. Moderate degrees of melting (~10–20%) leave **harzburgite** — a clinopyroxene-poor, olivine-orthopyroxene rock depleted in incompatible elements. Higher degrees of melting leave **dunite**, consisting of nearly pure olivine. These depleted residues form the lower portion of the oceanic lithosphere and are sampled in ophiolites (slices of oceanic crust obducted onto continents), providing direct access to the products of mantle melting that normally remain below the seafloor.`,
      keyTerms: [
        ...
        {
          term: 'Solidus',
          def: 'The pressure-temperature curve below which a rock is entirely solid. Above the solidus, some melt coexists with crystals (partial melting zone); above the liquidus, the rock is entirely molten. The dry peridotite solidus at 100 km (62 mi) is ~1,300°C (2372°F); adding ~0.1 wt% H₂O lowers it by ~100°C (212°F), explaining flux melting in subduction zones.',
        },
        {
      ...
      cards: [
        {
          ...
          icon: Mountain,
          color: BRAND.accent,
          desc: 'Rising mantle crosses the solidus as pressure drops faster than temperature during adiabatic ascent. Governed by mantle potential temperature (Tp ~1,280°C (2336°F) at MOR). Generates ~21 km³ (5.0 cu mi)/yr globally; ~30% of all mantle melting occurs at mid-ocean ridges. Produces olivine-saturated primary basalt at ~50% SiO₂.',
          examples: 'Mid-Atlantic Ridge: ~2–3 cm/yr half-spreading, continuous basalt generation · Iceland: MOR + plume, anomalously thick crust (30 km (19 mi) vs. 7 km (4.3 mi) normal) from elevated Tp · Hawaii: hotspot plume decompression, shield-building tholeiitic basalt',
        },
        {
          name: 'Flux Melting',
          icon: Thermometer,
          color: BRAND.ruby,
          desc: 'Water released by slab dehydration at 80–120 km (75 mi) depth lowers the peridotite solidus by ~100°C (212°F) per wt% H₂O, triggering melting in the overlying wedge. Produces volatile-rich, silica-enriched magmas (andesite to dacite). Drives Ring of Fire volcanism and explosive eruption styles due to high dissolved H₂O and CO₂.',
          examples: 'Cascades: Juan de Fuca slab dehydration at ~90 km (56 mi) depth, Mt. St. Helens dacite · Andes: Nazca plate subduction, andesitic-dacitic stratovolcanoes · Sumatra-Java arc: 130+ active volcanoes above subducting Indo-Australian plate',
        },
        {
          ...
          examples: 'Yellowstone: basaltic plume magma heats lower crust, generating rhyolitic calderas (Lava Creek Tuff ~0.64 Ma, ~1,000 km³ (240 cu mi)) · Snake River Plain: track of heat-transfer melting as North American plate overrides Yellowstone hotspot',
        },
        {
          ...
          examples: 'MORB tholeiites: F ~15–25%, harzburgite residue, ~50% SiO₂ · Ocean island alkali basalts (Hawaii): F ~3–8%, garnet lherzolite source > 75 km (47 mi) depth · Ophiolite peridotites (Oman, Cyprus): harzburgite and dunite residues directly exposed at surface',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'Spinel or garnet lherzolite in the asthenospheric mantle. Composed of olivine (~60%), orthopyroxene, clinopyroxene, and aluminous phase. Solidus at ~1,300°C (2372°F) at 100 km (62 mi) depth. Contains trace H₂O (~50–200 ppm) and CO₂ stored in nominally anhydrous minerals.',
            color: BRAND.textDim,
          },
          {
            id: 'melting-trigger',
            label: 'Melting Trigger',
            description: 'One of three mechanisms pushes rock past the solidus: (1) Decompression — pressure drop during adiabatic ascent at MOR or hotspot; (2) Flux — H₂O from slab dehydration lowers solidus by ~100°C (212°F)/wt%; (3) Heat transfer — mantle plume thermally erodes thick continental crust.',
            color: BRAND.ruby,
          },
          {
          ...
          },
          {
            ...
            description: 'Primary basaltic melt ponds at the base of the crust or in a shallow axial magma chamber. Fractional crystallisation, magma mixing, and assimilation of wall rock modify composition. At MOR, the chamber is largely crystal mush with small melt lenses at 1–4 km (2.5 mi) depth.',
            color: BRAND.coral,
          },
          {
            id: 'eruption',
            label: 'Volcanic Eruption',
            description: 'Magma ascends through dykes and conduits to the surface. MOR: basaltic pillow lavas and sheet flows quenched by seawater at >2,500 m (8202 ft) depth. Subduction zones: volatile-rich andesitic to dacitic magmas drive explosive plinian eruptions. Hotspots: shield-building tholeiitic basalt flows.',
    ...
    },
    {
      ...
      questions: [
        {
          q: 'A geophysicist studying a fast-spreading mid-ocean ridge segment measures seismic velocities that indicate a thin, lens-shaped region of low-velocity material at ~2 km (1.2 mi) below the ridge axis. The region is interpreted as a melt-rich zone. What melting mechanism generated this melt, and why does the melt accumulate at this particular depth rather than continuing to ascend?',
          a: [
            'The melt was generated by decompression melting: as the plates diverge, asthenospheric mantle rises adiabatically, crosses the peridotite solidus at ~60–80 km (50 mi) depth, and produces basaltic melt; as this primary melt ascends, it ponds in an axial magma chamber at ~1–4 km (2.5 mi) depth because the surrounding oceanic crust at that level is cool enough and rigid enough to form a density trap, and because the melt has partially crystallised and lost buoyancy',
            'The melt was generated by flux melting: seawater circulating through the hot oceanic crust releases water at depth, lowering the solidus of the basaltic crust and triggering melting; the melt ponds at 2 km (1.2 mi) because the overlying crust is too cold and brittle to allow further dyke propagation until sufficient magmatic pressure builds',
            'The melt was generated by heat-transfer melting: the adjacent transform faults bring anomalously hot mantle into contact with the cooler ridge flank, and conductive heat transfer melts the lower oceanic crust; the melt ponds at 2 km (1.2 mi) because that is the depth at which crustal density equals melt density, creating neutral buoyancy',
            'The melt at 2 km (1.2 mi) depth is not newly generated magma but rather ancient mantle that was never fully solidified; fast-spreading ridges preserve pockets of primordial melt within the crust because rapid crustal accretion insulates the interior from heat loss; the seismic anomaly reflects this relict melt, not active magmatic processes',
          ],
          correct: 0,
          explain: 'Flux melting (B) is the mechanism at subduction zones, not mid-ocean ridges; seawater hydrothermal circulation does alter the oceanic crust but does not generate significant volumes of new melt. Heat-transfer melting (C) occurs where a mantle plume impinges on thick continental crust and is not the dominant mechanism at fast-spreading ridges; transform faults do not supply anomalously hot mantle that melts the crust. Relict primordial melt (D) is not consistent with the petrological and geochemical evidence from mid-ocean ridge basalts, which show fresh, recently fractionated compositions, not ancient unmodified melts. The correct answer is A: decompression melting begins at ~60–80 km (50 mi) below the ridge axis as the diverging plates drive passive upwelling of the asthenosphere. The rising peridotite crosses the dry solidus and begins producing basaltic melt; F increases to ~15–25% by the time the residue reaches the base of the lithosphere. The melt segregates into dunite channels and ascends rapidly. It ponds at ~1–4 km (2.5 mi) depth in an axial magma lens because at that level the surrounding gabbroic crust is cold and rigid enough to arrest further ascent until dyking events carry melt to the surface. Seismic surveys of the East Pacific Rise confirm this geometry: a bright reflector at ~1.2–2.5 km (1.6 mi) sub-axial depth marks the top of the melt lens, underlain by a broader region of crystal mush (60–90% crystals) to ~5–7 km (4.3 mi) depth. This magmatic plumbing system produces all the oceanic crust generated along the ~65,000 km (40391 mi) global ridge network.',
        },
        {
        ...
        },
        {
          ...
          a: [
            ...
            'The ~65–75 km (47 mi) boundary represents the base of the crust; spinel lherzolites are crustal rocks derived from the lower crust and garnet lherzolites are sub-crustal mantle rocks; the coexistence of both types indicates that the erupting magma sampled both the lower crust and the underlying mantle during its rapid ascent',
            'The difference between spinel and garnet lherzolite xenoliths is purely a product of magmatic differentiation during ascent: both started as identical garnet lherzolite but the spinel lherzolites reacted with the host magma at shallow crustal levels, converting garnet to spinel through decompression; the boundary at 65–75 km (47 mi) therefore records the depth at which significant magma-xenolith reaction begins',
            'The coexistence of both assemblages indicates that the xenoliths sample different depths of the lithospheric mantle column beneath the volcano: spinel lherzolite is stable at shallower depths (roughly <65–75 km (47 mi)) where the aluminous phase is MgAl₂O₄ spinel, while garnet lherzolite is stable at greater depths (>65–75 km (47 mi)) where the higher pressure stabilises pyrope-rich garnet instead; the depth of this transition is sensitive to temperature and bulk composition, and the two xenolith types together constrain the depth extent of the lithospheric keel sampled by the eruption',
          ],
          correct: 3,
          explain: 'Option A incorrectly attributes the mineralogical difference to tectonic provenance rather than pressure-temperature stability; spinel and garnet lherzolites are defined by their aluminous phase, not their tectonic setting. Option B incorrectly places the transition at the crust-mantle boundary (Moho); the Moho beneath continental crust is typically at 30–50 km (31 mi) depth, well above the ~65–75 km (47 mi) spinel-garnet transition, which is entirely within the mantle. Option C partially describes a real process (retrograde conversion of garnet to spinel during decompression can occur in slowly ascending xenoliths) but this is not the primary interpretation — the coexistence of both pristine assemblages without pervasive reaction textures indicates sampling from two different pressure regimes. The correct answer is D: the aluminium phase in peridotite changes systematically with pressure because the thermodynamic stability of the three Al-bearing phases depends on the P-T conditions. At the lowest pressures (roughly <30 km (19 mi)), plagioclase feldspar (CaAl₂Si₂O₈) is stable. At intermediate pressures (roughly 30–75 km (47 mi)), aluminium is incorporated into spinel (MgAl₂O₄), which is denser than plagioclase. At greater pressures (>65–75 km (47 mi)), garnet (specifically pyrope-rich garnet, Mg₃Al₂Si₃O₁₂) becomes the stable aluminous phase because its denser, more compact structure is favoured by high pressure. The exact depth of the spinel-garnet transition varies with temperature (hotter geotherms push the boundary deeper) and bulk composition. Crucially, garnet strongly retains the heavy rare-earth elements (HREE: Dy, Er, Yb) due to their ionic radius match with the garnet dodecahedral site, while spinel does not; magmas generated in the garnet stability field therefore show HREE depletion, providing a geochemical barometer for melting depth.',
        },
        {
          q: 'The global mid-ocean ridge system generates approximately 21 km³ (5.0 cu mi) of new basaltic crust per year, and roughly 30% of all mantle melting on Earth occurs at ridges. Given that Iceland sits at the intersection of the Mid-Atlantic Ridge and the Iceland mantle plume, it has anomalously thick oceanic crust (~30 km (19 mi) vs. the typical ~7 km (4.3 mi)). What does this crustal thickness anomaly tell us about the melting process beneath Iceland, and how does the concept of mantle potential temperature (Tp) explain it?',
          a: [
            'The thick crust beneath Iceland results from flux melting: the Iceland plume carries large amounts of water from the deep mantle, and this water lowers the solidus sufficiently to generate the extra melt needed for 30 km (19 mi) of crust; the potential temperature concept is irrelevant here because the extra melting is driven by volatiles, not heat',
            'The thick crust beneath Iceland indicates that the mantle beneath the island is anomalously hot relative to normal ridge mantle; mantle potential temperature (Tp) is the temperature a parcel of mantle would have if brought adiabatically to the surface without melting; normal MORB-source mantle has Tp ~1,280°C (2336°F); the Iceland plume has estimated Tp ~1,480–1,530°C (2786°F); higher Tp means the mantle crosses the solidus at greater depth and continues melting over a longer pressure interval, producing a much higher total melt fraction F and therefore thicker crust',
            'The 30 km (19 mi) crust beneath Iceland is not anomalous in thickness — all oceanic crust formed at slow-spreading ridges like the Mid-Atlantic Ridge is ~30 km (19 mi) thick because slow spreading allows more time for melt to pool and crystallise before the plates separate; fast-spreading ridges like the East Pacific Rise produce thinner crust (~7 km (4.3 mi)) because rapid divergence spreads the melt over a larger area',
          ...
          correct: 1,
          explain: 'Flux melting by plume-derived water (A) is not the mechanism; the Iceland plume is a thermal (high Tp) anomaly, not primarily a volatile-enriched one; volatile-driven (flux) melting is the mechanism in subduction zones. Slow-spreading ridge crust (C) is actually slightly thinner or comparable to fast-spreading crust, not thicker; spreading rate primarily controls the morphology of the ridge (axial valley vs. axial high) rather than crustal thickness; and the Mid-Atlantic Ridge at non-Iceland segments generates standard ~7 km (4.3 mi) crust despite being slow-spreading. Mechanical injection of plume volume without melting (D) is not consistent with the geochemical and petrological evidence; Iceland lavas show higher degrees of partial melting (higher F), not just more material. The correct answer is B: mantle potential temperature (Tp), introduced by Dan McKenzie and colleagues in the 1980s, is the key parameter linking mantle temperature to melt productivity. Tp is defined as the temperature a mantle parcel would have at the surface if brought up adiabatically along the mantle adiabat without crossing the solidus — it is essentially a normalised temperature that allows comparison of mantle parcels at different depths. Normal MORB-source mantle has Tp ~1,280°C (2336°F); the associated melting column extends from the solidus intersection (~60 km (37 mi)) to the base of the lithosphere (~7 km (4.3 mi)), generating ~15–20% total melt fraction and ~7 km (4.3 mi) of oceanic crust. The Iceland plume, with Tp ~1,480–1,530°C (2786°F), intersects the solidus at ~120–150 km (93 mi) depth — much deeper — and the melting column is correspondingly longer. The total integrated melt fraction is 4–5× larger, consistent with the observed ~30 km (19 mi) crustal thickness. This relationship between Tp, melting column length, and crustal thickness is one of the quantitative successes of simple mantle melting theory (the McKenzie-Bickle 1988 parameterisation) and explains why large igneous provinces (LIPs) — where Tp may reach ~1,600°C (2912°F) — generate flood basalt volumes of hundreds of thousands of cubic kilometres.',
        },
      ],
    },
  ],
