      ...
      questions: [
        {
          ...
          a: [
            "Using travel-time equations: if P arrives at time t_P and S at t_S, then t_P = d/v_P and t_S = d/v_S; S-P time = d/v_S - d/v_P = d(1/v_S - 1/v_P) = d(1/3.5 - 1/6) = d × 0.119; so d = 24/0.119 ≈ 202 km (126 mi); approximately 200 km (124 mi) from the epicentre",
            "The S-P time of 24 seconds at average seismic velocity 4.75 km/s gives distance = 24 × 4.75 = 114 km (71 mi); this is the correct method because you should use the average of P and S velocities rather than the difference in their travel times",
        ...
        },
        {
          ...
          a: [
            ...
            "Rayleigh waves\' retrograde motion creates a surface pressure wave in the ground; this pressure oscillation liquefies the upper 1–5 m (16 ft) of soil at the building foundation by cycling the pore water pressure above and below the liquefaction threshold; all buildings are vulnerable because all foundations are in the upper 5 m (16 ft) of soil; the 1–10 s period is dangerous because it takes ~1–2 wave cycles to fully liquefy the soil",
