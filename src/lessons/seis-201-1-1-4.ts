...
const mantlePlumesSlabs: Lesson = {
  ...
  sources: [
    ...
    { org: 'GRL',      title: 'Fukao & Obayashi (2013) — Subducted slabs stagnant above, penetrating through, and trapped below the 660 km (410 mi) discontinuity, JGR', url: 'https://doi.org/10.1002/jgrb.50188' },
...
**The Tonga slab.** The Tonga-Kermadec subduction system has the fastest convergence rate on Earth (~24 cm/yr at the northern Tonga trench) and produces one of the most intensely imaged slab anomalies in global tomography. The Tonga slab appears in multiple models as a sharp, coherent fast anomaly descending steeply into the mantle, with evidence of both stagnation and penetration at 660 km (410 mi) depending on the specific location along the arc. The rapid subduction rate means large volumes of cold material enter the mantle quickly, producing anomalies detectable to great depths even in global-resolution models.`,
    ...
    },
    {
      ...
      body: `**The resolution challenge.** Global body-wave tomography models have typical horizontal resolution of 300–500 km (311 mi) in well-sampled regions. The expected diameter of a mantle plume tail is ~100–200 km (124 mi) — at or below this resolution. This means that plume conduits, if they exist as narrow features, will appear broadened and weakened in global models (the smoothing of the inversion spreads a narrow anomaly over a larger area while reducing its amplitude). This is why the absence of a clear plume conduit in a global model does not prove the plume doesn't exist.

**Iceland plume.** Iceland is the most robustly tomographically imaged hotspot. Wolfe et al. (1997) deployed a temporary broadband seismograph array across Iceland and performed regional P and S wave tomography with much higher resolution than global models can achieve. They imaged a slow Vp/Vs anomaly extending at least 400 km (249 mi) below Iceland, consistent with a thermal plume with ~100–150 K excess temperature. The Iceland anomaly also appears in global S-wave models as a slow feature extending from the surface to at least 400 km (249 mi) depth and possibly connecting to the base of the transition zone. Iceland's anomalously thick oceanic crust (~30 km (19 mi) vs ~7 km (4.3 mi) for normal ocean crust) and high magma production rate support the plume interpretation.

**Yellowstone.** The Yellowstone hotspot in the western United States has been imaged by multiple studies using USArray data. Body-wave tomography (Smith et al. 2009; Schmandt & Humphreys 2010) shows a slow P and S wave anomaly tilted to the NW beneath Yellowstone, interpreted as a plume conduit deflected by the southwestward motion of the North American plate. The slow anomaly extends to ~200 km (124 mi) depth in P-wave models and to ~500–600 km (373 mi) in some S-wave models. The tilted geometry is consistent with plate motion dragging the upwelling conduit: if the mantle source is fixed and the plate moves at ~2.5 cm/yr to the SW, the conduit would be tilted that direction. The Yellowstone hotspot track — a chain of calderas aging NE from Yellowstone — confirms plate motion over a relatively fixed source.
    ...
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          {
            ...
            description: 'Old oceanic lithosphere is ~7–10 km (6.2 mi) of basaltic crust plus ~80–100 km (62 mi) of cold, depleted peridotite. As it ages, it cools and densifies — by ~80–100 Ma it is denser than the underlying asthenosphere and will subduct wherever plate convergence forces it down. In tomographic images, the cold lithosphere appears as fast (blue) material in the shallow mantle. At a subduction zone, this cold material begins sinking; its thermal anomaly (−300 to −800°C (1472°F) relative to ambient mantle) persists for tens of millions of years as it sinks through the mantle.',
            color: BRAND.accent,
          },
          {
            id: 'subduction-zone',
            label: 'Subduction Zone: Slab Entry into Mantle',
            description: 'At a convergent margin, the dense oceanic plate bends and sinks into the mantle. Seismicity defines the slab geometry: the Wadati-Benioff zone of intermediate and deep focus earthquakes (to ~700 km (435 mi)) marks the slab interior. In P-wave tomography, the slab appears as a sharp fast anomaly — dVp of +1 to +3% — beginning at the trench and extending steeply into the mantle. The slab carries water in hydrous minerals; dehydration at 50–150 km (93 mi) depth fluxes the mantle wedge above, lowering its solidus and causing arc volcanism at the surface.',
            color: BRAND.coral,
          },
          {
            id: 'transition-zone-660',
            label: '660-km Transition Zone Boundary: Penetrate or Stagnate?',
            description: 'The 660 km (410 mi) discontinuity — where ringwoodite breaks down to bridgmanite + ferropericlase — is the key dynamic filter for slab penetration into the lower mantle. The negative Clapeyron slope creates upward buoyancy in cold slabs at this boundary; combined with the factor 10–30 viscosity increase across 660 km (410 mi), some slabs flatten and spread horizontally (stagnant slabs: Pacific under East Asia). Others overcome the resistance and penetrate into the lower mantle (Farallon, Cocos, Mariana). The 660 km (410 mi) boundary is the most important dynamic interface in the mantle for controlling whole-mantle vs layered convection.',
            color: BRAND.amethyst,
          },
          {
            id: 'lower-mantle-slab',
            label: 'Lower Mantle Slab: Cold Curtain to the CMB',
            description: 'Slabs that penetrate 660 km (410 mi) sink slowly through the lower mantle at ~1–2 cm/yr (limited by high viscosity). They remain coherent, cold anomalies for tens of millions of years before thermally equilibrating with the surrounding mantle. The Farallon slab, subducted from ~170 to ~30 Ma and now resting at ~2,800 km (1740 mi) depth under eastern North America, is the most dramatic example. In global P-wave tomography, it appears as a blue curtain extending the full depth of the mantle — a geological snapshot of 170 Ma of subduction history preserved in the cold interior of the lower mantle.',
            color: BRAND.jade,
          },
          {
            id: 'cmb-plume-origin',
        ...
        edges: [
          ...
          { from: 'subduction-zone',      to: 'transition-zone-660', label: 'slab sinks through upper mantle (fast anomaly +1 to +3% dVp), encounters 660 km (410 mi) barrier: negative Clapeyron slope + viscosity jump' },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'The Farallon slab is significant because it is the only slab that penetrates through 660 km (410 mi); all other subducted slabs stagnate at the transition zone, providing strong evidence for layered convection that is occasionally punctuated by slab avalanches',
            'The Farallon slab image is significant because it shows subducted oceanic material as a coherent fast anomaly from ~100 km (62 mi) depth to ~2,800 km (the CMB) beneath North America — spanning the entire mantle depth — demonstrating that mass exchange between the upper and lower mantle does occur, and that at least this slab has undergone whole-mantle convection; this is direct evidence against a rigid chemical boundary at 660 km (410 mi) and supports models in which mantle convection is at least partly whole-mantle in character',
            ...
            'The Farallon image is scientifically significant because it proves that the Farallon plate was subducted in the last 5 Ma and is still in the upper mantle — the image shows material that has not yet sunk below 660 km (410 mi), meaning the 660 is an absolute barrier and subducted material cannot penetrate it',
          ],
          correct: 1,
          explain: 'The layered-mantle convection model, which was influential through the 1980s, proposed that the 660 km (410 mi) discontinuity acts as a near-impermeable boundary between two separately convecting shells: the upper mantle (above 660 km (410 mi)) and the lower mantle (below 660 km (410 mi)). This model was supported by geochemical arguments (distinct noble gas and isotope signatures in MORB vs ocean island basalts, suggesting separate reservoirs) and by the impeding effect of the negative Clapeyron slope at 660 km (410 mi). The Farallon slab image is a decisive argument against a rigid layered-mantle model: the fast anomaly spans from the shallow upper mantle all the way to the CMB as a single coherent feature. The Farallon plate subducted primarily from ~170 to ~30 Ma; if the 660 were impermeable, the slab material would have had to pile up at 660 km (410 mi) for 140 Ma — but no such enormous accumulation is seen at 660 km (410 mi) beneath North America. Instead, the coherent slab has sunk through 660 km (410 mi) and reached the CMB, demonstrating that mass transfer across 660 km (410 mi) does occur. Modern consensus acknowledges that some slabs stagnate at 660 km (410 mi) while others penetrate, but the Farallon image is the strongest single piece of evidence for at least partial whole-mantle convection. Option A is incorrect — many slabs penetrate 660 km (Farallon, Cocos, Mariana, ancient Tethyan slabs), and stagnation is the exception rather than the rule for the whole-mantle debate. Option C is possible in principle but is not the scientific interpretation — the geometry, continuity, and scale of the anomaly match predictions for subducted Farallon lithosphere far better than any alternative. Option D contradicts the observation — the Farallon plate was subducted from 170 to 30 Ma; material subducted 30 Ma ago has had time to sink thousands of kilometres.',
        },
        {
          ...
          a: [
            ...
            'Anderson argues that the mantle is entirely molten below 660 km (410 mi) and that "plumes" are simply vertical conduits through this magma ocean that passively feed surface volcanism; he is challenged by PREM, which shows that shear waves do propagate through the lower mantle (proving it is solid) and that Vs increases steadily with depth',
        ...
        },
        {
          ...
          a: [
            ...
            'The key factors are the competition between the slab\'s negative buoyancy (driving penetration) and the resistance at 660 km (410 mi) from the negative Clapeyron slope (which creates anomalous positive buoyancy in the cold slab material at that depth) and the mantle viscosity increase (which dramatically slows sinking into the lower mantle); slabs with faster subduction rates, older and denser ages, and steeper dip angles are more likely to penetrate, while slower, younger, or flat-lying slabs are more susceptible to stagnation; trench retreat (rollback) also promotes horizontal slab flattening',
        ...
        },
        {
          ...
          a: [
            ...
            'Ocean-bottom seismometers are necessary to detect the core-mantle boundary reflections (ScS and PcP phases) that are the only seismic phases sensitive to plume structure below 200 km (124 mi); surface-based seismometers cannot record these deep-sampling phases because they arrive at angles too steep for surface stations to detect',
          ],
          correct: 1,
          explain: 'This question highlights the resolution limitation that is central to plume tomography. Global body-wave tomography models have horizontal resolution of ~300–500 km (311 mi) in well-sampled continental regions and ~500–1,000 km (621 mi) in oceanic regions where station coverage is sparse. A plume conduit in the lower mantle is expected to be ~100–200 km (124 mi) in diameter based on fluid dynamics calculations. Even in the best-sampled continental regions, global models would see a 150 km (93 mi) diameter plume conduit as a broadened, amplitude-reduced anomaly; in the poorly covered central Pacific beneath Hawaii, it might be entirely missed. A regional ocean-bottom seismometer (OBS) array deployed around Hawaii addresses both problems. First, station spacing of 50–150 km (93 mi) provides the geometric aperture to resolve features at the 100 km (62 mi) scale. Second, the OBS stations are positioned directly above and beside the plume volume, providing dense ray coverage from many azimuthal directions — the critical ingredient for tomographic resolution. Third, by analysing waveforms from many teleseismic earthquakes using all available ray paths through the local volume, the inversion has far more constraints per unit volume than global models. Wolfe et al. (2009) used this approach to image a slow anomaly beneath Hawaii extending to at least 1,500 km (932 mi) depth — the deepest imaging of the Hawaiian plume and a significant contribution to the plume existence debate. Option A is incorrect — while ocean coverage does limit global models, terrestrial stations worldwide do record seismic waves that sample beneath Hawaii; the issue is resolution, not absence of data. Option C describes a non-existent "plume tremor" — no such special low-frequency signal unique to plumes is known. Option D incorrectly states that surface seismometers cannot record core-interacting phases; ScS and PcP are routinely recorded at global surface stations.',
        },
      ],
    },
  ],
