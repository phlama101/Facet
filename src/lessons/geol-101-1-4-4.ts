...
**Module 1.4 — complete.** This lesson closes Module 1.4. You now have a complete framework for plate tectonics: the theory and its evidence (1.4.1), the three boundary types (1.4.2), the mechanics of subduction and mountain building (1.4.3), and intraplate volcanism from mantle plumes (1.4.4). Module 1.5 will apply this framework at the landscape scale — reading the surface features of Earth as products of the tectonic, volcanic, and erosional processes you now understand.`,
      cards: [
        {
          name: 'Mantle Plumes',
          icon: Flame,
