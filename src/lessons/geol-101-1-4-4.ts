...
const hotspotsAndPlumes: Lesson = {
  ...
  duration: '13 min',
  xpReward: 150,
  description: "Kīlauea sits 3,200 km (1988 mi) from the nearest plate boundary. The Hawaiian Islands grow older to the northwest like a timestamp trail — each island the frozen record of a plate moving over a fixed heat source in the mantle.",
  sources: [
...
That heat source is a **mantle plume** — a narrow column of anomalously hot rock rising from deep in the mantle, generating magma through decompression melting as it ascends. The plume is approximately stationary; the Pacific Plate moves over it. Each time the plate carries an active volcanic edifice away from the plume, a new volcano begins to form above the fixed heat source. The old volcano is cut off from its magma supply, becomes dormant, is eroded by waves, and eventually subsides below sea level as the ocean floor cools and contracts — becoming a seamount. The Hawaiian-Emperor seamount chain is simultaneously a trail of the Pacific Plate's history and a clock recording the age of every piece of ocean floor that passed over the plume.`,
      keyTerms: [
        ...
        {
          term: 'Mantle plume',
          def: "A narrow, buoyant upwelling of anomalously hot mantle rock, possibly originating at the core-mantle boundary (~2,900 km (1802 mi) depth). As the plume rises and pressure decreases, the rock undergoes decompression melting, generating basaltic magma that erupts through the overlying lithospheric plate.",
        },
        {
          term: 'Seamount chain',
...
**Flood basalts — plume heads arriving.** When a mantle plume first arrives at the base of the lithosphere, its head is enormous — potentially 1,000 km (621 mi) across — and has been heating and expanding for millions of years during its ascent. The initial eruption of this plume head produces a **flood basalt** or **Large Igneous Province (LIP)**: a catastrophic outpouring of basaltic lava that covers hundreds of thousands to millions of square kilometres in geologically brief time (1–3 million years). The **Deccan Traps** of India — 2 million km² (772,200 sq mi) of basalt, erupted around 66 million years ago — coincide with the arrival of the plume that now underlies Réunion Island in the Indian Ocean. The **Columbia River Basalt** of the Pacific Northwest — erupted 17–6 million years ago — marks the arrival of the Yellowstone plume head, before the North American Plate's westward motion carried the continent over the narrowing plume tail that now feeds Yellowstone. After the catastrophic plume-head eruption, the magma supply settles into the more modest, sustained output of the plume tail — the source of the ongoing hotspot chain.`,
      cards: [
        ...
        },
        {
          ...
          icon: Waves,
          color: BRAND.accent,
          desc: "Fixed plume + moving plate = age-progressive trail. Hawaiian chain: Big Island active now → Maui ~1 Ma → Oʻahu ~3 Ma → Kauaʻi ~5 Ma → seamounts to ~80 Ma. Distance ÷ age = plate speed (~9 cm/yr (3.5 in/yr) for Pacific Plate). Emperor Seamount Chain bends 60° at ~50 Ma: records abrupt shift in Pacific Plate motion direction. Iceland sits on Mid-Atlantic Ridge + hotspot → double heat source → 30 km (19 mi) thick crust → island above sea level on otherwise submerged ridge.",
          examples: 'Hawaiian chain: 9 cm/yr (3.5 in/yr) NW · Emperor bend: 50 Ma motion change · Iceland: ridge + hotspot · Galápagos: active spreading centre nearby',
        },
        {
          ...
          examples: 'Yellowstone caldera: 72×55 km (34 mi) · Snake River Plain: hotspot trail · Deccan Traps: 2M km² · Columbia River Basalt: 17 Ma LIP',
        },
      ],
    },
    {
      ...
      questions: [
        {
          q: "The Hawaiian Islands form a chain in which the Big Island is volcanically active today while Kauaʻi, 550 km (342 mi) to the northwest, is geologically extinct and ~5 million years old. Beyond Kauaʻi, a chain of seamounts extends thousands of kilometres further northwest with ages up to ~80 million years. What process produces this age-progressive pattern?",
          a: [
        ...
        },
        {
          ...
          a: [
            ...
            "The Hawaiian plume rises beneath thin oceanic crust (~7 km (4.3 mi)) and erupts basaltic magma directly with little crustal interaction; the Yellowstone plume rises beneath thick continental crust (~40 km (25 mi)) and its basaltic magma heats and partially melts the surrounding silica-rich continental rock, producing rhyolitic magma that is far more viscous and erupts explosively",
        ...
        {
          q: "The Deccan Traps of India cover approximately 2 million km² (772,200 sq mi) with basalt up to 2 km (1.2 mi) thick and erupted around 66 million years ago — coinciding with the end-Cretaceous mass extinction. What process produced this enormous volume of basalt in such a geologically short time, and what distinguishes this type of volcanism from ordinary hotspot chain volcanism?",
          a: [
