...
Module 1.5 applies the tools of Modules 1.1–1.4 to the visible landscape. This lesson maps the five major volcanic landform types to their magma compositions and tectonic settings. Lessons 1.5.2–1.5.4 will extend this approach to the erosional, fluvial, and glacial landscapes that shape Earth's non-volcanic surface.`,
      keyTerms: [
        ...
        {
          term: 'Cinder cone',
          def: "A small, steep-sided volcanic cone built entirely from pyroclastic fragments (cinders, scoria, lapilli) ejected from a single vent. Typically forms in a single eruptive episode lasting weeks to years. Rarely exceeds 300 m height. The simplest and most common volcanic landform. Examples: Parícutin (Mexico, grew 424 m in 9 years), Sunset Crater (Arizona).",
        },
        {
          term: 'Caldera',
          def: "A large, roughly circular depression formed by the collapse of a volcanic edifice into a partially emptied magma chamber. Distinguished from a crater (which forms by explosion) by its origin through subsidence. Calderas range from 1 km to over 100 km across. Examples: Crater Lake (Oregon, 10 km), Yellowstone (72×55 km), Campi Flegrei (Italy).",
        },
        {
          term: 'Lava plateau',
...
**Reading compound volcanic landscapes.** Real volcanic regions rarely contain just one landform type. The Cascade Range contains stratovolcanoes (Mt. Rainier, Mt. Hood, Mt. Shasta), lava fields, cinder cone clusters, and the caldera of Crater Lake — all reflecting different phases and locations of subduction-zone magmatism. The Snake River Plain is a lava plateau (basalt fissure eruptions) dotted with cinder cones, produced by the Yellowstone plume as the North American Plate moved over it. Iceland combines shield volcanoes (Skjaldbreiður), fissure systems (Laki, which erupted in 1783 and killed a quarter of Iceland's population through famine and fluorine poisoning), and the emergent mid-ocean ridge. Reading a volcanic landscape means identifying each feature type, inferring the magma composition that built it, and reconstructing the tectonic history that placed that magma source there.`,
      cards: [
        {
          ...
          icon: Flame,
          color: BRAND.ruby,
          desc: "Low-silica basalt → low viscosity → lava flows far from vent → gentle slopes. Shield volcanoes: slopes 2–10°, enormous volume. Mauna Loa: 75,000 km³, 9 km from seafloor — tallest mountain on Earth from base to summit. Kīlauea: near-continuous eruption through rift zones. Lava plateaus: fissure eruptions flood hundreds of thousands of km². Columbia River Basalt: 210,000 km², up to 3.5 km thick, flows 600 km from vent. Iceland's interior: active fissure fields, 1/3 of Earth's recent surface lava.",
          examples: 'Mauna Loa: largest volcano by volume · Kīlauea: near-continuous · Columbia River Basalt: 210,000 km² · Laki 1783: fissure eruption',
        },
        {
          name: 'Explosive Landforms',
          icon: Mountain,
          color: BRAND.coral,
          desc: "High-silica andesite/rhyolite → high viscosity → gas trapped → explosive. Stratovolcanoes: steep cones (25–35°), alternating lava + pyroclastic layers, most iconic volcano shape. Fuji, Rainier, St. Helens (1980 eruption removed 400 m from summit), Pinatubo, Vesuvius. Cinder cones: monogenetic, form in days-years, slopes ~33°. Parícutin: grew 424 m from a cornfield in 1943. Calderas: collapse into emptied magma chamber — not explosion holes. Crater Lake: 10 km, 7,700 BP. Yellowstone: 72×55 km, last eruption 640 Ka.",
          examples: 'Mt. St. Helens: 1980 lateral blast · Parícutin: new cone 1943 · Crater Lake: caldera collapse · Yellowstone: 72×55 km caldera',
        },
        {
    ...
    },
    {
      ...
      questions: [
        {
          q: "Mauna Loa (Hawaii) has slopes of approximately 5° and a volume of ~75,000 km³. Mt. St. Helens (Washington) has slopes of ~30° and is dramatically smaller. What accounts for this fundamental difference in volcanic shape?",
          a: [
        ...
        {
          q: "Crater Lake in Oregon occupies a circular depression ~10 km across and ~600 m deep. It formed approximately 7,700 years ago when the ancient volcano Mt. Mazama underwent a major eruption. What process specifically created the depression, and why is it called a caldera rather than a crater?",
          a: [
            "The eruption of Mt. Mazama was so large and explosive that it blasted away the top of the volcano, excavating the circular depression by force; it is called a caldera rather than a crater because of its exceptional size — calderas are defined as explosion holes larger than 1 km",
        ...
        {
          q: "Mt. St. Helens erupted catastrophically on 18 May 1980, when a magnitude 5.1 earthquake triggered the collapse of the volcano's north flank. The collapse was immediately followed by a lateral blast that devastated 600 km² of forest and removed 400 m from the summit. Why did the flank collapse trigger such a violent eruption, and what does this mechanism reveal about the nature of silica-rich magma?",
          a: [
