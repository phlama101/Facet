...
**Surge glaciers** are a distinct class: glaciers that periodically shift from slow creep to catastrophically rapid flow (100–1,000× normal velocity), typically due to a build-up and sudden release of meltwater at the glacier base that hydroplanes the glacier on a pressurised water layer. Surge behaviour is not directly caused by climate change but surging glaciers create hazards through rapid advance, ice dam formation, and altered meltwater routing. Their distribution — concentrated in Svalbard, Alaska, the Karakoram, and Iceland — helps define where ice-dam GLOFs are possible.`,
      ...
      cards: [
        {
          ...
          examples: '2013 Kedarnath (India): moraine-dammed lake above Chorabari Glacier, combined with extreme monsoon rainfall, triggered a debris flow killing 5,748+ people. Imja Lake (Nepal): one of the fastest-growing glacial lakes in the Himalayas, dammed by a moraine ~30 m (98 ft) high; volume reached ~100 million m³ by 2016; subject of an international GLOF risk reduction engineering project that lowered the lake level by ~3.4 m (11 ft) in 2016. Dig Tsho (Nepal, 1985): moraine dam failure released 5 million m³ of water and debris, killing 5 people and destroying the nearly-completed Namche Hydropower Project in minutes.',
        },
        {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'The GLOF scours valley sides, removes bridges, destroys settlements and infrastructure, and deposits massive debris fans. The 2013 Kedarnath GLOF killed 5,748+ people. Valleys can be reshaped in hours. Risk is highest within 50–100 km (31–62 mi) of the lake source.',
            color: BRAND.ruby,
          },
          {
            id: 'early-warning',
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'The 2002 Kolka–Karmadon ice-rock avalanche in Russia killed approximately 140 people and travelled 19 km (12 mi) down the Genaldon valley. What combination of factors made this event so much more destructive than a typical glacier calving or serac collapse?',
          a: [
            ...
            'A combination of factors amplified the destruction: the detachment included not just glacier ice but a large rock slope failure from ~4,500 m (14,764 ft), which entrained the entire Kolka Glacier (not just a serac); the combined ice-rock mass had enormous momentum and low friction on the steep valley floor; the event transformed into a hyperconcentrated flow that maintained high velocity over 19 km (12 mi); the speed (~180 km/h (112 mph)) meant there was effectively no warning time for valley inhabitants',
