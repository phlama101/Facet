    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          examples: 'Atlantic CCD: ~4,500 m (14,764 ft) · Pacific CCD: ~3,500 m (11,484 ft) (more corrosive deep water) · CCD during Last Glacial Maximum: ~500 m (1,640 ft) deeper in some basins, reflecting higher deep-ocean carbonate ion concentrations · Benthic foraminifera dissolve below the lysocline, biasing the fossil record',
        },
        {
    ...
    },
    {
      ...
      interaction: {
        ...
        edges: [
          ...
          { from: 'sinking-particles', to: 'remineralization',    label: 'Bacterial decomposition removes ~90–99% of flux in upper 1,000 m (3,281 ft)' },
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          correct: 1,
          explain: `Carbon does not sink by gravity (A) — CO₂ and its ionic forms are dissolved in solution, not settling as particles; the relevant physics is chemical equilibrium and ocean circulation, not particle settling. Deep-sea photosynthesis (C) does not occur because there is no sunlight below the photic zone (~200 m (656 ft)), let alone at 1,000–4,000 m (3,281–13,124 ft) depth. The ocean surface is not a one-way valve (D) — gas exchange across the air-sea interface is reversible; upwelling regions are net sources of CO₂ to the atmosphere. The correct answer is B: the ocean\'s vastly greater carbon storage capacity relative to the atmosphere rests on two pillars. First, volume: the ocean\'s mean depth is ~3,700 m (12,140 ft) and its total volume is ~1.335 × 10⁹ km³; even at the same carbon concentration as the atmosphere, the ocean would hold more total carbon. Second, and more importantly, seawater chemistry: dissolved CO₂ reacts with water to form H₂CO₃, which dissociates to HCO₃⁻ and CO₃²⁻; this speciation means the total DIC in solution is ~100–200× the concentration of dissolved CO₂ alone, vastly increasing the ocean\'s capacity to absorb and store carbon relative to the partial pressure of CO₂ in air. The isolation of deep water from the atmosphere by thermohaline circulation residence times of centuries to a millennium means this stored carbon cannot return to the atmosphere on human timescales without deliberate disruption.`,
        },
        {
