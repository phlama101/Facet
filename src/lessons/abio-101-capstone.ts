    ...
    },
    {
      ...
      questions: [
        ...
        // Q5 — correct: 3
        {
          ...
          a: [
            '50–70 °C (158°F); they inhabit hot springs and geothermal soils at continental volcanic fields',
            '40–60 °C (140°F); they are dominant microorganisms in industrial composting heaps and thermophilic anaerobic digesters',
            '100–150 °C (302°F); they require superheated supercritical water and cannot reproduce below 100 °C (212°F) at any pressure',
            '80–121 °C (250°F); they are found at deep-sea hydrothermal vents and can survive brief autoclaving temperatures that sterilise standard lab equipment',
          ],
          correct: 3,
          explain: 'Hyperthermophiles are microorganisms with optimal growth temperatures above 80 °C (176°F). Pyrolobus fumarii, an archaeon first isolated from hydrothermal vent chimney walls on the Mid-Atlantic Ridge by Blöchl et al. (1997), grows optimally at 106 °C (223°F) and can tolerate temperatures up to 121 °C (250°F) — the standard autoclaving temperature used to sterilise laboratory equipment. It cannot grow below 90 °C (194°F). These organisms thrive in deep-sea black smoker environments where superheated water (up to 400 °C (752°F) at the vent orifice) mixes with cold seawater (~2 °C (36°F)), creating steep thermal gradients across centimetres. Their discovery dramatically expanded the known temperature limits of life and reinforced the plausibility of microbial habitats in high-temperature subsurface environments on other worlds, particularly within hydrothermal systems beneath the icy shells of Europa and Enceladus.',
        },
        // Q6 — correct: 0
        {
        ...
        // Q15 — correct: 1
        {
          ...
          a: [
            ...
            'The inner edge is the distance at which surface temperature exceeds 100 °C (212°F) at standard atmospheric pressure, causing oceans to boil',
          ],
          correct: 1,
