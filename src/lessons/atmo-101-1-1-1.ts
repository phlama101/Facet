...
• **The ionosphere makes long-distance radio and auroras possible**: Solar radiation strips electrons from gas molecules in the thermosphere, creating a conductive plasma layer that reflects AM radio waves back to Earth and glows green and red when charged solar particles collide with oxygen and nitrogen at 100–300 km altitude.`,
    },
    {
      ...
      questions: [
        ...
        {
          q: "Noctilucent clouds (NLCs) are rare, luminous clouds visible near the poles on summer nights, long after the sun has set below the horizon. They form at approximately 82 km altitude — in the mesosphere — at temperatures near −90°C. What makes NLCs unique compared to all other cloud types, and why do they form specifically at the mesopause during polar summer?",
          a: [
            ...
            "NLCs are the highest clouds in Earth's atmosphere, forming at ~82 km in the mesosphere — far above all tropospheric and stratospheric clouds; they are composed of ice crystals nucleated on meteoric smoke particles; the mesopause in polar summer is paradoxically the coldest point in the entire atmosphere (~−90°C), because rising air in the polar mesosphere expands and cools adiabatically; this extreme cold is the only place in the atmosphere where the trace amounts of water vapour present at that altitude can condense and freeze",
            "NLCs form at the mesopause because the thin air at 82 km allows rapid molecular diffusion; water molecules produced by methane oxidation diffuse upward from the stratosphere and concentrate at the mesopause due to a temperature inversion; during polar summer, increased UV radiation oxidises more stratospheric methane, providing additional water vapour for NLC formation",
