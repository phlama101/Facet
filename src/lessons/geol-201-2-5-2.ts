...
Every fold, every fault, every slickenlined surface you find in the field is a record of a force applied to rock at a particular depth, temperature, and rate. Understanding that record — reading the structures to infer the forces — is the core of structural geology. A fault that slipped metres in seconds records brittle failure near the surface; a gently curved fold that once lay 20 km underground records ductile flow of rock over millions of years. Same rock, different conditions — entirely different structures.`,
      keyTerms: [
        ...
        },
        {
          ...
          def: 'Rock deformation by continuous flow without macroscopic fracture, like very stiff putty. Occurs at depth (high confining pressure), high temperatures (typically >300°C for quartz-rich crust), and/or slow strain rates. Results in folds, foliation, and mylonite. The brittle–ductile transition in continental crust occurs at roughly 15–20 km depth under typical geothermal gradients.',
        },
        {
          term: 'fold',
...
**Brittle vs. ductile deformation.** At shallow depths (low confining pressure), low temperatures, and high strain rates, rock responds to stress by fracturing — *brittle deformation*, producing faults and joints. At depth (high confining pressure), high temperatures (>~300°C for quartz-dominated crust), and slow strain rates, rock flows continuously without fracturing — *ductile deformation*, producing folds and foliation. The brittle-to-ductile transition is not a sharp boundary but occurs at roughly 15–20 km depth in typical continental crust. The same quartz-sandstone that fractures at the surface can fold at depth; the conditions, not the rock type alone, determine the deformation style.
      ...
      cards: [
        {
          ...
          examples: 'San Andreas Fault (California): dextral strike-slip; ~6 cm/yr relative motion; cumulative offset ~315 km since ~18 Ma; offset stream channels (Wallace Creek offset ~130 m) are a textbook example of marker offsets defining fault kinematics · Heart Mountain detachment (Wyoming): one of the largest known sub-horizontal thrusts; ~50 km of transport; Paleozoic carbonates emplaced over younger Eocene volcanic rocks · East African Rift System: active normal fault system producing Lake Tanganyika graben (1,470 m deep — deepest African lake); fault scarps on west shore reach 1,000 m in height',
        },
      ],
    },
    {
      ...
      questions: [
        {
          ...
          a: [
            ...
            'Brittle deformation occurs at shallow crustal depths (low confining pressure), low temperatures, and/or high strain rates, and produces faults and joints. Ductile deformation occurs at depth (high confining pressure, temperatures typically >~300°C for quartz-dominated crust), and/or slow strain rates, and produces folds and foliation. The same rock can behave brittlely near the surface and ductilely at depth; the deformation mode is controlled by conditions, not solely by rock type',
