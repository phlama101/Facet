...
This lesson introduces the two settings where metamorphism occurs, the key textural feature — **foliation** — that distinguishes most metamorphic rocks in the field, the sequence of rock types produced as metamorphic intensity increases, and the common metamorphic rocks you are most likely to encounter. With this lesson, Module 1.3 is complete: you now have the vocabulary for all three rock families. Module 1.4 will show how plate tectonics controls where in the rock cycle rocks currently sit.`,
      keyTerms: [
        {
          term: 'Metamorphism',
