      ...
      cards: [
        {
          ...
          icon: Flame,
          color: BRAND.ruby,
          desc: '252 Ma; ~4×10⁶ km³; emplaced in <1 Ma. Killed 96% of marine species. SO₂ → sulfate aerosols → acid rain and volcanic cooling. CO₂ → 5–10°C (9–18°F) warming, ocean acidification. Sill intrusion into coal and evaporites amplified volatile release far beyond magmatic budget. Strangelove Ocean: photosynthetic collapse, 4–5 Ma recovery.',
        ...
        },
        {
          ...
          examples: 'Deccan Traps, Western India — ~1.1×10⁶ km³, stacked basalt flows up to 2 km (1.2 mi) thick · Chicxulub crater, Yucatán — 66.043 ± 0.011 Ma (Renne et al. 2013) · Hell Creek Formation (USA) — K-Pg boundary record in continental sediments · Seismic triggering of post-impact Deccan pulse — Richards et al. 2015',
        },
        {
          ...
          examples: 'CAMP basalts: Morocco, Nova Scotia, Brazil, Iberia — 201 Ma, LIP of Pangaea breakup · Triassic-Jurassic boundary sections, Kennecott Point (Canada) — Hg anomaly and δ¹³C excursion · Karoo-Ferrar (183 Ma) — Toarcian OAE, marine anoxia, North Sea oil source rocks · Columbia River Basalts (15–17 Ma) — ~210,000 km³ (50379 cu mi), most recent major flood basalt; no associated mass extinction',
        },
        {
          name: 'Volatile Emissions & Kill Mechanisms',
          icon: Thermometer,
          color: BRAND.gold,
          desc: 'SO₂ degassing (petrological method + ice-core analogy): short-term cooling, acid rain, ozone destruction. CO₂: long-term warming 5–10°C (9–18°F), ocean acidification (pH drop 0.3–0.7 units). Competing signals: volcanic winter (SO₂) vs. greenhouse (CO₂) on different timescales. Sill-induced thermogenic CO₂ can exceed magmatic budget 5–10×. Mercury proxy: Hg/TOC spikes fingerprint LIP activity in distal sediments.',
          examples: 'Siberian Traps SO₂ estimate: 30,000–40,000 Gt SO₂ over <1 Ma (Black et al. 2012) · Deccan CO₂: ~1.5×10¹⁷ g CO₂ emitted (Self et al. 2006 petrological estimate) · Laki 1783 (Iceland): 14 km³ (3.4 cu mi) basalt, 120 Mt SO₂ — short-term analogue for single flood basalt pulse · Columbia River Basalts ice-core analogue: each eruption pulse estimated at 300–1,000 Mt SO₂',
        },
      ],
    },
    {
        ...
        nodes: [
          {
            ...
            description: 'A large, anomalously hot mantle plume head (1,400–1,600°C (2912°F)) impinges on the base of the lithosphere. Decompression melting generates enormous volumes of basaltic melt — potentially 10⁶–10⁷ km³ over 1–5 Ma. The plume head flattens and spreads laterally beneath the lithosphere, feeding multiple fissure eruption centres simultaneously. Plume head arrival is often associated with domal uplift (up to 1–2 km (1.2 mi)) of the overlying crust before eruption begins, preserved in pre-LIP stratigraphy as an erosional unconformity.',
            color: BRAND.ruby,
          },
          {
            id: 'eruption',
            label: 'Fissure Eruption Pulses',
            description: 'Low-viscosity basaltic magma erupts from fissure swarms — linear fractures extending hundreds of kilometres — as high-effusion-rate lava floods. Individual flow pulses last years to decades and produce sheet flows 10–100 m (328 ft) thick and 10,000–100,000 km² (38610 sq mi) in area. Individual flow volumes up to 2,000 km³ (480 cu mi) have been documented in the Columbia River Basalts. Intrusive equivalents (dykes, sills) simultaneously invade the host crust and — critically — country rocks rich in organic carbon, coal, or evaporites, triggering thermogenic volatile release at volumes far exceeding the magmatic degassing budget alone.',
            color: BRAND.coral,
          },
          {
            id: 'volatiles',
      ...
      questions: [
        {
          ...
          a: [
            ...
            'SO₂ injected into the atmosphere has an atmospheric residence time of only 1–3 years before it is oxidised to sulfate aerosol, washed out as acid rain, and removed from the climate system; each SO₂ pulse therefore produces a short, sharp cooling event (1–5°C (2–9°F), decades timescale) followed by recovery; CO₂, by contrast, has an atmospheric residence time of thousands to hundreds of thousands of years, so repeated pulses accumulate in the atmosphere and drive sustained long-term warming; it is the cumulative, multi-million-year CO₂ load — not the short SO₂ pulses — that creates the prolonged environmental stress sufficient to cause a mass extinction',
