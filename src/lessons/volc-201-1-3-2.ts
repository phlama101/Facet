      ...
      cards: [
        {
          ...
          icon: Flame,
          color: BRAND.ruby,
          desc: '252 Ma; ~4×10⁶ km³; emplaced in <1 Ma. Killed 96% of marine species. SO₂ → sulfate aerosols → acid rain and volcanic cooling. CO₂ → 5–10°C (50°F) warming, ocean acidification. Sill intrusion into coal and evaporites amplified volatile release far beyond magmatic budget. Strangelove Ocean: photosynthetic collapse, 4–5 Ma recovery.',
      ...
      questions: [
        {
          ...
          a: [
            ...
            'SO₂ injected into the atmosphere has an atmospheric residence time of only 1–3 years before it is oxidised to sulfate aerosol, washed out as acid rain, and removed from the climate system; each SO₂ pulse therefore produces a short, sharp cooling event (1–5°C (41°F), decades timescale) followed by recovery; CO₂, by contrast, has an atmospheric residence time of thousands to hundreds of thousands of years, so repeated pulses accumulate in the atmosphere and drive sustained long-term warming; it is the cumulative, multi-million-year CO₂ load — not the short SO₂ pulses — that creates the prolonged environmental stress sufficient to cause a mass extinction',
