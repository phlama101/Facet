...
The most dramatic of these boundaries are controlled not by composition alone but by changes in physical state. At the CMB, chemically the mantle above and the core below are utterly different materials (silicate rock vs iron metal), and the S-wave velocity dropping to zero unambiguously confirms the outer core is liquid. At the ICB, the pressure becomes high enough that iron solidifies despite the extreme temperature (~5,400 K) — the melting point of iron rises steeply with pressure, and at 330 GPa the solid inner core is thermodynamically stable. The transition zone discontinuities at 410 and 660 km (410 mi) are subtler: the composition stays the same (olivine-dominated peridotite), but the crystal structure reorganises into progressively denser polymorphs under increasing pressure, each reorganisation increasing both bulk modulus and density and thus boosting seismic velocity in a step-wise fashion visible globally on seismograms.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          {
            id: 'crust',
            label: 'Crust (0–35 km (22 mi) continental / 0–7 km (4.3 mi) oceanic)',
            description: 'P-wave velocity 5.5-6.5 km/s; S-wave velocity 3.2-3.8 km/s. Continental crust is 25-70 km (43 mi) thick, composed of granitic to metamorphic rocks; oceanic crust is 5-7 km (4.3 mi) thick, composed of basalt and gabbro. The Moho marks the base of the crust everywhere on Earth. Oldest continental crust ~4.0 Ga (Acasta Gneiss, Canada). Density ~2.7-3.0 g/cm³ — far lower than the mantle below, which is why continents float high and ocean floors sit deep.',
            color: BRAND.coral,
          },
          {
            id: 'upper-mantle',
            label: 'Upper Mantle + Asthenosphere (35–410 km (255 mi))',
            description: 'Peridotite composition (olivine + pyroxene + garnet). P-wave velocity ~8.0-9.5 km/s; S-wave velocity ~4.4-5.0 km/s. The asthenosphere (low-velocity zone, ~80-200 km (124 mi) depth) is slightly partially molten and mechanically weak, enabling tectonic plate motion above it. Seismic anisotropy from flow-aligned olivine crystals records present and ancient mantle flow directions. Lithospheric mantle above the asthenosphere is cold, rigid, and moves with the overlying crust as a single tectonic plate.',
            color: BRAND.gold,
          },
          {
            id: 'transition-zone',
            label: 'Transition Zone (410–660 km (410 mi))',
            description: 'Dominated by olivine phase transitions that increase mineral density without changing bulk composition. The 410 km (255 mi) discontinuity marks olivine converting to the denser wadsleyite polymorph; the 660 km (410 mi) discontinuity marks ringwoodite breaking down to bridgmanite + ferropericlase + calcium perovskite. Each step increases density by ~3-7% and P-wave velocity correspondingly. Acts as a partial barrier to mantle convection; subducted slabs appear as cold fast anomalies that pool temporarily at 660 km (410 mi) before some penetrate into the lower mantle.',
            color: BRAND.amethyst,
          },
          {
            id: 'lower-mantle',
            label: 'Lower Mantle (660–2891 km (1796 mi))',
          ...
          {
            id: 'outer-core',
            label: 'Outer Core (2891–5150 km (3200 mi)) — Liquid',
          ...
          {
            id: 'inner-core',
            label: 'Inner Core (5150–6371 km (3959 mi)) — Solid',
        ...
        edges: [
          { from: 'crust',          to: 'upper-mantle',   label: 'Moho: P-velocity jumps ~6.5→8.0 km/s; base of crust; 35 km (22 mi) continental, 7 km (4.3 mi) oceanic' },
          { from: 'upper-mantle',   to: 'transition-zone', label: '410 km (255 mi) discontinuity: olivine→wadsleyite phase transition; ~3% velocity and density increase' },
          { from: 'transition-zone', to: 'lower-mantle',  label: '660 km (410 mi) discontinuity: ringwoodite→bridgmanite; largest mantle discontinuity; acts as partial barrier to convection' },
          { from: 'lower-mantle',   to: 'outer-core',     label: 'CMB at 2891 km (1796 mi): P-velocity 13.7→8.1 km/s (decrease); S-velocity 7.3→0; liquid outer core begins; Gutenberg discontinuity' },
          { from: 'outer-core',     to: 'inner-core',     label: 'ICB at 5150 km (3200 mi): P-velocity increases 10.4→11.0 km/s; S-velocity reappears (~3.5 km/s); solid inner core; Lehmann discontinuity' },
    ...
    },
    {
      ...
      questions: [
        {
          q: 'The olivine-to-wadsleyite phase transition at 410 km (255 mi) and the post-spinel transition at 660 km (410 mi) produce seismic discontinuities visible globally. Why do these mineralogical phase transitions produce detectable seismic velocity jumps?',
          a: [
            'Phase transitions produce jumps in both density (ρ) and elastic moduli (K and μ) because the crystal structure and atomic packing change: wadsleyite has a denser crystal structure than olivine (~3% higher density at 410 km (255 mi)) with stronger atomic bonds, increasing both K and μ; since P-wave velocity = √((K+4μ/3)/ρ), the moduli increase proportionally more than the density, producing a net velocity increase; the transition occurs over a narrow pressure range corresponding to ~10-20 km (12 mi) depth, producing a sharp enough boundary to reflect high-frequency waves; exothermic transitions (like 410 km (255 mi)) produce a positive Clapeyron slope — the transition depth varies with temperature, making it shallower in cold subducted slabs and deeper under hot mantle plumes',
            'Phase transitions produce velocity jumps because the chemical composition changes at the boundary: olivine (Mg₂SiO₄) is chemically converted to wadsleyite by reaction with subducting oceanic crust that introduces water, changing the Si/Mg ratio and therefore the bulk modulus; the velocity jump magnitude depends entirely on the amount of water delivered by slabs, which is why the 410 km (255 mi) discontinuity is stronger beneath subduction zones than beneath oceanic plates',
            'The velocity jumps at 410 and 660 km (410 mi) are produced by temperature discontinuities rather than phase transitions: the mantle is heated from below by the core, and convective instabilities create sharp horizontal temperature contrasts at these depths; P-wave velocity is sensitive to temperature (higher temperature lowers velocity), so the velocity jumps simply reflect a step-change in temperature at the boundary between warmer and cooler convection cells',
            'Velocity jumps at these depths are artifacts of the seismic travel-time inversion method: the PREM reference model imposes sharp boundaries at 410 and 660 km (410 mi) by construction, and tomographic models inherit these discontinuities from the reference model; actual mantle mineralogy changes continuously with depth, producing gradual velocity gradients rather than the sharp jumps seen in standard Earth models',
          ],
          correct: 0,
          explain: 'Mineralogical phase transitions produce seismic velocity jumps because they change the crystal structure of the mineral without changing its bulk chemical composition — but the new crystal structure packs atoms more tightly and bonds them more strongly, simultaneously increasing both the bulk modulus K (resistance to compression) and shear modulus μ (resistance to shearing). Since P-wave velocity = √((K + 4μ/3)/ρ) and S-wave velocity = √(μ/ρ), increases in K and μ that outpace the accompanying density increase produce net velocity increases. At the 410 km (255 mi) discontinuity, olivine (Mg₂SiO₄, orthorhombic structure) transforms to wadsleyite (also Mg₂SiO₄, but a denser modified spinel structure), increasing density by ~3% and moduli by ~5-6%, yielding a net P-velocity increase of ~3-5%. At 660 km (410 mi), ringwoodite (a spinel-structure polymorph) breaks down to bridgmanite (MgSiO₃ perovskite) + ferropericlase (MgO), a more complex transition with a ~7% density increase and a velocity jump of ~3-5%. The sharpness of these boundaries — critical for them to reflect high-frequency seismic energy — depends on the width of the two-phase coexistence region in pressure-temperature space, typically corresponding to only 5-20 km (12 mi) depth. The Clapeyron slope (dP/dT of the phase boundary) has opposite signs at the two discontinuities: positive at 410 km (olivine-wadsleyite transition is exothermic — cold slabs push the boundary shallower, hot plumes push it deeper) and negative at 660 km (ringwoodite-bridgmanite transition is endothermic — cold slabs are deflected upward by this boundary, which partially resists slab penetration into the lower mantle). This negative Clapeyron slope at 660 km (410 mi) helps explain why some subducted slabs temporarily pond at this depth before breaking through episodically, and why the 660 km (410 mi) boundary may act as an intermittent filter for mantle convection, segregating geochemical reservoirs on timescales of hundreds of millions of years.',
        },
        {
        ...
        },
        {
          ...
          a: [
            'If convection were strictly layered (upper mantle convects separately from lower mantle, separated at the 660 km (410 mi) discontinuity), then subducted slabs should pond at 660 km (410 mi) and never penetrate to the lower mantle; the clear tomographic evidence for slabs penetrating through the 660 km (410 mi) boundary into the lower mantle (e.g., Tonga slab to ~1500 km (932 mi), Farallon plate remnant at 500-1000 km (621 mi) depth under North America) proves that whole-mantle convection does occur — at least episodically; the 660 km (410 mi) boundary does impede convection (slabs sometimes pond temporarily at this depth before breaking through), but it is not an absolute barrier; this has implications for how Earth\'s mantle mixes geochemically and removes heat from the core',
            'Slab penetration through the 660 km (410 mi) discontinuity confirms strictly layered convection: in layered convection models, cold material accumulates at the 660 km (410 mi) boundary until a gravitational instability causes a catastrophic avalanche of slab material into the lower mantle; each tomographically imaged deep slab represents the aftermath of such an avalanche; between avalanches, convection is fully layered; whole-mantle convection in the strict sense never occurs because the lower mantle viscosity is 30-100× higher than the upper mantle, preventing continuous flow across the boundary',
            ...
            'Slab penetration to the CMB indicates that mantle convection is driven from the bottom by heat from the core rather than from the top by subduction; cold slabs do not sink under their own negative buoyancy but are drawn down by large-scale return flow from deep core-heated upwellings; the tomographic fast anomalies beneath subduction zones extend continuously to the CMB because they are root zones of superplumes, not subducted oceanic slabs; this bottom-driven convection model eliminates the need for any boundary at 660 km (410 mi)',
          ],
          correct: 0,
          explain: 'The debate between strictly layered mantle convection and whole-mantle convection was one of the central controversies in geodynamics for decades, and seismic tomography has largely — though not completely — resolved it in favour of whole-mantle (or at least intermittently whole-mantle) convection. In the strictly layered model, the 660 km (410 mi) discontinuity acts as an impermeable barrier: upper mantle and lower mantle circulate in separate closed cells, exchange heat by conduction across the boundary, and never mix. This model predicted that subducted slabs would pond at 660 km (410 mi), flatten along the discontinuity, and eventually be reincorporated into the upper mantle. Geochemical evidence supported the existence of distinct mantle reservoirs — mid-ocean ridge basalts (MORB) and ocean island basalts (OIB) have different isotopic compositions suggesting different source regions that have remained separated for billions of years. The whole-mantle convection model, by contrast, predicted that slabs would sink freely through 660 km (410 mi) into the lower mantle. Global seismic tomography models from the 1990s and 2000s (van der Hilst et al. 1997, Grand et al. 1997) provided compelling images of high-velocity (cold) anomalies extending continuously from subduction zones at the surface down through the 660 km (410 mi) boundary and into the lower mantle — some slabs imaged as deep as 1,500 km (Tonga-Kermadec slab) and the ancient Farallon plate remnant visible at 500-1,000 km (621 mi) depth under eastern North America. The current consensus is a mixed picture: whole-mantle convection does occur (slabs do penetrate 660 km (410 mi)), but the 660 km (410 mi) boundary does impede flow — slabs often temporarily pond or buckle at this depth before breaking through. The negative Clapeyron slope at 660 km (endothermic transition) provides a resistance force opposing slab penetration; slabs that arrive with sufficient negative buoyancy eventually break through. This picture is compatible with the two-reservoir geochemical model if geochemically distinct "blobs" (recycled oceanic crust, ancient depleted lithosphere) survive as heterogeneities in the lower mantle for billions of years without being fully homogenised by convective stirring.',
        },
        {
          ...
          a: [
            ...
            'ULVZs mark the locations of current or recent deep mantle earthquakes (deep-focus events below 660 km (410 mi)): the P-wave velocity reduction is caused by fracture damage and micro-crack porosity created by the rupture; deep mantle earthquakes occur by transformational faulting (phase transition from bridgmanite to post-perovskite) and the resulting porous shear zones maintain low velocity for millions of years after the seismic event; the correlation of ULVZs with convergent margins above supports this interpretation',
