...
const carbonBudget: Lesson = {
  ...
  duration: '13 min',
  xpReward: 130,
  description: 'Cumulative emissions, the remaining carbon budget for 1.5 °C (2.7°F) and 2 °C (3.6°F), and the implications for decarbonisation timelines',
  sources: [
  ...
  sections: [
    {
      ...
      body: `One of the most powerful — and sobering — insights in climate science is that global warming is approximately proportional to the total cumulative amount of CO₂ emitted by human activity, regardless of when those emissions occur. This relationship, known as the **Transient Climate Response to Cumulative Emissions (TCRE)**, links every tonne of CO₂ released to a predictable increment of global warming. IPCC AR6 estimates TCRE at approximately **1.65 °C (3.0°F) per 1,000 Pg CO₂** (petagrammes of carbon dioxide; 1 Pg = 1 billion tonnes (1.1 billion tons) = 1 Gt). The implication is profound: warming is not primarily a function of emission rates at any given moment but of the total stock of CO₂ accumulated in the atmosphere since industrialisation.

Since approximately 1850, human activity has released roughly **2,400 Pg CO₂** into the atmosphere — primarily through fossil fuel combustion, cement production, and land-use change. This cumulative burden, equivalent to raising atmospheric CO₂ from ~280 ppm to ~422 ppm today, has already delivered approximately 1.2–1.3 °C (2.2–2.3°F) of global mean warming above pre-industrial levels. The TCRE framework allows scientists to calculate, with quantifiable uncertainty, how much CO₂ humanity can still emit while keeping warming below a given temperature threshold — the **remaining carbon budget**.

IPCC AR6 (2021) estimates the remaining carbon budget for **1.5 °C (2.7°F)** at approximately **380 Pg CO₂** for a 50% probability of staying below that threshold, and ~500 Pg CO₂ for a 33% probability. At current global emissions of approximately **37 Pg CO₂ per year** (Global Carbon Project 2023), the 50% chance budget is consumed in roughly **10 years**; the 33% chance budget in roughly 14 years. For the **2 °C (3.6°F)** target, the remaining budget is approximately **1,150 Pg CO₂** at 50% probability — around 31 years at current rates. These numbers explain why climate scientists, policymakers, and activists alike treat the late 2020s and early 2030s as a critical window.
...
The **Paris Agreement** (2015) set the goal of limiting warming to well below 2 °C (3.6°F), pursuing efforts toward 1.5 °C (2.7°F). Parties submit **Nationally Determined Contributions (NDCs)** — voluntary national climate plans. Current NDCs, even if fully implemented, are projected to result in approximately 2.5–2.9 °C (4.5–5.2°F) of warming by 2100 — a significant gap from the 1.5 °C (2.7°F) ambition. Bridging this gap requires peak global emissions by approximately **2025** for a credible pathway to 1.5 °C (2.7°F). Delaying peak emissions by even five years dramatically narrows the technological and economic feasibility of remaining below 1.5 °C (2.7°F).
...
The **IPCC Shared Socioeconomic Pathways (SSPs)** provide a scenario framework for exploring alternative futures. **SSP1-1.9** represents aggressive mitigation consistent with 1.5 °C (2.7°F); **SSP2-4.5** a moderate mitigation pathway reaching ~2.7 °C (~4.9°F); **SSP5-8.5** a high-emissions baseline reaching ~4.4 °C (~7.9°F) by 2100. Under SSP5-8.5, global emissions do not peak until the 2050s and the carbon budget for 1.5 °C (2.7°F) is exhausted within the next decade.

Most 1.5 °C (2.7°F) scenarios require achieving **net-zero CO₂ emissions** globally by approximately **2050**, with deep reductions in non-CO₂ gases. Net zero means that any residual emissions — from hard-to-abate sectors like aviation, shipping, agriculture, and industrial processes — are balanced by active removal of CO₂ from the atmosphere through **negative emissions**. Carbon Dioxide Removal (CDR) technologies and approaches include Bioenergy with Carbon Capture and Storage (BECCS), Direct Air Capture (DAC), enhanced weathering, and natural sinks (reforestation, soil carbon). In **overshoot scenarios** — where temperature temporarily exceeds 1.5 °C (2.7°F) — large-scale CDR in the second half of the century is required to return to target, making negative emissions not merely desirable but mathematically necessary.`,
      keyTerms: [
        {
        ...
        },
        {
          ...
          def: `A country\'s self-determined climate action plan submitted to the UNFCCC under the Paris Agreement, specifying emission reduction targets and adaptation policies for approximately 5-year cycles. NDCs are updated progressively ("ratchet mechanism"). As of 2023, current unconditional NDCs combined put the world on track for ~2.5–2.9 °C (4.5–5.2°F), well above the 1.5 °C (2.7°F) target. The gap between NDC ambition and 1.5 °C (2.7°F)-compatible pathways is the central challenge of international climate diplomacy.`,
        },
        {
          term: 'SSP scenario',
          def: 'Shared Socioeconomic Pathway: a scenario framework used by IPCC AR6 combining a narrative of societal development with projected emissions. SSP1-1.9: strong sustainability, ~1.5 °C (~2.7°F). SSP1-2.6: sustainability, ~1.8 °C (~3.2°F). SSP2-4.5: middle-of-road, ~2.7 °C (~4.9°F). SSP3-7.0: regional rivalry, ~3.6 °C (~6.5°F). SSP5-8.5: fossil-fuelled development, ~4.4 °C (~7.9°F). SSPs replaced the older RCP framework; they are not predictions but explore a range of plausible futures depending on policy, technology, and social choices.',
        },
      ],
    },
    {
...
**Translating the budget into years.** The global remaining carbon budget is a hard physical constraint, but its translation into years depends on the emissions trajectory. If emissions remained flat at 37 Pg CO₂/yr, the 50% chance 1.5 °C (2.7°F) budget would be exhausted in approximately 10 years. If emissions are cut linearly to zero by 2040 (a very aggressive pathway), cumulative emissions under that trajectory sum to approximately 370 Pg CO₂ — just within the 50% budget. This arithmetic explains why climate scientists emphasise that emissions must peak not just eventually but by 2025 at the latest for 1.5 °C (2.7°F)-aligned pathways. Every year of flat or rising emissions makes the subsequent required rate of decline steeper — what analysts call the "cliff edge" of delayed action.
...
**Permafrost and aerosol wildcards.** The carbon budget uncertainties are not merely statistical. Earth system feedbacks — particularly permafrost thaw and the aerosol masking effect — could substantially shrink the effective remaining budget. Northern hemisphere permafrost contains approximately 1,700 Pg of organic carbon, some of which is released as CO₂ and methane as soils warm. Current IPCC estimates suggest permafrost could release 50–100 Pg CO₂-equivalent per °C of warming — equivalent to consuming 10–25% of the remaining 1.5 °C (2.7°F) budget per degree. The aerosol masking effect is equally significant: industrial sulfate aerosols from fossil fuel combustion currently reduce warming by approximately 0.5–1.0 °C (0.9–1.8°F) globally; as emissions fall under decarbonisation, this masking effect will diminish, delivering an "unmasking warming" pulse that could consume additional budget. Neither effect invalidates the carbon budget framework, but both reinforce the case for urgency.`,
      cards: [
        {
          name: 'TCRE: Linking Emissions to Warming',
          icon: Thermometer,
          color: BRAND.accentHot,
          desc: 'Warming ~proportional to cumulative CO₂ emitted. IPCC AR6: ~1.65 °C (~3.0°F) per 1,000 Pg CO₂. Linearity arises from cancellation of log-CO₂ forcing and declining sink efficiency. Means: every tonne of CO₂ matters equally regardless of when emitted; delaying reductions does not reduce long-run warming.',
          examples: '2,400 Pg CO₂ emitted since 1850 → ~1.2–1.3 °C (2.2–2.3°F) warming observed. At 1.65 °C (3.0°F)/1,000 Pg: 500 more Pg → +0.83 °C (+1.5°F) additional → total ~2.0 °C (~3.6°F). Budget arithmetic is direct and auditable.',
        },
        {
          name: 'Remaining Carbon Budgets for 1.5°C (2.7°F) and 2°C (3.6°F)',
          icon: BarChart,
          color: BRAND.jade,
          desc: 'IPCC AR6 remaining budget (from 2020): 380 Pg CO₂ for 50% chance of 1.5 °C (2.7°F); 500 Pg CO₂ for 33% chance. For 2 °C (3.6°F): ~1,150 Pg CO₂ at 50%. At 37 Pg/yr current emissions: 1.5 °C (2.7°F) 50% budget exhausted ~2030; 2 °C (3.6°F) budget ~2051.',
          examples: 'MCC Carbon Clock (Berlin): real-time countdown of remaining 1.5 °C (2.7°F) budget. As of 2024, ~6–8 years remain at current rates for 50% chance. Every year of flat emissions spends ~10% of remaining 1.5 °C (2.7°F) budget.',
        },
        {
        ...
        },
        {
          ...
          icon: Activity,
          color: BRAND.accent,
          desc: 'Paris Agreement: limit warming well below 2 °C (3.6°F), pursue 1.5 °C (2.7°F). NDCs: voluntary national pledges; current NDCs → ~2.5–2.9 °C (4.5–5.2°F). Net zero by 2050 required for 1.5 °C (2.7°F). Negative emissions (CDR) needed for residual hard-to-abate sectors and overshoot recovery. Ratchet mechanism: NDCs must be updated every 5 years with increasing ambition.',
          examples: 'Urgenda v. Netherlands (2019): court ordered 25% emission cuts by 2020 based on climate attribution science. Over 140 countries have net-zero targets but fewer than 10% have near-term policies consistent with 1.5 °C (2.7°F)-aligned pathways.',
        },
      ],
    },
    {
      ...
      body: 'How annual CO₂ emissions accumulate in the atmosphere, translate through TCRE into global warming, and ultimately consume the remaining carbon budget until the 1.5 °C (2.7°F) threshold is crossed — or negative emissions bring temperatures back down.',
      interaction: {
        type: 'flow-simulator' as const,
        description: 'showing how annual CO₂ emissions accumulate, drive warming via TCRE, and consume the remaining carbon budget toward the 1.5 °C (2.7°F) threshold — with overshoot requiring negative emissions for return',
        nodes: [
          {
            id: 'annual-emissions',
            label: 'Annual CO₂ Emissions (~37 Pg/yr)',
            description: 'Fossil fuel combustion, cement, and land-use change release approximately 37 Pg CO₂ per year globally. Energy (34%), industry (24%), transport (16%), and agriculture (12%) are the dominant sources. China (31%), USA (14%), and EU (8%) account for over half. Emissions must peak by ~2025 for credible 1.5 °C (2.7°F) pathways.',
            color: BRAND.coral,
          },
          {
            id: 'cumulative-co2',
          ...
          {
            id: 'tcre',
            label: 'TCRE: 1.65 °C (3.0°F) per 1,000 Pg CO₂',
            description: 'The Transient Climate Response to Cumulative Emissions (TCRE) converts cumulative CO₂ into warming. Best estimate ~1.65 °C (~3.0°F) per 1,000 Pg CO₂ (IPCC AR6); likely range 1.0–2.3 °C (1.8–4.1°F)/1,000 Pg. Linearity holds across a wide range of emission pathways. Earth system feedbacks (permafrost, aerosol unmasking) may effectively increase TCRE by reducing the available budget.',
            color: BRAND.accentHot,
          },
          {
            id: 'budget-consumed',
            label: 'Remaining Budget Consumed',
            description: 'Each year of emissions at current rates (~37 Pg CO₂) consumes approximately 10% of the remaining 50%-probability 1.5 °C (2.7°F) budget. The budget is a one-way counter: once emitted, CO₂ persists for centuries. Budget uncertainties (±220 Pg CO₂ at 1-sigma) reflect permafrost feedbacks, aerosol forcing, and historical emission estimates. The MCC Carbon Clock displays real-time budget consumption.',
            color: BRAND.amethyst,
          },
          {
            id: 'threshold',
            label: '1.5 °C (2.7°F) Threshold',
            description: 'At 1.5 °C (2.7°F) above pre-industrial, coral reef die-offs increase dramatically, 500-million-person exposure to water stress, tropical crop yield losses begin. Difference between 1.5 °C (2.7°F) and 2 °C (3.6°F): ~2× frequency of extreme heat events; ~3× more frequent extreme drought; sea level rise ~0.1 m (3 ft) higher by 2100. The 1.5 °C (2.7°F) threshold may be temporarily crossed (overshoot) and then brought back below target via CDR.',
            color: BRAND.ruby,
          },
          {
            id: 'overshoot-cdr',
            label: 'Overshoot and Negative Emissions Required',
            description: 'In most 1.5 °C (2.7°F) scenarios, global temperature temporarily exceeds 1.5 °C (2.7°F) (overshoot) before returning below target via Carbon Dioxide Removal (CDR). CDR methods: Bioenergy with CCS (BECCS), Direct Air Capture (DAC), enhanced weathering, reforestation. IPCC AR6 median scenario removes 1–10 Pg CO₂/yr by 2050. Large-scale CDR is controversial: land requirements for BECCS, energy requirements for DAC, permanence of carbon storage.',
            color: BRAND.jade,
          },
        ],
        edges: [
          ...
          { from: 'tcre',             to: 'budget-consumed', label: '1.65 °C (3.0°F)/1,000 Pg consumes remaining budget' },
          { from: 'budget-consumed',  to: 'threshold',       label: 'Budget exhausted → 1.5 °C (2.7°F) crossed' },
      ...
      questions: [
        {
          ...
          a: [
            ...
            'TCRE (Transient Climate Response to Cumulative Emissions) is the approximately linear relationship between total cumulative CO₂ emitted and global mean temperature rise (~1.65 °C (~3.0°F) per 1,000 Pg CO₂); it is useful because it directly translates a remaining temperature budget into a finite allowable quantity of future CO₂ emissions — making the concept of a carbon budget scientifically rigorous and policy-actionable',
          ...
          correct: 1,
          explain: 'TCRE stands for Transient Climate Response to Cumulative Emissions. Its policy power rests on the near-linear relationship between cumulative CO₂ emitted and warming: for every 1,000 Pg of CO₂ released (cumulatively, from any combination of sources and years), global mean temperature rises by approximately 1.65 °C (IPCC AR6 best estimate; likely range 1.0–2.3 °C (1.8–4.1°F)/1,000 Pg). This linearity — which arises from the approximate cancellation of the logarithmic CO₂ forcing relationship and the declining ocean/land sink efficiency — means the temperature target can be directly converted into a total carbon budget, which is then simply the maximum cumulative CO₂ humanity can emit. TCRE does not describe annual emissions alone (A mischaracterises it); it is not about ocean absorption efficiency (C); and it is not the Keeling Curve rate equation (D). The critical policy implication of TCRE is that the timing of emissions is secondary to their total quantity — every tonne of CO₂ contributes equally to warming regardless of when it is emitted, which undermines arguments that delaying emission reductions is acceptable because future technology will solve the problem.',
        },
        {
          q: 'What is the remaining carbon budget for a 50% chance of limiting warming to 1.5 °C (2.7°F), and how many years does this represent at current emission rates?',
          a: [
            'Approximately 1,150 Pg CO₂; at 37 Pg/yr this represents roughly 31 years — meaning current emission rates could continue until roughly 2055 before the 1.5 °C (2.7°F) budget is consumed',
            'Approximately 50 Pg CO₂; at 37 Pg/yr this represents less than 2 years — meaning the 1.5 °C (2.7°F) target has already been effectively foreclosed and only 2 °C (3.6°F) pathways remain feasible',
            'Approximately 380 Pg CO₂; at 37 Pg/yr this represents roughly 10 years — meaning emissions must begin declining immediately and reach near-zero by approximately 2050 to stay within a 50% probability of 1.5 °C (2.7°F)',
          ...
          correct: 2,
          explain: 'IPCC AR6 (Chapter 5, Table 5.8) estimates the remaining carbon budget from January 2020 for a 50% probability of limiting warming to 1.5 °C (2.7°F) at approximately 500 Pg CO₂ (some analyses citing from 2023 give ~380 Pg CO₂ as a more current estimate reflecting emissions since 2020). At current global emissions of approximately 37 Pg CO₂/yr, dividing 380 Pg by 37 Pg/yr gives roughly 10 years. This is why the mid-2030s represents a critical threshold in most analyses. The 1,150 Pg CO₂ figure (A) is the remaining budget for 2 °C (3.6°F) at 50% probability, not 1.5 °C (2.7°F). The 50 Pg figure (B) significantly understates the remaining budget and would imply the target is already lost, which is not the IPCC consensus view. The 750 Pg figure (D) does not correspond to any IPCC AR6 stated budget for 1.5 °C (2.7°F) at 50% probability. The budget for 1.5 °C (2.7°F) at 67% probability (a higher bar) is smaller still — approximately 300 Pg CO₂ — underscoring the urgency of the near-term emission trajectory.',
        },
        {
        ...
        {
          q: 'What does net zero mean in the context of climate policy, and why do most 1.5 °C (2.7°F) scenarios require large-scale negative emissions rather than simply reaching zero gross emissions?',
          a: [
        ...
        },
        {
          ...
          a: [
            ...
            'The remaining carbon budget has large uncertainties due to: (1) uncertain TCRE itself (likely range 1.0–2.3 °C (1.8–4.1°F)/1,000 Pg in AR6); (2) uncertain Earth system feedbacks including permafrost carbon release (50–100 Pg CO₂-eq per °C) and aerosol unmasking (~0.5–1.0 °C (0.9–1.8°F) warming as industrial aerosols are reduced); (3) uncertain historical emissions and their carbon cycle impact; and (4) non-CO₂ greenhouse gas treatments; these compound to give budget uncertainty of roughly ±220 Pg CO₂ at one standard deviation',
