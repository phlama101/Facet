...
**Ice sheet dynamics and Marine Ice Sheet Instability.** The most uncertain and consequential component of sea level rise projections is the potential destabilisation of marine ice sheets. The West Antarctic Ice Sheet (WAIS) rests on a retrograde bed — the bedrock deepens inland — making it susceptible to Marine Ice Sheet Instability (MISI): warm Circumpolar Deep Water intrudes beneath ice shelves (Pine Island, Thwaites), melts them from below, reduces their buttressing on inland glaciers, and allows faster flow to the ocean. As the grounding line retreats into deeper water, the process can accelerate. **Thwaites Glacier** — nicknamed the "doomsday glacier" — is already retreating; its loss alone could eventually contribute 65 cm (25.6 in) to sea level, with cascading failures potentially adding several metres over centuries. IPCC AR6 projects likely GMSL rise of 0.32–0.62 m (203 ft) by 2100 under SSP1-2.6 (low emissions) and 0.63–1.01 m (3 ft) under SSP5-8.5 (high emissions), but "low-likelihood high-impact" scenarios involving ice sheet instability could exceed 2 m (7 ft) by 2100.
...
**Permafrost thaw and carbon release.** Permafrost stores approximately 1,500 GtC in frozen organic matter. As permafrost thaws, microbial decomposition releases CO₂ under aerobic conditions and the more potent CH₄ under waterlogged anaerobic conditions. The permafrost carbon feedback represents a significant amplifier of anthropogenic warming that most Earth system models underestimate — abrupt thaw processes like thermokarst lake formation and retrogressive thaw slumps can release carbon 10× faster than gradual top-down thaw. Arctic air temperatures are rising at 3–4 °C (5.4–7.2°F) per degree of global warming; permafrost is warming at 0.3–0.5 °C (0.5–0.9°F)/decade and the active layer depth (seasonally thawed zone) is increasing across Siberia, Alaska, and Canada.`,
    ...
    },
    {
      ...
      questions: [
        {
          q: 'The rate of global mean sea level rise has accelerated from ~1.7 mm/yr (0.07 in/yr) in the 20th century to >4 mm/yr (0.16 in/yr) in the 2020s. What primarily drives this acceleration?',
          a: [
        ...
        {
          q: 'Global mean sea level rise projections for 2100 range from ~0.3 m (10 ft) under aggressive emissions reductions to >1 m (3 ft) under high-emission scenarios, with low-likelihood high-impact scenarios exceeding 2 m (7 ft). Why is the upper end of sea level projections so uncertain, and what physical processes are responsible for the asymmetry between the likely range and the high-impact tail?',
          a: [
            'The upper-end sea level projections are uncertain primarily because of uncertainty in future emissions scenarios — if global emissions are not reduced, thermal expansion of the ocean will dominate and drive sea level to 2 m (7 ft) by 2100; the ice sheet contribution is relatively well-constrained and contributes a fixed amount regardless of emissions trajectory; the uncertainty is therefore policy-driven rather than geophysical',
            'The upper end of sea level projections is dominated by structural uncertainties in ice sheet dynamics that cannot be fully resolved with current models or observations: Marine Ice Sheet Instability (MISI) in the West Antarctic Ice Sheet and the related Marine Ice Cliff Instability (MICI) hypothesis could produce rapid, potentially irreversible ice discharge; ice shelf hydrofracture (surface meltwater penetrating and widening crevasses, destabilising ice shelves) could accelerate ice mass loss beyond what gradual warming alone would produce; because these processes involve threshold behaviour and are inadequately represented in ice sheet models, the probability distribution of sea level rise has a heavy tail — small additional warming increments could disproportionately increase the probability of triggering multi-metre sea level rise over the coming centuries; this asymmetry is why the IPCC presents both "likely" ranges and separate "low-likelihood high-impact" scenarios',
            'The upper end of sea level projections is uncertain because ocean thermal expansion is poorly constrained at depth — deep ocean warming below 2,000 m (6,562 ft) has not been measured accurately before the Argo float network was established in 2000, and historical deep-ocean warming rates are unknown; without knowing how much the deep ocean has already warmed, future thermal expansion cannot be predicted; this measurement gap is responsible for the wide uncertainty range',
            'The high-impact sea level rise scenarios assume that all ice sheets collapse simultaneously in a coordinated fashion — the Greenland Ice Sheet, West Antarctic Ice Sheet, and East Antarctic Ice Sheet all lose mass at maximum rates at the same time; this simultaneous collapse scenario is physically implausible because the ice sheets are in different hemispheres and respond to different regional climate changes; the high-impact tail therefore represents a physically unrealistic worst case that should be disregarded in planning',
          ],
          correct: 1,
          explain: 'Ocean thermal expansion is a real and well-quantified contributor, but it is not the dominant driver of upper-end projections — thermal expansion is expected to contribute ~0.1–0.3 m (10 ft) by 2100, well within the likely range; the tail risk above ~1 m (3 ft) is driven by ice sheet dynamics, not thermal expansion; characterising the uncertainty as primarily policy-driven (from emissions scenarios) rather than geophysical ignores the structural ice sheet modelling uncertainties (A misidentifies the source of upper-end uncertainty). Deep ocean warming below 2,000 m (6,562 ft) has been measured by Argo floats since ~2000 and by historical hydrographic cruises before that; the measurement gap is real but manageable — GRACE/GRACE-FO satellite gravimetry directly measures ice mass changes independently of ocean temperature measurements; the claim that deep ocean uncertainty is responsible for the wide sea level range misattributes the source of uncertainty (C overstates the deep ocean measurement gap as the primary uncertainty). High-impact sea level scenarios do not require simultaneous collapse of all ice sheets — the scenarios are constructed by considering plausible ranges of each component (thermal expansion, mountain glaciers, Greenland, and Antarctica) from their uncertainty distributions; the scenarios are designed to capture the physically plausible range of outcomes, not an implausible worst-case simultaneous collapse; moreover, the East Antarctic Ice Sheet is mostly above sea level and is not included in the dominant high-impact scenarios, which focus on WAIS (D misrepresents how high-impact scenarios are constructed). The correct answer is B: the asymmetry between the likely range (~0.3–1.0 m (0 ft)) and the high-impact tail (>2 m (7 ft) possible by 2100) arises from the non-linear dynamics of marine ice sheets. The key uncertainties are: (1) MISI: once the Thwaites or Pine Island grounding line retreats into deeper water, the process may become self-sustaining regardless of subsequent forcing changes — this irreversibility creates a threshold that, if crossed, produces rapid ice loss cascading through the WAIS; (2) MICI: the hypothesis (DeConto and Pollard 2016) that marine-terminating ice cliffs can fail structurally once they exceed ~90 m (295 ft) above sea level, producing rapid calving; this is supported by geological evidence of rapid ice loss events but contested in the modelling community; (3) Ice shelf hydrofracture: surface meltwater from atmospheric warming penetrates and expands crevasses in ice shelves, accelerating collapse as seen with Larsen B; under high emissions, extensive surface melting of Antarctic ice shelves could trigger widespread hydrofracture. Because these processes involve tipping-point dynamics and bistability, the probability distribution of sea level outcomes is not symmetric — it has a heavier upper tail than lower tail. This motivates the IPCC approach of presenting likely ranges (based on processes that can be modelled) separately from low-likelihood high-impact scenarios (based on processes that could operate but are not well constrained).',
        },
      ],
    },
  ],
