    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            'The upper-end sea level projections are uncertain primarily because of uncertainty in future emissions scenarios — if global emissions are not reduced, thermal expansion of the ocean will dominate and drive sea level to 2 m by 2100; the ice sheet contribution is relatively well-constrained and contributes a fixed amount regardless of emissions trajectory; the uncertainty is therefore policy-driven rather than geophysical',
            ...
            'The upper end of sea level projections is uncertain because ocean thermal expansion is poorly constrained at depth — deep ocean warming below 2,000 m has not been measured accurately before the Argo float network was established in 2000, and historical deep-ocean warming rates are unknown; without knowing how much the deep ocean has already warmed, future thermal expansion cannot be predicted; this measurement gap is responsible for the wide uncertainty range',
