    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          icon: AlertTriangle,
          color: BRAND.coral,
          desc: 'Coral bleaching occurs when SSTs exceed the local bleaching threshold (MMM + 1°C). Bleached corals can recover if temperatures drop within weeks, but prolonged exposure causes starvation and mortality. The Great Barrier Reef has experienced mass bleaching in 1998, 2002, 2016, 2017, 2020, 2022, and 2024 — with the interval between events compressing from ~27 years (1998–to the 1970s) to nearly annual. Repeated bleaching prevents full recovery between events, driving a net decline in coral cover.',
          examples: '2016 GBR bleaching: 93% of reefs bleached, >50% mortality on northern reefs; DHW exceeded 8°C-weeks across hundreds of km · 1998 global bleaching: first global event, coincided with 1997–98 El Niño; estimated 16% of global coral destroyed · 2024 global bleaching: declared fourth global bleaching event by NOAA, affecting all ocean basins simultaneously',
        },
        {
      ...
      cards: [
        {
          ...
          examples: 'Pre-industrial: ~1-in-50-year MHW events · 1.5°C warming: frequency ×16; 2°C: ×23 (Frölicher et al. 2018) · SSP5-8.5 by 2100: 1-in-50-year events effectively annual · MHW annual days: ~30/yr current → 220–250/yr at 4°C warming · 2023 North Atlantic: anomaly exceeded 2°C above climatology across millions of km²',
        },
        {
          name: 'Observing and Early Warning Systems',
          icon: AlertTriangle,
          color: BRAND.amethyst,
          desc: 'NOAA Coral Reef Watch uses daily 5km satellite SST to compute DHW globally, issuing bleaching Watch, Warning, and Alert Level 1/2 notifications that give reef managers days to weeks of advance warning. The Copernicus Marine Environment Monitoring Service (CMEMS) provides pan-European and global MHW tracking. Argo float data contributes subsurface temperature profiles essential for understanding heat content and mixed layer dynamics during MHWs. Integrated forecast systems (seasonal and sub-seasonal models) are becoming capable of predicting MHW onset 1–3 months in advance for some regions.',
          examples: 'NOAA CRW: 5km daily SST, global DHW mapping, operational since 1997 · Copernicus C3S: ERA5 reanalysis confirms 2023 North Atlantic records · TAO/TRITON + Argo: subsurface heat content monitoring critical for Pacific MHW prediction · IMOS (Australia): national MHW tracking integrating ship, buoy, Argo, and satellite data',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: `Under the pre-industrial climate, events meeting today\'s 90th percentile threshold for marine heat waves were rare — occurring roughly once every 50 years at any given location. Today, the shifted baseline means such events occur approximately every 5–10 years. Under 1.5°C of global warming, Frölicher et al. (2018, *Nature*) calculate MHW frequency increases by a factor of ~16 relative to the pre-industrial; under 2°C, by a factor of ~23. Under high-emissions scenarios (SSP5-8.5), what are today classified as "rare extreme" MHWs will recur annually by 2100, making the current concept of a "marine heat wave" obsolete — the extreme becomes the baseline. IPCC AR6 confirms this trajectory with high confidence. Managing ocean ecosystems through this transition requires anticipatory governance, early warning systems, and active interventions such as assisted evolution of thermal-tolerant coral genotypes and protection of climate refugia.`,
            color: BRAND.accent,
          },
        ],
        edges: [
          ...
          { from: 'ocean-warming',       to: 'primary-impacts',   label: 'thermal stress accumulates on corals, kelp, and seagrasses (DHW > 4–8°C-weeks)' },
      ...
      questions: [
        {
          ...
          a: [
            'A marine heat wave is defined as any period during which sea surface temperature exceeds 25°C in the tropics or 15°C in temperate regions, regardless of duration or local climatological baseline, because these absolute thresholds represent thermal stress for most marine organisms',
        ...
        },
        {
          ...
          a: [
            ...
            'DHW represent the accumulated thermal stress above the local bleaching threshold (Maximum Monthly Mean + 1°C) over a rolling 12-week window, expressed in °C-weeks; DHW > 4°C-weeks is associated with coral bleaching; DHW > 8°C-weeks is associated with severe coral mortality; computed from daily 5km satellite SST by NOAA Coral Reef Watch',
