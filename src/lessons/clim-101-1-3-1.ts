...
Understanding the instrumental record and attribution methods is foundational for all that follows in this module: sea level rise, ecosystem disruption, extreme events, and the policy choices that depend on knowing how much warming will occur under different emission scenarios. The IPCC AR6 (2021) stated for the first time that human influence on the climate is "unequivocal" — the strongest language the Panel has ever used.`,
      keyTerms: [
        ...
        { term: 'Transient Climate Response (TCR)', def: 'The global mean surface temperature increase at the time of CO₂ doubling in a model experiment where CO₂ increases at 1 % per year. Measures the near-term climate sensitivity, incorporating the ocean\'s heat uptake delay. IPCC AR6 assessed TCR = 1.8 °C (likely range 1.2–2.4 °C). TCR is used to estimate warming expected over the 21st century under different emission scenarios.' },
        { term: 'Equilibrium Climate Sensitivity (ECS)', def: 'The equilibrium global mean surface temperature increase following a sustained doubling of atmospheric CO₂. Represents the full, long-term response after all fast feedbacks (water vapour, lapse rate, sea ice, clouds) equilibrate. IPCC AR6 assessed ECS = 3.0 °C (likely range 2.5–4.0 °C), narrowed by combining the instrumental record, paleoclimate evidence, and process-level understanding. ECS is relevant for projecting long-term warming beyond 2100.' },
        { term: 'Remaining carbon budget', def: 'The total net CO₂ emissions compatible with limiting global warming to a given temperature level. IPCC AR6 estimated approximately 500 GtCO₂ remaining from 2020 for a 50 % probability of staying below 1.5 °C. At 2023 emission rates (~40 GtCO₂/yr), this budget is exhausted in ~12 years. The budget is sensitive to assumptions about non-CO₂ gases, aerosols, and carbon cycle feedbacks (permafrost, land-use). Each additional 1,000 GtCO₂ of cumulative emissions corresponds to roughly 0.45 °C of additional GMST (the TCRE relationship).' },
      ],
    },
    {
      type: 'concept',
...
The record shows approximately **+1.2 °C** of warming above the 1850–1900 baseline (IPCC AR6, 2021). Warming is not uniform in space: land warms ~2× faster than ocean; the Arctic warms ~3–4× the global average (polar amplification driven by ice-albedo and water vapour feedbacks); and the Northern Hemisphere has warmed faster than the Southern Hemisphere due to the greater land fraction and faster aerosol reductions. The warming has also accelerated: the rate from 2011–2020 was +0.2 °C/decade, compared to +0.15 °C/decade from 1980–2010. Ocean heat content (OHC), measured by the Argo float network since 2000, provides an independent and physically robust measure of Earth's energy imbalance — approximately 90 % of the excess energy trapped by greenhouse gases ends up in the ocean.

**Detection and attribution: fingerprinting human influence.** The detection-attribution method compares the spatial and vertical patterns ("fingerprints") of observed temperature change against those predicted by climate models driven by different forcings. The greenhouse gas fingerprint is characterised by: (1) strong warming at the surface; (2) cooling of the stratosphere (where CO₂ traps heat below); (3) greater warming over land than ocean; (4) polar amplification; (5) greater warming at night than day; and (6) more warming in the Northern Hemisphere. This multi-dimensional pattern is distinct from solar forcing (which would warm both troposphere and stratosphere equally) and cannot be reproduced by models run with only natural forcings (solar + volcanoes). IPCC AR6 concluded that human influence has warmed the climate at a rate unprecedented in at least 2,000 years, and that approximately 1.0 °C of the observed 1.07 °C warming since 1850–1900 is attributable to net human influence.

**Committed warming and the remaining carbon budget.** Even if all CO₂ emissions stopped today, the climate would continue to warm by ~0.3–0.5 °C as the ocean reaches thermal equilibrium with the elevated GHG concentrations already in the atmosphere. This "warming in the pipeline" reflects the ocean's enormous heat capacity and slow response time. The relationship between cumulative CO₂ emissions and eventual warming — the **Transient Climate Response to Cumulative CO₂ Emissions (TCRE)** — is approximately linear: each additional 1,000 GtCO₂ of cumulative emissions adds roughly 0.45 °C. This allows direct calculation of the remaining carbon budget for any target temperature. For 1.5 °C, approximately 500 GtCO₂ remained as of 2020; at current rates this is exhausted within ~12 years, highlighting the urgency of rapid emissions reductions.`,
      cards: [
        {
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.jade,
          desc: 'Optimal fingerprinting compares observed patterns against model-predicted forcing fingerprints. GHG fingerprint: surface warming + stratospheric cooling + greater land than ocean warming + polar amplification + night-warming > day-warming. Solar fingerprint: uniform troposphere + stratosphere warming; no polar amplification asymmetry. Natural forcings only: cannot reproduce observed trend 1950–present; match only ~1900–1950 period. IPCC AR6: "unequivocal" human influence; ~1.0 °C of 1.07 °C warming attributable to net human influence. ECS = 3.0 °C (2.5–4.0 °C likely).',
          examples: 'Volcanic cooling test: 1991 Pinatubo produced −0.5 °C 1–2 years later (captured in models); validates model sensitivity · Solar output: satellite measurements since 1978 show slight decline since 1980; cannot explain 0.5 °C of warming over same period · Day/night asymmetry: nighttime Tmin warming faster than daytime Tmax globally — GHG signature, not UHI artifact',
        },
        {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Even if global CO₂ emissions fell to zero tomorrow, scientists expect an additional ~0.3–0.5 °C of warming. What is the primary physical cause?',
          a: [
