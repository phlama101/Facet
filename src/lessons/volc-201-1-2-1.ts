...
Two of the world's best-studied transcrustal magmatic systems are **Yellowstone** (Wyoming, USA) and **Long Valley** (California, USA). At Yellowstone, seismic tomography has resolved an upper rhyolitic mush at 5–17 km depth (with an estimated melt fraction of ~5–15%) underlain by a broader basaltic partial-melt body at ~20–50 km depth, fed ultimately by a mantle plume. Ground deformation at Yellowstone — measured by continuous GPS and InSAR campaigns — shows episodic uplift and subsidence at rates up to 7 cm/year, reflecting hydrothermal fluid migration and small melt batch intrusions within the mush. At Long Valley, a 760,000-year-old caldera formed by a VEI 7–8 eruption (the Bishop Tuff, ~600 km³ of rhyolite), modern unrest manifests as swarms of small earthquakes, CO₂ emissions, and ground deformation; ambient noise tomography has imaged a crystal mush with ~10% melt beneath the resurgent dome.
...
**Seismic imaging and geodetic monitoring.** Two observational techniques anchor modern understanding of mush systems. (1) **Seismic velocity anomalies**: VP/VS ratios are diagnostic of melt fraction because melt dramatically reduces VS (shear-wave velocity) while having a smaller effect on VP (P-wave velocity) — so a high VP/VS ratio signals partial melt. Ambient noise tomography using dense seismic networks (such as the EarthScope Transportable Array across the western USA, or the AIRA-net at Aira caldera, Japan) resolves mush geometry at 1–5 km horizontal resolution. At Aira (Sakurajima\'s source caldera), VP/VS anomalies delineate a shallow mush at 3–10 km depth that inflates during inter-eruption intervals and deflates during eruption sequences. (2) **Geodetic deformation**: InSAR measures ground surface deformation to millimetre precision from orbiting radar satellites. Inflation (surface doming) signals melt or fluid injection; deflation signals withdrawal or compaction. At Long Valley caldera, an ongoing episode of unrest since 1980 has produced ~80 cm of total uplift of the resurgent dome, attributed to intrusion of small basaltic sills into the base of the mush — recharge events that have not yet triggered eruption but demonstrate active mush-column dynamics.`,
      cards: [
        {
          ...
          examples: 'Yellowstone upper mush: 5–17 km depth, ~5–15% melt · Long Valley: ~10% melt under resurgent dome · Taupo Volcanic Zone (NZ): distributed mush column beneath 350-km-long rift',
        },
        {
          ...
          examples: 'Yellowstone: episodic basaltic intrusions drive caldera floor uplift up to 7 cm/yr without eruption · Long Valley: 80 cm cumulative uplift since 1980 from basaltic sill intrusions · Santorini 2011–2012 unrest: seismic and geodetic signals interpreted as basaltic recharge into rhyolitic mush',
        },
        {
          name: 'Seismic Imaging of Mush',
          icon: Activity,
          color: BRAND.jade,
          desc: 'Body-wave tomography: VP anomalies of –3% to –8% = 5–20% melt (vs. –20 to –30% for pure melt). High VP/VS ratio diagnostic of partial melt. Ambient noise tomography: cross-correlates continuous seismic noise; resolves shallow mush at 1–5 km resolution without earthquakes. S-wave shadows indicate melt-rich lenses.',
          examples: 'Yellowstone: dual-level anomaly — rhyolitic upper mush (5–17 km) + basaltic lower body (20–50 km) · Aira caldera, Japan: VP/VS anomaly delineates 3–10 km mush; inflates between Sakurajima eruption sequences · Long Valley: ambient noise tomography maps partial-melt zone beneath Bishop Tuff caldera',
        },
        {
          ...
          examples: 'Long Valley InSAR: 80 cm total resurgent dome uplift 1980–present, ongoing non-eruptive unrest · Yellowstone GPS: 2004–2010 uplift at 7 cm/yr followed by subsidence; no eruption · Campi Flegrei (Italy): bradyseismic crises in 1970–72 and 1982–84 lifted caldera floor 3.5 m total; town of Pozzuoli evacuated twice; eruption has not occurred since 1538',
        },
      ],
    },
    {
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'Crystal zoning profiles in quartz phenocrysts from a large rhyolitic ignimbrite show Ti concentrations consistent with temperatures of ~720°C throughout most of the crystal interior, with a sharp high-Ti rim recording ~850°C grown just before eruption. Using Ti-in-quartz thermometry and diffusion modelling, the high-temperature rim is estimated to have grown within 100–300 years before eruption. What is the volcanological significance of this petrological observation?',
          a: [
            'The crystals demonstrate that the magma chamber was liquid at 850°C for its entire pre-eruptive history and only cooled to 720°C after eruption during lava flow emplacement; the zoning records post-eruptive cooling, not pre-eruptive storage',
            'The low-temperature interior records long-duration (thousands of years) storage of the crystal in a cold (~720°C) crystal mush near the solidus; the high-temperature rim records thermal rejuvenation by a recharge event in the centuries before eruption that raised melt fraction above the rheological lock and mobilised the mush; the observation supports mush remobilisation on century timescales by recharge',
            'The zoning profile indicates the eruption was triggered by a meteorite impact that instantaneously heated the upper crust from 720°C to 850°C; only an external thermal input of this magnitude could explain the sharp compositional boundary between interior and rim',
            'The temperature jump from 720°C to 850°C recorded in the rim indicates the crystal was transported from a shallow cold storage region to a deeper hotter region shortly before eruption — downward transport of crystals by convection in a liquid magma chamber is the most parsimonious explanation',
          ],
          correct: 1,
          explain: 'Post-eruptive cooling (A) is ruled out by the sequence: the low-temperature interior is the older part of the crystal (grown during storage) and the high-temperature rim is the younger part (grown just before eruption); post-eruption lava flows cool far faster (days to weeks) than the 100–300 year timescale estimated from diffusion modelling of the rim thickness. Meteorite impact (C) is not a mechanism that can selectively heat a sub-volcanic crystal mush to 850°C without leaving unambiguous geological evidence including an impact crater, ejecta layer, and shocked mineral assemblage, none of which are reported in this scenario. Downward convective transport in a liquid chamber (D) contradicts both the long cold storage duration (thousands of years in the crystal interior, far too long for a convecting liquid to maintain without reheating all crystals uniformly) and the modern evidence against liquid-dominated chambers. The correct answer is B: this type of crystal zoning record — cold interior recording near-solidus mush storage, sharp hot rim recording pre-eruptive thermal rejuvenation — is now widely documented in silicic volcanic systems (Yellowstone, Taupo, Fish Canyon Tuff). It is one of the key petrological pillars of the TAMI model. The ~100–300 year duration of the high-temperature rim growth sets a timescale for mush mobilisation by recharge: centuries, not millennia — fast enough to be relevant for monitoring but too slow to appear in historical records for many calderas with recurrence intervals of 10⁴–10⁵ years.',
        },
        {
