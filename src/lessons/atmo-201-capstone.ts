    ...
    },
    {
      ...
      questions: [
        ...
        // ── Q9: Polar jet stream — pressure level and latitude — correct: 1 ─
        {
          ...
          a: [
            'Near 500 hPa (~5.5 km), between 60°N and 80°N; the polar jet follows the edge of the polar ice cap throughout the year',
            'Near 200 hPa (~12 km), between 40°N and 70°N; the polar jet sits at the tropopause level near the polar front where temperature gradients between Arctic and subtropical air masses are steepest',
            'Near 850 hPa (~1.5 km), between 30°N and 50°N; the polar jet is a low-level feature driven primarily by boundary-layer temperature gradients rather than upper-tropospheric thermal wind balance',
            'Near 200 hPa (~12 km), between 15°N and 30°N; the polar jet migrates equatorward of 30°N during winter because the polar front retreats toward the tropics as the polar vortex strengthens',
          ],
          correct: 1,
          explain:
            'The polar jet stream is an upper-tropospheric feature located near the tropopause, typically at 200–300 hPa (~9–13 km). It exists because of the thermal wind relationship: large horizontal temperature gradients along the polar front produce strong vertical wind shear, and the integrated shear generates jet-level winds exceeding 50–80 m/s in the jet core. In boreal winter the polar front migrates equatorward, placing the jet between roughly 40°N and 70°N (most variability at 45°N–60°N). Option A gives the correct latitude range but the wrong pressure level; the jet is upper-tropospheric, not mid-tropospheric, and does not simply follow the sea-ice edge. Option C places the jet in the boundary layer, which is incorrect; near-surface fronts are related but do not define the jet. Option D gives the correct pressure level but an incorrect latitude, confusing the polar jet with the subtropical jet found near 25°–35°N.',
        },
        ...
        // ── Q15: CAPE — definition — correct: 1 ─────────────────────────────
        {
          ...
          a: [
            ...
            'CAPE measures total precipitable water in a column from 850 hPa to 200 hPa; values above 50 mm are considered extreme and associated with mesoscale convective systems capable of producing flash flooding',
            'CAPE measures the temperature difference between the 500 hPa level and the surface; values greater than 30°C represent extreme instability and are used as the primary severe-weather threshold by the Storm Prediction Center',
          ],
          correct: 1,
          explain:
            'CAPE is the vertical integral of parcel buoyancy from the Level of Free Convection (LFC) to the Equilibrium Level (EL): CAPE = ∫(LFC→EL) g × [(Tv,parcel − Tv,env) / Tv,env] dz. It represents the maximum theoretical kinetic energy a convective updraft can acquire (J/kg), directly related to maximum updraft speed: w_max ≈ √(2 × CAPE). Values of 0–1,000 J/kg indicate marginal instability; 1,000–2,500 J/kg moderate; 2,500–4,000 J/kg large; above 4,000 J/kg extreme. CAPE values above ~2,500–3,000 J/kg, particularly when paired with strong wind shear (≥35–40 kt in the 0–6 km layer), are associated with supercell thunderstorms capable of producing violent tornadoes. Option A describes wind energy, not buoyancy. Option C describes precipitable water (PW), not CAPE. Option D confuses lapse rate indices with the CAPE definition.',
        },
        // ── Q16: Derecho — distinguishing feature — correct: 3 ───────────────
        {
          ...
          a: [
            ...
            'A derecho is distinguished from ordinary thunderstorms solely by duration — any convective complex persisting for more than 6 hours and producing any wind gusts above 50 km/h qualifies as a derecho, regardless of path length or peak wind speed',
            'A derecho is a long-lived, fast-moving, bow-echo–dominated convective system that produces a swath of widespread damaging straight-line winds of at least 93 km/h (58 mph) extending more than 400 km along its path, with wind damage reports distributed along most of the path length',
          ],
          correct: 3,
          explain:
            'The term "derecho" (from the Spanish for "straight") was coined by Gustavus Hinrichs in 1888 to contrast straight-line convective windstorms with the rotating winds of a tornado. The modern operational definition, formalised by Johns and Hirt (1987) and updated by Evans and Doswell (2001), requires a swath of wind damage and/or gusts ≥93 km/h (50 kt / 58 mph) extending at least 400 km along its path, with reports distributed along most of the corridor — not just isolated wind events. Derechos are typically produced by bow echoes or progressive/serial mesoscale convective systems (MCSs) in a strongly sheared environment where rear-inflow jets reinforce the leading-line winds. Option A incorrectly attributes rotating updrafts (mesocyclones) to derechos; mesocyclones define supercells, not derechos. Option B is incorrect; an MCV is not a defining criterion. Option C understates both the required path length and peak wind thresholds.',
        },
        // ── Q17: Atmospheric river IVT threshold — correct: 2 ───────────────
        {
          ...
          a: [
            'IVT ≥ 100 kg m⁻¹ s⁻¹, integrated from the surface to 100 hPa; atmospheric rivers of this intensity can produce moderate precipitation over coastal mountain ranges',
            'IVT ≥ 500 kg m⁻¹ s⁻¹, integrated from 850 hPa to 500 hPa only; low-level moisture below 850 hPa is excluded because it contributes negligible horizontal transport',
            'IVT ≥ 250 kg m⁻¹ s⁻¹, integrated from the surface (or 1000 hPa) to 300 hPa; the most extreme atmospheric rivers (AR Cat 5) exceed 1,250 kg m⁻¹ s⁻¹ and are capable of catastrophic precipitation on orographic terrain',
            'IVT ≥ 50 kg m⁻¹ s⁻¹, integrated from the surface to 700 hPa; the low threshold reflects that moisture transport above 700 hPa is too diffuse to contribute meaningfully to precipitation',
          ],
          correct: 2,
          explain:
            'IVT is computed as the vertically integrated horizontal flux of water vapour, typically from the surface (or 1000 hPa) to 300 hPa: IVT = (1/g) × ∫(300→surface) q·V dp, where q is specific humidity and V is the horizontal wind vector. The NOAA/CW3E AR scale defines atmospheric rivers as features with IVT ≥ 250 kg m⁻¹ s⁻¹ (AR Cat 1) persisting for at least 24 hours with sufficient length and width. The five-category scale by Ralph et al. (2019) extends through Cat 5 (IVT > 1,250 kg m⁻¹ s⁻¹), capturing extreme events capable of record-setting precipitation and flooding on coastal ranges such as the Sierra Nevada. Option A gives too low a threshold (100 kg m⁻¹ s⁻¹ reflects ordinary enhanced moisture transport). Option B incorrectly restricts integration to 850–500 hPa and uses an IVT threshold of 500, which would exclude many well-documented ARs. Option D gives both a threshold too low and an incorrect integration depth.',
        },
        ...
        // ── Q19: Rapid intensification threshold — correct: 3 ───────────────
        {
          ...
          a: [
            'An increase in maximum sustained winds of at least 15 knots (28 km/h) in 12 hours, or the onset of a warm-core structure above Category 1 intensity',
