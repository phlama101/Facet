...
**The K–h relationship.** Arc lavas directly above shallower slab segments tend to be basaltic to basaltic-andesite with low K₂O; those above deeper portions of the slab (farther from the trench) are more silicic and potassium-rich, grading from calc-alkaline through high-K calc-alkaline to shoshonitic. This "K–h relationship" reflects the depth-dependent breakdown of potassium-bearing minerals in the slab (amphibole and phengite break down at progressively greater depths), delivering K-rich fluids to progressively deeper wedge regions.`,
      cards: [
        {
          ...
          examples: 'Cascades: shallow Juan de Fuca slab (~80 km (50 mi) beneath volcanic front) → low-K basaltic andesites at Newberry · Japan arc: deep Pacific slab → high-K shoshonites in back-arc · Andes: phengite breakdown signature in potassic lavas of the Central Volcanic Zone',
        },
        {
        ...
        nodes: [
          {
            ...
            description: 'Altered oceanic crust (~6 km (3.7 mi)) and overlying marine sediment (~0.5 km (0.3 mi)) descend into the mantle. The slab carries hydrous minerals (serpentinite, chlorite, amphibole, phengite), fluid-mobile elements (Ba, K, Rb, Sr, Pb) in altered basalt and sediment, and high-field-strength elements (Nb, Ta, Ti) locked in rutile. The slab surface reaches ~80–130 km (81 mi) depth beneath the volcanic front, where P–T conditions drive hydrous mineral breakdown.',
            color: BRAND.accent,
          },
          {
            id: 'dehydration',
            label: 'Slab Dehydration',
            description: 'As temperature and pressure increase with depth, hydrous minerals break down in a predictable sequence: serpentinite at 50–150 km (93 mi), chlorite at 70–100 km (62 mi), amphibole at 70–200 km (124 mi), and phengite at 200–300 km (186 mi). Each reaction releases supercritical aqueous fluid rich in fluid-mobile elements (Ba, K, Rb, Sr, Pb). Rutile is stable throughout the dehydration sequence, sequestering Nb, Ta, and Ti and preventing their transfer upward — the origin of the HFSE depletion in arc lavas.',
          ...
          },
          {
            ...
            description: `Flux melting generates primary hydrous basaltic melt (3–5 wt% H₂O) from the metasomatised wedge at ~80–130 km (81 mi) depth, approximately 100–130 km (81 mi) above the slab surface. The melt inherits the wedge\'s geochemical signature: elevated Ba, K, Rb, Sr, Pb; depleted Nb, Ta, Ti; MORB-like HREE (heavy rare earth elements) unless garnet is in the residue. If the slab itself melts (young or hot slab), adakitic melt with high Sr/Y and low Y is generated directly from the eclogitic slab at >45 km (28 mi). Both melt types rise through the wedge, reacting with peridotite and gaining MgO en route.`,
            color: BRAND.coral,
          },
          {
            id: 'eruption',
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: 'A geochemist analyses lavas from two volcanoes above the same subduction zone: Volcano A (closer to the trench, ~80 km (50 mi) above the slab) has low K₂O (0.4 wt%) at 52% SiO₂; Volcano B (farther from the trench, ~150 km (93 mi) above the slab) has high K₂O (2.1 wt%) at the same SiO₂. What process explains this K–h relationship, and which slab mineral is the primary K-carrier at depth?',
          a: [
            ...
            'The K–h relationship reflects depth-dependent breakdown of potassium-bearing hydrous minerals in the slab: amphibole and serpentinite release K at shallow depths (< ~150 km (93 mi)) affecting Volcano A, but phengite — a K-rich white mica stable to >200–300 km (186 mi) — only breaks down at the greater depth beneath Volcano B, delivering K-rich fluids to the deep wedge and generating high-K magmas',
