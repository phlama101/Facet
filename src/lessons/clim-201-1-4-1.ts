...
**Key findings from ice core archives** have been transformative for understanding the carbon cycle and climate feedbacks. The Vostok core (420,000-year record) first revealed that atmospheric CO₂ oscillated between ~180 ppm during glacial maxima and ~280–300 ppm during interglacials — a range of approximately **100 ppm** tightly correlated with reconstructed Antarctic temperature. The EPICA Dome C record extended this to eight cycles and confirmed that the Holocene (current interglacial) has been unusually stable compared with the volatile transitions of previous cycles. CH₄ fluctuations, driven by tropical and boreal wetland extent, track temperature changes even more rapidly than CO₂, with glacial values of ~350 ppb rising to ~700 ppb during interglacials. Crucially, **volcanic acid layers** (H₂SO₄ deposited as sulfate spikes) and **dust layers** provide absolute time markers that allow cross-correlation between distant ice cores and with other proxy archives, underpinning the global synchronisation of palaeoclimate records.`,
      keyTerms: [
        ...
        {
          term: 'EPICA Dome C',
          def: `The European Project for Ice Coring in Antarctica drilling site at Dome C (75°S, 123°E) on the East Antarctic Plateau, which produced the longest continuous ice core climate record currently available. Drilled to 3,270 m (10,729 ft) depth (reaching ice ~800,000 years old), the core spans eight complete glacial–interglacial cycles. The site\'s extreme cold (mean annual temperature –54.5°C (130°F)) and low accumulation rate (~2.5 cm (1.0 in) of ice per year) enable very deep, highly compressed records. Published by the EPICA community members in Nature (2004) and Science (2007), the Dome C record revealed that CO₂ concentrations ranged from ~172 ppm at glacial maxima to ~300 ppm during warm interglacials and that the current rate of CO₂ increase is unprecedented in the 800,000-year record.`,
        },
      ],
    },
    {
      ...
      cards: [
        {
          ...
          examples: 'Vostok (Russia/France): 3,623 m (11,887 ft), 420 kyr, first ice core to reveal 4-cycle CO₂–temperature correlation · EPICA Dome C: 3,270 m (10,729 ft), 800 kyr, 8 cycles, current record holder for longest continuous record · WAIS Divide: 3,405 m (11,172 ft), 68 kyr at annual resolution — precisely dates Southern Hemisphere response to Dansgaard-Oeschger events · Dome Fuji (Japan): 3,035 m (9,958 ft), ~720 kyr, provides independent verification of EPICA record',
        },
        {
          name: 'Greenland and High-Altitude Ice Cores',
          icon: Thermometer,
          color: BRAND.coral,
          desc: 'Greenland cores (GISP2, GRIP, NGRIP, NEEM) provide the highest-resolution Northern Hemisphere records for the last ~125,000 years, with annual layers preserved to >40 kyr. Greenland δ¹⁸O records are world-famous for capturing Dansgaard-Oeschger (D-O) events — abrupt warming episodes of 8–15°C (14.4–27°F) in decades. Tropical mountain glaciers (Quelccaya, Kilimanjaro, Guliya) extend records to regions not covered by polar cores, though they are retreating rapidly due to warming.',
          examples: 'NGRIP (North Greenland Ice Core Project): continuous annual layers to 123 kyr, spanning the entire last glacial cycle · GISP2 vs. GRIP: drilled 30 m (98 ft) apart; agreement validates the 110 kyr record, divergence below 110 kyr reveals glacial flow disturbance · Quelccaya ice cap (Peru, 5,670 m (18,603 ft)): longest tropical ice core record, annual layers to 1,800 years — shows 1990s retreat erasing 1,600 years of accumulation record · NEEM (Northwest Greenland): reaches Last Interglacial ice showing 8°C (14°F) local warming at 120 kyr with Greenland up to 6 m (20 ft) lower in extent',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        edges: [
          ...
          { from: 'deep-archive',       to: 'drilling-extraction', label: 'Drill retrieves ice in 1–3 m (3–10 ft) cylinders from surface to 3+ km depth' },
