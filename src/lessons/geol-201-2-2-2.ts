...
**Unconformities break Walther's Law.** Walther's Law states that vertically adjacent facies were once laterally adjacent. This holds only where the succession is conformable. An unconformity severs that relationship: the environment above the unconformity may be completely unrelated to the environment below. Marine limestone below an angular unconformity may be followed above by a fluvial red sandstone deposited millions of years later in a completely different tectonic setting. Reading across an unconformity as if the sequence were conformable would lead to a fundamentally wrong environmental reconstruction.`,
      cards: [
        ...
        },
        {
          ...
          icon: Mountain,
          color: BRAND.coral,
          desc: "Stage 1 — Deposition: sediment accumulates in basin below base level. Stage 2 — Uplift: tectonics raise region above base level; if folding occurs → angular unconformity; if gentle → disconformity. Stage 3 — Erosion: exposed rocks stripped at ~0.01–1 mm/yr (0.00–0.04 in/yr); duration of erosion = duration of hiatus; deeper erosion into basement → nonconformity. Stage 4 — Subsidence and burial: region sinks; new sediment blankets erosion surface → unconformity preserved. Duration of hiatus: determined only by radiometric dating of rocks above and below, not from the surface itself.",
    ...
    },
    {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            "The duration is measured by the thickness of rock missing — thicker unconformities represent longer gaps; at a standard sedimentation rate of 1 mm/yr (0.04 in/yr), the thickness of the erosion surface in metres gives the duration in thousands of years",
