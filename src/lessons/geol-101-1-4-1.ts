...
**The rock cycle, unified.** Plate tectonics explains where all three rock families form and why they are distributed as they are. Basalt (extrusive mafic igneous rock) floors every ocean basin because it is continuously generated at mid-ocean ridges by partial melting of the mantle. Granite (felsic intrusive igneous rock) dominates continental crust because silica-rich magmas generated at subduction zones intrude into and build up the continents. Sedimentary rocks accumulate in passive margin basins, continental shelves, and the abyssal ocean floor. Metamorphic rocks form at convergent margins — in the deep roots of mountain belts generated by collision, and in the high-pressure, relatively low-temperature conditions of subducting slabs. Lessons 1.4.2 through 1.4.4 will develop each of these settings in detail.`,
    ...
    },
    {
      ...
      questions: [
        ...
        {
          q: "The oldest ocean floor anywhere on Earth is approximately 200 million years old, found in the far western Pacific near subduction zones. Continental rocks, by contrast, can be up to 4 billion years old. What explains the enormous age difference between the oldest oceanic and continental crust?",
          a: [
            "Oceanic crust forms more slowly than continental crust — mid-ocean ridge spreading produces rock at only a few centimetres per year, so the oldest oceanic crust simply has not had enough time to accumulate to greater ages",
            "Oceanic crust is continuously created at mid-ocean ridges and destroyed at subduction zones; because it is constantly recycled back into the mantle at convergent boundaries, none can survive to great age; continental crust is too buoyant to subduct and therefore accumulates over billions of years",
            "The ocean floor was completely resurfaced by a global volcanic event 200 million years ago (the same event that broke up Pangaea), erasing all older oceanic crust; continental crust escaped because it stood above the lava flows",
            "Seawater chemically weathers oceanic crust at a rate that destroys it within 200 million years; continental crust is protected from this chemical attack because it sits above sea level",
          ],
          correct: 1,
          explain: "Spreading rate (A) controls how quickly new ocean floor forms but does not limit the maximum age of oceanic crust — if old crust were preserved, it would simply extend the record further back in time regardless of spreading rate; the reason no old oceanic crust exists is not a formation-rate issue but a destruction issue. The correct answer is B: oceanic crust is continuously created at mid-ocean ridges through seafloor spreading and continuously destroyed at subduction zones, where the denser oceanic lithosphere sinks into the mantle and is recycled; the ocean floor is essentially a conveyor belt — basalt created at the ridge moves outward, ages, cools, and densifies until it reaches a subduction zone, where it descends back into the mantle; at typical spreading rates, the entire ocean floor is replaced on a timescale of roughly 200 million years; no oceanic crust can survive longer than this because all old oceanic crust eventually reaches a subduction zone; continental crust, composed of low-density felsic rock, is too buoyant to subduct into the mantle, so it persists at the surface and can accumulate to ages of 4 billion years. The Pangaea breakup (~175 Ma) did produce large volumes of basalt, but it did not globally resurface the ocean floor (C) — the Pacific Ocean has oceanic crust dating back ~200 Ma that predates Pangaea breakup; the oldest ocean floor is simply what survives from before the nearest subduction zone consumed it. Chemical weathering by seawater (D) does alter oceanic crust (hydrothermal alteration) but does not destroy it on a 200 million year timescale — chemically altered oceanic crust is still solid rock that subducts intact; weathering cannot dissolve kilometres of basalt and gabbro.",
        },
      ],
    },
  ],
