...
const craterMorphologyAndClassification: Lesson = {
  ...
  duration: '16 min',
  xpReward: 200,
  description: 'Impact craters are not all alike — their shape encodes the size of the impact, the gravity of the target body, and billions of years of subsequent modification. From simple bowl-shaped depressions to multi-ring basins 1,000 km across, each morphological class reveals distinct physics of crater collapse and planetary evolution.',
  sources: [
...
**Complex craters** begin to appear above the simple-to-complex transition diameter and display a progressively richer set of morphological features as diameter increases. The central peak — a mountain of uplifted target rock rising from the crater floor — is the hallmark of mid-sized complex craters. For Copernicus (93 km, Moon), the central peak rises ~1.2 km above the floor and exposes material from depths of ~10 km below the pre-impact surface, providing a window into the lunar deep crust. Terraced walls — a series of concentric inward-facing fault scarps — surround the crater interior, marking where large blocks of the crater rim slid inward along listric faults during modification. As diameter increases further, the central peak itself becomes unstable and collapses outward to form a **central pit** (in ice-rich targets like Ganymede) or a **peak ring** (in rock targets).

**Multi-ring basins** are the geological superlatives of the Solar System. Lunar Orientale, at 930 km diameter, is the youngest and best-preserved lunar multi-ring basin, formed ~3.72 Ga. Its structure consists of three main rings: the Montes Rook inner ring (~480 km), the Montes Rook outer ring (~620 km), and the Montes Cordillera (~930 km). The interior of the basin was flooded by mare basalt volcanism in some regions but the ring structure remains clearly visible in topographic data from the Lunar Reconnaissance Orbiter (LRO). South Pole-Aitken Basin (SPA) at 2,500 km diameter and 8 km depth is the largest and oldest confirmed impact structure in the Solar System, predating most of the preserved lunar crater record. On Callisto, the Valhalla multi-ring system (outer ring ~3,800 km diameter) formed in a body with a differentiated icy crust, producing a more subdued ring structure due to viscous relaxation of the ice over geological time.`,
      cards: [
        {
          name: 'Simple Craters: Bowl-Shaped Benchmarks',
          icon: Circle,
          color: BRAND.accent,
          desc: 'Diameter below transition (~2–4 km on Earth, ~4 km on Moon). Bowl-shaped, d/D ≈ 0.2 (constant across bodies). Raised rim of inverted ejecta stratigraphy. Floor lens of breccia + impact melt, up to 0.3× crater depth. Smooth, continuous walls without terracing. On Earth, very few simple craters preserved due to rapid erosion; Moon retains simple craters from Archean-equivalent ages. Transition diameter D_trans ∝ g⁻¹: D_trans(Moon) ≈ 4 km, D_trans(Earth) ≈ 2–3 km, D_trans(Mars) ≈ 8 km — ratio matches g ratios precisely.',
          examples: 'Meteor Crater (Barringer), Arizona: 1.2 km diameter, 175 m deep, 50,000 years old — best-preserved terrestrial simple crater; iron meteorite fragments found in surrounding plains · Linné Crater, Moon: 2.2 km diameter, pristine simple crater on Mare Serenitatis; LRO images reveal sharp rim and smooth bowl interior · Pingualuit Crater, Quebec: 3.4 km diameter, ~1.4 Ma; nearly perfectly circular lake-filled simple crater; water in the lake is among the purest on Earth due to minimal inflow',
        },
        {
          name: 'Complex Craters: Peaks, Terraces, and Rings',
          icon: Mountain,
          color: BRAND.gold,
          desc: 'Diameter above transition; d/D decreases from ~0.1 at transition to ~0.04 for largest craters (gravitational collapse shallows floor). Central peak of uplifted deep target rock (exposed from depths = 0.1× crater diameter). Terraced walls from listric fault block slumping. As D increases: central peak → peak ring → multi-ring. Central peak exposes subcrater geology: mantle material exposed at Kaguya/Grail-identified lunar craters. IODP 2016 Chicxulub drilling: peak ring = shocked granite uplifted from ~8–10 km depth, with suevite cap.',
          examples: 'Tycho Crater, Moon (86 km, ~108 Ma): iconic central peak and terraced walls; rays extend >1,500 km across lunar surface; Apollo 17 boulder sampled from Tycho ejecta may date to ~108 Ma · Chicxulub, Mexico (180 km, 66 Ma): peak ring drilled by IODP 364 expedition (2016); recovered shocked granite, suevite, impact melt rock; magnetic anomaly from melt sheet still detectable · Gosses Bluff, Australia (22 km, ~142 Ma): central uplift ring ~5 km diameter exposed at surface; surrounding rim eroded away — illustrates how terrestrial complex craters degrade',
        },
        {
          name: 'Multi-Ring Basins and Ejecta Systematics',
          icon: Orbit,
          color: BRAND.amethyst,
          desc: 'Diameter >300 km on Moon; multiple concentric fault-bounded rings form by inward collapse of entire crustal volumes. Innermost ring = collapsed peak ring. Outer rings = outer rim equivalents of progressively larger transient craters. Ejecta blanket thickness: t(r) ≈ 0.14 R_c (r/R_c)^(−3). Secondary craters from large ejecta blocks (>1 km) can form 100-km chains. Oblique impacts (<15° from horizontal): produce elliptical craters and characteristic butterfly ejecta pattern (forbidden zone downrange and uprange); <5° required for distinctly elliptical crater shape.',
          examples: 'Orientale Basin, Moon (930 km, ~3.72 Ga): youngest preserved multi-ring basin; LRO gravity data (GRAIL) reveals deeply buried basin structure · Valhalla, Callisto (outer ring ~3,800 km): formed in differentiated ice crust; ring topography subdued by viscous relaxation of warm ice over 4 Ga · Hellas Basin, Mars (2,300 km, >4 Ga): deepest point on Mars at ~7 km below datum; floor may preserve ancient valley networks buried by impact melt · Davy Crater Chain, Moon: 47-km chain of secondary craters from large Imbrium ejecta blocks — illustrates secondary cratering contamination of isochron databases',
        },
      ],
    },
    {
...
**Oblique impacts** add morphological complexity across all crater classes. At angles less than ~15° from horizontal, the ejecta pattern becomes asymmetric, with a "forbidden zone" of reduced ejecta deposition in the downrange direction — creating the characteristic butterfly ejecta pattern. At angles below ~5°, the crater itself becomes measurably elliptical. Roughly 50% of all impacts occur at angles between 30° and 60° from horizontal (the geometrically most probable range), and these produce essentially circular craters with minor ejecta asymmetries; only ~10% of impacts are oblique enough (<15°) to produce a clearly asymmetric ejecta pattern. The Ries Crater, Germany (26 km, ~14.8 Ma), shows a slightly asymmetric ejecta blanket (Bunte Breccia) suggesting an oblique impactor trajectory from the southwest.`,
      cards: [
        ...
        },
        {
          ...
          examples: 'Tycho Crater: slightly asymmetric ray system indicating ~30–45° oblique impact from northwest · Messier and Messier A (Moon): classic double crater from very oblique impact (<5°); elongated ejecta extends 120 km downrange in twin rays · Ries Crater, Germany (26 km, 14.8 Ma): Bunte Breccia ejecta distribution asymmetric, indicating oblique impact from ~SW direction; Moldavite tektites found 450 km to NE along trajectory',
        },
      ],
    },
    {
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Rock strength exceeds gravitational stresses; walls slump minimally. Final form: bowl-shaped, d/D ≈ 0.2, smooth floor with breccia lens. Raised rim of inverted ejecta stratigraphy. Transition diameter: ~2–4 km (Earth), ~4 km (Moon), ~8 km (Mars) — scales as g^(−1).',
            color: BRAND.accent,
          },
          {
            id: 'complex',
            label: 'Complex Crater (D > transition)',
            description: 'Gravity overcomes rock strength. Floor rebounds upward (central peak uplift, km-scale); walls collapse inward on listric faults (terraces). d/D decreases from ~0.1 to ~0.04. Central peak exposes deep target material (~0.1× D depth). Examples: Copernicus (93 km), Tycho (86 km).',
            color: BRAND.gold,
          },
          {
            id: 'peak-ring',
            label: 'Peak Ring Basin (D ~ 100–300 km)',
            description: 'Central peak collapses outward to form a ring of hills (peak ring) at ~0.5× crater radius from centre. Peak ring = suevite-capped shocked granite uplifted from 8–10 km depth (confirmed by IODP 364 drilling at Chicxulub). Floor: coherent impact melt sheet. Examples: Chicxulub (180 km), Schrödinger (320 km, Moon).',
            color: BRAND.coral,
          },
          {
            id: 'multi-ring',
            label: 'Multi-Ring Basin (D > 300 km)',
            description: 'Entire crustal thickness involved in collapse. Multiple concentric fault-bounded rings form beyond crater rim. Innermost ring = peak ring equivalent. Outer rings = progressively larger rim structures. Examples: Orientale (930 km, Moon), Valhalla (3,800 km outer ring, Callisto), South Pole-Aitken (2,500 km, Moon).',
            color: BRAND.amethyst,
          },
        ],
        edges: [
    ...
    },
    {
      ...
      questions: [
        {
          q: 'The simple-to-complex crater transition diameter scales approximately as D_trans ∝ g⁻¹ with surface gravity. On the Moon (g = 1.62 m/s²), the transition occurs at ~4 km. What would you predict for the transition diameter on Mars (g = 3.72 m/s²)?',
          a: [
            'About 1.7 km on Mars, because D_trans ∝ g⁻¹ gives D_Mars = D_Moon × (g_Moon/g_Mars) = 4 × (1.62/3.72) ≈ 1.74 km',
            'About 9.2 km on Mars, because lower gravity than Earth means larger craters collapse; D_Mars = D_Moon × (g_Mars/g_Moon) = 4 × (3.72/1.62) ≈ 9.2 km',
            'About 4 km on Mars, the same as the Moon, because the transition diameter is a universal property of rock strength that does not vary with gravity',
            'About 24 km on Mars, because Mars craters are always larger than lunar craters due to the higher impact velocity in the inner Solar System',
          ],
          correct: 0,
          explain: `The transition diameter scales as D_trans ∝ g⁻¹ (not g^(−1/3) as for crater size scaling — the transition is controlled by the ratio of gravitational stress to rock strength). Mars has g = 3.72 m/s², which is 3.72/1.62 = 2.30× the Moon\'s gravity. Therefore D_trans(Mars) = D_trans(Moon) / 2.30 = 4 / 2.30 ≈ 1.74 km. In practice, observed Mars transition diameters are ~6–8 km due to target properties (weaker, possibly ice-bearing substrate), but the directional prediction — that higher gravity means a smaller transition diameter — is correct. Option B inverts the ratio; higher gravity should give a smaller transition (less collapse distance before gravity wins), not larger. Option C incorrectly treats transition diameter as a universal constant. Option D confuses crater size with transition diameter.`,
        },
        {
          ...
          a: [
            'The peak ring consists of shocked granite uplifted from ~8–10 km depth below the original surface, capped by suevite and impact melt rock — confirming that peak rings form by dynamic collapse of an uplifted central peak rather than by simple inward collapse of the crater rim',
        ...
        {
          q: `What is the depth of origin of the rocks forming the central peak of a complex crater, as a fraction of the crater\'s final diameter? If Copernicus Crater (93 km diameter) has a central peak rising 1.2 km above its floor, approximately how deep below the pre-impact surface did the peak rock originate?`,
          a: [
            'Central peak rocks originate from ~0.1× the crater diameter in depth; for Copernicus (93 km), this gives approximately 9–10 km below the pre-impact lunar surface',
            'Central peak rocks originate from the same depth as the crater floor (0.2× diameter); for Copernicus the rocks come from ~18 km depth, equivalent to the present crater depth',
            'Central peak rocks originate from approximately 0.5× the crater diameter; for Copernicus this would be ~46 km — equivalent to the entire lunar crust thickness',
            'Central peak height directly equals the depth of origin: the peak rises 1.2 km above the floor, so the rocks came from 1.2 km below the pre-impact surface',
          ],
          correct: 0,
          explain: `Empirical scaling relationships established by Cintala & Grieve (1998) and confirmed by spectral and sample studies show that the depth of origin of central peak material scales as approximately 0.1× the crater diameter. For Copernicus (93 km), this gives an origin depth of ~9–10 km below the pre-impact lunar surface. This is a critical property: central peaks provide natural "boreholes" into the crust, exposing material that would otherwise be inaccessible. Remote sensing spectroscopy of lunar central peaks (using Kaguya/SELENE and Lunar Reconnaissance Orbiter DIVINER data) has been used to map the composition of the deep lunar crust. Option B confuses crater depth with origin depth of central peak material; the crater depth is ~0.04–0.1× D, but peak rocks come from greater depth. Option C (0.5× D) would imply that Copernicus excavated to ~46 km depth — far exceeding the Moon\'s entire crustal thickness (~30–60 km). Option D confuses the peak\'s topographic height above the crater floor with its depth of origin; the uplift of km-scale is achieved by the rebound of rock that was originally much deeper.`,
        },
      ],
    },
  ],
