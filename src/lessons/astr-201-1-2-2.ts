...
const runawayGreenhouseVenus: Lesson = {
  ...
  duration: '16 min',
  xpReward: 200,
  description: 'Venus is hotter than Mercury despite receiving less sunlight. Its 465°C surface, 92-bar atmosphere, and 150× Earth D/H ratio tell the story of a runaway greenhouse — a cautionary tale for the inner edge of every planetary habitable zone.',
  sources: [
...
**Exoplanet implications: the HZ inner edge.** The Venus zone concept is now a standard framework in exoplanet habitability science. For a Sun-like star (G2V), the conservative HZ inner edge is ~0.95–1.0 AU (moist greenhouse begins significantly depleting water) and the runaway threshold is ~0.84 AU. For cooler M-dwarf stars, the HZ moves inward (lower luminosity), but the runaway threshold also scales proportionally — so the Venus–Earth analogy applies at different absolute distances depending on stellar type. The key observational challenge is distinguishing a "Venus twin" from an "Earth twin" at similar orbital distances, since both would appear as rocky planets in the HZ from the perspective of transit surveys. JWST observations of TRAPPIST-1c (0.0293 AU from its M8 star, insolation ~2.25 Earth units — comparable to Venus's 1.9) in 2023 found no evidence for a thick CO₂ atmosphere, suggesting it may be a bare rock rather than a Venus analog — adding complexity to the simple Venus-at-inner-HZ picture.`,
      cards: [
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.accent,
          desc: `Pioneer Venus (1978) measured D/H = 150× Earth\'s SMOW standard in Venus\'s atmospheric water vapour. Jeans escape rate of H >> D (λ scales with mass); preferential H escape enriches D/H over Ga. Required initial water: 3–300 m global layer (calculation depends on assumed escape history and initial D/H). Photodissociation: UV breaks H₂O → H + OH in the stratosphere; cold trap failed on Venus when it became too warm for condensation.`,
    ...
    },
    {
      ...
      interaction: {
        ...
        description: 'The runaway greenhouse cascade on Venus: from early surface water through photodissociation, H escape, carbonate cycle failure, and CO₂ accumulation to the present 92-bar 465°C state',
        nodes: [
          {
            id: 'early-venus',
            label: 'Early Venus: possible surface water',
            description: `In the first ~1–2 billion years of solar system history, the Sun was ~70–80% as luminous as today. At 0.72 AU, Venus may have received insolation just barely compatible with liquid surface water — estimated surface temperatures ~30–40°C with a modest CO₂ atmosphere. The D/H ratio enrichment of 150× Earth\'s standard is consistent with an original global water layer 3–300 m deep. This "habitable early Venus" scenario is uncertain but scientifically plausible given the faint young Sun.`,
            color: BRAND.accent,
          },
          {
          ...
          {
            id: 'present-venus',
            label: 'Present Venus: 92 bar, 465°C',
            description: 'The endpoint: 96.5% CO₂, 3.5% N₂, trace H₂O (~30 ppm), SO₂, and HCl. Surface pressure 92 bar. Surface temperature 465°C (738 K) — nearly uniform across the globe despite a 243-day solar day, due to efficient atmospheric heat transport. Sulphuric acid cloud deck at 45–70 km altitude, visible albedo 0.77. The planet radiates from cold cloud tops at ~230 K, losing heat very slowly. D/H = 150× Earth in the residual water vapour. No liquid water anywhere. Surface geology: basaltic plains, tesserae (ancient highland terrain), large shield volcanoes. No confirmed present-day volcanic eruption, though Magellan and Venus Express data suggest recent (<1 Ma) surface changes.',
    ...
    },
    {
      ...
      questions: [
        {
          q: `Venus absorbs only ~160 W/m² of solar energy on average — less than Earth\'s ~240 W/m² — yet its surface is 465°C while Earth\'s surface averages ~15°C. What is the correct physical explanation for this paradox?`,
          a: [
            'Venus absorbs less energy because its dense atmosphere reflects most sunlight, but the thermal inertia of the 92-bar atmosphere stores heat over the 243-day day-night cycle, accumulating energy until the surface reaches 465°C — effectively a seasonal heat buildup that never dissipates',
        ...
        },
        {
          ...
          a: [
            ...
            'The runaway greenhouse is still actively occurring on Venus today; surface water is currently evaporating at a rate of ~1 mm per year, and Venus will have completely expelled all surface and crustal water within 200 million years; the current atmospheric state represents the intermediate phase of an ongoing planetary-scale water loss event',
