...
Digital elevation models (DEMs) and GIS tools have transformed watershed analysis. USGS StreamStats and similar tools automatically delineate watershed boundaries, compute morphometric parameters (area, perimeter, mean slope, hypsometric integral, stream density), and extract stream networks from 1/3 arc-second (~10 m (33 ft)) or 1 arc-second (~30 m (98 ft)) DEMs. These parameters feed into hydrological models and flood frequency analysis. The hypsometric integral — the ratio of the area under the hypsometric curve (elevation vs. normalised area) to the total area — indicates watershed erosional maturity: young (integral > 0.6), mature (~0.4–0.6), and monadnock (< 0.35) stages.`,
      keyTerms: [
        {
          term: 'Watershed',
