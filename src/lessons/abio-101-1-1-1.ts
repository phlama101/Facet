    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.coral,
          desc: 'Alkaline hydrothermal vents like Lost City produce natural pH and redox gradients across thin mineral membranes, mirroring the electrochemical gradients cells use to make ATP. The cool (~40–90°C) alkaline fluids are more compatible with fragile RNA chemistry than the >300°C acidic black smokers, and labyrinthine mineral micropores provide natural compartments for concentrating chemistry.',
          examples: `Lost City hydrothermal field (Mid-Atlantic Ridge, discovered 2000): 40–90°C, pH 9–11, H₂-rich serpentinisation fluids; black smokers (Galápagos Rift, 1977): >300°C, acidic, sulfide-rich; Russell & Hall (1997) iron-sulfide bubble model; Nick Lane\'s chemiosmotic origin-of-life hypothesis`,
        },
        {
      ...
      questions: [
        ...
        },
        {
          ...
          a: [
            ...
            'Alkaline vents produce natural proton-concentration gradients across thin iron-sulfide mineral membranes at moderate temperatures (~40–90°C), closely mirroring the electrochemical gradients that living cells use to make ATP, while black smokers\' temperatures exceed 300°C and their acidity is incompatible with RNA chemistry and fatty acid membrane stability',
