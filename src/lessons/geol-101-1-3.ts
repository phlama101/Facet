...
This lesson explains how solid rock can flow, where the heat driving that flow comes from, what the convection cycle looks like, and how it produces the features we see at Earth's surface.`,
      ...
      interaction: {
        ...
        src: 'https://upload.wikimedia.org/wikipedia/commons/8/83/Rock_cycle.jpg',
        alt: 'Diagram of the rock cycle showing the relationships between igneous, sedimentary, and metamorphic rocks',
        aspectRatio: '4/3',
        ...
        annotations: [
          {
            ...
            y: 15,
            label: 'Magma / Lava',
            description: 'Molten rock that originates in the mantle or lower crust. Where it rises to the surface, it erupts as lava; where it solidifies underground, it forms intrusive igneous rock. Mantle convection drives magma generation at mid-ocean ridges and subduction zones.',
          },
          {
            id: '2',
            x: 20,
            y: 45,
            label: 'Igneous Rock',
            description: 'Rock formed by the cooling and solidification of magma. Granite (slow cooling, large crystals) and basalt (fast cooling, fine crystals) are the two most common types and represent the building blocks of continental and oceanic crust respectively.',
          },
          {
            id: '3',
            x: 80,
            ...
            description: 'Rock formed from compressed and cemented fragments of weathered pre-existing rock, or from chemical precipitation. Sandstone, limestone, and shale preserve Earth\'s environmental history in their layers.',
          },
          {
            id: '4',
            x: 50,
            ...
            description: 'Rock transformed by heat and pressure without melting. Slate, schist, and marble form where tectonic forces bury and compress existing rock, changing its mineral composition and texture.',
          },
        ],
      },
    },
