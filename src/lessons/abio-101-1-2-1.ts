    ...
    },
    {
      ...
      cards: [
        ...
        },
        {
          ...
          icon: Globe,
          color: BRAND.coral,
          desc: 'MARSIS radar detected a 20 km (12 mi) subglacial reflector ~1.5 km (0.9 mi) beneath the south polar cap (2018), interpreted as a perchlorate brine lake. Recurring slope lineae suggested seasonal brines but now favour dry granular flows. Methane spikes (~7 ppb) detected by Curiosity remain controversial. The deep subsurface is the leading present-day habitability target.',
          examples: 'MARSIS south polar bright reflector: 20 km (12 mi) wide, ~1.5 km (0.9 mi) depth, interpreted as perchlorate brine lake; alternative explanations (clays, CO₂ ice) debated · Curiosity methane: episodic spikes ~7 ppb vs ESA TGO upper limit ~0.05 ppb — discrepancy unresolved · Phoenix perchlorate discovery (2008): ClO₄⁻ at ~0.5 wt% in arctic soil, lowers brine freezing point to −70 °C (-94°F)',
        },
        {
          name: 'Mars Atmosphere and Habitability Constraints',
          icon: Thermometer,
          color: BRAND.gold,
          desc: `Present Mars has a 6 mbar CO₂ atmosphere — 0.6% of Earth\'s — with a mean surface temperature of −63 °C (-81°F). Loss of the global magnetosphere ~4.0 Ga allowed solar wind stripping (MAVEN measures ~100 g/s ongoing loss). UV flux at the surface is intense. Perchlorates oxidise organics. These factors make surface habitability effectively impossible today.`,
      ...
      interaction: {
        ...
        nodes: [
          ...
          },
          {
            ...
            description: 'Over 40,000 km (24856 mi) of branching river valley systems carved into southern highlands. Gale Crater lake (~3.5 Ga) preserved pH-neutral mudstone with CHNOPS chemistry. Jezero Crater delta formed by sustained river input. These environments were demonstrably habitable.',
            color: BRAND.jade,
          },
          {
          ...
          },
          {
            ...
            description: 'Amazonian Mars (3.0 Ga–present): 6 mbar CO₂ atmosphere, mean −63 °C (-81°F), liquid water thermodynamically unstable. Intense UV flux at surface. Perchlorate salts oxidise organics. Recurring slope lineae probably dry granular flows. Curiosity methane spikes unresolved. Surface is effectively uninhabitable.',
            color: BRAND.coral,
          },
          {
            id: 'subsurface-target',
            label: 'Subsurface Habitability Target',
            description: 'The deep subsurface is shielded from UV and cosmic rays, may contact perchlorate brines stable below −70 °C (-94°F), and could be sustained by serpentinisation or radiolysis. MARSIS detected a candidate subglacial brine lake 1.5 km (0.9 mi) beneath the south polar cap. The subsurface is the leading target for extant Martian life.',
      ...
      questions: [
        {
          ...
          correct: 1,
          explain: 'The Noachian (~4.1–3.7 Ga) is defined by heavy impact bombardment and, critically for habitability, by sustained liquid water activity evidenced by global valley network systems spanning more than 40,000 km (24856 mi), by delta and alluvial fan deposits, and by phyllosilicate (clay) minerals that can only form through prolonged aqueous alteration of silicate rock. These clay minerals — detected from orbit by instruments including CRISM on MRO — require water-to-rock ratios and timescales inconsistent with brief impact-melt events. Answer A describes conditions not applicable to any Martian period; Mars never had a nitrogen-dominated atmosphere. Answer C better describes the Hesperian. Answer D conflates the Amazonian with the event of magnetosphere loss, which occurred near the end of the Noachian. The Noachian is the period that both surface rovers (Curiosity, Perseverance) are targeting for biosignature searches precisely because its environmental conditions — near-neutral pH, low salinity, available chemical energy, persistent liquid water — most closely resemble environments on Earth where life thrives.',
        },
        {
        ...
        },
        {
          ...
          a: [
            ...
            'MARSIS detected a 20 km (12 mi)-wide radar-bright reflector ~1.5 km (0.9 mi) beneath the south polar layered deposits, interpreted as a subglacial liquid water lake — likely a perchlorate brine — but alternative explanations including frozen CO₂, clay minerals, or conductive basal sediments remain viable',
        ...
        },
        {
          ...
          a: [
            ...
            'Perchlorates help by lowering the freezing point of water, potentially enabling briny liquid water in the shallow subsurface at temperatures down to −70 °C (-94°F); they hinder by generating highly reactive chlorine radicals under Martian UV irradiation that rapidly oxidise and destroy organic molecules',
