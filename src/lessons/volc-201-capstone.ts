    ...
    },
    {
      ...
      questions: [
        ...
        // ── Q6: LIP definition — volume threshold ───────────────────────────
        {
          ...
          a: [
            'A LIP requires a minimum of 10,000 km³ (2399 cu mi) of igneous material emplaced over any time period; by this threshold, Yellowstone qualifies as a LIP because its three caldera-forming eruptions together exceed 10,000 km³ (2399 cu mi)',
            'A LIP requires a minimum of 100,000 km³ (23990 cu mi) of predominantly mafic igneous material emplaced in less than ~50 million years, usually in one or a few short pulses; the Ontong Java Plateau (~50 × 10⁶ km³) and the Siberian Traps (~3 × 10⁶ km³ surface volcanic material plus extensive sills) qualify, whereas the Cascade volcanic arc (~5,000 km³ (1200 cu mi) total) does not',
            'A LIP requires a minimum erupted volume of 100 km³ (24 cu mi) of felsic material; the definition specifically excludes mafic provinces because basaltic eruptions cannot sustain the high eruption columns needed to distribute material over continental scale',
            'LIPs are defined solely by areal extent exceeding 1,000,000 km² (386100 sq mi); volume is not a criterion, and both the Himalayan granites and the Deccan Traps qualify equally as LIPs regardless of composition',
          ],
          correct: 1,
          explain:
            'The definition of a Large Igneous Province, formalised by Bryan and Ernst (2008) and widely adopted, requires a minimum volume of ~100,000 km³ (23990 cu mi) of predominantly mafic (and/or ultramafic) igneous material emplaced in geologically short time intervals (typically <50 Myr, often <5 Myr). The emphasis on mafic composition and rapid emplacement distinguishes LIPs from slow-growing magmatic arcs or granitic batholiths. The Ontong Java Plateau (western Pacific) is the largest known LIP at roughly 50 × 10⁶ km³; the Siberian Traps (~252 Ma, ~3 × 10⁶ km³ of surface lava plus an even larger sill complex intruding the Tunguska Basin) and the Deccan Traps (~66 Ma, ~0.5–1.5 × 10⁶ km³) are canonical continental flood basalt LIPs. Yellowstone\'s three eruptions total only ~3,000–4,000 km³ (960 cu mi) DRE and are felsic (rhyolitic), disqualifying it on both volume and composition grounds. The Cascade arc is an active continental margin arc, not a LIP.',
        },
        ...
        // ── Q8: Crystal mush — eruptibility threshold ───────────────────────
        {
          ...
          a: [
            ...
            'Any melt fraction above 1% is sufficient for eruption; even trace amounts of interstitial melt allow crystal mushes to flow under the very high lithostatic pressures present at 5–10 km (6.2 mi) depth in the crust',
          ],
          correct: 0,
          explain:
        ...
        // ── Q9: Yellowstone magmatic system depth ───────────────────────────
        {
          ...
          a: [
            'A shallow rhyolitic crystal mush reservoir at approximately 5–17 km (11 mi) depth is underlain by a much larger basaltic/gabbroic partial melt zone extending from ~20 to ~50 km (31 mi) depth, which itself sits above the top of the mantle plume; together these represent a vertically connected magmatic system with a total volume of roughly 46,000 km³ (11035 cu mi) of partial melt',
            'A single rhyolitic magma chamber at 5–15 km (9.3 mi) depth containing ~30% melt fraction underlies the entire caldera; below 15 km (9.3 mi) the crust is entirely solid and no magmatic material is present',
            'The Yellowstone hotspot is fed directly by a tear in the North American plate that exposes the core–mantle boundary; magma wells up from 2,900 km (1802 mi) depth without any crustal storage, explaining the rapid onset of eruptions',
          ...
          correct: 0,
          explain:
            'Seismic tomography studies (Farrell et al. 2014; Huang et al. 2015) have imaged a two-level magmatic architecture beneath Yellowstone. The upper crustal reservoir, at roughly 5–17 km (11 mi) depth, is a rhyolitic crystal mush with an estimated 5–15% partial melt fraction and a volume of ~4,000–10,000 km³ (2399 cu mi); this is the source reservoir for rhyolitic eruptions. A deeper, larger basaltic/gabbroic partial melt zone extends from approximately 20 to 50 km (31 mi) depth, with volumes estimated up to ~46,000 km³ (11035 cu mi) at ~2% melt fraction. This deeper body represents basaltic underplating by the Yellowstone mantle plume, which provides the heat that maintains the overlying rhyolitic mush. Heat transfer from the basaltic lower zone periodically remobilises the upper rhyolitic mush toward the lock-up threshold. The two-tier system is connected but separated by a mostly solid crustal region, explaining the time lag between plume heat pulses and surface rhyolitic volcanism. The last major rhyolitic eruption at Yellowstone was the Lava Creek Tuff caldera-forming event ~631,000 years ago.',
        },
        ...
        // ── Q11: Toba supereruption age and volume ──────────────────────────
        {
          ...
          a: [
            ...
            'Approximately 640,000 years ago and ~1,000 km³ (240 cu mi) DRE; Toba is the most recent caldera-forming eruption at Yellowstone, and its ash layer is used to correlate Pleistocene stratigraphic sections across North America',
            'Approximately 26,500 years ago and ~530 km³ (127 cu mi) DRE; Toba is the correct name for the Oruanui eruption at Lake Taupo, New Zealand, which is the most recent confirmed VEI 8 eruption on Earth',
            'Approximately 74,000 years ago (Marine Isotope Stage 4) and ~2,800 km³ (672 cu mi) dense-rock equivalent (bulk tephra ~5,000–7,000 km³ (1679 cu mi)); it produced a caldera ~100 × 30 km (19 mi) in northern Sumatra and deposited recognisable ash across South Asia, the Indian Ocean, and East Africa',
          ],
          correct: 3,
          explain:
            'The Toba supereruption occurred approximately 73,500–74,000 years ago (U–Pb and ⁴⁰Ar/³⁹Ar dating) during Marine Isotope Stage 4, a glacial period, on the island of Sumatra (Indonesia). It erupted approximately 2,800 km³ (672 cu mi) DRE (dense-rock equivalent), making it the largest known eruption of the Quaternary. The resulting caldera — now occupied by Lake Toba — measures approximately 100 km (62 mi) × 30 km (19 mi). The Youngest Toba Tuff is the principal deposit, with thicknesses of several centimetres to metres found across South Asia, the Bay of Bengal, and East Africa. Toba has been proposed (controversially) to have caused a human population bottleneck, though the genetic and archaeological evidence for catastrophic effects on human populations remains debated. The end-Permian Siberian Traps (~252 Ma) and Yellowstone\'s Lava Creek Tuff (~631 ka) are entirely different events. The Oruanui eruption (~26.5 ka, ~530 km³ (127 cu mi) DRE) is at Taupo, New Zealand — a distinct volcano.',
        },
        ...
        // ── Q18: MORB spreading rate vs axial structure ──────────────────────
        {
          ...
          a: [
            'Fast-spreading ridges (e.g., East Pacific Rise, ~10 cm/yr full rate) have a prominent axial rift valley 20–40 km (25 mi) wide and 1–3 km (1.9 mi) deep, caused by the high extension rate pulling the crust apart before magma supply can fill the gap; slow ridges (e.g., Mid-Atlantic Ridge, ~2–3 cm/yr) have a narrow axial high without a rift valley, reflecting the robust melt supply at high spreading rates',
            'Slow-spreading ridges (e.g., Mid-Atlantic Ridge, ~2–3 cm/yr full rate) have a prominent axial rift valley 20–40 km (25 mi) wide and 1–3 km (1.9 mi) deep, caused by extension exceeding magmatic supply and allowing normal faulting to dominate; fast-spreading ridges (e.g., East Pacific Rise, ~10 cm/yr) have a narrow (<1–2 km (1.2 mi) wide), low-relief axial high underlain by an axial magma chamber lens, reflecting robust magma supply that keeps pace with or exceeds extension and prevents rift valley formation',
          ...
          correct: 1,
          explain:
            'The relationship between spreading rate and axial morphology is one of the most fundamental observations of mid-ocean ridge geology, established by the global survey work of Macdonald, Purdy, and others in the 1970s–1980s. The key variable is the ratio of magmatic heat supply to the rate of extension-driven cooling. At slow-spreading ridges (~1–5 cm/yr full rate, e.g., Mid-Atlantic Ridge, Southwest Indian Ridge), the magma supply is insufficient to keep the ridge thermally robust; the crust cools and becomes brittle, and normal faulting accommodates the extension, creating a pronounced axial rift valley 20–50 km (31 mi) wide and 1–3 km (1.9 mi) deep bounded by inward-facing fault scarps. Mantle peridotite is commonly exposed on the valley walls. At fast-spreading ridges (~8–16 cm/yr, e.g., East Pacific Rise), continuous robust magma supply maintains high crustal temperatures; the crust is thin and warm enough to deform ductilely rather than by brittle faulting, and the axial zone is an inflated high with a narrow (<1 km (0.6 mi)), shallow (<200 m (656 ft) deep) axial summit trough rather than a deep rift. Multichannel seismic profiling typically images an axial magma chamber melt lens at 1–3 km (1.9 mi) depth beneath fast ridges.',
        },
