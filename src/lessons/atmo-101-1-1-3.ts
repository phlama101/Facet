  ...
  sections: [
    {
      ...
      body: `The sun is 150 million kilometres away, yet it is the ultimate source of nearly all energy that drives Earth's climate, weather, and life. The solar constant — the average amount of solar energy reaching the top of the atmosphere — is approximately 1,361 watts per square metre. Over time, this energy input must be balanced by an equal output of energy back to space, or Earth's temperature would continuously rise or fall. This balance between incoming solar energy and outgoing radiation is Earth's **energy budget**, and understanding it is the foundation of climate science.
