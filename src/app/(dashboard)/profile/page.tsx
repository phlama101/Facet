...
// Only consider lesson IDs that have actual lesson files
const LESSON_ID_SET = new Set(LESSON_LIST.map(l => l.id))
...
type AchCategory = 'lessons' | 'xp' | 'streak' | 'level' | 'path'
...
const ACHIEVEMENTS: Achievement[] = [
  // ── Lesson count milestones ───────────────────────────────────────────────
  {
    ...
    category: 'lessons', rarity: 'common', color: BRAND.accent, xpBonus: 50,
    check: c => c.count >= 1,
  },
  {
    id: 'three-edges',
    ...
    category: 'lessons', rarity: 'common', color: BRAND.jade, xpBonus: 75,
    check: c => c.count >= 3,
  },
  {
    ...
    category: 'lessons', rarity: 'common', color: BRAND.gold, xpBonus: 100,
    check: c => c.count >= 5,
  },
  {
    id: 'decahedral',
    ...
    category: 'lessons', rarity: 'uncommon', color: BRAND.gold, xpBonus: 200,
    check: c => c.count >= 10,
  },
  {
    id: 'field-ready',
    ...
    category: 'lessons', rarity: 'uncommon', color: BRAND.coral, xpBonus: 300,
    check: c => c.count >= 20,
  },
  {
    id: 'deep-section',
    ...
    category: 'lessons', rarity: 'rare', color: BRAND.coral, xpBonus: 500,
    check: c => c.count >= 35,
  },
  {
    id: 'half-century',
    ...
    category: 'lessons', rarity: 'rare', color: BRAND.amethyst, xpBonus: 750,
    check: c => c.count >= 50,
  },
  {
    id: 'rock-record',
    ...
    category: 'lessons', rarity: 'epic', color: BRAND.ruby, xpBonus: 1000,
    check: c => c.count >= 75,
  },
  {
    id: 'century-scholar',
    ...
    category: 'lessons', rarity: 'epic', color: BRAND.gold, xpBonus: 1500,
    check: c => c.count >= 100,
  },
  {
    id: 'obsidian-scholar',
    ...
    category: 'lessons', rarity: 'legendary', color: BRAND.amethyst, xpBonus: 2000,
  ...
  // ── XP milestones ─────────────────────────────────────────────────────────
  {
    ...
    name: 'Spark',
    desc: 'Earn 500 XP',
    category: 'xp', rarity: 'common', color: BRAND.accent, xpBonus: 50,
    check: c => c.xp >= 500,
  },
  {
    id: 'xp-1k',
    name: 'Brilliant',
    desc: 'Earn 1,000 XP',
    category: 'xp', rarity: 'uncommon', color: BRAND.gold, xpBonus: 150,
    check: c => c.xp >= 1000,
  },
  {
    id: 'xp-2500',
    name: 'Crystalline',
    desc: 'Earn 2,500 XP',
    category: 'xp', rarity: 'rare', color: BRAND.amethyst, xpBonus: 300,
    check: c => c.xp >= 2500,
  },
  {
    id: 'xp-5k',
    name: 'Igneous',
    desc: 'Earn 5,000 XP',
    category: 'xp', rarity: 'epic', color: BRAND.ruby, xpBonus: 500,
    check: c => c.xp >= 5000,
  },
  {
    id: 'xp-10k',
    name: 'Metamorphic',
    desc: 'Earn 10,000 XP',
    category: 'xp', rarity: 'legendary', color: BRAND.gold, xpBonus: 1000,
    check: c => c.xp >= 10000,
  },
  ...
  // ── Streak milestones ─────────────────────────────────────────────────────
  {
    ...
    category: 'streak', rarity: 'common', color: BRAND.jade, xpBonus: 75,
    check: c => c.streak >= 3,
  },
  {
    id: 'streak-7',
    ...
    category: 'streak', rarity: 'uncommon', color: BRAND.jade, xpBonus: 200,
    check: c => c.streak >= 7,
  },
  {
    id: 'streak-14',
    ...
    category: 'streak', rarity: 'rare', color: BRAND.gold, xpBonus: 400,
    check: c => c.streak >= 14,
  },
  {
    id: 'streak-30',
    ...
    category: 'streak', rarity: 'epic', color: BRAND.amethyst, xpBonus: 750,
    check: c => c.streak >= 30,
  },
  {
    id: 'streak-100',
    ...
    category: 'streak', rarity: 'legendary', color: BRAND.ruby, xpBonus: 2000,
  ...
  // ── Level milestones ──────────────────────────────────────────────────────
  {
    ...
    name: 'Polished',
    desc: 'Reach level 5',
    category: 'level', rarity: 'uncommon', color: BRAND.accent, xpBonus: 250,
    check: c => c.level >= 5,
  },
  {
    id: 'level-10',
    name: 'Hardened Core',
    desc: 'Reach level 10',
    category: 'level', rarity: 'rare', color: BRAND.coral, xpBonus: 500,
    check: c => c.level >= 10,
  },
  {
    id: 'level-15',
    name: 'Crystallised',
    desc: 'Reach level 15',
    category: 'level', rarity: 'epic', color: BRAND.amethyst, xpBonus: 1000,
    check: c => c.level >= 15,
  },
  {
    id: 'level-20',
    name: 'Masterwork',
    desc: 'Reach level 20',
    category: 'level', rarity: 'legendary', color: BRAND.gold, xpBonus: 2000,
    check: c => c.level >= 20,
  },

  // ── Path completion ───────────────────────────────────────────────────────
  {
    id: 'path-earth-foundations',
    ...
    check: c => {
      const ids = availableInPath('earth-foundations')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    id: 'path-deep-time',
    ...
    check: c => {
      const ids = availableInPath('deep-time')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    id: 'path-ocean-systems',
    name: 'Oceanographer',
    desc: 'Complete all Ocean Systems lessons',
    category: 'path', rarity: 'rare', color: BRAND.accent, xpBonus: 750,
    check: c => {
      const ids = availableInPath('ocean-systems')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    id: 'path-atmosphere',
    name: 'Meteorologist',
    desc: 'Complete all Atmosphere & Weather lessons',
    category: 'path', rarity: 'rare', color: BRAND.jade, xpBonus: 750,
    check: c => {
      const ids = availableInPath('atmosphere-weather')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    id: 'path-volcanoes',
    name: 'Volcanologist',
    desc: 'Complete all Volcanoes lessons',
    category: 'path', rarity: 'rare', color: BRAND.coral, xpBonus: 750,
    check: c => {
      const ids = availableInPath('volcanoes')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    ...
    desc: 'Complete all Climate, Past & Future lessons',
    category: 'path', rarity: 'epic', color: BRAND.ruby, xpBonus: 1500,
    check: c => {
      const ids = availableInPath('climate-past-future')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    id: 'path-solar-system',
    name: 'Solar System Explorer',
    desc: 'Complete all Solar System lessons',
    category: 'path', rarity: 'rare', color: BRAND.gold, xpBonus: 750,
    check: c => {
      const ids = availableInPath('solar-system')
      return ids.length > 0 && ids.every(id => c.ids.includes(id))
    },
  },
  {
    id: 'path-all-complete',
    name: 'Grand Naturalist',
    desc: 'Complete every learning path',
    category: 'path', rarity: 'legendary', color: BRAND.amethyst, xpBonus: 5000,
    check: c => {
      const allIds = LEARNING_PATHS.flatMap(p =>
...
const ACHIEVEMENT_GROUPS: { key: AchCategory; label: string }[] = [
